...
- `site/content/Api-v5/`, `site/content/Api-v4/` — generated namespace markdown
- `site/taxonomy/api-v5/`, `site/taxonomy/api-v4/` — generated taxonomy YAML

Hand-authored files (committed to git) include `site/content/GettingStarted/`, `site/content/Home/`, `site/taxonomy/api/index.yml`, and the theme's SCSS/JS/layout views.
