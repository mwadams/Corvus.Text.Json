...
public readonly struct Age : IJsonElement<Age>
{
    ...
    public static class JsonSchema
    {
        ...
        internal static void ApplyJsonSchema(IJsonDocument parentDocument, int parentIndex, ref JsonSchemaContext context)
        {
            ...
            if (!JsonSchemaMatching.MatchTypeNumber(tokenType, Keywords_9857823edfdd454b8bdf0af5fa37e392.Type, ref context))
            {
                ...
                context.Ignored(JsonSchemaMatching.IgnoredNotTypeNumber, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Minimum);
                context.Ignored(JsonSchemaMatching.IgnoredNotTypeNumber, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Maximum);
            }
            else
            {
                ...
                if (JsonElementHelpers.CompareNormalizedJsonNumbers(
                    ...
                    MinimumExponent) < 0)
                {
                    context.Matched(false, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Minimum);
                    if (!context.HasCollector)
                    {
                        context.PopSchemaLocation();
                        return;
                ...
                {
                    context.Matched(true, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Minimum);
                }
                ...
                if (JsonElementHelpers.CompareNormalizedJsonNumbers(
                    ...
                    MaximumExponent) > 0)
                {
                    context.Matched(false, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Maximum);
                    if (!context.HasCollector)
                    {
                        context.PopSchemaLocation();
                        return;
                ...
                {
                    context.Matched(true, schemaEvaluationPath: Keywords_9857823edfdd454b8bdf0af5fa37e392.Maximum);
                }
            }
