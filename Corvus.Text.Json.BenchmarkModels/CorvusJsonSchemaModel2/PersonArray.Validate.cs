...
public readonly partial struct PersonArray
{
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<Benchmark.CorvusJsonSchema2.Person> arrayEnumerator = value.EnumerateArray();
            while (arrayEnumerator.MoveNext())
            {
                ...
                switch (length)
                {
                    case 0:
                        ...
                        itemResult = arrayEnumerator.Current.As<Corvus.Json.JsonNumber>().Validate(result.CreateChildContext(), level);
                    ...
                    default:
                        if (!result.HasEvaluatedLocalOrAppliedItemIndex(length))
                        {
                            if (level > ValidationLevel.Basic)
                            {
                                result = result.PushValidationLocationReducedPathModifier(new("#/unevaluatedItems/$ref"));
                            }
