...
public readonly partial struct OtherNames
    : IJsonValue<Benchmark.CorvusJsonSchema2.OtherNames>
{
    ...
    /// <summary>
    /// Gets the instance as a <see cref="Benchmark.CorvusJsonSchema2.NameComponent" />.
    /// </summary>
    public Benchmark.CorvusJsonSchema2.NameComponent AsNameComponent
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema2.NameComponent>();
        }
    }

    /// <summary>
    /// Gets a value indicating whether the instance is a <see cref="Benchmark.CorvusJsonSchema2.NameComponent" />.
    /// </summary>
    public bool IsNameComponent
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema2.NameComponent>().IsValid();
        }
    }

    /// <summary>
    /// Gets the instance as a <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray" />.
    /// </summary>
    public Benchmark.CorvusJsonSchema2.NameComponentArray AsNameComponentArray
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema2.NameComponentArray>();
        }
    }

    /// <summary>
    /// Gets a value indicating whether the instance is a <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray" />.
    /// </summary>
    public bool IsNameComponentArray
    {
        get
        {
            return this.As<Benchmark.CorvusJsonSchema2.NameComponentArray>().IsValid();
        }
    }
    ...
    /// <summary>
    /// Conversion to <see cref="Benchmark.CorvusJsonSchema2.NameComponent"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Benchmark.CorvusJsonSchema2.NameComponent(OtherNames value)
    {
        return value.As<Benchmark.CorvusJsonSchema2.NameComponent>();
    }

    /// <summary>
    /// Conversion from <see cref="Benchmark.CorvusJsonSchema2.NameComponent"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Benchmark.CorvusJsonSchema2.NameComponent value)
    {
        return value.As<OtherNames>();
    }

    /// <summary>
    /// Conversion to <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Benchmark.CorvusJsonSchema2.NameComponentArray(OtherNames value)
    {
        return value.As<Benchmark.CorvusJsonSchema2.NameComponentArray>();
    }

    /// <summary>
    /// Conversion from <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator OtherNames(Benchmark.CorvusJsonSchema2.NameComponentArray value)
    {
        return value.As<OtherNames>();
    }
    ...
    /// <param name="matchNameComponent">Match a <see cref="Benchmark.CorvusJsonSchema2.NameComponent"/>.</param>
    /// <param name="matchNameComponentArray">Match a <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray"/>.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TOut Match<TIn, TOut>(
        in TIn context,
        Matcher<Benchmark.CorvusJsonSchema2.NameComponent, TIn, TOut> matchNameComponent,
        Matcher<Benchmark.CorvusJsonSchema2.NameComponentArray, TIn, TOut> matchNameComponentArray,
        Matcher<Benchmark.CorvusJsonSchema2.OtherNames, TIn, TOut> defaultMatch)
    {
        Benchmark.CorvusJsonSchema2.NameComponent matchNameComponentValue = this.As<Benchmark.CorvusJsonSchema2.NameComponent>();
        if (matchNameComponentValue.IsValid())
        {
            return matchNameComponent(matchNameComponentValue, context);
        }

        Benchmark.CorvusJsonSchema2.NameComponentArray matchNameComponentArrayValue = this.As<Benchmark.CorvusJsonSchema2.NameComponentArray>();
    ...
    public TOut Match<TOut>(
        Matcher<Benchmark.CorvusJsonSchema2.NameComponent, TOut> matchNameComponent,
        Matcher<Benchmark.CorvusJsonSchema2.NameComponentArray, TOut> matchNameComponentArray,
        Matcher<Benchmark.CorvusJsonSchema2.OtherNames, TOut> defaultMatch)
    {
        Benchmark.CorvusJsonSchema2.NameComponent matchNameComponentValue = this.As<Benchmark.CorvusJsonSchema2.NameComponent>();
        if (matchNameComponentValue.IsValid())
        {
    ...
    /// <summary>
    /// Gets the value as a <see cref="Benchmark.CorvusJsonSchema2.NameComponent" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsNameComponent(out Benchmark.CorvusJsonSchema2.NameComponent result)
    {
        result = this.As<Benchmark.CorvusJsonSchema2.NameComponent>();
        return result.IsValid();
    }

    /// <summary>
    /// Gets the value as a <see cref="Benchmark.CorvusJsonSchema2.NameComponentArray" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsNameComponentArray(out Benchmark.CorvusJsonSchema2.NameComponentArray result)
    {
        result = this.As<Benchmark.CorvusJsonSchema2.NameComponentArray>();
        return result.IsValid();
    }
}
