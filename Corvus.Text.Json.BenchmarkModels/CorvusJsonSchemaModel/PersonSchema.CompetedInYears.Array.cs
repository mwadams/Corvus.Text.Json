...
public readonly partial struct PersonSchema
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(CompetedInYears), "Create")]
#endif
    public readonly partial struct CompetedInYears
        : IJsonArray<Benchmark.CorvusJsonSchema.PersonSchema.CompetedInYears>,
          IReadOnlyCollection<Corvus.Json.JsonInt32>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static CompetedInYears EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<CompetedInYears>.this[int index]
        {
            get
            {
        ...
        public Corvus.Json.JsonInt32 this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Corvus.Json.JsonInt32>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator CompetedInYears(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(CompetedInYears value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator CompetedInYears(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(CompetedInYears value)
        {
            return
                value.AsArray;
        }
        ...
        public static CompetedInYears From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="CompetedInYears"/>" struct from a span of items.
        /// </summary>
        ...
        public static CompetedInYears Create(ReadOnlySpan<Corvus.Json.JsonInt32> items)
        {
            return new([..items]);
        }
        ...
        public static CompetedInYears FromItems(params Corvus.Json.JsonInt32[] items)
        {
            return new([..items]);
        }
        ...
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2, in Corvus.Json.JsonInt32 item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2, in Corvus.Json.JsonInt32 item3, in Corvus.Json.JsonInt32 item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2, in Corvus.Json.JsonInt32 item3, in Corvus.Json.JsonInt32 item4, in Corvus.Json.JsonInt32 item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2, in Corvus.Json.JsonInt32 item3, in Corvus.Json.JsonInt32 item4, in Corvus.Json.JsonInt32 item5, in Corvus.Json.JsonInt32 item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static CompetedInYears FromItems(in Corvus.Json.JsonInt32 item1, in Corvus.Json.JsonInt32 item2, in Corvus.Json.JsonInt32 item3, in Corvus.Json.JsonInt32 item4, in Corvus.Json.JsonInt32 item5, in Corvus.Json.JsonInt32 item6, in Corvus.Json.JsonInt32 item7)
        {
        ...
        public static CompetedInYears FromRange(IEnumerable<Corvus.Json.JsonInt32> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static CompetedInYears IJsonArray<CompetedInYears>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static CompetedInYears IJsonArray<CompetedInYears>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<Corvus.Json.JsonInt32> IEnumerable<Corvus.Json.JsonInt32>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Corvus.Json.JsonInt32>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Corvus.Json.JsonInt32> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<CompetedInYears>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<CompetedInYears>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public CompetedInYears Add(in Corvus.Json.JsonInt32 item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public CompetedInYears Add(params Corvus.Json.JsonInt32[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonInt32 item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public CompetedInYears AddRange(IEnumerable<Corvus.Json.JsonInt32> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Corvus.Json.JsonInt32 item in items)
            {
        ...
        /// <inheritdoc/>
        public CompetedInYears Insert(int index, in Corvus.Json.JsonInt32 item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public CompetedInYears InsertRange(int index, IEnumerable<Corvus.Json.JsonInt32> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public CompetedInYears Replace(in Corvus.Json.JsonInt32 oldValue, in Corvus.Json.JsonInt32 newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public CompetedInYears SetItem(int index, in Corvus.Json.JsonInt32 value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        CompetedInYears IJsonArray<CompetedInYears>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public CompetedInYears Remove(in Corvus.Json.JsonInt32 oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in CompetedInYears arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in CompetedInYears arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in CompetedInYears arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in CompetedInYears arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in CompetedInYears arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in CompetedInYears arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in CompetedInYears arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in CompetedInYears arrayInstance, int index, TEnumerable values)
