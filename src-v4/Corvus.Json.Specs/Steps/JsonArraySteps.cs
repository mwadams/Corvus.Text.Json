...
public class JsonArraySteps
{
    ...
    public void WhenIRemoveTheItemAtIndexFromTheJsonAny(int index)
    {
        try
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonAny>(JsonValueSteps.SubjectUnderTest).AsArray.RemoveAt(index).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIRemoveTheItemAtIndexFromTheJsonNotAny(int index)
    {
        try
        {
            this.scenarioContext.Set(this.scenarioContext.Get<JsonNotAny>(JsonValueSteps.SubjectUnderTest).AsArray.RemoveAt(index).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void ThenTheItemInTheJsonAnyAtShouldBeTheObject(int index, string expected)
    {
        ...
        Assert.AreEqual(JsonAny.Parse(expected), value.AsArray[index].AsObject);
    }
    ...
    {
        JsonAny value = this.scenarioContext.Get<JsonAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonAny.Parse(expected), value.AsArray[index].AsNumber);
    }
    ...
    {
        JsonAny value = this.scenarioContext.Get<JsonAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonAny.Parse(expected), value.AsArray[index].AsBoolean);
    }
    ...
    {
        JsonAny value = this.scenarioContext.Get<JsonAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonAny.Parse(expected), value.AsArray[index].AsString);
    }
    ...
    public void WhenISetTheItemInTheJsonAnyToTheValue(int index, string value)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.SetItem(index, JsonAny.Parse(value)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void ThenTheItemInTheJsonNotAnyAtShouldBeTheObject(int index, string expected)
    {
        ...
        Assert.AreEqual(JsonNotAny.Parse(expected), value.AsArray[index].AsObject);
    }
    ...
    /// <param name="index">The index at which to test the item.</param>
    /// <param name="expected">The serialized value expected to be found at the given index.</param>
    [Then("the item in the JsonNotAny at index (.*) should be (.*) of type JsonArray")]
    ...
    {
        JsonNotAny value = this.scenarioContext.Get<JsonNotAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonNotAny.Parse(expected), value.AsArray[index].AsNumber);
    }
    ...
    {
        JsonNotAny value = this.scenarioContext.Get<JsonNotAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonNotAny.Parse(expected), value.AsArray[index].AsBoolean);
    }
    ...
    {
        JsonNotAny value = this.scenarioContext.Get<JsonNotAny>(ArrayValueResultkey);
        Assert.AreEqual(JsonNotAny.Parse(expected), value.AsArray[index].AsString);
    }
    ...
    public void WhenISetTheItemInTheJsonNotAnyToTheValue(int index, string value)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.SetItem(index, JsonNotAny.Parse(value)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIGetTheNumberInTheJsonArrayAtIndex(int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut[index].AsNumber, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIGetTheNumberInTheJsonAnyAtIndex(int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray[index].AsNumber, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIGetTheStringInTheJsonArrayAtIndex(int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut[index].AsString, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIGetTheStringInTheJsonAnyAtIndex(int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray[index].AsString, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIInsertTheItemInTheJsonAnyAtIndex(string value, int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Insert(index, JsonAny.Parse(value)).As<JsonAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIReplaceTheItemInTheJsonAnyAtIndex(string oldValue, string newValue)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Replace(JsonAny.Parse(oldValue), JsonAny.Parse(newValue)).As<JsonAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIInsertTheItemInTheJsonNotAnyAtIndex(string value, int index)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Insert(index, JsonNotAny.Parse(value)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIReplaceTheItemInTheJsonNotAnyAtIndex(string oldValue, string newValue)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Replace(JsonNotAny.Parse(oldValue), JsonNotAny.Parse(newValue)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemToTheJsonAny(string value)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonAny.Parse(value)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonAny(string value1, string value2)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonAny.Parse(value1), JsonAny.Parse(value2)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonAny(string value1, string value2, string value3)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonAny.Parse(value1), JsonAny.Parse(value2), JsonAny.Parse(value3)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonAny(string value1, string value2, string value3, string value4)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonAny.Parse(value1), JsonAny.Parse(value2), JsonAny.Parse(value3), JsonAny.Parse(value4)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonAny(string value1, string value2, string value3, string value4, string value5)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonAny.Parse(value1), JsonAny.Parse(value2), JsonAny.Parse(value3), JsonAny.Parse(value4), JsonAny.Parse(value5)).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheRangeToTheJsonAny(string values)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.AddRange(JsonAny.Parse(values).AsArray.AsImmutableList()).AsAny, ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemToTheJsonNotAny(string value)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonNotAny.Parse(value)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonNotAny(string value1, string value2)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonNotAny.Parse(value1), JsonNotAny.Parse(value2)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonNotAny(string value1, string value2, string value3)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonNotAny.Parse(value1), JsonNotAny.Parse(value2), JsonNotAny.Parse(value3)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonNotAny(string value1, string value2, string value3, string value4)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonNotAny.Parse(value1), JsonNotAny.Parse(value2), JsonNotAny.Parse(value3), JsonNotAny.Parse(value4)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheItemsToTheJsonNotAny(string value1, string value2, string value3, string value4, string value5)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.Add(JsonNotAny.Parse(value1), JsonNotAny.Parse(value2), JsonNotAny.Parse(value3), JsonNotAny.Parse(value4), JsonNotAny.Parse(value5)).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
    ...
    public void WhenIAddTheRangeToTheJsonNotAny(string values)
    {
        ...
        try
        {
            this.scenarioContext.Set(sut.AsArray.AddRange(JsonNotAny.Parse(values).AsArray.AsImmutableList()).As<JsonNotAny>(), ArrayValueResultkey);
        }
        catch (Exception ex)
        {
            this.scenarioContext.Set(ex, ArrayExceptionKey);
