...
/// </summary>
public class PropertiesValidationHandler2 : IChildObjectPropertyValidationHandler, IJsonSchemaClassSetup
{
    ...
    /// </summary>
    public static PropertiesValidationHandler2 Instance { get; } = CreateDefaultInstance();

    private static PropertiesValidationHandler2 CreateDefaultInstance()
    {
        PropertiesValidationHandler2 instance = new();
    ...
    public CodeGenerator AppendJsonSchemaClassSetup(CodeGenerator generator, TypeDeclaration typeDeclaration)
    {
        ...
        {
            generator
                .AppendIndent("internal delegate void ", globalName, "(IJsonDocument parentDocument, int parentDocumentIndex, ref JsonSchemaContext context")
        ...
        foreach (PropertyDeclaration property in propertiesToGenerate)
        {
            ...
            generator
                .AppendSeparatorLine()
                .AppendIndent("private static void ", methodName, "(IJsonDocument parentDocument, int parentDocumentIndex, ref JsonSchemaContext context")
                .AppendNamedPropertyValidatorParameters(typeDeclaration, children)
                .AppendLine(")")
                .AppendLineIndent("{")
                .PushIndent()
...
file static class PropertiesValidationHandlerExtensions
{
    ...
    {
        generator
            .AppendIndent("validator(parentDocument, objectValidation_currentIndex, ref context");
    ...
    public static CodeGenerator BuildPropertyValidatorMap(this CodeGenerator generator, TypeDeclaration typeDeclaration, List<INamedPropertyChildHandler> children, List<(string propertyName, string methodName)> propertyAndMethodNames, string propertyValidatorDelegateName)
    {
        ...
        if (propertyAndMethodNames.Count > PropertiesValidationHandler2.MinPropertiesForMap)
        {
            ...
            generator
                .AppendSeparatorLine()
                .AppendLineIndent("private static PropertySchemaMatchers2<", propertyValidatorDelegateName, "> ", builderName, "()")
                .AppendLineIndent("{")
                .PushIndent()
                    .AppendLineIndent("return new PropertySchemaMatchers2<", propertyValidatorDelegateName, ">([")
                    .PushIndent();
            ...
            generator
                ...
                .AppendLineIndent("}")
                .AppendSeparatorLine()
                .AppendLineIndent("private static PropertySchemaMatchers2<", propertyValidatorDelegateName, "> ", mapName, " { get; } = ", builderName, "();")
                .AppendSeparatorLine()
