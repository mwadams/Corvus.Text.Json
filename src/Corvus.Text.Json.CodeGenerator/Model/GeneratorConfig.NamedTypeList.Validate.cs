    ...
    public readonly partial struct NamedTypeList
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("#/$defs/namedTypeList");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<Corvus.Json.CodeGenerator.GeneratorConfig.NamedTypeSpecification> arrayEnumerator = value.EnumerateArray();
