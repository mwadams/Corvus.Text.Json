...
public readonly partial struct GeneratorConfig
{
    ...
    public readonly partial struct IfTrueDoNotUseOptionalNameHeuristics
        : IJsonBoolean<Corvus.Json.CodeGenerator.GeneratorConfig.IfTrueDoNotUseOptionalNameHeuristics>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfTrueDoNotUseOptionalNameHeuristics(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator IfTrueDoNotUseOptionalNameHeuristics(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(IfTrueDoNotUseOptionalNameHeuristics value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(IfTrueDoNotUseOptionalNameHeuristics value)
        {
