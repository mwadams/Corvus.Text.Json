...
See the [CLI Code Generation guide](https://github.com/mwadams/Corvus.Text.Json/blob/main/docs/CodeGenerator.md) for the full reference including config file format, naming heuristics, and advanced usage.
