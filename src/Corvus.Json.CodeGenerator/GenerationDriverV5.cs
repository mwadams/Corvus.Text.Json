// <copyright file="GenerationDriverV5.cs" company="Endjin Limited">
...
public static class GenerationDriverV5
{
    ...
    private static void WriteMapFile(string? mapFile, int index, GeneratedCodeFile generatedCodeFile, string outputFile)
    {
        if (!string.IsNullOrEmpty(mapFile))
        {
            ...
            string? typeName = CodeGeneration.CSharpLanguageProvider.GetFullyQualifiedDotnetTypeName(generatedCodeFile);
