...
namespace Corvus.Text.Json.Serialization
{
    /// <summary>
    /// When placed on a property or field of type <see cref="Corvus.Text.Json.Nodes.JsonObject"/> or
    ...
    /// <see cref="object"/>, the type of object created will either be a <see cref="Corvus.Text.Json.Nodes.JsonNode"/> or a
    /// <see cref="JsonElement"/> depending on the value of <see cref="Corvus.Text.Json.JsonSerializerOptions.UnknownTypeHandling"/>.
    ///
