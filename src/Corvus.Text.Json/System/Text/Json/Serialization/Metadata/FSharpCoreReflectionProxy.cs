...
namespace Corvus.Text.Json.Serialization.Metadata
{
    ...
    // Every F# application ships with a copy of FSharp.Core, however it is not available statically to Corvus.Text.Json.
    ...
    /// <summary>
    /// Proxy class used to access FSharp.Core metadata and reflection APIs that are not statically available to Corvus.Text.Json.
    /// </summary>
    internal sealed class FSharpCoreReflectionProxy
    {
        /// <summary>
        /// The various categories of F# types that Corvus.Text.Json supports.
        /// </summary>
