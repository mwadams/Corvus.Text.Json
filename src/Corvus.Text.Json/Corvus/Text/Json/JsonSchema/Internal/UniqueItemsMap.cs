...
/////// </remarks>
////public ref struct UniqueItemsMap
////{
////    /// <summary>
...
////    [CLSCompliant(false)]
////    public UniqueItemsMap(IJsonDocument parentDocument, int itemsCount)
////    {
////        _parentDocument = parentDocument;
////        CreateMap(itemsCount);
////    }
...
////    /// </remarks>
////    private void CreateMap(int itemCount)
////    {
////        _size = HashHelpers.GetPrime(itemCount);
////        int entriesSize = _size * PropertyMap.Entry.Size;

////        // Make sure we have space for the buckets
////        _bucketsBacking = ArrayPool<int>.Shared.Rent(itemCount);
////        _entriesBacking = ArrayPool<byte>.Shared.Rent(entriesSize);

////        _buckets = _bucketsBacking.AsSpan(0, itemCount);
...
////        _propertyMap = PropertyMap.Create(itemCount, itemCount);
////    }

////    public bool AddItemAndTestDuplicate(int parentDocumentIndex)
////    {
////        ulong hashCode = PropertyMap.GetHashCode(_parentDocument, parentDocumentIndex);

////        ref int bucket = ref PropertyMap.GetBucket(_buckets, hashCode, _size);

////        int entryIndex = _propertyIndex * PropertyMap.Entry.Size;
////        PropertyMap.Entry.Write(_entries.Slice(entryIndex, PropertyMap.Entry.Size), hashCode, bucket - 1, _propertyIndex);
////        _propertyIndex++;
