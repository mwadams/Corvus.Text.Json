...
namespace Corvus.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        internal const string SerializationRequiresDynamicCodeMessage = "JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use Corvus.Text.Json source generation for native AOT applications.";
        ...
        /// </summary>
        /// <remarks>
        /// The value of the property is backed by the "Corvus.Text.Json.JsonSerializer.IsReflectionEnabledByDefault"
        /// <see cref="AppContext"/> setting and defaults to <see langword="true"/> if unset.
        /// </remarks>
        [FeatureSwitchDefinition("Corvus.Text.Json.JsonSerializer.IsReflectionEnabledByDefault")]
        public static bool IsReflectionEnabledByDefault { get; } =
            AppContext.TryGetSwitch(
                switchName: "Corvus.Text.Json.JsonSerializer.IsReflectionEnabledByDefault",
