...
using FoundProperty = System.ValueTuple<Corvus.Text.Json.Serialization.Metadata.JsonPropertyInfo, Corvus.Text.Json.JsonReaderState, long, byte[]?, string?>;
using FoundPropertyAsync = System.ValueTuple<Corvus.Text.Json.Serialization.Metadata.JsonPropertyInfo, object?, string?>;
