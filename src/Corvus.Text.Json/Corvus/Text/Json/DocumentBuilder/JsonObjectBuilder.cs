...
namespace Corvus.Text.Json
{
    ...
    /// <remarks>
    /// <para>
    /// <see cref="JsonObjectBuilder"/> is a ref struct designed for use in stack-based scenarios,
    ...
    {
        /// <summary>
        /// Delegate for building a value using a <see cref="JsonObjectBuilder"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonObjectBuilder"/> struct.
        /// </summary>
        ...
        [CLSCompliant(false)]
        /// <summary>
        /// Adds a property with a value of a custom JSON element type to the current object.
        /// </summary>
        /// <typeparam name="T">The type of the JSON element.</typeparam>
        /// <param name="propertyName">The property name as a UTF-8 byte span.</param>
        /// <param name="value">The value of the custom JSON element.</param>
        /// <param name="escapeName">Whether to escape the property name.</param>
        /// <param name="nameRequiresUnescaping">Whether the property name requires unescaping.</param>
        ...
        /// <param name="propertyName">The property name as a character span.</param>
        /// <param name="value">A delegate that builds the array value.</param>
        public void Add(ReadOnlySpan<char> propertyName, JsonArrayBuilder.Build value)
        {
            _builder.AddProperty(
                propertyName,
                (ref valueBuilder) => JsonArrayBuilder.BuildValue(value, ref valueBuilder));
