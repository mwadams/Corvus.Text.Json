// <copyright file="JsonRegexCaseBehavior.cs" company="Endjin Limited">
...
/// <summary>
/// When a regular expression specifies the option <see cref="JsonRegexOptions.IgnoreCase"/> then comparisons between the input and the
...
/// </summary>
internal enum JsonRegexCaseBehavior
{
    /// <summary>
    ...
    /// specified <see cref="JsonRegexOptions.CultureInvariant"/> or when the CurrentCulture is <see cref="CultureInfo.InvariantCulture"/>.
    /// </summary>
    Invariant,
