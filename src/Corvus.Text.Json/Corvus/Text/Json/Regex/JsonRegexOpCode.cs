// <copyright file="JsonRegexOpCode.cs" company="Endjin Limited">
...
internal enum JsonRegexOpCode
{
    ...
    /// <remarks>
    /// For quantified constructs with a minimum of zero (<see cref="JsonRegexNode.M"/> == 0), this opcode pushes a counter
