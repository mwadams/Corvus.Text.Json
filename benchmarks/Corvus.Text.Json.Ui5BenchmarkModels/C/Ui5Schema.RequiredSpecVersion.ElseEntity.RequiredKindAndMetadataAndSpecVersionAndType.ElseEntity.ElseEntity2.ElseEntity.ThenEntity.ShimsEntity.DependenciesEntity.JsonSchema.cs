                                ...
                                public readonly partial struct ShimsEntity
                                {
                                        ...
                                        : IJsonElement<DependenciesEntity>
                                    {
                                        public static partial class JsonSchema
                                        {
                                            ...
                                            /// </summary>
                                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/dependencies"u8, buffer, out written);

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated.
                                            /// </summary>
                                            public const string SchemaLocation = "ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/dependencies";

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                                            /// </summary>
                                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/dependencies"u8;
                                                ...
                                                else
                                                {
                                                    ...
                                                    while (objectValidation_enumerator.MoveNext())
                                                    {
                                                        ...
                                                        if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                                        {
                                                            ...
                                                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ThenEntity.ShimsEntity.DependenciesEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
