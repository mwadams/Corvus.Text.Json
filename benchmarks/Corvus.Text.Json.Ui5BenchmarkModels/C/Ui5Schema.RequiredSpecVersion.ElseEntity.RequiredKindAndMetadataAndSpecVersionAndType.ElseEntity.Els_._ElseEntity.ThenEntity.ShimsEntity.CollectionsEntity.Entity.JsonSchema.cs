                                    ...
                                    public readonly partial struct CollectionsEntity
                                    {
                                            ...
                                            : IJsonElement<Entity>
                                        {
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                private static void MatchModules(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                                {
                                                    context.AddLocalEvaluatedProperty(propertyCount);
                                                    JsonSchemaContext childContext =
                                                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ThenEntity.ShimsEntity.CollectionsEntity.Entity.ModulesEntity.JsonSchema.PushChildContextUnescaped(
                                                            parentDocument,
                                                            parentDocumentIndex,
                                                            ref context,
                                                    ...
                                                    Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ThenEntity.ShimsEntity.CollectionsEntity.Entity.ModulesEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                                ...
                                                {
                                                    if (span.SequenceEqual(JsonPropertyNames.ModulesUtf8))
                                                    {
                                                        matcher = MatchModules;
                                                        return true;
                                                    }
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/collections/patternProperties/.+"u8, buffer, out written);

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated.
                                                /// </summary>
                                                public const string SchemaLocation = "ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/collections/patternProperties/.+";

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                                /// </summary>
                                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/else/then/else/else/else/then/definitions/shims/properties/collections/patternProperties/.+"u8;
