                                    ...
                                    public static partial class JsonSchema
                                    {
                                        ...
                                        private static void MatchConfiguration(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                        {
                                            ...
                                            JsonSchemaContext childContext =
                                                Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.JsonSchema.PushChildContextUnescaped(
                                                    parentDocument,
                                                    parentDocumentIndex,
                                                    ref context,
                                            ...
                                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                        ...
                                        /// </summary>
                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources"u8, buffer, out written);

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated.
                                        /// </summary>
                                        public const string SchemaLocation = "ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources";

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                                        /// </summary>
                                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources"u8;
