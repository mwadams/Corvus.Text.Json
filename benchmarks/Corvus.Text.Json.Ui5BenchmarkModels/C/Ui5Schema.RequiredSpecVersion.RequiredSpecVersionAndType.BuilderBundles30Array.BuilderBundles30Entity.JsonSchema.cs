    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderBundles30Array
            {
                ...
                public readonly partial struct BuilderBundles30Entity
                    : IJsonElement<BuilderBundles30Entity>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaPathProvider BundleDefinitionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/bundleDefinition/$ref"u8, buffer, out written);
                        private static readonly JsonSchemaPathProvider BundleOptionsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/bundleOptions/$ref"u8, buffer, out written);

                        private static void MatchBundleDefinition(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext =
                                Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName3.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.BundleDefinitionUtf8,
                                    evaluationPath: BundleDefinitionSchemaEvaluationPath);

                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName3.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            context.CommitChildContext(childContext.IsMatch, ref childContext);
                        }

                        private static void MatchBundleOptions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext1 =
                                Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderBundlesBundleOptions30Entity.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.BundleOptionsUtf8,
                                    evaluationPath: BundleOptionsSchemaEvaluationPath);

                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderBundlesBundleOptions30Entity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                (static () => JsonPropertyNames.BundleDefinitionUtf8, MatchBundleDefinition),
                                (static () => JsonPropertyNames.BundleOptionsUtf8, MatchBundleOptions),
                            ]);
                        }
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/builder-bundles-3.0/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/builder-bundles-3.0/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/builder-bundles-3.0/items"u8;
