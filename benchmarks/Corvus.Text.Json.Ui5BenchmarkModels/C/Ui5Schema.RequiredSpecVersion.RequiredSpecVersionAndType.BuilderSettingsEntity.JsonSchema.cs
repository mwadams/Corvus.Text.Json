    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
                ...
                : IJsonElement<BuilderSettingsEntity>
            {
                ...
                {
                    private static readonly JsonSchemaPathProvider IncludeDependencySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/includeDependency"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider IncludeDependencyRegExpSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/includeDependencyRegExp"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider IncludeDependencyTreeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/includeDependencyTree"u8, buffer, out written);

                    private static void MatchIncludeDependency(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.IncludeDependencyUtf8,
                                evaluationPath: IncludeDependencySchemaEvaluationPath);

                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        context.CommitChildContext(childContext.IsMatch, ref childContext);
                    }

                    private static void MatchIncludeDependencyRegExp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.IncludeDepArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.IncludeDependencyRegExpUtf8,
                                evaluationPath: IncludeDependencyRegExpSchemaEvaluationPath);

                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.IncludeDepArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                    }

                    private static void MatchIncludeDependencyTree(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext2 =
                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.IncludeDepArray.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.IncludeDependencyTreeUtf8,
                                evaluationPath: IncludeDependencyTreeSchemaEvaluationPath);

                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.IncludeDepArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.IncludeDependencyUtf8, MatchIncludeDependency),
                            (static () => JsonPropertyNames.IncludeDependencyRegExpUtf8, MatchIncludeDependencyRegExp),
                            (static () => JsonPropertyNames.IncludeDependencyTreeUtf8, MatchIncludeDependencyTree),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/builder-settings"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/builder-settings";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/builder-settings"u8;
