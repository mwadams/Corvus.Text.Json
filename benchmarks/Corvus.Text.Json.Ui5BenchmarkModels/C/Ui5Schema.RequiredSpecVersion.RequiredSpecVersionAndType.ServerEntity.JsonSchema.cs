    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct ServerEntity
                : IJsonElement<ServerEntity>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaPathProvider CustomMiddlewareSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/customMiddleware"u8, buffer, out written);
                    ...
                    private static void MatchCustomMiddleware(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.CustomMiddlewareUtf8,
                                evaluationPath: CustomMiddlewareSchemaEvaluationPath);

                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchSettings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.CustomMiddlewareUtf8, MatchCustomMiddleware),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/server"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/server";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/server"u8;
