        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct ServerEntity
            {
                    ...
                    : IJsonElement<SettingsEntity>
                {
                    ...
                    {
                        private static readonly JsonSchemaPathProvider HttpPortSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/httpPort"u8, buffer, out written);
                        private static readonly JsonSchemaPathProvider HttpsPortSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/httpsPort"u8, buffer, out written);

                        private static void MatchHttpPort(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext =
                                Corvus.Ui5Benchmark.Current.JsonNumber.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.HttpPortUtf8,
                                    evaluationPath: HttpPortSchemaEvaluationPath);

                            Corvus.Ui5Benchmark.Current.JsonNumber.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            context.CommitChildContext(childContext.IsMatch, ref childContext);
                        }

                        private static void MatchHttpsPort(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext1 =
                                Corvus.Ui5Benchmark.Current.JsonNumber.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.HttpsPortUtf8,
                                    evaluationPath: HttpsPortSchemaEvaluationPath);

                            Corvus.Ui5Benchmark.Current.JsonNumber.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                (static () => JsonPropertyNames.HttpPortUtf8, MatchHttpPort),
                                (static () => JsonPropertyNames.HttpsPortUtf8, MatchHttpsPort),
                            ]);
                        }
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/server/properties/settings"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/server/properties/settings";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/server/properties/settings"u8;
