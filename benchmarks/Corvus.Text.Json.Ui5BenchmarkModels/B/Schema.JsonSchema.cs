    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchSpecVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Ui5Benchmark.Baseline.Schema.SpecVersionEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5Benchmark.Baseline.Schema.SpecVersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext ifContext =
                Corvus.Ui5Benchmark.Baseline.Schema.IfEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
            Corvus.Ui5Benchmark.Baseline.Schema.IfEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
            ...
            if (ifContext.IsMatch)
            {
                ...
                JsonSchemaContext thenContext =
                    Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
            ...
            else
            {
                JsonSchemaContext elseContext =
                    Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
