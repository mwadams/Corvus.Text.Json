                                    ...
                                    public readonly partial struct ThenEntity
                                    {
                                            ...
                                            : IJsonElement<TypeEntity>
                                        {
                                            ...
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/else/then/else/else/else/else/then/properties/type"u8, buffer, out written);

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated.
                                                /// </summary>
                                                public const string SchemaLocation = "schema.json#/then/then/else/then/else/else/else/else/then/properties/type";

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                                /// </summary>
                                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/else/then/else/else/else/else/then/properties/type"u8;
