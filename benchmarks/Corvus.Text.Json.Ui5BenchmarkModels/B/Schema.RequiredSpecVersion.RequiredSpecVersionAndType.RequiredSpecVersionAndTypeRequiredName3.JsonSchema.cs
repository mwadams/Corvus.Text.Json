        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
                ...
                : IJsonElement<RequiredSpecVersionAndTypeRequiredName3>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/builder-bundles-bundleDefinition-2.4"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/then/then/definitions/builder-bundles-bundleDefinition-2.4";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/builder-bundles-bundleDefinition-2.4"u8;
