                    ...
                    public readonly partial struct RequiredName
                    {
                            ...
                            : IJsonElement<ThenEntity>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/framework/properties/libraries/items/then"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "schema.json#/then/then/definitions/framework/properties/libraries/items/then";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/framework/properties/libraries/items/then"u8;
