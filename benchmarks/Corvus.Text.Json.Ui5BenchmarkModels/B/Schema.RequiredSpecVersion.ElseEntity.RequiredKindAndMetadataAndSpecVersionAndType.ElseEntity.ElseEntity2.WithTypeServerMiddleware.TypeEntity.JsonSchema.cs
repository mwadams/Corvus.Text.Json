                        ...
                        public readonly partial struct WithTypeServerMiddleware
                        {
                                ...
                                : IJsonElement<TypeEntity>
                            {
                                ...
                                private static class Constants
                                {
                                    ...
                                    /// </summary>
                                    public static readonly byte[] Const = "server-middleware"u8.ToArray();
                                    /// <summary>
                                    /// A constant for the <c>const</c> keyword.
                                    /// </summary>
                                    public static readonly TypeEntity ConstJson = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"server-middleware\""u8]);
                                }
                                ...
                                public static partial class JsonSchema
                                {
                                    ...
                                    /// </summary>
                                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/else/then/else/else/if/properties/type"u8, buffer, out written);

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated.
                                    /// </summary>
                                    public const string SchemaLocation = "schema.json#/then/else/then/else/else/if/properties/type";

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/else/then/else/else/if/properties/type"u8;
                                        ...
                                        ref JsonSchemaContext context)
                                    {
                                        ...
                                        if (tokenType == JsonTokenType.String)
                                        {
                                            ...
                                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "server-middleware"u8, "server-middleware", "const"u8, ref context);
                                        }
                                        else
                                        {
                                            context.EvaluatedKeyword(false, "server-middleware", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                                        }
                                    }
