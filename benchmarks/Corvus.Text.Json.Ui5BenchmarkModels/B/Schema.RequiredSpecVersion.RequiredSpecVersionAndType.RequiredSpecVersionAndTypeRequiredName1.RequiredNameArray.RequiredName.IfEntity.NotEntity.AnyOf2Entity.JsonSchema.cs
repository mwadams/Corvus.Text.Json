                            ...
                            public readonly partial struct NotEntity
                            {
                                    ...
                                    : IJsonElement<AnyOf2Entity>
                                {
                                    public static partial class JsonSchema
                                    {
                                        ...
                                        /// </summary>
                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2"u8, buffer, out written);

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated.
                                        /// </summary>
                                        public const string SchemaLocation = "schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2";

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                                        /// </summary>
                                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2"u8;
                                            ...
                                            ref JsonSchemaContext context)
                                        {
                                            ...
                                            JsonSchemaContext notContext =
                                                Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf2Entity.NotEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: NotSchemaEvaluationPath);
                                            Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf2Entity.NotEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref notContext);
