                    ...
                    public readonly partial struct CustomMiddlewareEntity
                    {
                            ...
                            : IJsonElement<RequiredBeforeMiddlewareAndName>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/0"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/0";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/0"u8;
