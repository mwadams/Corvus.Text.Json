                                    ...
                                    public readonly partial struct ElseEntity
                                    {
                                            ...
                                            : IJsonElement<SpecVersionEntity>
                                        {
                                            ...
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/else/else/else/then/else/else/else/properties/specVersion"u8, buffer, out written);

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated.
                                                /// </summary>
                                                public const string SchemaLocation = "schema.json#/then/then/else/else/else/then/else/else/else/properties/specVersion";

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                                /// </summary>
                                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/else/else/else/then/else/else/else/properties/specVersion"u8;
