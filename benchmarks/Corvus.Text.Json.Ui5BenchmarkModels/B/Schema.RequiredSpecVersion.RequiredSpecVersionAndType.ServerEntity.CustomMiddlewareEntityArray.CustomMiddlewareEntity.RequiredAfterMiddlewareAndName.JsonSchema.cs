                ...
                public readonly partial struct CustomMiddlewareEntityArray
                {
                    ...
                    public readonly partial struct CustomMiddlewareEntity
                    {
                            ...
                            : IJsonElement<RequiredAfterMiddlewareAndName>
                        {
                            ...
                            {
                                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAfterMiddlewarePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("afterMiddleware"u8, buffer, out written);
                                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAfterMiddlewareNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("afterMiddleware"u8, buffer, out written);

                                private const int RequiredOffsetForAfterMiddleware = 0;
                                private const uint RequiredBitForAfterMiddleware = 0b00000000000000000000000000000001;
                                ...
                                private const uint RequiredBitMask0 =
                                    RequiredBitForAfterMiddleware | RequiredBitForName;
                                private static readonly JsonSchemaPathProvider AfterMiddlewareSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/afterMiddleware"u8, buffer, out written);
                                ...
                                private static void MatchAfterMiddleware(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    JsonSchemaContext childContext =
                                        Corvus.Ui5Benchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                            ...
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.AfterMiddlewareUtf8,
                                            evaluationPath: AfterMiddlewareSchemaEvaluationPath);

                                    Corvus.Ui5Benchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                    ...
                                    requiredBitBuffer[RequiredOffsetForAfterMiddleware] |= RequiredBitForAfterMiddleware;
                                }
                                ...
                                private static void MatchMountPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    Corvus.Ui5Benchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                                ...
                                private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                                {
                                    return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                                        (static () => JsonPropertyNames.AfterMiddlewareUtf8, MatchAfterMiddleware),
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/1"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/1";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/server/properties/customMiddleware/items/oneOf/1"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAfterMiddlewarePresent, "afterMiddleware"u8, "required"u8);
                                        ...
                                        {
                                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAfterMiddleware] & RequiredBitForAfterMiddleware) == 0)
                                            {
                                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAfterMiddlewareNotPresent, "afterMiddleware"u8, "required"u8);
                                            }
                                            else
                                            {
                                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAfterMiddlewarePresent, "afterMiddleware"u8, "required"u8);
