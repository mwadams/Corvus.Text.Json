        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct CustomTasksEntityArray
            {
                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredAfterTaskAndName
                        : IJsonElement<RequiredAfterTaskAndName>
                    {
                        public static partial class JsonSchema
                        {
                            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAfterTaskPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("afterTask"u8, buffer, out written);
                            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAfterTaskNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("afterTask"u8, buffer, out written);

                            private const int RequiredOffsetForAfterTask = 0;
                            private const uint RequiredBitForAfterTask = 0b00000000000000000000000000000001;
                            ...
                            private const uint RequiredBitMask0 =
                                RequiredBitForAfterTask | RequiredBitForName;
                            private static readonly JsonSchemaPathProvider AfterTaskSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/afterTask"u8, buffer, out written);
                            ...
                            private static void MatchAfterTask(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                            {
                                ...
                                JsonSchemaContext childContext =
                                    Corvus.Ui5Benchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                        ...
                                        parentDocumentIndex,
                                        ref context,
                                        JsonPropertyNames.AfterTaskUtf8,
                                        evaluationPath: AfterTaskSchemaEvaluationPath);
                                ...
                                requiredBitBuffer[RequiredOffsetForAfterTask] |= RequiredBitForAfterTask;
                            }
                            ...
                            private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                            {
                                return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                                    (static () => JsonPropertyNames.AfterTaskUtf8, MatchAfterTask),
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/customTasks/items/oneOf/1"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "schema.json#/then/then/definitions/customTasks/items/oneOf/1";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/customTasks/items/oneOf/1"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAfterTaskPresent, "afterTask"u8, "required"u8);
                                    ...
                                    {
                                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAfterTask] & RequiredBitForAfterTask) == 0)
                                        {
                                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAfterTaskNotPresent, "afterTask"u8, "required"u8);
                                        }
                                        else
                                        {
                                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAfterTaskPresent, "afterTask"u8, "required"u8);
