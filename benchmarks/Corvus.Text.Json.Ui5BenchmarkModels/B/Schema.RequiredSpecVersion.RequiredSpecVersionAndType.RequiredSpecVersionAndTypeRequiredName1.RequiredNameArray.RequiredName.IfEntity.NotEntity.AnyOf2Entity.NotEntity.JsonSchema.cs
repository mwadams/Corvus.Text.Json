                                ...
                                public readonly partial struct AnyOf2Entity
                                {
                                        ...
                                        : IJsonElement<NotEntity>
                                    {
                                        public static partial class JsonSchema
                                        {
                                            ...
                                            /// </summary>
                                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2/not"u8, buffer, out written);

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated.
                                            /// </summary>
                                            public const string SchemaLocation = "schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2/not";

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                                            /// </summary>
                                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/2/not"u8;
