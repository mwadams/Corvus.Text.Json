...
public readonly partial struct Schema
{
        ...
        : IJsonElement<ElseEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/else"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/else";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/else"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                if (ifContext.IsMatch)
                {
                    ...
                    JsonSchemaContext thenContext =
                        Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                    Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
