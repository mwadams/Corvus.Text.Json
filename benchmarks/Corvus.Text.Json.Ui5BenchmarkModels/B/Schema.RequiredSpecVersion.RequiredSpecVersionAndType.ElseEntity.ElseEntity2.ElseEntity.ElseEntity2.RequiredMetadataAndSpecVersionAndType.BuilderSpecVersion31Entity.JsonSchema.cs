                                    ...
                                    : IJsonElement<BuilderSpecVersion31Entity>
                                {
                                    public static partial class JsonSchema
                                    {
                                        ...
                                        private static void MatchResources(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                        {
                                            ...
                                            Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderResourcesEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                        ...
                                        private static void MatchSettings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                        {
                                            ...
                                            Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                        ...
                                        /// </summary>
                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/else/else/else/else/then/definitions/builder-specVersion-3.1"u8, buffer, out written);

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated.
                                        /// </summary>
                                        public const string SchemaLocation = "schema.json#/then/then/else/else/else/else/then/definitions/builder-specVersion-3.1";

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                                        /// </summary>
                                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/else/else/else/else/then/definitions/builder-specVersion-3.1"u8;
