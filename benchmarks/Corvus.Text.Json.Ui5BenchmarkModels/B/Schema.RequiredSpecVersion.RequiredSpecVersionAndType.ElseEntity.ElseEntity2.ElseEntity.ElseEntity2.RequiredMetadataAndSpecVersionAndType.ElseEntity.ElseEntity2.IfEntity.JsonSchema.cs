                                            ...
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                private static void MatchSpecVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                                {
                                                    ...
                                                    JsonSchemaContext childContext =
                                                        Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.IfEntity.SpecVersionEntity.JsonSchema.PushChildContextUnescaped(
                                                            parentDocument,
                                                            parentDocumentIndex,
                                                            ref context,
                                                    ...
                                                    Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.IfEntity.SpecVersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/else/else/else/else/then/else/else/if"u8, buffer, out written);

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated.
                                                /// </summary>
                                                public const string SchemaLocation = "schema.json#/then/then/else/else/else/else/then/else/else/if";

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                                /// </summary>
                                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/else/else/else/else/then/else/else/if"u8;
