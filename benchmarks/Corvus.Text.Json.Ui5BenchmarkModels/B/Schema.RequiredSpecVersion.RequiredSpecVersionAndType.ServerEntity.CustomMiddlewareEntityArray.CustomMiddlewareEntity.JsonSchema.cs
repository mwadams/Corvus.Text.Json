            ...
            public readonly partial struct ServerEntity
            {
                ...
                public readonly partial struct CustomMiddlewareEntityArray
                {
                    ...
                    public readonly partial struct CustomMiddlewareEntity
                        : IJsonElement<CustomMiddlewareEntity>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/then/then/definitions/server/properties/customMiddleware/items"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "schema.json#/then/then/definitions/server/properties/customMiddleware/items";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/then/then/definitions/server/properties/customMiddleware/items"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                JsonSchemaContext oneOfContext0 =
                                    Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.RequiredBeforeMiddlewareAndName.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.RequiredBeforeMiddlewareAndName.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                                ...
                                JsonSchemaContext oneOfContext1 =
                                    Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.RequiredAfterMiddlewareAndName.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.RequiredAfterMiddlewareAndName.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
