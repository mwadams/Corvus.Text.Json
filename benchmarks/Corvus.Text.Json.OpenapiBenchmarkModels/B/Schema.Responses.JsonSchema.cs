        ...
        public static partial class JsonSchema
        {
            ...
            private static void MatchDefault(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                if (ifContext.IsMatch)
                {
                    ...
                    JsonSchemaContext thenContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
