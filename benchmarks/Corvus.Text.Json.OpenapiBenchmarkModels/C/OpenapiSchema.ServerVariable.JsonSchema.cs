...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<ServerVariable>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("default"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDefaultNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("default"u8, buffer, out written);

            private const int RequiredOffsetForDefault = 0;
            private const uint RequiredBitForDefault = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForDefault;
            ...
            private static void MatchDefault(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                requiredBitBuffer[RequiredOffsetForDefault] |= RequiredBitForDefault;
            }
            ...
            private static void MatchEnum(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/server-variable"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/server-variable";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/server-variable"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultPresent, "default"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDefault] & RequiredBitForDefault) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDefaultNotPresent, "default"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDefaultPresent, "default"u8, "required"u8);
