...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<Paths>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^~1/$ref"u8, buffer, out written);
            ...
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/paths";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/paths"u8;
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                        {
                            ...
                            Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItem.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
