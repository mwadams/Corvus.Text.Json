    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct RepresentCardFooterAttributes
        {
                ...
                : IJsonElement<ExperimentalDescribesThePaginator>
            {
                ...
                {
                    private static readonly JsonSchemaPathProvider PageSizeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/pageSize"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider TotalCountSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/totalCount"u8, buffer, out written);
                    ...
                    private static void MatchPageSize(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.PageSizeUtf8,
                                evaluationPath: PageSizeSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        context.CommitChildContext(childContext.IsMatch, ref childContext);
                    }

                    private static void MatchTotalCount(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.TotalCountUtf8,
                                evaluationPath: TotalCountSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.PageSizeUtf8, MatchPageSize),
                            (static () => JsonPropertyNames.TotalCountUtf8, MatchTotalCount),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.card/properties/footer/properties/paginator"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.card/properties/footer/properties/paginator";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.card/properties/footer/properties/paginator"u8;
