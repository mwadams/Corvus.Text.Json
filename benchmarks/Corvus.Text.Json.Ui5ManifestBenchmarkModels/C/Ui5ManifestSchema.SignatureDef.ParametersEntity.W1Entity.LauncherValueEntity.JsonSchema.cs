            ...
            public readonly partial struct W1Entity
            {
                    ...
                    : IJsonElement<LauncherValueEntity>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        private static readonly JsonSchemaPathProvider PromptSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/prompt"u8, buffer, out written);
                        ...
                        private static void MatchFormat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            ...
                            JsonSchemaContext childContext =
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                            ...
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            context.CommitChildContext(childContext.IsMatch, ref childContext);
                        }

                        private static void MatchPrompt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext1 =
                                Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.PromptUtf8,
                                    evaluationPath: PromptSchemaEvaluationPath);
                        ...
                        private static void MatchValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                        {
                            ...
                            JsonSchemaContext childContext2 =
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                            ...
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                        ...
                        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                ...
                                (static () => JsonPropertyNames.PromptUtf8, MatchPrompt),
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$/properties/launcherValue"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$/properties/launcherValue";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$/properties/launcherValue"u8;
