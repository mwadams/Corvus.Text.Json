...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<Microchart>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/Microchart"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/Microchart";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/Microchart"u8;
                ...
                ref JsonSchemaContext context)
            {
                        ...
                        using (UnescapedUtf8JsonString oneOfDiscriminatorPropName = parentDocument.GetPropertyNameUnescaped(oneOfDiscriminatorEnum.CurrentIndex))
                        {
                            if (oneOfDiscriminatorPropName.Span.SequenceEqual("type"u8))
                            {
                                if (parentDocument.GetJsonTokenType(oneOfDiscriminatorEnum.CurrentIndex) == JsonTokenType.String)
                                {
                                    ...
                                    if (discriminatorValue.Span.SequenceEqual("Bullet"u8))
                                    {
                                        oneOfDiscriminatorBranch = 0;
                                        break;
                                    }
                                    if (discriminatorValue.Span.SequenceEqual("StackedBar"u8))
                                    {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
