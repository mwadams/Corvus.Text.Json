...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<Data>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider ExtensionValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/extension/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider JsonSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/json"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider MockDataSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/mockData"u8, buffer, out written);
            ...
            private static readonly JsonSchemaPathProvider RequestValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/request/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider ServiceValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/service/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider UpdateIntervalSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/updateInterval"u8, buffer, out written);

            private static void MatchExtensionValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Extension.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ExtensionValueUtf8,
                        evaluationPath: ExtensionValueSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Extension.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchJson(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.JsonUtf8,
                        evaluationPath: JsonSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchMockData(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.MockDataUtf8,
                        evaluationPath: MockDataSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext4 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ThePathFromTheJsonToBeUsedAsRoot.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ThePathFromTheJsonToBeUsedAsRoot.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                context.CommitChildContext(childContext4.IsMatch, ref childContext4);
            }

            private static void MatchRequestValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext5 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Request.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.RequestValueUtf8,
                        evaluationPath: RequestValueSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Request.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
                context.CommitChildContext(childContext5.IsMatch, ref childContext5);
            }

            private static void MatchServiceValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext6 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ServiceValueUtf8,
                        evaluationPath: ServiceValueSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
                context.CommitChildContext(childContext6.IsMatch, ref childContext6);
            }

            private static void MatchUpdateInterval(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext7 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.UpdateIntervalEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.UpdateIntervalUtf8,
                        evaluationPath: UpdateIntervalSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.UpdateIntervalEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext7);
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.ExtensionValueUtf8, MatchExtensionValue),
                    (static () => JsonPropertyNames.JsonUtf8, MatchJson),
                    (static () => JsonPropertyNames.MockDataUtf8, MatchMockData),
                    (static () => JsonPropertyNames.NameUtf8, MatchName),
                    (static () => JsonPropertyNames.PathUtf8, MatchPath),
                    (static () => JsonPropertyNames.RequestValueUtf8, MatchRequestValue),
                    (static () => JsonPropertyNames.ServiceValueUtf8, MatchServiceValue),
                    (static () => JsonPropertyNames.UpdateIntervalUtf8, MatchUpdateInterval),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/data"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/data";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/data"u8;
