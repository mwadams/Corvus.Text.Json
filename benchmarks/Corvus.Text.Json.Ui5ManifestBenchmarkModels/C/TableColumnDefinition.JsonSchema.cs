    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchHorizontalCellContentAlignment(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.MustBeTableColumnDefinition.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.MustBeTableColumnDefinition.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchVerticalCellContentAlignment(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchWidth(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext3 =
                Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TableColumnDefinition"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TableColumnDefinition";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TableColumnDefinition"u8;
