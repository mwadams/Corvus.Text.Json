...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapWcfNamespace
        : IJsonElement<JsonSchemaForSapWcfNamespace>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWcfTargetIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("wcf-target-id"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWcfTargetIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("wcf-target-id"u8, buffer, out written);

            private const int RequiredOffsetForWcfTargetId = 0;
            private const uint RequiredBitForWcfTargetId = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForWcfTargetId;
            ...
            private static readonly JsonSchemaPathProvider WcfTargetIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/wcf-target-id"u8, buffer, out written);
            ...
            private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWcfNamespace.VersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWcfNamespace.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchWcfTargetId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.WcfTargetIdUtf8,
                        evaluationPath: WcfTargetIdSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForWcfTargetId] |= RequiredBitForWcfTargetId;
            }
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.WcfTargetIdUtf8, MatchWcfTargetId),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.wcf"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.wcf";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.wcf"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWcfTargetIdPresent, "wcf-target-id"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForWcfTargetId] & RequiredBitForWcfTargetId) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyWcfTargetIdNotPresent, "wcf-target-id"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWcfTargetIdPresent, "wcf-target-id"u8, "required"u8);
