...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        public readonly partial struct DeprecatedDescribesThePlotAreaProperties
            : IJsonElement<DeprecatedDescribesThePlotAreaProperties>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider CategoryAxisTextSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/categoryAxisText/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider DataLabelSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/dataLabel/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ValueAxisTextSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/valueAxisText/$ref"u8, buffer, out written);

                private static void MatchCategoryAxisText(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.CategoryAxisTextUtf8,
                            evaluationPath: CategoryAxisTextSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchDataLabel(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalDataLabel.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.DataLabelUtf8,
                            evaluationPath: DataLabelSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalDataLabel.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchValueAxisText(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ValueAxisTextUtf8,
                            evaluationPath: ValueAxisTextSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.CategoryAxisTextUtf8, MatchCategoryAxisText),
                        (static () => JsonPropertyNames.DataLabelUtf8, MatchDataLabel),
                        (static () => JsonPropertyNames.ValueAxisTextUtf8, MatchValueAxisText),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/plotArea"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/plotArea";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/plotArea"u8;
