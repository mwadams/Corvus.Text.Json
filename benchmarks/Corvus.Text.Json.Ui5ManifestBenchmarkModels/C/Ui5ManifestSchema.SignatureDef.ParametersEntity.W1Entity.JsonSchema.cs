    ...
    public readonly partial struct SignatureDef
    {
        ...
        public readonly partial struct ParametersEntity
        {
                ...
                : IJsonElement<W1Entity>
            {
                ...
                {
                    private static readonly JsonSchemaPathProvider DefaultValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/defaultValue"u8, buffer, out written);
                    ...
                    private static readonly JsonSchemaPathProvider LauncherValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/launcherValue"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider RenameToSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/renameTo"u8, buffer, out written);
                    ...
                    private static void MatchDefaultValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsADefaultValue.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.DefaultValueUtf8,
                                evaluationPath: DefaultValueSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsADefaultValue.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchFilter(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsAFilterOnlyIfInputParameterMatchesFilter.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsAFilterOnlyIfInputParameterMatchesFilter.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                    }

                    private static void MatchLauncherValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext2 =
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.LauncherValueUtf8,
                                evaluationPath: LauncherValueSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                        context.CommitChildContext(childContext2.IsMatch, ref childContext2);
                    }

                    private static void MatchRenameTo(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext3 =
                            Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.RenameToUtf8,
                                evaluationPath: RenameToSchemaEvaluationPath);
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                            (static () => JsonPropertyNames.DefaultValueUtf8, MatchDefaultValue),
                            (static () => JsonPropertyNames.FilterUtf8, MatchFilter),
                            (static () => JsonPropertyNames.LauncherValueUtf8, MatchLauncherValue),
                            (static () => JsonPropertyNames.RenameToUtf8, MatchRenameTo),
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$"u8;
