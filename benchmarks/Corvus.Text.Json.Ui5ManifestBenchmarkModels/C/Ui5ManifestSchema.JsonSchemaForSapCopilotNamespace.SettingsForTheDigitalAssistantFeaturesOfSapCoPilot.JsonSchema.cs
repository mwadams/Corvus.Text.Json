...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
        ...
        public readonly partial struct SettingsForTheDigitalAssistantFeaturesOfSapCoPilot
            : IJsonElement<SettingsForTheDigitalAssistantFeaturesOfSapCoPilot>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider IntentDefinitionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/intentDefinition"u8, buffer, out written);

                private static void MatchIntentDefinition(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.IntentDefinitionUtf8,
                            evaluationPath: IntentDefinitionSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.IntentDefinitionUtf8))
                    {
                        matcher = MatchIntentDefinition;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant"u8;
