    ...
    : IJsonElement<Authentication>
{
    ...
    {
        private static readonly JsonSchemaPathProvider ButtonsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/buttons"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider ConnectionNameSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/connectionName"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider TokenExchangeResourceSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/tokenExchangeResource/$ref"u8, buffer, out written);
        ...
        private static void MatchButtons(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Ui5ManifestBenchmark.Current.Authentication.AuthCardButtonArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ButtonsUtf8,
                    evaluationPath: ButtonsSchemaEvaluationPath);

            Corvus.Ui5ManifestBenchmark.Current.Authentication.AuthCardButtonArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            context.CommitChildContext(childContext.IsMatch, ref childContext);
        }

        private static void MatchConnectionName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext1 =
                Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.ConnectionNameUtf8,
                    evaluationPath: ConnectionNameSchemaEvaluationPath);
        ...
        private static void MatchTokenExchangeResource(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext3 =
                Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.TokenExchangeResourceUtf8,
                    evaluationPath: TokenExchangeResourceSchemaEvaluationPath);

            Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext4 =
                Corvus.Ui5ManifestBenchmark.Current.Authentication.MustBeAuthentication.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.Authentication.MustBeAuthentication.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                (static () => JsonPropertyNames.ButtonsUtf8, MatchButtons),
                (static () => JsonPropertyNames.ConnectionNameUtf8, MatchConnectionName),
                (static () => JsonPropertyNames.TextUtf8, MatchText),
                (static () => JsonPropertyNames.TokenExchangeResourceUtf8, MatchTokenExchangeResource),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Authentication"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Authentication";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Authentication"u8;
