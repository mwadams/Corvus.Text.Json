...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<JsonSchemaForSapBpaTaskNamespace>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCategoryPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("category"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCategoryNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("category"u8, buffer, out written);

            private const int RequiredOffsetForCategory = 0;
            private const uint RequiredBitForCategory = 0b00000000000000000000000000000010;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOutcomesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("outcomes"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOutcomesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("outcomes"u8, buffer, out written);

            private const int RequiredOffsetForOutcomes = 0;
            private const uint RequiredBitForOutcomes = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForVersion | RequiredBitForCategory | RequiredBitForOutcomes;
            ...
            private static readonly JsonSchemaPathProvider InputsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/inputs/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider OutcomesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/outcomes"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider OutputsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/outputs/$ref"u8, buffer, out written);
            ...
            private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchCategory(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                requiredBitBuffer[RequiredOffsetForCategory] |= RequiredBitForCategory;
            }

            private static void MatchInputs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchOutcomes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.OutcomesUtf8,
                        evaluationPath: OutcomesSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                requiredBitBuffer[RequiredOffsetForOutcomes] |= RequiredBitForOutcomes;
            }
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.InputsUtf8, MatchInputs),
                    (static () => JsonPropertyNames.OutcomesUtf8, MatchOutcomes),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.bpa.task"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.bpa.task";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.bpa.task"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCategoryPresent, "category"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyOutcomesPresent, "outcomes"u8, "required"u8);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCategory] & RequiredBitForCategory) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyCategoryNotPresent, "category"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCategoryPresent, "category"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOutcomes] & RequiredBitForOutcomes) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyOutcomesNotPresent, "outcomes"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyOutcomesPresent, "outcomes"u8, "required"u8);
