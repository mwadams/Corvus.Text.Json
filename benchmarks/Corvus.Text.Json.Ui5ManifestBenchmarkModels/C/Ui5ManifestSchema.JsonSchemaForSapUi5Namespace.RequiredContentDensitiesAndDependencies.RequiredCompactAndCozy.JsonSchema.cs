    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
                ...
                : IJsonElement<RequiredCompactAndCozy>
            {
                ...
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCompactPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("compact"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCompactNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("compact"u8, buffer, out written);

                    private const int RequiredOffsetForCompact = 0;
                    private const uint RequiredBitForCompact = 0b00000000000000000000000000000001;

                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCozyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("cozy"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCozyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("cozy"u8, buffer, out written);

                    private const int RequiredOffsetForCozy = 0;
                    private const uint RequiredBitForCozy = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForCompact | RequiredBitForCozy;
                    ...
                    private static readonly JsonSchemaPathProvider CozySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/cozy"u8, buffer, out written);

                    private static void MatchCompact(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        requiredBitBuffer[RequiredOffsetForCompact] |= RequiredBitForCompact;
                    }

                    private static void MatchCozy(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.CozyUtf8,
                                evaluationPath: CozySchemaEvaluationPath);
                        ...
                        requiredBitBuffer[RequiredOffsetForCozy] |= RequiredBitForCozy;
                    }
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                            ...
                            (static () => JsonPropertyNames.CozyUtf8, MatchCozy),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/contentDensities"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/contentDensities";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/contentDensities"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCompactPresent, "compact"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCozyPresent, "cozy"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCompact] & RequiredBitForCompact) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCompactNotPresent, "compact"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCompactPresent, "compact"u8, "required"u8);
                                ...
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCozy] & RequiredBitForCozy) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyCozyNotPresent, "cozy"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCozyPresent, "cozy"u8, "required"u8);
