...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct RepresentsTheDefinitionOfTargets
            : IJsonElement<RepresentsTheDefinitionOfTargets>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/routing_flexEnabled/properties/targets"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/routing_flexEnabled/properties/targets";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/routing_flexEnabled/properties/targets"u8;
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
