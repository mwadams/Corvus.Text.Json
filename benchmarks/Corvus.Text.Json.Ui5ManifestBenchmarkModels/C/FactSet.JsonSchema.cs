...
public readonly partial struct FactSet
    : IJsonElement<FactSet>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFactsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("facts"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFactsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("facts"u8, buffer, out written);

        private const int RequiredOffsetForFacts = 0;
        private const uint RequiredBitForFacts = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForFacts;
        private static readonly JsonSchemaPathProvider FactsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/facts"u8, buffer, out written);
        ...
        private static void MatchFacts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Ui5ManifestBenchmark.Current.FactSet.FactArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.FactsUtf8,
                    evaluationPath: FactsSchemaEvaluationPath);

            Corvus.Ui5ManifestBenchmark.Current.FactSet.FactArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForFacts] |= RequiredBitForFacts;
        }
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext8 =
                Corvus.Ui5ManifestBenchmark.Current.FactSet.MustBeFactSet.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.FactSet.MustBeFactSet.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext8);
        ...
        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.FactsUtf8, MatchFacts),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FactSet"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FactSet";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FactSet"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            if (tokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFactsPresent, "facts"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForFacts] & RequiredBitForFacts) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyFactsNotPresent, "facts"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFactsPresent, "facts"u8, "required"u8);
