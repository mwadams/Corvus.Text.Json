...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<JsonSchemaForSapPlatformSfsfNamespace>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAppNamePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("appName"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAppNameNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("appName"u8, buffer, out written);

            private const int RequiredOffsetForAppName = 0;
            private const uint RequiredBitForAppName = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForAppName;
            ...
            private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformSfsfNamespace.VersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformSfsfNamespace.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchAppName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                ...
                requiredBitBuffer[RequiredOffsetForAppName] |= RequiredBitForAppName;
            }

            private static void MatchAppVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.platform.sfsf"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.platform.sfsf";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.platform.sfsf"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAppNamePresent, "appName"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAppName] & RequiredBitForAppName) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAppNameNotPresent, "appName"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAppNamePresent, "appName"u8, "required"u8);
