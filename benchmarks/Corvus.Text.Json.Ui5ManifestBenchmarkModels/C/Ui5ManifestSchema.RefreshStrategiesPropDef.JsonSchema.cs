...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RefreshStrategiesPropDef
        : IJsonElement<RefreshStrategiesPropDef>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider EntitySetsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/entitySets"u8, buffer, out written);

            private static void MatchEntitySets(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.EntitySetsEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.EntitySetsUtf8,
                        evaluationPath: EntitySetsSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.EntitySetsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.EntitySetsUtf8))
                {
                    matcher = MatchEntitySets;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/refreshStrategies_prop_def"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/refreshStrategies_prop_def";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/refreshStrategies_prop_def"u8;
