...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<SignatureDef>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAdditionalParametersPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("additionalParameters"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAdditionalParametersNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("additionalParameters"u8, buffer, out written);

            private const int RequiredOffsetForAdditionalParameters = 0;
            private const uint RequiredBitForAdditionalParameters = 0b00000000000000000000000000000001;
            ...
            private const uint RequiredBitForParameters = 0b00000000000000000000000000000010;

            private const uint RequiredBitMask0 =
                RequiredBitForAdditionalParameters | RequiredBitForParameters;
            private static readonly JsonSchemaPathProvider AdditionalParametersSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/additionalParameters"u8, buffer, out written);
            ...
            private static void MatchAdditionalParameters(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.AdditionalParametersEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AdditionalParametersUtf8,
                        evaluationPath: AdditionalParametersSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.AdditionalParametersEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForAdditionalParameters] |= RequiredBitForAdditionalParameters;
            }
            ...
            private static void MatchParameters(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.AdditionalParametersUtf8, MatchAdditionalParameters),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/signature_def"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/signature_def";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/signature_def"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAdditionalParametersPresent, "additionalParameters"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyParametersPresent, "parameters"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAdditionalParameters] & RequiredBitForAdditionalParameters) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAdditionalParametersNotPresent, "additionalParameters"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAdditionalParametersPresent, "additionalParameters"u8, "required"u8);
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyParametersNotPresent, "parameters"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyParametersPresent, "parameters"u8, "required"u8);
