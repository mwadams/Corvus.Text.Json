...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationFilterTypeSelect
    {
        ...
        public readonly partial struct ConfigurationFilterItemArray
            : IJsonElement<ConfigurationFilterItemArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/Configuration.FilterType.Select/properties/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/Configuration.FilterType.Select/properties/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/Configuration.FilterType.Select/properties/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
