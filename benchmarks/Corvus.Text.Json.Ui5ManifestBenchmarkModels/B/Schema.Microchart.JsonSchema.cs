...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Microchart>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/Microchart"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/Microchart";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/Microchart"u8;
                ...
                ref JsonSchemaContext context)
            {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartStackedBar.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartStackedBar.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartStackedBar.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartStackedBar.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
