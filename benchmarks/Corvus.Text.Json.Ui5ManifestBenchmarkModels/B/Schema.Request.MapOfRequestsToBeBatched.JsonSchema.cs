...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Request
    {
        ...
        public readonly partial struct MapOfRequestsToBeBatched
            : IJsonElement<MapOfRequestsToBeBatched>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/request/properties/batch"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/request/properties/batch";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/request/properties/batch"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            {
                                JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
