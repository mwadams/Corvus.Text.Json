...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapWcfNamespace
    {
        ...
        public readonly partial struct RepresentsTheTargetTechnicalIdForAWcfApplication
            : IJsonElement<RepresentsTheTargetTechnicalIdForAWcfApplication>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.wcf/properties/wcf-target-id"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/properties/sap.wcf/properties/wcf-target-id";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.wcf/properties/wcf-target-id"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-zA-Z0-9\\/_]{1,10}$", "pattern"u8, ref context);
                    }
                }
...
#else
                private static Regex CreatePattern() => new("^[a-zA-Z0-9\\/_]{1,10}$", RegexOptions.Compiled);
#endif
