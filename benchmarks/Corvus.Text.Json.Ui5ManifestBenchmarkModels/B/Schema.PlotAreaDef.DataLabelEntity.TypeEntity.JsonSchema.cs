        ...
        public readonly partial struct DataLabelEntity
        {
                ...
                : IJsonElement<TypeEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "value"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly TypeEntity EnumJson1 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"value\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "percentage"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly TypeEntity EnumJson2 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"percentage\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// </summary>
                    public static TypeEntity Value { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "value"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ValueUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "percentage"
                    /// as a <see cref="TypeEntity"/>.
                    /// </summary>
                    public static TypeEntity Percentage { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "percentage"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> PercentageUtf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/plotAreaDef/properties/dataLabel/properties/type"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/plotAreaDef/properties/dataLabel/properties/type";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/plotAreaDef/properties/dataLabel/properties/type"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("value"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("percentage"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
