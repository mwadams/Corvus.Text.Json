...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Vendor>
    {
        public static partial class JsonSchema
        {
            ...
            private const uint RequiredBitForUrl = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForId | RequiredBitForName | RequiredBitForUrl;
            ...
            private static readonly JsonSchemaPathProvider LineOfBusinessSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/lineOfBusiness"u8, buffer, out written);
            ...
            private static void MatchLineOfBusiness(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LineOfBusinessUtf8,
                        evaluationPath: LineOfBusinessSchemaEvaluationPath);
            ...
            private static void MatchUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.LineOfBusinessUtf8, MatchLineOfBusiness),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/vendor"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/vendor";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/vendor"u8;
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUrlPresent, "url"u8, "required"u8);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyUrlNotPresent, "url"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUrlPresent, "url"u8, "required"u8);
