    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
            ...
            : IJsonElement<OptionsEntityArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/Configuration.FilterType.DateRange/properties/options"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/Configuration.FilterType.DateRange/properties/options";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/Configuration.FilterType.DateRange/properties/options"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
