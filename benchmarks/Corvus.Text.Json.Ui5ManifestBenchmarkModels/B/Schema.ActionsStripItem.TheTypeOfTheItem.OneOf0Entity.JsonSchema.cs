        ...
        public readonly partial struct TheTypeOfTheItem
        {
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "Button"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson1 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Button\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "ToolbarSpacer"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson2 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"ToolbarSpacer\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "Link"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson3 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Link\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "Button"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity Button { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "Button"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ButtonUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "ToolbarSpacer"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity ToolbarSpacer { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "ToolbarSpacer"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ToolbarSpacerUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "Link"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity Link { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "Link"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> LinkUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/actionsStripItem/properties/type/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/actionsStripItem/properties/type/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/actionsStripItem/properties/type/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("Button"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("ToolbarSpacer"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("Link"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
