    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct HoldsConfigurationForTheDefaultActionHandlers
                : IJsonElement<HoldsConfigurationForTheDefaultActionHandlers>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaPathProvider SubmitSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/submit"u8, buffer, out written);

                    private static void MatchSubmit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.SubmitUtf8))
                        {
                            matcher = MatchSubmit;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.card/properties/configuration/properties/actionHandlers"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/properties/sap.card/properties/configuration/properties/actionHandlers";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.card/properties/configuration/properties/actionHandlers"u8;
