        ...
        public readonly partial struct DefinesTheLayoutTypeOfTheAttributes
        {
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "OneColumn"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson1 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"OneColumn\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "TwoColumns"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson2 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"TwoColumns\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "OneColumn"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity OneColumn { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "OneColumn"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> OneColumnUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "TwoColumns"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity TwoColumns { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "TwoColumns"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> TwoColumnsUtf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("OneColumn"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("TwoColumns"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
