...
public readonly partial struct Schema
{
        ...
        : IJsonElement<ResizableLayoutVariant>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/resizableLayoutVariant"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/resizableLayoutVariant";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/resizableLayoutVariant"u8;
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                        {
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.ResizableLayoutVariantCardProperties.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
