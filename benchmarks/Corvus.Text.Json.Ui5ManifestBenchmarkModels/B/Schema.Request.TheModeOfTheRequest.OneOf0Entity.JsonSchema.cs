...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Request
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct TheModeOfTheRequest
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "no-cors"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson1 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"no-cors\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "same-origin"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson2 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"same-origin\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "cors"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson3 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"cors\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "no-cors"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity NoCors { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "no-cors"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> NoCorsUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "same-origin"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity SameOrigin { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "same-origin"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> SameOriginUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "cors"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity Cors { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "cors"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> CorsUtf8 => Constants.Enum3;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/request/properties/mode/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/request/properties/mode/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/request/properties/mode/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("no-cors"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("same-origin"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("cors"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
