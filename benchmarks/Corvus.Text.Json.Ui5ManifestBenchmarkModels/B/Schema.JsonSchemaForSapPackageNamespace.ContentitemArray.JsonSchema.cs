...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapPackageNamespace
    {
        ...
        public readonly partial struct ContentitemArray
            : IJsonElement<ContentitemArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.package/properties/contents"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/properties/sap.package/properties/contents";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.package/properties/contents"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
