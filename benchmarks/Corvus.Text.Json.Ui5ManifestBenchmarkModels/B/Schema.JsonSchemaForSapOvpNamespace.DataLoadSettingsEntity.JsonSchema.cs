...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct DataLoadSettingsEntity
            : IJsonElement<DataLoadSettingsEntity>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider LoadDataOnAppLaunchSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/loadDataOnAppLaunch"u8, buffer, out written);

                private static void MatchLoadDataOnAppLaunch(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.LoadDataOnAppLaunchUtf8,
                            evaluationPath: LoadDataOnAppLaunchSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.LoadDataOnAppLaunchUtf8))
                    {
                        matcher = MatchLoadDataOnAppLaunch;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.ovp/properties/dataLoadSettings"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/properties/sap.ovp/properties/dataLoadSettings";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.ovp/properties/dataLoadSettings"u8;
