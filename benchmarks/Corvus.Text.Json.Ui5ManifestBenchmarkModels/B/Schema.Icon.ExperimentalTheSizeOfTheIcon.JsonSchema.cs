    ...
    public readonly partial struct Icon
    {
            ...
            : IJsonElement<ExperimentalTheSizeOfTheIcon>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/icon/properties/size"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/icon/properties/size";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/icon/properties/size"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.Icon.ExperimentalTheSizeOfTheIcon.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Icon.ExperimentalTheSizeOfTheIcon.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
