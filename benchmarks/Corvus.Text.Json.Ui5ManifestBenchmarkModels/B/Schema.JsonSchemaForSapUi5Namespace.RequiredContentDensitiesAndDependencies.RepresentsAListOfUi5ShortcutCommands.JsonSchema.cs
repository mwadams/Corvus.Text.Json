    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsAListOfUi5ShortcutCommands
                : IJsonElement<RepresentsAListOfUi5ShortcutCommands>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^[A-Za-z_][A-Za-z0-9_\\-\\|@]+$/$ref"u8, buffer, out written);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.ui5/allOf/0/properties/commands"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/properties/sap.ui5/allOf/0/properties/commands";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.ui5/allOf/0/properties/commands"u8;
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                {
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
                                    context.EvaluatedKeyword(context.IsMatch, "^[A-Za-z_][A-Za-z0-9_\\-\\|@]+$", messageProvider: JsonSchemaEvaluation.ExpectedMatchPatternPropertySchema, "patternProperties"u8);
...
#else
                    private static Regex CreatePatternProperties() => new("^[A-Za-z_][A-Za-z0-9_\\-\\|@]+$", RegexOptions.Compiled);
#endif
