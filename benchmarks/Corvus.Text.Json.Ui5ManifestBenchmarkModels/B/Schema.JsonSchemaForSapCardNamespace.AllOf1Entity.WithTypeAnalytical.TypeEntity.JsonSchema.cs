            ...
            public readonly partial struct WithTypeAnalytical
            {
                    ...
                    : IJsonElement<TypeEntity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Const = "Analytical"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>const</c> keyword.
                        /// </summary>
                        public static readonly TypeEntity ConstJson = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"Analytical\""u8]);
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.card/allOf/1/if/properties/type"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "schema.json#/properties/sap.card/allOf/1/if/properties/type";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.card/allOf/1/if/properties/type"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "Analytical"u8, "Analytical", "const"u8, ref context);
                            }
                            else
                            {
                                context.EvaluatedKeyword(false, "Analytical", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                            }
                        }
