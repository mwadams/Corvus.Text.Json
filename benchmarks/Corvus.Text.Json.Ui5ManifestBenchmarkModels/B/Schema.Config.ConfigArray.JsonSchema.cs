...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Config
    {
        ...
        public readonly partial struct ConfigArray
            : IJsonElement<ConfigArray>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/config/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/config/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/config/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
