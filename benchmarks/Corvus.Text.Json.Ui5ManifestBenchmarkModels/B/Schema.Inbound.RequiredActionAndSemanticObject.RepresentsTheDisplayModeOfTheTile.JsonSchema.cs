        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
                ...
                : IJsonElement<RepresentsTheDisplayModeOfTheTile>
            {
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/inbound/patternProperties/^[\\w\\.\\-]+$/properties/displayMode"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/inbound/patternProperties/^[\\w\\.\\-]+$/properties/displayMode";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/inbound/patternProperties/^[\\w\\.\\-]+$/properties/displayMode"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("ContentMode"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("HeaderMode"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
