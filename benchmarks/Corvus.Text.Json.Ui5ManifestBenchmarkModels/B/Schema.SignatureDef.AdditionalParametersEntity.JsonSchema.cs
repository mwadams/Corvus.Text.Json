    ...
    public readonly partial struct SignatureDef
    {
            ...
            : IJsonElement<AdditionalParametersEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "ignored"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AdditionalParametersEntity EnumJson1 = ParsedJsonDocument<AdditionalParametersEntity>.StringConstant([.."\"ignored\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "allowed"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AdditionalParametersEntity EnumJson2 = ParsedJsonDocument<AdditionalParametersEntity>.StringConstant([.."\"allowed\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "notallowed"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly AdditionalParametersEntity EnumJson3 = ParsedJsonDocument<AdditionalParametersEntity>.StringConstant([.."\"notallowed\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// </summary>
                public static AdditionalParametersEntity Ignored { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "ignored"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> IgnoredUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "allowed"
                /// as a <see cref="AdditionalParametersEntity"/>.
                /// </summary>
                public static AdditionalParametersEntity Allowed { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "allowed"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> AllowedUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "notallowed"
                /// as a <see cref="AdditionalParametersEntity"/>.
                /// </summary>
                public static AdditionalParametersEntity Notallowed { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "notallowed"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> NotallowedUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/signature_def/properties/additionalParameters"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/signature_def/properties/additionalParameters";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/signature_def/properties/additionalParameters"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("ignored"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("allowed"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("notallowed"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
