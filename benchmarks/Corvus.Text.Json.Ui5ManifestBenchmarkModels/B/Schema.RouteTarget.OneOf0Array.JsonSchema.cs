    ...
    public readonly partial struct RouteTarget
    {
            ...
            : IJsonElement<OneOf0Array>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/routeTarget/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/routeTarget/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/routeTarget/oneOf/0"u8;
                    ...
                    else
                    {
                        ...
                        while (arrayValidation_enumerator.MoveNext())
                        {
                            ...
                            switch (arrayValidation_itemCount)
                            {
                                case 0:
                                {
                                    JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity.JsonSchema.PushChildContext(
                                        parentDocument,
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
