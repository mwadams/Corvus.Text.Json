...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct DescribesWhatDestinationsAreUsedByTheCard
                : IJsonElement<DescribesWhatDestinationsAreUsedByTheCard>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/sap.card/properties/configuration/properties/destinations"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/properties/sap.card/properties/configuration/properties/destinations";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/sap.card/properties/configuration/properties/destinations"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                {
                                    JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationDestinations.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationDestinations.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
