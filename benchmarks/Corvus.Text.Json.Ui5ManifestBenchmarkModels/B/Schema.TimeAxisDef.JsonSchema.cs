...
public readonly partial struct Schema
{
        ...
        : IJsonElement<TimeAxisDef>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider LevelsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/levels/$ref"u8, buffer, out written);

            private static void MatchLevels(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LevelsUtf8,
                        evaluationPath: LevelsSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.LevelsUtf8))
                {
                    matcher = MatchLevels;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/timeAxisDef"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/timeAxisDef";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/timeAxisDef"u8;
