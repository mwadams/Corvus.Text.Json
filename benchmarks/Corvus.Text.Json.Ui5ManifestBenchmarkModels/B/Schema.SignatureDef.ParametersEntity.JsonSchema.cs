    ...
    public readonly partial struct SignatureDef
    {
            ...
            : IJsonElement<ParametersEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/signature_def/properties/parameters"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/signature_def/properties/parameters";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/signature_def/properties/parameters"u8;
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
