        ...
        public static partial class JsonSchema
        {
            ...
            private static void MatchBuildPresets(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.BuildPresetsV2.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchConfigurePresets(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsV1.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.ConfigurePresetsV1.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchTestPresets(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV2.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.TestPresetsV2.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static void MatchVendorValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Vendor.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
            ...
            private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext5 =
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType2.VersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WithVersionType2.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/oneOf/1"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cmake-presets-schema.json#/oneOf/1";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/oneOf/1"u8;
