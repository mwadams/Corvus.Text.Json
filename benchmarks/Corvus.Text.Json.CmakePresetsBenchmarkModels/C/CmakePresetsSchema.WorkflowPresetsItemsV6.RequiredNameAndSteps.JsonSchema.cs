            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.NameEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static void MatchSteps(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext3 =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.RequiredNameAndTypeArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static void MatchVendor(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext4 =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.WorkflowPresetsItemsV6.RequiredNameAndSteps.VendorEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
