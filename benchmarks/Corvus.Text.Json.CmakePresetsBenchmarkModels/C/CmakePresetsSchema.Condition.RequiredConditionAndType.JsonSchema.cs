...
public readonly partial struct CmakePresetsSchema
{
    ...
    public readonly partial struct Condition
    {
        ...
        public readonly partial struct RequiredConditionAndType
            : IJsonElement<RequiredConditionAndType>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForCondition | RequiredBitForType;
                private static readonly JsonSchemaPathProvider ConditionValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/condition/$ref"u8, buffer, out written);
                ...
                private static void MatchConditionValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ConditionValueUtf8,
                            evaluationPath: ConditionValueSchemaEvaluationPath);

                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.CmakePresetsBenchmark.Current.CmakePresetsSchema.Condition.RequiredConditionAndType.ARequiredStringSpecifyingTheTypeOfTheCondition.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.CmakePresetsBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.ConditionValueUtf8, MatchConditionValue),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cmake-presets-schema.json#/definitions/condition/anyOf/10"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "cmake-presets-schema.json#/definitions/condition/anyOf/10";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cmake-presets-schema.json#/definitions/condition/anyOf/10"u8;
