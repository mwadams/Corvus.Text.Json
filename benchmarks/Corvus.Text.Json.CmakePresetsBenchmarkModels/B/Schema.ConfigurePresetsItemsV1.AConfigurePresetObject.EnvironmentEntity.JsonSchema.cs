        ...
        public readonly partial struct AConfigurePresetObject
        {
                ...
                : IJsonElement<EnvironmentEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/configurePresetsItemsV1/items/properties/environment"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/configurePresetsItemsV1/items/properties/environment";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/configurePresetsItemsV1/items/properties/environment"u8;
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                using (var fixedJsonString = FixedStringJsonDocument<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.EnvironmentEntity.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                                {
                                    JsonSchemaContext childContext =
                                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.EnvironmentEntity.PropertyNamesEntity.JsonSchema.PushChildContext(
                                            fixedJsonString,
                                            0,
                                            ref context,
                                            schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.EnvironmentEntity.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                                ...
                                {
                                    JsonSchemaContext childContext1 = Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
