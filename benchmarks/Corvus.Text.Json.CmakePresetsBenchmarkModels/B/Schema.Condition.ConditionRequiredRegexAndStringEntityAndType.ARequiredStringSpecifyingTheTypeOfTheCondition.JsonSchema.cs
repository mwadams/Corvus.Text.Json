        ...
        public readonly partial struct ConditionRequiredRegexAndStringEntityAndType
        {
                ...
                : IJsonElement<ARequiredStringSpecifyingTheTypeOfTheCondition>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Const = "notMatches"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>const</c> keyword.
                    /// </summary>
                    public static readonly ARequiredStringSpecifyingTheTypeOfTheCondition ConstJson = ParsedJsonDocument<ARequiredStringSpecifyingTheTypeOfTheCondition>.StringConstant([.."\"notMatches\""u8]);
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/condition/anyOf/7/properties/type"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/condition/anyOf/7/properties/type";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/condition/anyOf/7/properties/type"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "notMatches"u8, "notMatches", "const"u8, ref context);
                        }
                        else
                        {
                            context.EvaluatedKeyword(false, "notMatches", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                        }
                    }
