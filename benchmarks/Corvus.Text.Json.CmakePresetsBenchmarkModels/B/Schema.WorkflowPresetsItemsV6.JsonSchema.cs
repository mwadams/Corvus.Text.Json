...
public readonly partial struct Schema
{
        ...
        : IJsonElement<WorkflowPresetsItemsV6>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/workflowPresetsItemsV6"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/workflowPresetsItemsV6";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/workflowPresetsItemsV6"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.WorkflowPresetsItemsV6.RequiredNameAndSteps.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
