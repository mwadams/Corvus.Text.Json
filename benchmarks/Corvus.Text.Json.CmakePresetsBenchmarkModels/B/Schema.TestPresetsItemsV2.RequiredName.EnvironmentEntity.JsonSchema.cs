        ...
        public readonly partial struct RequiredName
        {
                ...
                : IJsonElement<EnvironmentEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/testPresetsItemsV2/items/properties/environment"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/testPresetsItemsV2/items/properties/environment";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/testPresetsItemsV2/items/properties/environment"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                using (var fixedJsonString = FixedStringJsonDocument<Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                                {
                                    JsonSchemaContext childContext =
                                        Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity.JsonSchema.PushChildContext(
                                            fixedJsonString,
                                            0,
                                            ref context,
                                            schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                                ...
                                {
                                    JsonSchemaContext childContext1 = Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.RequiredName.EnvironmentEntity.AdditionalPropertiesEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
