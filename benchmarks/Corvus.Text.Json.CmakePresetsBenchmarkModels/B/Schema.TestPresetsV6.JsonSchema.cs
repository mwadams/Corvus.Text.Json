...
public readonly partial struct Schema
{
        ...
        : IJsonElement<TestPresetsV6>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/testPresetsV6"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/testPresetsV6";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/testPresetsV6"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext allOfContext0 =
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf0SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV2.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext0);
                ...
                JsonSchemaContext allOfContext1 =
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV3.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext1);
                ...
                JsonSchemaContext allOfContext2 =
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf2SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV5.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext2);
                ...
                JsonSchemaContext allOfContext3 =
                    Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf3SchemaEvaluationPath);
                Corvus.CmakePresetsBenchmark.Baseline.Schema.TestPresetsItemsV6.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext3);
