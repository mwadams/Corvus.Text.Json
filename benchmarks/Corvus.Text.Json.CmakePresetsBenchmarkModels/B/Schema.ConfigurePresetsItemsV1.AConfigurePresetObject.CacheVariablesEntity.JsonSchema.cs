    ...
    public readonly partial struct ConfigurePresetsItemsV1
    {
        ...
        public readonly partial struct AConfigurePresetObject
        {
            ...
            public readonly partial struct CacheVariablesEntity
                : IJsonElement<CacheVariablesEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/configurePresetsItemsV1/items/properties/cacheVariables"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/configurePresetsItemsV1/items/properties/cacheVariables";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/configurePresetsItemsV1/items/properties/cacheVariables"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                using (var fixedJsonString = FixedStringJsonDocument<Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                                {
                                    JsonSchemaContext childContext =
                                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.PropertyNamesEntity.JsonSchema.PushChildContext(
                                            fixedJsonString,
                                            0,
                                            ref context,
                                            schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                                ...
                                {
                                    JsonSchemaContext childContext1 = Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV1.AConfigurePresetObject.CacheVariablesEntity.AdditionalPropertiesEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
