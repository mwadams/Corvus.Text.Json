    ...
    public readonly partial struct WithVersionType1
    {
            ...
            : IJsonElement<VersionEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly NormalizedJsonNumber Const = new(false, [.."1"u8], [..""u8], 0);
                /// <summary>
                /// A constant for the <c>const</c> keyword.
                /// </summary>
                public static readonly VersionEntity ConstJson = ParsedJsonDocument<VersionEntity>.NumberConstant([.."1"u8]);
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/oneOf/0/properties/version"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/oneOf/0/properties/version";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/oneOf/0/properties/version"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.Number)
                    {
                        ...
                        JsonSchemaEvaluation.MatchEquals(isNegative, integral, fractional, exponent, false, "1"u8, ""u8, 0, "1", "const"u8, ref context);
                    }
                    else
                    {
                        context.EvaluatedKeyword(false, "1", messageProvider: JsonSchemaEvaluation.ExpectedEquals, "const"u8);
                    }
                }
