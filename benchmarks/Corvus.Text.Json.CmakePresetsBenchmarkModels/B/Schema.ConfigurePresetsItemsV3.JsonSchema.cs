...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurePresetsItemsV3
        : IJsonElement<ConfigurePresetsItemsV3>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/configurePresetsItemsV3"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/configurePresetsItemsV3";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/configurePresetsItemsV3"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.CmakePresetsBenchmark.Baseline.Schema.ConfigurePresetsItemsV3.AConfigurePresetObject.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
