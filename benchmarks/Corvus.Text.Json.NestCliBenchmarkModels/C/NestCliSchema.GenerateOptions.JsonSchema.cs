...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GenerateOptions
        : IJsonElement<GenerateOptions>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider BaseDirSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/baseDir/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider FlatSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/flat/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider SpecSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/spec/$ref"u8, buffer, out written);

            private static void MatchBaseDir(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.BaseDirUtf8,
                        evaluationPath: BaseDirSchemaEvaluationPath);

                Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchFlat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.FlatUtf8,
                        evaluationPath: FlatSchemaEvaluationPath);

                Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchSpec(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.SpecUtf8,
                        evaluationPath: SpecSchemaEvaluationPath);

                Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static PropertySchemaMatchers<Corvus.NestCliBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.NestCliBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.BaseDirUtf8, MatchBaseDir),
                    (static () => JsonPropertyNames.FlatUtf8, MatchFlat),
                    (static () => JsonPropertyNames.SpecUtf8, MatchSpec),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/nest-cli.json#/definitions/GenerateOptions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/nest-cli.json#/definitions/GenerateOptions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/nest-cli.json#/definitions/GenerateOptions"u8;
