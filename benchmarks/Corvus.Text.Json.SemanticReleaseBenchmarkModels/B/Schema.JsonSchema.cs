    ...
    : IJsonElement<Schema>
{
    ...
    {
        private static readonly JsonSchemaPathProvider BranchesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/branches"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider CiSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/ci"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider DryRunSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/dryRun"u8, buffer, out written);
        ...
        private static void MatchBranches(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.BranchesUtf8,
                    evaluationPath: BranchesSchemaEvaluationPath);

            Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchCi(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.SemanticReleaseBenchmark.Baseline.Schema.CiEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.CiUtf8,
                    evaluationPath: CiSchemaEvaluationPath);

            Corvus.SemanticReleaseBenchmark.Baseline.Schema.CiEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchDryRun(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.DryRunUtf8,
                    evaluationPath: DryRunSchemaEvaluationPath);

            Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchExtends(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext3 =
                Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchPlugins(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext4 =
                Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static void MatchRepositoryUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext5 =
                Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.RepositoryUrlUtf8,
                    evaluationPath: RepositoryUrlSchemaEvaluationPath);

            Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
        ...
        private static void MatchTagFormat(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext6 =
                Corvus.SemanticReleaseBenchmark.Baseline.Schema.TagFormatEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.TagFormatUtf8,
                    evaluationPath: TagFormatSchemaEvaluationPath);

            Corvus.SemanticReleaseBenchmark.Baseline.Schema.TagFormatEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
            context.CommitChildContext(childContext6.IsMatch, ref childContext6);
        }

        private static PropertySchemaMatchers<Corvus.SemanticReleaseBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.SemanticReleaseBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.BranchesUtf8, MatchBranches),
                (static () => JsonPropertyNames.CiUtf8, MatchCi),
                (static () => JsonPropertyNames.DryRunUtf8, MatchDryRun),
                (static () => JsonPropertyNames.ExtendsUtf8, MatchExtends),
                (static () => JsonPropertyNames.PluginsUtf8, MatchPlugins),
                (static () => JsonPropertyNames.RepositoryUrlUtf8, MatchRepositoryUrl),
                (static () => JsonPropertyNames.TagFormatUtf8, MatchTagFormat),
            ]);
        }

        private static PropertySchemaMatchers<Corvus.SemanticReleaseBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Corvus.SemanticReleaseBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.SemanticReleaseBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
