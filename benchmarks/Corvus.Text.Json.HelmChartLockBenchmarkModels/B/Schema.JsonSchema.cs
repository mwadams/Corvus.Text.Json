    ...
    : IJsonElement<Schema>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForDigest = 0b00000000000000000000000000000010;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGeneratedPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("generated"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyGeneratedNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("generated"u8, buffer, out written);

        private const int RequiredOffsetForGenerated = 0;
        private const uint RequiredBitForGenerated = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForDependencies | RequiredBitForDigest | RequiredBitForGenerated;
        ...
        private static readonly JsonSchemaPathProvider GeneratedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/generated"u8, buffer, out written);
        ...
        private static void MatchDependencies(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.HelmChartLockBenchmark.Baseline.Schema.RequiredNameAndRepositoryAndVersionArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchDigest(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.HelmChartLockBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.HelmChartLockBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchGenerated(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.GeneratedUtf8,
                    evaluationPath: GeneratedSchemaEvaluationPath);

            Corvus.HelmChartLockBenchmark.Baseline.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            requiredBitBuffer[RequiredOffsetForGenerated] |= RequiredBitForGenerated;
        }

        private static PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.DependenciesUtf8, MatchDependencies),
                (static () => JsonPropertyNames.DigestUtf8, MatchDigest),
                (static () => JsonPropertyNames.GeneratedUtf8, MatchGenerated),
            ]);
        }

        private static PropertySchemaMatchers<Corvus.HelmChartLockBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Corvus.HelmChartLockBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.HelmChartLockBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyDigestPresent, "digest"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyGeneratedPresent, "generated"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyDigestNotPresent, "digest"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyDigestPresent, "digest"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForGenerated] & RequiredBitForGenerated) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyGeneratedNotPresent, "generated"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyGeneratedPresent, "generated"u8, "required"u8);
