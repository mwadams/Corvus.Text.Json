            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
