...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        /// </remarks>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(ResponseBodyMasksJsonStringArray), "Create")]
#endif
        public readonly partial struct ResponseBodyMasksJsonStringArray
            : IJsonArray<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.ResponseBodyMasksJsonStringArray>,
              IReadOnlyCollection<Corvus.Json.JsonString>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static ResponseBodyMasksJsonStringArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<ResponseBodyMasksJsonStringArray>.this[int index]
            {
                get
                {
            ...
            public static implicit operator ResponseBodyMasksJsonStringArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(ResponseBodyMasksJsonStringArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ResponseBodyMasksJsonStringArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(ResponseBodyMasksJsonStringArray value)
            {
                return
                    value.AsArray;
            }
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ResponseBodyMasksJsonStringArray"/> struct.
            /// </summary>
            ...
            public static ResponseBodyMasksJsonStringArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="ResponseBodyMasksJsonStringArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static ResponseBodyMasksJsonStringArray Create(ReadOnlySpan<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            public static ResponseBodyMasksJsonStringArray FromItems(params Corvus.Json.JsonString[] items)
            {
                return new([..items]);
            }
            ...
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ResponseBodyMasksJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6, in Corvus.Json.JsonString item7)
            {
            ...
            public static ResponseBodyMasksJsonStringArray FromRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<ResponseBodyMasksJsonStringArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<ResponseBodyMasksJsonStringArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.Add(params JsonAny[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.AddRange<TItem>(IEnumerable<TItem> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.InsertRange<TArray>(int index, in TArray items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.InsertRange(int index, IEnumerable<JsonAny> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.SetItem(int index, in JsonAny value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray Add(in Corvus.Json.JsonString item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray Add(params Corvus.Json.JsonString[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray AddRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonString item in items)
                {
            ...
            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray Insert(int index, in Corvus.Json.JsonString item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray InsertRange(int index, IEnumerable<Corvus.Json.JsonString> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray Replace(in Corvus.Json.JsonString oldValue, in Corvus.Json.JsonString newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray SetItem(int index, in Corvus.Json.JsonString value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            ResponseBodyMasksJsonStringArray IJsonArray<ResponseBodyMasksJsonStringArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public ResponseBodyMasksJsonStringArray Remove(in Corvus.Json.JsonString oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in ResponseBodyMasksJsonStringArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ResponseBodyMasksJsonStringArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in ResponseBodyMasksJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in ResponseBodyMasksJsonStringArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in ResponseBodyMasksJsonStringArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ResponseBodyMasksJsonStringArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in ResponseBodyMasksJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ResponseBodyMasksJsonStringArray arrayInstance, int index, TEnumerable values)
