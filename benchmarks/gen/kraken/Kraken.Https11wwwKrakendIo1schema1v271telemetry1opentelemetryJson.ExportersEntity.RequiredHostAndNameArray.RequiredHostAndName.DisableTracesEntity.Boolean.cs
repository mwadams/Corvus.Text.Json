            ...
            public readonly partial struct RequiredHostAndNameArray
            {
                ...
                public readonly partial struct RequiredHostAndName
                {
                    ...
                    public readonly partial struct DisableTracesEntity
                        : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.DisableTracesEntity>
                    {
                        /// <summary>
                        /// Conversion from <see cref="bool"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DisableTracesEntity(bool value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DisableTracesEntity(JsonBoolean value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonBoolean(DisableTracesEntity value)
                        {
                            return
                                value.AsBoolean;
                        }
                        ...
                        public static implicit operator bool(DisableTracesEntity value)
                        {
