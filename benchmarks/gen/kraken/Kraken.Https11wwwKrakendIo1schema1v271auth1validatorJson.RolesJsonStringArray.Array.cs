...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        /// </remarks>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(RolesJsonStringArray), "Create")]
#endif
        public readonly partial struct RolesJsonStringArray
            : IJsonArray<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.RolesJsonStringArray>,
              IReadOnlyCollection<Corvus.Json.JsonString>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static RolesJsonStringArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<RolesJsonStringArray>.this[int index]
            {
                get
                {
            ...
            public static implicit operator RolesJsonStringArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(RolesJsonStringArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RolesJsonStringArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(RolesJsonStringArray value)
            {
                return
                    value.AsArray;
            }
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RolesJsonStringArray"/> struct.
            /// </summary>
            ...
            public static RolesJsonStringArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="RolesJsonStringArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static RolesJsonStringArray Create(ReadOnlySpan<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            public static RolesJsonStringArray FromItems(params Corvus.Json.JsonString[] items)
            {
                return new([..items]);
            }
            ...
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RolesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6, in Corvus.Json.JsonString item7)
            {
            ...
            public static RolesJsonStringArray FromRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static RolesJsonStringArray IJsonArray<RolesJsonStringArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static RolesJsonStringArray IJsonArray<RolesJsonStringArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<RolesJsonStringArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<RolesJsonStringArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.Add(params JsonAny[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.AddRange<TItem>(IEnumerable<TItem> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.InsertRange<TArray>(int index, in TArray items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.InsertRange(int index, IEnumerable<JsonAny> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.SetItem(int index, in JsonAny value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            public RolesJsonStringArray Add(in Corvus.Json.JsonString item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public RolesJsonStringArray Add(params Corvus.Json.JsonString[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public RolesJsonStringArray AddRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonString item in items)
                {
            ...
            /// <inheritdoc/>
            public RolesJsonStringArray Insert(int index, in Corvus.Json.JsonString item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public RolesJsonStringArray InsertRange(int index, IEnumerable<Corvus.Json.JsonString> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public RolesJsonStringArray Replace(in Corvus.Json.JsonString oldValue, in Corvus.Json.JsonString newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public RolesJsonStringArray SetItem(int index, in Corvus.Json.JsonString value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            RolesJsonStringArray IJsonArray<RolesJsonStringArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public RolesJsonStringArray Remove(in Corvus.Json.JsonString oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in RolesJsonStringArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in RolesJsonStringArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in RolesJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in RolesJsonStringArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in RolesJsonStringArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in RolesJsonStringArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in RolesJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in RolesJsonStringArray arrayInstance, int index, TEnumerable values)
