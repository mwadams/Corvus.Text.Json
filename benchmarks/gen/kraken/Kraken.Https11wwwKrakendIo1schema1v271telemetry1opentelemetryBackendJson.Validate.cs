    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-backend.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.BackendUtf8, JsonPropertyNames.Backend))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.BackendEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.ProxyUtf8, JsonPropertyNames.Proxy))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.ProxyEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
