...
#if NET8_0_OR_GREATER
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity>,
                      IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity>,
                      ...
                      IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity>,
                      IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity>
#else
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.WorkersEntity>
#endif
                {
                    /// <summary>
                    /// Initializes a new instance of the <see cref = "WorkersEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public WorkersEntity(long value)
                    ...
                    public static implicit operator WorkersEntity(JsonNumber value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonNumber(WorkersEntity value)
                    {
                        return
                            value.AsNumber;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonInteger(WorkersEntity value)
                    {
                        return
                    ...
                    public static explicit operator byte(WorkersEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(byte value)
                    {
                    ...
                    public static explicit operator decimal(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(decimal value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator double(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(double value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator short(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator int(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static implicit operator long(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static implicit operator WorkersEntity(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Int128(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(Int128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator sbyte(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Half(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(Half value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator float(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ushort(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator uint(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(uint value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ulong(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator UInt128(WorkersEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="WorkersEntity"/>.</returns>
                    public static explicit operator WorkersEntity(UInt128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    /// </returns>
                    public static bool operator <(WorkersEntity left, WorkersEntity right)
                    {
                    ...
                    public static WorkersEntity operator +(WorkersEntity left, WorkersEntity right)
                    {
                    ...
                    /// <returns>The result of the operation.</returns>
                    public static WorkersEntity operator ++(WorkersEntity value)
                    {
                    ...
                    /// </returns>
                    public static int Compare(in WorkersEntity lhs, in WorkersEntity rhs)
                    {
