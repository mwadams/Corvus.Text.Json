        ...
        public readonly partial struct HeaderMappingEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1grpc.json/properties/header_mapping");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty<Corvus.Json.JsonNotAny> property in value.EnumerateObject())
                    {
                        ...
                        if (PatternProperties.IsMatch(propertyNameAsString))
                        {
                            ...
                            result = property.Value.As<Corvus.Json.JsonString>().Validate(result, level);
