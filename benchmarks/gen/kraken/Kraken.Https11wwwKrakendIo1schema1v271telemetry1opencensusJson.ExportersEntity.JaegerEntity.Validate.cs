            ...
            public readonly partial struct JaegerEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opencensus.json/properties/exporters/properties/jaeger");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext oneOfResult0 = value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.JaegerEntity.RequiredEndpointAndServiceName>().Validate(oneOfChildContext0, level);
                        ...
                        ValidationContext oneOfResult1 = value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.JaegerEntity.RequiredAgentEndpointAndServiceName>().Validate(oneOfChildContext1, level);
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            if (property.NameEquals(JsonPropertyNames.AgentEndpointUtf8, JsonPropertyNames.AgentEndpoint))
                            {
                                result = result.WithLocalProperty(propertyCount);
                                if (level > ValidationLevel.Basic)
                                {
                                    result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/agent_endpoint"), JsonPropertyNames.AgentEndpoint);
                                }
                            ...
                            else if (property.NameEquals(JsonPropertyNames.BufferMaxCountUtf8, JsonPropertyNames.BufferMaxCount))
                            {
                                result = result.WithLocalProperty(propertyCount);
                                if (level > ValidationLevel.Basic)
                                {
                                    result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/buffer_max_count"), JsonPropertyNames.BufferMaxCount);
                                }
