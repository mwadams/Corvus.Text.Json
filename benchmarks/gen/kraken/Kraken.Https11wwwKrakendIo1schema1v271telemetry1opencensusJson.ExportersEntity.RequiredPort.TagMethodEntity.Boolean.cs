        ...
        public readonly partial struct ExportersEntity
        {
            ...
            public readonly partial struct RequiredPort
            {
                ...
                public readonly partial struct TagMethodEntity
                    : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.RequiredPort.TagMethodEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator TagMethodEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator TagMethodEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(TagMethodEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(TagMethodEntity value)
                    {
