...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        /// </remarks>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(ScopesJsonStringArray), "Create")]
#endif
        public readonly partial struct ScopesJsonStringArray
            : IJsonArray<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.ScopesJsonStringArray>,
              IReadOnlyCollection<Corvus.Json.JsonString>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static ScopesJsonStringArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<ScopesJsonStringArray>.this[int index]
            {
                get
                {
            ...
            public static implicit operator ScopesJsonStringArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(ScopesJsonStringArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ScopesJsonStringArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(ScopesJsonStringArray value)
            {
                return
                    value.AsArray;
            }
            ...
            public static ScopesJsonStringArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="ScopesJsonStringArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static ScopesJsonStringArray Create(ReadOnlySpan<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            public static ScopesJsonStringArray FromItems(params Corvus.Json.JsonString[] items)
            {
                return new([..items]);
            }
            ...
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static ScopesJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6, in Corvus.Json.JsonString item7)
            {
            ...
            public static ScopesJsonStringArray FromRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<ScopesJsonStringArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<ScopesJsonStringArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.Add(params JsonAny[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.AddRange<TItem>(IEnumerable<TItem> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.InsertRange<TArray>(int index, in TArray items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.InsertRange(int index, IEnumerable<JsonAny> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.SetItem(int index, in JsonAny value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            public ScopesJsonStringArray Add(in Corvus.Json.JsonString item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ScopesJsonStringArray Add(params Corvus.Json.JsonString[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public ScopesJsonStringArray AddRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonString item in items)
                {
            ...
            /// <inheritdoc/>
            public ScopesJsonStringArray Insert(int index, in Corvus.Json.JsonString item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public ScopesJsonStringArray InsertRange(int index, IEnumerable<Corvus.Json.JsonString> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public ScopesJsonStringArray Replace(in Corvus.Json.JsonString oldValue, in Corvus.Json.JsonString newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public ScopesJsonStringArray SetItem(int index, in Corvus.Json.JsonString value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            ScopesJsonStringArray IJsonArray<ScopesJsonStringArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public ScopesJsonStringArray Remove(in Corvus.Json.JsonString oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in ScopesJsonStringArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in ScopesJsonStringArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in ScopesJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in ScopesJsonStringArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in ScopesJsonStringArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in ScopesJsonStringArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in ScopesJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in ScopesJsonStringArray arrayInstance, int index, TEnumerable values)
