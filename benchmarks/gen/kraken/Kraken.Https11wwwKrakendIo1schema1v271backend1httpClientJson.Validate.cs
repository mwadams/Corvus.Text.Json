    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1httpClientJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1http_client.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271backend1httpClientJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.NoRedirectUtf8, JsonPropertyNames.NoRedirect))
                    {
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/no_redirect"), JsonPropertyNames.NoRedirect);
                        }

                        ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1httpClientJson.NoRedirectEntity>().Validate(result.CreateChildContext(), level);
                        if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                        {
                            return propertyResult;
                        }
                    ...
                    else if (property.NameEquals(JsonPropertyNames.ProxyAddressUtf8, JsonPropertyNames.ProxyAddress))
                    {
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/proxy_address"), JsonPropertyNames.ProxyAddress);
                        }
