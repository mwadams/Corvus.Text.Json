        ...
        public readonly partial struct ExportersEntity
        {
            ...
            public readonly partial struct LoggerEntity
            {
                ...
                public readonly partial struct SpansEntity
                    : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.LoggerEntity.SpansEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator SpansEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator SpansEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(SpansEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(SpansEntity value)
                    {
