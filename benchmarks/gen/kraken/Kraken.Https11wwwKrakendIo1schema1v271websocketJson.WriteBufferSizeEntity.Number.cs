...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271websocketJson
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct WriteBufferSizeEntity
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.WriteBufferSizeEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "WriteBufferSizeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public WriteBufferSizeEntity(long value)
            ...
            public static implicit operator WriteBufferSizeEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(WriteBufferSizeEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(WriteBufferSizeEntity value)
            {
                return
            ...
            public static explicit operator byte(WriteBufferSizeEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(byte value)
            {
            ...
            public static explicit operator decimal(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static implicit operator WriteBufferSizeEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(WriteBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="WriteBufferSizeEntity"/>.</returns>
            public static explicit operator WriteBufferSizeEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(WriteBufferSizeEntity left, WriteBufferSizeEntity right)
            {
            ...
            public static WriteBufferSizeEntity operator +(WriteBufferSizeEntity left, WriteBufferSizeEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static WriteBufferSizeEntity operator ++(WriteBufferSizeEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in WriteBufferSizeEntity lhs, in WriteBufferSizeEntity rhs)
            {
