    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271validation1celJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ArrayValidationHandler(
                in Https11wwwKrakendIo1schema1v271validation1celJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271validation1celJson.RequiredCheckExpr> arrayEnumerator = value.EnumerateArray();
