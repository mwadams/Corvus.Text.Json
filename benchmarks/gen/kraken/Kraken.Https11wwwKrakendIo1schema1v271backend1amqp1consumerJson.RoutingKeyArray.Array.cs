...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson
    {
        ...
        /// </remarks>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(RoutingKeyArray), "Create")]
#endif
        public readonly partial struct RoutingKeyArray
            : IJsonArray<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.RoutingKeyArray>,
              IReadOnlyCollection<Corvus.Json.JsonAny>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static RoutingKeyArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            public static implicit operator RoutingKeyArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(RoutingKeyArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RoutingKeyArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(RoutingKeyArray value)
            {
                return
                    value.AsArray;
            }
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RoutingKeyArray"/> struct.
            /// </summary>
            ...
            public static RoutingKeyArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="RoutingKeyArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static RoutingKeyArray Create(ReadOnlySpan<Corvus.Json.JsonAny> items)
            {
                return new([..items]);
            }
            ...
            public static RoutingKeyArray FromItems(params Corvus.Json.JsonAny[] items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The value from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the value.</returns>
            public static RoutingKeyArray FromItems<TItem>(params TItem[] items)
            ...
            public static RoutingKeyArray FromItems<TItem1>(in TItem1 item1)
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2>(in TItem1 item1, in TItem2 item2)
                where TItem1 : struct, IJsonValue<TItem1>
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2, TItem3>(in TItem1 item1, in TItem2 item2, in TItem3 item3)
                where TItem1 : struct, IJsonValue<TItem1>
                where TItem2 : struct, IJsonValue<TItem2>
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2, TItem3, TItem4>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4)
                where TItem1 : struct, IJsonValue<TItem1>
                where TItem2 : struct, IJsonValue<TItem2>
                where TItem3 : struct, IJsonValue<TItem3>
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2, TItem3, TItem4, TItem5>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5)
                where TItem1 : struct, IJsonValue<TItem1>
                where TItem2 : struct, IJsonValue<TItem2>
                where TItem3 : struct, IJsonValue<TItem3>
                where TItem4 : struct, IJsonValue<TItem4>
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6)
                where TItem1 : struct, IJsonValue<TItem1>
                where TItem2 : struct, IJsonValue<TItem2>
                where TItem3 : struct, IJsonValue<TItem3>
                where TItem4 : struct, IJsonValue<TItem4>
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static RoutingKeyArray FromItems<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7>(in TItem1 item1, in TItem2 item2, in TItem3 item3, in TItem4 item4, in TItem5 item5, in TItem6 item6, in TItem7 item7)
                where TItem1 : struct, IJsonValue<TItem1>
                where TItem2 : struct, IJsonValue<TItem2>
                where TItem3 : struct, IJsonValue<TItem3>
                where TItem4 : struct, IJsonValue<TItem4>
            ...
            public static RoutingKeyArray FromRange(IEnumerable<Corvus.Json.JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            public static RoutingKeyArray FromRange<TItem>(IEnumerable<TItem> items)
                where TItem : struct, IJsonValue<TItem>
            {
                return new([..items.Select(item => item.AsAny)]);
            }
            ...
            public static RoutingKeyArray FromRange(IEnumerable<string> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static RoutingKeyArray FromRange(IEnumerable<double> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static RoutingKeyArray FromRange(IEnumerable<float> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static RoutingKeyArray FromRange(IEnumerable<int> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static RoutingKeyArray FromRange(IEnumerable<long> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to create the array.</param>
            /// <returns>The new array created from the items.</returns>
            public static RoutingKeyArray FromRange(IEnumerable<bool> items)
            {
                return new([..items]);
            }
            ...
            /// </remarks>
            public static RoutingKeyArray From<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            public RoutingKeyArray Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            public RoutingKeyArray Add(params JsonAny[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public RoutingKeyArray AddRange<TArray>(in TArray items)
            ...
            /// <inheritdoc/>
            public RoutingKeyArray AddRange<TItem>(IEnumerable<TItem> items)
                where TItem : struct, IJsonValue<TItem>
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public RoutingKeyArray AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public RoutingKeyArray Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public RoutingKeyArray InsertRange<TArray>(int index, in TArray items)
                where TArray : struct, IJsonArray<TArray>
            {
            ...
            /// <inheritdoc/>
            public RoutingKeyArray InsertRange<TItem>(int index, IEnumerable<TItem> items)
                where TItem : struct, IJsonValue<TItem>
            {
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                public static ImmutableList<JsonAny> GetImmutableList(in RoutingKeyArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in RoutingKeyArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in RoutingKeyArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in RoutingKeyArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in RoutingKeyArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in RoutingKeyArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in RoutingKeyArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in RoutingKeyArray arrayInstance, int index, TEnumerable values)
