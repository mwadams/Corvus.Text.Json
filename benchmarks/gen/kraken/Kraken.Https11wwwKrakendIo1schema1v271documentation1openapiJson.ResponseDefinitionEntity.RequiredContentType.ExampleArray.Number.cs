...
#if NET8_0_OR_GREATER
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>,
                      IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>
#else
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType.ExampleArray>
#endif
                {
                    ...
                    public ExampleArray(long value)
                    ...
                    public static implicit operator ExampleArray(JsonNumber value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonNumber(ExampleArray value)
                    {
                        return
                            value.AsNumber;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonInteger(ExampleArray value)
                    {
                        return
                    ...
                    public static explicit operator byte(ExampleArray value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(byte value)
                    {
                    ...
                    public static explicit operator decimal(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(decimal value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator double(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(double value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator short(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator int(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static implicit operator long(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static implicit operator ExampleArray(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Int128(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(Int128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator sbyte(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Half(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(Half value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator float(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ushort(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator uint(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(uint value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ulong(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator UInt128(ExampleArray value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="ExampleArray"/>.</returns>
                    public static explicit operator ExampleArray(UInt128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    /// </returns>
                    public static bool operator <(ExampleArray left, ExampleArray right)
                    {
                    ...
                    public static ExampleArray operator +(ExampleArray left, ExampleArray right)
                    {
                    ...
                    /// <returns>The result of the operation.</returns>
                    public static ExampleArray operator ++(ExampleArray value)
                    {
                    ...
                    /// </returns>
                    public static int Compare(in ExampleArray lhs, in ExampleArray rhs)
                    {
