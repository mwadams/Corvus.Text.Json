...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271clientTlsJson
    {
        ...
        public readonly partial struct AllowInsecureConnectionsEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271clientTlsJson.AllowInsecureConnectionsEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowInsecureConnectionsEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowInsecureConnectionsEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(AllowInsecureConnectionsEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(AllowInsecureConnectionsEntity value)
            {
