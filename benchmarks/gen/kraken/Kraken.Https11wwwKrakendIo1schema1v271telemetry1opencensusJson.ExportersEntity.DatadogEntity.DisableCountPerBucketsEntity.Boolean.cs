        ...
        public readonly partial struct ExportersEntity
        {
            ...
            public readonly partial struct DatadogEntity
            {
                ...
                public readonly partial struct DisableCountPerBucketsEntity
                    : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.DatadogEntity.DisableCountPerBucketsEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator DisableCountPerBucketsEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator DisableCountPerBucketsEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(DisableCountPerBucketsEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(DisableCountPerBucketsEntity value)
                    {
