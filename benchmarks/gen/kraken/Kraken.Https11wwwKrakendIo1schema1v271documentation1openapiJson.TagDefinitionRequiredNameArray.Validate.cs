        ...
        public readonly partial struct TagDefinitionRequiredNameArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/tag_definition");
                }
            ...
            public static partial class CorvusValidation
            {
                ...
                internal static ValidationContext ArrayValidationHandler(
                    in TagDefinitionRequiredNameArray value,
                    JsonValueKind valueKind,
                    in ValidationContext validationContext,
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.TagDefinitionRequiredNameArray.RequiredName> arrayEnumerator = value.EnumerateArray();
