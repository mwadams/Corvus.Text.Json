    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271asyncAgentJson
    {
        ...
        public readonly partial struct RequiredBackendAndConsumerAndExtraConfigAndName
        {
            ...
            public readonly partial struct RequiredTopic
            {
                ...
                /// </para>
                /// </remarks>
                public readonly partial struct MaxRateEntity
#if NET8_0_OR_GREATER
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity>,
                      IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity>,
                      ...
                      IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity>,
                      IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity>
#else
                    : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271asyncAgentJson.RequiredBackendAndConsumerAndExtraConfigAndName.RequiredTopic.MaxRateEntity>
#endif
                {
                    /// <summary>
                    /// Initializes a new instance of the <see cref = "MaxRateEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public MaxRateEntity(double value)
                    ...
                    public static implicit operator MaxRateEntity(JsonNumber value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonNumber(MaxRateEntity value)
                    {
                        return
                            value.AsNumber;
                    }
                    ...
                    public static explicit operator byte(MaxRateEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(byte value)
                    {
                    ...
                    public static explicit operator decimal(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(decimal value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static implicit operator double(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static implicit operator MaxRateEntity(double value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator short(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator int(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator long(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Int128(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(Int128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator sbyte(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Half(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(Half value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator float(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ushort(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator uint(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(uint value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ulong(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator UInt128(MaxRateEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="MaxRateEntity"/>.</returns>
                    public static explicit operator MaxRateEntity(UInt128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    /// </returns>
                    public static bool operator <(MaxRateEntity left, MaxRateEntity right)
                    {
                    ...
                    public static MaxRateEntity operator +(MaxRateEntity left, MaxRateEntity right)
                    {
                    ...
                    /// <returns>The result of the operation.</returns>
                    public static MaxRateEntity operator ++(MaxRateEntity value)
                    {
                    ...
                    /// </returns>
                    public static int Compare(in MaxRateEntity lhs, in MaxRateEntity rhs)
                    {
