                ...
                public readonly partial struct ServicesEntity
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1grpc.json/properties/server/properties/services/items");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            foreach (JsonObjectProperty property in value.EnumerateObject())
                            {
                                ...
                                if (property.NameEquals(JsonPropertyNames.MethodsUtf8, JsonPropertyNames.Methods))
                                {
                                    result = result.WithLocalProperty(propertyCount);
                                    if (level > ValidationLevel.Basic)
                                    {
                                        result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/methods"), JsonPropertyNames.Methods);
                                    }

                                    ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271grpcJson.ServerEntity.ServicesEntityArray.ServicesEntity.MethodsEntityArray>().Validate(result.CreateChildContext(), level);
