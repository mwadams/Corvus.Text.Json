        ...
        public readonly partial struct ReplaceEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1response-headers.json/properties/replace");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        if (PatternProperties.IsMatch(propertyNameAsString))
                        {
                            ...
                            result = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity.JsonStringArray>().Validate(result, level);
