...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1botDetectorJson
    {
        ...
        public readonly partial struct EmptyUserAgentIsBotEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1botDetectorJson.EmptyUserAgentIsBotEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EmptyUserAgentIsBotEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EmptyUserAgentIsBotEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(EmptyUserAgentIsBotEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(EmptyUserAgentIsBotEntity value)
            {
