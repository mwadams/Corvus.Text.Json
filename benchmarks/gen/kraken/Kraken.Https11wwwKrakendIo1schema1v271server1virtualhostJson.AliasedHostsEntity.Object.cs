...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271server1virtualhostJson
    {
        ...
        public readonly partial struct AliasedHostsEntity
            : IJsonObject<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271server1virtualhostJson.AliasedHostsEntity>
        {
            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AliasedHostsEntity(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(AliasedHostsEntity value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AliasedHostsEntity(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(AliasedHostsEntity value)
            {
                return
                    value.AsObject;
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Json.JsonString AZ09
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        ...
                        if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.AZ09Utf8, out JsonElement result))
                        {
                            return new(result);
                        }
                    }
                    ...
                    if ((this.backing & Backing.Object) != 0)
                    {
                        if (this.objectBacking.TryGetValue(JsonPropertyNames.AZ09, out JsonAny result))
                        {
            ...
            /// <inheritdoc/>
            public static AliasedHostsEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static AliasedHostsEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static AliasedHostsEntity FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }

            /// <summary>
            /// Creates an instance of a <see cref="AliasedHostsEntity"/>.
            /// </summary>
            public static AliasedHostsEntity Create(in Corvus.Json.JsonString? aZ09 = null)
            {
                var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();

                if (aZ09 is not null)
                {
                    builder.Add(JsonPropertyNames.AZ09, aZ09.Value.AsAny);
                }
            ...
            /// <summary>
            /// Sets the (optional) <c>[a-z0-9_]</c> property.
            /// Virtualhost
            /// </summary>
            ...
            /// </para>
            /// </remarks>
            public AliasedHostsEntity WithAZ09(in Corvus.Json.JsonString value)
            {
                return this.SetProperty(JsonPropertyNames.AZ09, value);
            }
            ...
            /// <inheritdoc />
            public AliasedHostsEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public AliasedHostsEntity RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AliasedHostsEntity RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AliasedHostsEntity RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AliasedHostsEntity RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in AliasedHostsEntity that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AliasedHostsEntity that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AliasedHostsEntity that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AliasedHostsEntity that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AliasedHostsEntity that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in AliasedHostsEntity that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
