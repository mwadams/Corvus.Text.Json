    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1martianJson
    {
        ...
        public readonly partial struct RequiredNameAndScopeAndValue
        {
            ...
            public readonly partial struct HttpOnlyEntity
                : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1martianJson.RequiredNameAndScopeAndValue.HttpOnlyEntity>
            {
                /// <summary>
                /// Conversion from <see cref="bool"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator HttpOnlyEntity(bool value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator HttpOnlyEntity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonBoolean(HttpOnlyEntity value)
                {
                    return
                        value.AsBoolean;
                }
