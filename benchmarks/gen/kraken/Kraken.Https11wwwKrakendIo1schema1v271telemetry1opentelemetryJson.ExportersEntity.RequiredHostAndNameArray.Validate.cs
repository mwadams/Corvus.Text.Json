            ...
            public readonly partial struct RequiredHostAndNameArray
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/exporters/properties/otlp");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ArrayValidationHandler(
                        in RequiredHostAndNameArray value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level)
                    {
                        ...
                        int length = 0;
                        using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName> arrayEnumerator = value.EnumerateArray();
