        ...
        public readonly partial struct ExportersEntity
        {
            ...
            public readonly partial struct RequiredAddressAndServiceName
            {
                ...
                public readonly partial struct EnableCompressionEntity
                    : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.RequiredAddressAndServiceName.EnableCompressionEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator EnableCompressionEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator EnableCompressionEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(EnableCompressionEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(EnableCompressionEntity value)
                    {
