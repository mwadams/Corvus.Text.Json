    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271serviceExtraConfigJson
    {
        ...
        public readonly partial struct RequiredAllowOrigins
        {
            ...
            public readonly partial struct AllowCredentialsEntity
                : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271serviceExtraConfigJson.RequiredAllowOrigins.AllowCredentialsEntity>
            {
                /// <summary>
                /// Conversion from <see cref="bool"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator AllowCredentialsEntity(bool value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator AllowCredentialsEntity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonBoolean(AllowCredentialsEntity value)
                {
                    return
                        value.AsBoolean;
                }
                ...
                public static implicit operator bool(AllowCredentialsEntity value)
                {
