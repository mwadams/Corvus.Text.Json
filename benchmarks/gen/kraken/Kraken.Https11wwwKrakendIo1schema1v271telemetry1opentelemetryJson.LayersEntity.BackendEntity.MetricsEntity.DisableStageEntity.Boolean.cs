            ...
            public readonly partial struct BackendEntity
            {
                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct DisableStageEntity
                        : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.BackendEntity.MetricsEntity.DisableStageEntity>
                    {
                        /// <summary>
                        /// Conversion from <see cref="bool"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DisableStageEntity(bool value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DisableStageEntity(JsonBoolean value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonBoolean(DisableStageEntity value)
                        {
                            return
                                value.AsBoolean;
                        }
                        ...
                        public static implicit operator bool(DisableStageEntity value)
                        {
