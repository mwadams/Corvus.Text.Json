        ...
        public readonly partial struct ResponseDefinitionEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/response_definition");
                }
            ...
            public static partial class CorvusValidation
            {
                ...
                internal static ValidationContext ObjectValidationHandler(
                    in ResponseDefinitionEntity value,
                    JsonValueKind valueKind,
                    in ValidationContext validationContext,
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty<Corvus.Json.JsonNotAny> property in value.EnumerateObject())
                    {
                        ...
                        if (PatternProperties.IsMatch(propertyNameAsString))
                        {
                            ...
                            result = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271documentation1openapiJson.ResponseDefinitionEntity.RequiredContentType>().Validate(result, level);
