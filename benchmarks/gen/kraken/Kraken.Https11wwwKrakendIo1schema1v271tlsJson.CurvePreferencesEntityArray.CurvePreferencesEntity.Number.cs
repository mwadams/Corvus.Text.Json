...
#if NET8_0_OR_GREATER
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>,
                  IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>
#else
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.CurvePreferencesEntityArray.CurvePreferencesEntity>
#endif
            {
                ...
                public CurvePreferencesEntity(double value)
                ...
                public static implicit operator CurvePreferencesEntity(JsonNumber value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonNumber(CurvePreferencesEntity value)
                {
                    return
                        value.AsNumber;
                }
                ...
                public static explicit operator byte(CurvePreferencesEntity value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(byte value)
                {
                ...
                public static explicit operator decimal(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(decimal value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static implicit operator double(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static implicit operator CurvePreferencesEntity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator short(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator int(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator long(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Int128(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(Int128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator sbyte(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Half(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(Half value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator float(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ushort(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator uint(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ulong(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator UInt128(CurvePreferencesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CurvePreferencesEntity"/>.</returns>
                public static explicit operator CurvePreferencesEntity(UInt128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                /// </returns>
                public static bool operator <(CurvePreferencesEntity left, CurvePreferencesEntity right)
                {
                ...
                public static CurvePreferencesEntity operator +(CurvePreferencesEntity left, CurvePreferencesEntity right)
                {
                ...
                /// <returns>The result of the operation.</returns>
                public static CurvePreferencesEntity operator ++(CurvePreferencesEntity value)
                {
                ...
                /// </returns>
                public static int Compare(in CurvePreferencesEntity lhs, in CurvePreferencesEntity rhs)
                {
