    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointExtraConfigJson
    {
        ...
        public readonly partial struct ProxyEntity
        {
            ...
            public readonly partial struct SequentialEntity
                : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271endpointExtraConfigJson.ProxyEntity.SequentialEntity>
            {
                /// <summary>
                /// Conversion from <see cref="bool"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator SequentialEntity(bool value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator SequentialEntity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonBoolean(SequentialEntity value)
                {
                    return
                        value.AsBoolean;
                }
                ...
                public static implicit operator bool(SequentialEntity value)
                {
