            ...
            public readonly partial struct RequiredCertificateAndPrivateKey
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1client_tls.json/properties/client_certs/items");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ObjectValidationHandler(
                        in RequiredCertificateAndPrivateKey value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        bool hasSeenCertificate = false;
                        bool hasSeenPrivateKey = false;
                        ...
                        foreach (JsonObjectProperty property in value.EnumerateObject())
                        {
                            ...
                            if (property.NameEquals(JsonPropertyNames.CertificateUtf8, JsonPropertyNames.Certificate))
                            {
                                hasSeenCertificate = true;
                                result = result.WithLocalProperty(propertyCount);
                                if (level > ValidationLevel.Basic)
                                {
                                    result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/certificate"), JsonPropertyNames.Certificate);
                                }
                        ...
                        if (!hasSeenCertificate)
                        {
                            if (level >= ValidationLevel.Basic)
                            {
                                result = result.WithResult(isValid: false, "Validation properties - the required property 'certificate' was not present.");
                            }
                            else
                            {
                        ...
                        {
                            result = result.WithResult(isValid: true, "Validation properties - the required property 'certificate' was present.");
                        }
                        ...
                        if (!hasSeenPrivateKey)
                        {
                            if (level >= ValidationLevel.Basic)
                            {
                                result = result.WithResult(isValid: false, "Validation properties - the required property 'private_key' was not present.");
                            }
                            else
                            {
                                return ValidationContext.InvalidContext;
                        ...
                        {
                            result = result.WithResult(isValid: true, "Validation properties - the required property 'private_key' was present.");
                        }
