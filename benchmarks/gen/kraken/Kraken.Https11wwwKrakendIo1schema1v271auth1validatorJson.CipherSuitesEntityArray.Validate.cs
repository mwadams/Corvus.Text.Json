        ...
        public readonly partial struct CipherSuitesEntityArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1validator.json/properties/cipher_suites");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CipherSuitesEntityArray.CipherSuitesEntity> arrayEnumerator = value.EnumerateArray();
