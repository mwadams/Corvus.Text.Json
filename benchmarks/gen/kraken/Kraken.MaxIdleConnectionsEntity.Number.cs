...
public readonly partial struct Kraken
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct MaxIdleConnectionsEntity
#if NET8_0_OR_GREATER
        : IJsonNumber<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          IAdditionOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          ISubtractionOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          IMultiplyOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          IDivisionOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity, CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          IIncrementOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>,
          IDecrementOperators<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>
#else
        : IJsonNumber<CorvusJsonSchema.Kraken.MaxIdleConnectionsEntity>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "MaxIdleConnectionsEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public MaxIdleConnectionsEntity(long value)
        ...
        public static implicit operator MaxIdleConnectionsEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(MaxIdleConnectionsEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(MaxIdleConnectionsEntity value)
        {
            return
        ...
        public static explicit operator byte(MaxIdleConnectionsEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(byte value)
        {
        ...
        public static explicit operator decimal(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static implicit operator MaxIdleConnectionsEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(MaxIdleConnectionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxIdleConnectionsEntity"/>.</returns>
        public static explicit operator MaxIdleConnectionsEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(MaxIdleConnectionsEntity left, MaxIdleConnectionsEntity right)
        {
        ...
        public static MaxIdleConnectionsEntity operator +(MaxIdleConnectionsEntity left, MaxIdleConnectionsEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static MaxIdleConnectionsEntity operator ++(MaxIdleConnectionsEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in MaxIdleConnectionsEntity lhs, in MaxIdleConnectionsEntity rhs)
        {
