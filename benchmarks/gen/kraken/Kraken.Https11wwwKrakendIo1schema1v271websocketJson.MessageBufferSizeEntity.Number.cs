...
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271websocketJson.MessageBufferSizeEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "MessageBufferSizeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public MessageBufferSizeEntity(long value)
            ...
            public static implicit operator MessageBufferSizeEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(MessageBufferSizeEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(MessageBufferSizeEntity value)
            {
                return
            ...
            public static explicit operator byte(MessageBufferSizeEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(byte value)
            {
            ...
            public static explicit operator decimal(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static implicit operator MessageBufferSizeEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(MessageBufferSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MessageBufferSizeEntity"/>.</returns>
            public static explicit operator MessageBufferSizeEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(MessageBufferSizeEntity left, MessageBufferSizeEntity right)
            {
            ...
            public static MessageBufferSizeEntity operator +(MessageBufferSizeEntity left, MessageBufferSizeEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static MessageBufferSizeEntity operator ++(MessageBufferSizeEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in MessageBufferSizeEntity lhs, in MessageBufferSizeEntity rhs)
            {
