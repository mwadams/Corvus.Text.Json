...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1corsJson
    {
        ...
        public readonly partial struct AllowPrivateNetworkEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1corsJson.AllowPrivateNetworkEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowPrivateNetworkEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AllowPrivateNetworkEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(AllowPrivateNetworkEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(AllowPrivateNetworkEntity value)
            {
