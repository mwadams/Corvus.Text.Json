...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct EchoEndpointEntity
        : IJsonBoolean<CorvusJsonSchema.Kraken.EchoEndpointEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator EchoEndpointEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator EchoEndpointEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(EchoEndpointEntity value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(EchoEndpointEntity value)
        {
