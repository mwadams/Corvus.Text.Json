    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1ntlmJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1ntlm.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271auth1ntlmJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                bool hasSeenPassword = false;
                bool hasSeenUser = false;
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.PasswordUtf8, JsonPropertyNames.Password))
                    {
                        hasSeenPassword = true;
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.UserUtf8, JsonPropertyNames.User))
                    {
                        hasSeenUser = true;
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/user"), JsonPropertyNames.User);
                        }
                ...
                if (!hasSeenPassword)
                {
                    if (level >= ValidationLevel.Basic)
                    {
                        result = result.WithResult(isValid: false, "Validation properties - the required property 'password' was not present.");
                    }
                    else
                    {
                ...
                {
                    result = result.WithResult(isValid: true, "Validation properties - the required property 'password' was present.");
                }
                ...
                if (!hasSeenUser)
                {
                    if (level >= ValidationLevel.Basic)
                    {
                        result = result.WithResult(isValid: false, "Validation properties - the required property 'user' was not present.");
                    }
                    else
                    {
                        return ValidationContext.InvalidContext;
                ...
                {
                    result = result.WithResult(isValid: true, "Validation properties - the required property 'user' was present.");
                }
