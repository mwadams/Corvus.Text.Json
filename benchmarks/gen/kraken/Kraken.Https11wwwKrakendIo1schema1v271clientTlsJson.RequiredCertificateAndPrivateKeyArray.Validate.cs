        ...
        public readonly partial struct RequiredCertificateAndPrivateKeyArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1client_tls.json/properties/client_certs");
                }
            ...
            public static partial class CorvusValidation
            {
                ...
                internal static ValidationContext ArrayValidationHandler(
                    in RequiredCertificateAndPrivateKeyArray value,
                    JsonValueKind valueKind,
                    in ValidationContext validationContext,
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271clientTlsJson.RequiredCertificateAndPrivateKeyArray.RequiredCertificateAndPrivateKey> arrayEnumerator = value.EnumerateArray();
