    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opencensusJson
    {
        ...
        public readonly partial struct EnabledLayersEntity
        {
            ...
            public readonly partial struct BackendEntity
                : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.EnabledLayersEntity.BackendEntity>
            {
                /// <summary>
                /// Conversion from <see cref="bool"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator BackendEntity(bool value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator BackendEntity(JsonBoolean value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonBoolean(BackendEntity value)
                {
                    return
                        value.AsBoolean;
                }
                ...
                public static implicit operator bool(BackendEntity value)
                {
