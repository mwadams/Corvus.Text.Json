...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1moesifJson
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct TimerWakeUpSecondsEntity
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.TimerWakeUpSecondsEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "TimerWakeUpSecondsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public TimerWakeUpSecondsEntity(long value)
            ...
            public static implicit operator TimerWakeUpSecondsEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(TimerWakeUpSecondsEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(TimerWakeUpSecondsEntity value)
            {
                return
            ...
            public static explicit operator byte(TimerWakeUpSecondsEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(byte value)
            {
            ...
            public static explicit operator decimal(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static implicit operator TimerWakeUpSecondsEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(TimerWakeUpSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="TimerWakeUpSecondsEntity"/>.</returns>
            public static explicit operator TimerWakeUpSecondsEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(TimerWakeUpSecondsEntity left, TimerWakeUpSecondsEntity right)
            {
            ...
            public static TimerWakeUpSecondsEntity operator +(TimerWakeUpSecondsEntity left, TimerWakeUpSecondsEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static TimerWakeUpSecondsEntity operator ++(TimerWakeUpSecondsEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in TimerWakeUpSecondsEntity lhs, in TimerWakeUpSecondsEntity rhs)
            {
