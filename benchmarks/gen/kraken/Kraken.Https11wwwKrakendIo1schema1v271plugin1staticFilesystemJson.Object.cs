...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson
        : IJsonObject<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson>
    {
        /// <summary>
        ...
        public static implicit operator Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson value)
        {
            return
                value.AsObject;
        }
        ...
        /// </para>
        /// </remarks>
        public CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson.SkipArray Skip
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson.SkipArray>();
                    }
                }
        ...
        /// <inheritdoc/>
        public static Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// </summary>
        public static Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson Create(
            in Corvus.Json.JsonString path,
            in Corvus.Json.JsonString prefix,
            in CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson.SkipArray? skip = null)
        {
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson WithPath(in Corvus.Json.JsonString value)
        {
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson WithPrefix(in Corvus.Json.JsonString value)
        {
        ...
        /// </para>
        /// </remarks>
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson WithSkip(in CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson.SkipArray value)
        {
        ...
        /// <inheritdoc />
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in Https11wwwKrakendIo1schema1v271plugin1staticFilesystemJson that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
