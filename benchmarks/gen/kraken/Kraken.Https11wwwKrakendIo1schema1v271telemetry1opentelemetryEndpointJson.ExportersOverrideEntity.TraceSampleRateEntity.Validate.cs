            ...
            public readonly partial struct TraceSampleRateEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-endpoint.json/properties/exporters_override/properties/trace_sample_rate");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    /// </summary>
                    public static readonly BinaryJsonNumber Maximum = new(1);
                    ...
                    internal static ValidationContext NumberValidationHandler(
                        in TraceSampleRateEntity value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level = ValidationLevel.Flag)
                    {
