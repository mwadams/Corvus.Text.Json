...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct CacheDurationEntity
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.CacheDurationEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "CacheDurationEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public CacheDurationEntity(long value)
            ...
            public static implicit operator CacheDurationEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(CacheDurationEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(CacheDurationEntity value)
            {
                return
            ...
            public static explicit operator byte(CacheDurationEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(byte value)
            {
            ...
            public static explicit operator decimal(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static implicit operator CacheDurationEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(CacheDurationEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="CacheDurationEntity"/>.</returns>
            public static explicit operator CacheDurationEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(CacheDurationEntity left, CacheDurationEntity right)
            {
            ...
            public static CacheDurationEntity operator +(CacheDurationEntity left, CacheDurationEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static CacheDurationEntity operator ++(CacheDurationEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in CacheDurationEntity lhs, in CacheDurationEntity rhs)
            {
