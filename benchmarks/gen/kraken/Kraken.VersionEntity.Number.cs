...
#if NET8_0_OR_GREATER
        : IJsonNumber<CorvusJsonSchema.Kraken.VersionEntity>,
          IAdditionOperators<CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity>,
          ISubtractionOperators<CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity>,
          IMultiplyOperators<CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity>,
          IDivisionOperators<CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity, CorvusJsonSchema.Kraken.VersionEntity>,
          IIncrementOperators<CorvusJsonSchema.Kraken.VersionEntity>,
          IDecrementOperators<CorvusJsonSchema.Kraken.VersionEntity>
#else
        : IJsonNumber<CorvusJsonSchema.Kraken.VersionEntity>
#endif
    {
        ...
        public VersionEntity(double value)
        ...
        public static implicit operator VersionEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(VersionEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        public static explicit operator byte(VersionEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(byte value)
        {
        ...
        public static explicit operator decimal(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator double(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static implicit operator VersionEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator long(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(VersionEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="VersionEntity"/>.</returns>
        public static explicit operator VersionEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static VersionEntity operator +(VersionEntity left, VersionEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static VersionEntity operator ++(VersionEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in VersionEntity lhs, in VersionEntity rhs)
        {
