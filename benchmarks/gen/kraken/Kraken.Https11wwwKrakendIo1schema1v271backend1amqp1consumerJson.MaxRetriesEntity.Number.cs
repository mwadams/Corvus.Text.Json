...
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1amqp1consumerJson.MaxRetriesEntity>
#endif
        {
