        ...
        public readonly partial struct BackendEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-backend.json/properties/backend");
                }
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        ...
                        if (property.NameEquals(JsonPropertyNames.MetricsUtf8, JsonPropertyNames.Metrics))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.BackendEntity.MetricsEntity>().Validate(result.CreateChildContext(), level);
                        ...
                        else if (property.NameEquals(JsonPropertyNames.TracesUtf8, JsonPropertyNames.Traces))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryBackendJson.BackendEntity.TracesEntity>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }
