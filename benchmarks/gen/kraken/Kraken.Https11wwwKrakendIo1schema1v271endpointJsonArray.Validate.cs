    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271endpointJsonArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/properties/endpoints");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ArrayValidationHandler(
                in Https11wwwKrakendIo1schema1v271endpointJsonArray value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level)
            {
                ...
                int length = 0;
                using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271endpointJson> arrayEnumerator = value.EnumerateArray();
