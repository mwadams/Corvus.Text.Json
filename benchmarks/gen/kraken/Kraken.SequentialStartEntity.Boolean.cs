...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct SequentialStartEntity
        : IJsonBoolean<CorvusJsonSchema.Kraken.SequentialStartEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SequentialStartEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SequentialStartEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(SequentialStartEntity value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(SequentialStartEntity value)
        {
