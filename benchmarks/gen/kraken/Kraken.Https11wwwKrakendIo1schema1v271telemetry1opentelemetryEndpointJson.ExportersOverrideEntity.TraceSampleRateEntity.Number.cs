...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson
    {
        ...
        public readonly partial struct ExportersOverrideEntity
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct TraceSampleRateEntity
#if NET8_0_OR_GREATER
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>,
                  IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>
#else
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryEndpointJson.ExportersOverrideEntity.TraceSampleRateEntity>
#endif
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "TraceSampleRateEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                public TraceSampleRateEntity(double value)
                ...
                public static implicit operator TraceSampleRateEntity(JsonNumber value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonNumber(TraceSampleRateEntity value)
                {
                    return
                        value.AsNumber;
                }
                ...
                public static explicit operator byte(TraceSampleRateEntity value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(byte value)
                {
                ...
                public static explicit operator decimal(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(decimal value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static implicit operator double(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static implicit operator TraceSampleRateEntity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator short(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator int(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator long(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Int128(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(Int128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator sbyte(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Half(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(Half value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator float(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ushort(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator uint(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ulong(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator UInt128(TraceSampleRateEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TraceSampleRateEntity"/>.</returns>
                public static explicit operator TraceSampleRateEntity(UInt128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                /// </returns>
                public static bool operator <(TraceSampleRateEntity left, TraceSampleRateEntity right)
                {
                ...
                public static TraceSampleRateEntity operator +(TraceSampleRateEntity left, TraceSampleRateEntity right)
                {
                ...
                /// <returns>The result of the operation.</returns>
                public static TraceSampleRateEntity operator ++(TraceSampleRateEntity value)
                {
                ...
                /// </returns>
                public static int Compare(in TraceSampleRateEntity lhs, in TraceSampleRateEntity rhs)
                {
