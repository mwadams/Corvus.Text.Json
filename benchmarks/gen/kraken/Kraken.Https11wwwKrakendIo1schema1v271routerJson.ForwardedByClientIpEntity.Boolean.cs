...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271routerJson
    {
        ...
        public readonly partial struct ForwardedByClientIpEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271routerJson.ForwardedByClientIpEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ForwardedByClientIpEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ForwardedByClientIpEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(ForwardedByClientIpEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(ForwardedByClientIpEntity value)
            {
