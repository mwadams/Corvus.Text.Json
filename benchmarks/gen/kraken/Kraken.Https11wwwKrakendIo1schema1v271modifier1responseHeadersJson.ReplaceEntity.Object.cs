...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson
    {
        ...
        public readonly partial struct ReplaceEntity
            : IJsonObject<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity>
        {
            /// <summary>
            /// The pattern matching '(.+)'
            /// for the pattern property producing the type
            /// <see cref="CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity.JsonStringArray"/>.
            /// </summary>
            ...
            public static implicit operator ReplaceEntity(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(ReplaceEntity value)
            {
                return
            ...
            /// <inheritdoc />
            public ReplaceEntity RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            /// </summary>
            public static bool TryAsPatternJsonStringArray(in JsonObjectProperty property, out CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity.JsonStringArray result)
            {
                if (property.Name.IsMatch(CorvusValidation.PatternProperties))
                {
                    result = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity.JsonStringArray>();
                    return result.IsValid();
                }

                result = CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.ReplaceEntity.JsonStringArray.Undefined;
                return false;
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in ReplaceEntity that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ReplaceEntity that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ReplaceEntity that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ReplaceEntity that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in ReplaceEntity that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in ReplaceEntity that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
