...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271tlsJson
    {
        ...
        public readonly partial struct EnableMtlsEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271tlsJson.EnableMtlsEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EnableMtlsEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator EnableMtlsEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(EnableMtlsEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(EnableMtlsEntity value)
            {
