...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct DebugEndpointEntity
        : IJsonBoolean<CorvusJsonSchema.Kraken.DebugEndpointEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DebugEndpointEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DebugEndpointEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(DebugEndpointEntity value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(DebugEndpointEntity value)
        {
