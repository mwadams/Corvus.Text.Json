...
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.BatchSizeEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "BatchSizeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public BatchSizeEntity(long value)
            ...
            public static implicit operator BatchSizeEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(BatchSizeEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(BatchSizeEntity value)
            {
                return
            ...
            public static explicit operator byte(BatchSizeEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(byte value)
            {
            ...
            public static explicit operator decimal(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static implicit operator BatchSizeEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(BatchSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="BatchSizeEntity"/>.</returns>
            public static explicit operator BatchSizeEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(BatchSizeEntity left, BatchSizeEntity right)
            {
            ...
            public static BatchSizeEntity operator +(BatchSizeEntity left, BatchSizeEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static BatchSizeEntity operator ++(BatchSizeEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in BatchSizeEntity lhs, in BatchSizeEntity rhs)
            {
