    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1staticFilesystemJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1static-filesystem.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271backend1staticFilesystemJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.DirectoryListingUtf8, JsonPropertyNames.DirectoryListing))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1staticFilesystemJson.DirectoryListingEntity>().Validate(result.CreateChildContext(), level);
