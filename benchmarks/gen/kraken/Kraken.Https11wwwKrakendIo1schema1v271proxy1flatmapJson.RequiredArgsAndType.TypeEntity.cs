    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271proxy1flatmapJson
    {
        ...
        public readonly partial struct RequiredArgsAndType
        {
...

            {
                ...
                /// </summary>
                public static string SchemaLocation { get; } = "kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1proxy~1flatmap.json/items/properties/type";
                ...
                /// <param name="matchMove">Match 1st item.</param>
                /// <param name="matchDel">Match 2nd item.</param>
                /// <param name="matchAppend">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TOut Match<TIn, TOut>(
                    in TIn context,
                    Func<TIn, TOut> matchMove,
                    Func<TIn, TOut> matchDel,
                    Func<TIn, TOut> matchAppend,
                    Func<TIn, TOut> defaultMatch)
                {
                    if (this.Equals(CorvusValidation.Enum1))
                    {
                        return matchMove(context);
                    }

                    if (this.Equals(CorvusValidation.Enum2))
                    {
                        return matchDel(context);
                    }

                    if (this.Equals(CorvusValidation.Enum3))
                    {
                        return matchAppend(context);
                    }
