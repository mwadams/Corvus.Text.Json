        ...
        public readonly partial struct TiersEntityArray
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1tiered.json/properties/tiers");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level)
                {
                    ...
                    int length = 0;
                    using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271qos1ratelimit1tieredJson.TiersEntityArray.TiersEntity> arrayEnumerator = value.EnumerateArray();
