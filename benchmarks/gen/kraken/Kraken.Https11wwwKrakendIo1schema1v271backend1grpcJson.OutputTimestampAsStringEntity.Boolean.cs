...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct OutputTimestampAsStringEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1grpcJson.OutputTimestampAsStringEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator OutputTimestampAsStringEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator OutputTimestampAsStringEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(OutputTimestampAsStringEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(OutputTimestampAsStringEntity value)
            {
