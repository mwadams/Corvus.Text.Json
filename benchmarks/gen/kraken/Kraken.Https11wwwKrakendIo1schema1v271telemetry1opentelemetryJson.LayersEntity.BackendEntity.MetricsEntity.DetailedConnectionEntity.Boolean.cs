            ...
            public readonly partial struct BackendEntity
            {
                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct DetailedConnectionEntity
                        : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.BackendEntity.MetricsEntity.DetailedConnectionEntity>
                    {
                        /// <summary>
                        /// Conversion from <see cref="bool"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DetailedConnectionEntity(bool value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator DetailedConnectionEntity(JsonBoolean value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonBoolean(DetailedConnectionEntity value)
                        {
                            return
                                value.AsBoolean;
                        }
                        ...
                        public static implicit operator bool(DetailedConnectionEntity value)
                        {
