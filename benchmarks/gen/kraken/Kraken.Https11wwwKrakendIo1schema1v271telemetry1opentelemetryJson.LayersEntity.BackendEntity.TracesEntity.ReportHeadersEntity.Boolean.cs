            ...
            public readonly partial struct BackendEntity
            {
                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct ReportHeadersEntity
                        : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.BackendEntity.TracesEntity.ReportHeadersEntity>
                    {
                        /// <summary>
                        /// Conversion from <see cref="bool"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ReportHeadersEntity(bool value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ReportHeadersEntity(JsonBoolean value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonBoolean(ReportHeadersEntity value)
                        {
                            return
                                value.AsBoolean;
                        }
                        ...
                        public static implicit operator bool(ReportHeadersEntity value)
                        {
