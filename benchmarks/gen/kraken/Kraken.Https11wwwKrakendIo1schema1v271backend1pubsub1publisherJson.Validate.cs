    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1publisher.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271backend1pubsub1publisherJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    if (property.NameEquals(JsonPropertyNames.TopicUrlUtf8, JsonPropertyNames.TopicUrl))
                    {
                        hasSeenTopicUrl = true;
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/topic_url"), JsonPropertyNames.TopicUrl);
                        }
                ...
                if (!hasSeenTopicUrl)
                {
                    if (level >= ValidationLevel.Basic)
                    {
                        result = result.WithResult(isValid: false, "Validation properties - the required property 'topic_url' was not present.");
                    }
                    else
                    {
                ...
                {
                    result = result.WithResult(isValid: true, "Validation properties - the required property 'topic_url' was present.");
                }
