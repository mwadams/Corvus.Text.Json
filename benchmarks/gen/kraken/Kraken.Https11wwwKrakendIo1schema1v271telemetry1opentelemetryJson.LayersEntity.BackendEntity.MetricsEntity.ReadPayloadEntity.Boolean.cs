            ...
            public readonly partial struct BackendEntity
            {
                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct ReadPayloadEntity
                        : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.BackendEntity.MetricsEntity.ReadPayloadEntity>
                    {
                        /// <summary>
                        /// Conversion from <see cref="bool"/>.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ReadPayloadEntity(bool value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ReadPayloadEntity(JsonBoolean value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonBoolean(ReadPayloadEntity value)
                        {
                            return
                                value.AsBoolean;
                        }
                        ...
                        public static implicit operator bool(ReadPayloadEntity value)
                        {
