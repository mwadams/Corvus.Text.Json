                ...
                public readonly partial struct MetricsStaticAttributesEntityArray
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/layers/properties/proxy/properties/metrics_static_attributes");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                        ...
                        internal static ValidationContext ArrayValidationHandler(
                            in MetricsStaticAttributesEntityArray value,
                            JsonValueKind valueKind,
                            in ValidationContext validationContext,
                            ValidationLevel level)
                        {
                            ...
                            int length = 0;
                            using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.ProxyEntity.MetricsStaticAttributesEntityArray.MetricsStaticAttributesEntity> arrayEnumerator = value.EnumerateArray();
