                    ...
                    public readonly partial struct RequiredKeyAndValueArray
                    {
                        ...
                        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            if (level > ValidationLevel.Basic)
                            {
                                ...
                                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/layers/properties/backend/properties/traces/properties/static_attributes");
                            }
                        ...
                        public static partial class CorvusValidation
                        {
                                ...
                                ValidationLevel level)
                            {
                                ...
                                int length = 0;
                                using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.LayersEntity.BackendEntity.TracesEntity.RequiredKeyAndValueArray.RequiredKeyAndValue> arrayEnumerator = value.EnumerateArray();
