...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendJson
    {
        ...
        public readonly partial struct IsCollectionEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backendJson.IsCollectionEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator IsCollectionEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator IsCollectionEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(IsCollectionEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(IsCollectionEntity value)
            {
