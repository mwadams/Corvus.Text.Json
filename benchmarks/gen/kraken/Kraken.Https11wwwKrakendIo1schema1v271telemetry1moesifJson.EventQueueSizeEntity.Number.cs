...
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1moesifJson.EventQueueSizeEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "EventQueueSizeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public EventQueueSizeEntity(long value)
            ...
            public static implicit operator EventQueueSizeEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(EventQueueSizeEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(EventQueueSizeEntity value)
            {
                return
            ...
            public static explicit operator byte(EventQueueSizeEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(byte value)
            {
            ...
            public static explicit operator decimal(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static implicit operator EventQueueSizeEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(EventQueueSizeEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="EventQueueSizeEntity"/>.</returns>
            public static explicit operator EventQueueSizeEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(EventQueueSizeEntity left, EventQueueSizeEntity right)
            {
            ...
            public static EventQueueSizeEntity operator +(EventQueueSizeEntity left, EventQueueSizeEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static EventQueueSizeEntity operator ++(EventQueueSizeEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in EventQueueSizeEntity lhs, in EventQueueSizeEntity rhs)
            {
