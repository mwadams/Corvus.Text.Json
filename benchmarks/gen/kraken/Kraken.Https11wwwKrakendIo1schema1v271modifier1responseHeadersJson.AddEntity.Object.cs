...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson
    {
        ...
        public readonly partial struct AddEntity
            : IJsonObject<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity>
        {
            /// <summary>
            /// The pattern matching '(.+)'
            /// for the pattern property producing the type
            /// <see cref="CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity.JsonStringArray"/>.
            /// </summary>
            public static Regex PatternPropertyJsonStringArray => CorvusValidation.PatternProperties;

            /// <summary>
            /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AddEntity(ImmutableList<JsonObjectProperty> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonObjectProperty>(AddEntity value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AddEntity(JsonObject value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonObject(AddEntity value)
            {
                return
                    value.AsObject;
            }
            ...
            /// <inheritdoc/>
            public static AddEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
            {
                return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
            }

            /// <inheritdoc/>
            public static AddEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
            {
            ...
            public static AddEntity FromProperties(ImmutableList<JsonObjectProperty> source)
            {
                return new(source);
            }
            ...
            /// <inheritdoc />
            public AddEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
            ...
            /// <inheritdoc />
            public AddEntity RemoveProperty(in JsonPropertyName name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AddEntity RemoveProperty(string name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AddEntity RemoveProperty(ReadOnlySpan<char> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }

            /// <inheritdoc />
            public AddEntity RemoveProperty(ReadOnlySpan<byte> name)
            {
                return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
            }
            ...
            /// <see cref="CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity.JsonStringArray"/>.
            /// </summary>
            public static bool MatchesPatternJsonStringArray(in JsonObjectProperty property) => property.Name.IsMatch(CorvusValidation.PatternProperties);
            ...
            /// </summary>
            public static bool TryAsPatternJsonStringArray(in JsonObjectProperty property, out CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity.JsonStringArray result)
            {
                if (property.Name.IsMatch(CorvusValidation.PatternProperties))
                {
                    result = property.Value.As<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity.JsonStringArray>();
                    return result.IsValid();
                }

                result = CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271modifier1responseHeadersJson.AddEntity.JsonStringArray.Undefined;
                return false;
            }
            ...
            private static class __CorvusObjectHelpers
            {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in AddEntity that)
                {
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AddEntity that, in JsonPropertyName name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AddEntity that, ReadOnlySpan<char> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AddEntity that, ReadOnlySpan<byte> name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in AddEntity that, string name)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
                        return that.objectBacking.Remove(name);
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in AddEntity that, in JsonPropertyName name, in JsonAny value)
                {
                    if ((that.backing & Backing.Object) != 0)
                    {
