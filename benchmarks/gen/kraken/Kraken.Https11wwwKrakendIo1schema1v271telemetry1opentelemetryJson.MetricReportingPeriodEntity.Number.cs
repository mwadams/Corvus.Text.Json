...
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.MetricReportingPeriodEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "MetricReportingPeriodEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public MetricReportingPeriodEntity(long value)
            ...
            public static implicit operator MetricReportingPeriodEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(MetricReportingPeriodEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(MetricReportingPeriodEntity value)
            {
                return
            ...
            public static explicit operator byte(MetricReportingPeriodEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(byte value)
            {
            ...
            public static explicit operator decimal(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static implicit operator MetricReportingPeriodEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(MetricReportingPeriodEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="MetricReportingPeriodEntity"/>.</returns>
            public static explicit operator MetricReportingPeriodEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(MetricReportingPeriodEntity left, MetricReportingPeriodEntity right)
            {
            ...
            public static MetricReportingPeriodEntity operator +(MetricReportingPeriodEntity left, MetricReportingPeriodEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static MetricReportingPeriodEntity operator ++(MetricReportingPeriodEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in MetricReportingPeriodEntity lhs, in MetricReportingPeriodEntity rhs)
            {
