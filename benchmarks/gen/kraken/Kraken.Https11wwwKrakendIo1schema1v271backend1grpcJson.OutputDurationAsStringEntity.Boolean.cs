...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1grpcJson
    {
        ...
        public readonly partial struct OutputDurationAsStringEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271backend1grpcJson.OutputDurationAsStringEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator OutputDurationAsStringEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator OutputDurationAsStringEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(OutputDurationAsStringEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(OutputDurationAsStringEntity value)
            {
