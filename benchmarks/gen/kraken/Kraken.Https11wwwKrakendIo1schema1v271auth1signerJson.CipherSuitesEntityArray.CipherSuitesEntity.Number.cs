...
#if NET8_0_OR_GREATER
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>,
                  IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>
#else
                : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1signerJson.CipherSuitesEntityArray.CipherSuitesEntity>
#endif
            {
                ...
                public CipherSuitesEntity(double value)
                ...
                public static implicit operator CipherSuitesEntity(JsonNumber value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonNumber(CipherSuitesEntity value)
                {
                    return
                        value.AsNumber;
                }
                ...
                public static explicit operator byte(CipherSuitesEntity value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(byte value)
                {
                ...
                public static explicit operator decimal(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(decimal value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static implicit operator double(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static implicit operator CipherSuitesEntity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator short(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator int(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator long(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Int128(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(Int128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator sbyte(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Half(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(Half value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator float(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ushort(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator uint(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ulong(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator UInt128(CipherSuitesEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="CipherSuitesEntity"/>.</returns>
                public static explicit operator CipherSuitesEntity(UInt128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                /// </returns>
                public static bool operator <(CipherSuitesEntity left, CipherSuitesEntity right)
                {
                ...
                public static CipherSuitesEntity operator +(CipherSuitesEntity left, CipherSuitesEntity right)
                {
                ...
                /// <returns>The result of the operation.</returns>
                public static CipherSuitesEntity operator ++(CipherSuitesEntity value)
                {
                ...
                /// </returns>
                public static int Compare(in CipherSuitesEntity lhs, in CipherSuitesEntity rhs)
                {
