    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
        ...
        public readonly partial struct ResponseDefinitionEntity
        {
            ...
            public readonly partial struct RequiredContentType
            {
                ...
                /// </para>
                /// </remarks>
                [System.Text.Json.Serialization.JsonConverter(typeof(Corvus.Json.Internal.JsonValueConverter<ExampleArray>))]
...

                {
                    ...
                    public ExampleArray(in JsonElement value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public ExampleArray(ImmutableList<JsonAny> value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public ExampleArray(bool value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public ExampleArray(BinaryJsonNumber value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public ExampleArray(ImmutableList<JsonObjectProperty> value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public ExampleArray(string value)
                    {
                    ...
                    /// </summary>
                    public static string SchemaLocation { get; } = "kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/response_definition/patternProperties/default|^[0-9]+$/properties/example";

                    /// <summary>
                    /// Gets a Null instance.
                    /// </summary>
                    public static ExampleArray Null { get; } = new(JsonValueHelpers.NullElement);

                    /// <summary>
                    /// Gets an Undefined instance.
                    /// </summary>
                    public static ExampleArray Undefined { get; }

                    /// <summary>
                    /// Gets the default instance.
                    /// </summary>
                    public static ExampleArray DefaultInstance { get; }
                    ...
                    public static implicit operator ExampleArray(JsonAny value)
                    {
                        return value.As<ExampleArray>();
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonAny(ExampleArray value)
                    {
                        return value.AsAny;
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in ExampleArray left, in ExampleArray right)
                    {
                    ...
                    public static ExampleArray FromJson(in JsonElement value)
                    {
                        return new(value);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromAny(in JsonAny value)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromBoolean<TValue>(in TValue value)
                    ...
                    /// <returns>An instance of this type, initialized from the provided value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromString<TValue>(in TValue value)
                    ...
                    /// <returns>An instance of this type, initialized from the provided value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromNumber<TValue>(in TValue value)
                    ...
                    /// <returns>An instance of this type, initialized from the provided value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromObject<TValue>(in TValue value)
                    ...
                    /// <returns>An instance of this type, initialized from the provided value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ExampleArray FromArray<TValue>(in TValue value)
                    ...
                    /// <summary>
                    /// Parses the ExampleArray.
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static ExampleArray Parse(string source, JsonDocumentOptions options = default)
                    {
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static ExampleArray Parse(Stream source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static ExampleArray Parse(ReadOnlyMemory<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static ExampleArray Parse(ReadOnlyMemory<char> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// <param name="source">The source of the JSON string to parse.</param>
                    /// <param name="options">The (optional) JsonDocumentOptions.</param>
                    public static ExampleArray Parse(ReadOnlySequence<byte> source, JsonDocumentOptions options = default)
                    {
                        using var jsonDocument = JsonDocument.Parse(source, options);
                        return new(jsonDocument.RootElement.Clone());
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static ExampleArray ParseValue(string source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<ExampleArray>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<ExampleArray>(source.AsSpan());
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static ExampleArray ParseValue(ReadOnlySpan<char> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<ExampleArray>.ParseValue(source);
#else
                        return JsonValueHelpers.ParseValue<ExampleArray>(source);
#endif
                    }
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static ExampleArray ParseValue(ReadOnlySpan<byte> source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<ExampleArray>.ParseValue(source);
#else
                    ...
                    /// </summary>
                    /// <param name="source">The source of the JSON string to parse.</param>
                    public static ExampleArray ParseValue(ref Utf8JsonReader source)
                    {
#if NET8_0_OR_GREATER
                        return IJsonValue<ExampleArray>.ParseValue(ref source);
#else
                        return JsonValueHelpers.ParseValue<ExampleArray>(ref source);
#endif
                    }
...
#else
                        return this.As<ExampleArray, TTarget>();
#endif
                    }
                    ...
                    {
                        return
                            (obj is IJsonValue jv && this.Equals(jv.As<ExampleArray>())) ||
                    ...
                    {
                        return this.Equals(other.As<ExampleArray>());
                    }
                    ...
                    public bool Equals(in ExampleArray other)
                    {
