...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271auth1validatorJson
    {
        ...
        /// </remarks>
#if NET8_0_OR_GREATER
        [CollectionBuilder(typeof(JwkFingerprintsJsonStringArray), "Create")]
#endif
        public readonly partial struct JwkFingerprintsJsonStringArray
            : IJsonArray<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271auth1validatorJson.JwkFingerprintsJsonStringArray>,
              IReadOnlyCollection<Corvus.Json.JsonString>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static JwkFingerprintsJsonStringArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
            ...
            /// <inheritdoc/>
            Corvus.Json.JsonAny IJsonArray<JwkFingerprintsJsonStringArray>.this[int index]
            {
                get
                {
            ...
            public static implicit operator JwkFingerprintsJsonStringArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ImmutableList<JsonAny>(JwkFingerprintsJsonStringArray value)
            {
                return
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JwkFingerprintsJsonStringArray(JsonArray value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonArray(JwkFingerprintsJsonStringArray value)
            {
                return
                    value.AsArray;
            }
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JwkFingerprintsJsonStringArray"/> struct.
            /// </summary>
            ...
            public static JwkFingerprintsJsonStringArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }

            /// <summary>
            /// Create an new instance of the <see cref="JwkFingerprintsJsonStringArray"/>" struct from a span of items.
            /// </summary>
            ...
            public static JwkFingerprintsJsonStringArray Create(ReadOnlySpan<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            public static JwkFingerprintsJsonStringArray FromItems(params Corvus.Json.JsonString[] items)
            {
                return new([..items]);
            }
            ...
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6)
            {
            ...
            /// <returns>An instance of the array constructed from the values.</returns>
            public static JwkFingerprintsJsonStringArray FromItems(in Corvus.Json.JsonString item1, in Corvus.Json.JsonString item2, in Corvus.Json.JsonString item3, in Corvus.Json.JsonString item4, in Corvus.Json.JsonString item5, in Corvus.Json.JsonString item6, in Corvus.Json.JsonString item7)
            {
            ...
            public static JwkFingerprintsJsonStringArray FromRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items .</returns>
            static JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.FromRange(IEnumerable<JsonAny> items)
            {
                return new([..items]);
            }
            ...
            /// <param name="items">The items from which to construct the instance.</param>
            /// <returns>An instance of the array constructed from the items.</returns>
            static JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.FromRange<T>(IEnumerable<T> items)
            {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<JwkFingerprintsJsonStringArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<JwkFingerprintsJsonStringArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new(this.jsonElementBacking);
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.Add(in JsonAny item1)
            {
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.Add(params JsonAny[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.AddRange<TArray>(in TArray items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.AddRange<TItem>(IEnumerable<TItem> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.AddRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.Insert(int index, in JsonAny item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.InsertRange<TArray>(int index, in TArray items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.InsertRange(int index, IEnumerable<JsonAny> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.SetItem(int index, in JsonAny value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray Add(in Corvus.Json.JsonString item1)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray Add(params Corvus.Json.JsonString[] items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            ...
            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray AddRange(IEnumerable<Corvus.Json.JsonString> items)
            {
                ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                foreach (Corvus.Json.JsonString item in items)
                {
            ...
            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray Insert(int index, in Corvus.Json.JsonString item1)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
            }

            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray InsertRange(int index, IEnumerable<Corvus.Json.JsonString> items)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
            }

            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray Replace(in Corvus.Json.JsonString oldValue, in Corvus.Json.JsonString newValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
            }

            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray SetItem(int index, in Corvus.Json.JsonString value)
            {
                return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.Remove(in JsonAny oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.RemoveAt(int index)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
            }

            /// <inheritdoc/>
            JwkFingerprintsJsonStringArray IJsonArray<JwkFingerprintsJsonStringArray>.RemoveRange(int index, int count)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
            }

            /// <inheritdoc/>
            public JwkFingerprintsJsonStringArray Remove(in Corvus.Json.JsonString oldValue)
            {
                return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
            }
            ...
            private static class __CorvusArrayHelpers
            {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableList(in JwkFingerprintsJsonStringArray arrayInstance)
                {
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in JwkFingerprintsJsonStringArray arrayInstance)
                {
                ...
                public static ImmutableList<JsonAny> GetImmutableListSetting(in JwkFingerprintsJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListReplacing(in JwkFingerprintsJsonStringArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithout(in JwkFingerprintsJsonStringArray arrayInstance, in JsonAny item)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in JwkFingerprintsJsonStringArray arrayInstance, int index, int count)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith(in JwkFingerprintsJsonStringArray arrayInstance, int index, in JsonAny value)
                {
                    if ((arrayInstance.backing & Backing.JsonElement) != 0)
                    {
                        if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                ...
                /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in JwkFingerprintsJsonStringArray arrayInstance, int index, TEnumerable values)
