    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271telemetry1gelfJson
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1gelf.json");
            }
        ...
        public static partial class CorvusValidation
        {
            ...
            internal static ValidationContext ObjectValidationHandler(
                in Https11wwwKrakendIo1schema1v271telemetry1gelfJson value,
                JsonValueKind valueKind,
                in ValidationContext validationContext,
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    ...
                    else if (property.NameEquals(JsonPropertyNames.EnableTcpUtf8, JsonPropertyNames.EnableTcp))
                    {
                        hasSeenEnableTcp = true;
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/enable_tcp"), JsonPropertyNames.EnableTcp);
                        }
                ...
                if (!hasSeenEnableTcp)
                {
                    if (level >= ValidationLevel.Basic)
                    {
                        result = result.WithResult(isValid: false, "Validation properties - the required property 'enable_tcp' was not present.");
                    }
                    else
                    {
                        return ValidationContext.InvalidContext;
                ...
                {
                    result = result.WithResult(isValid: true, "Validation properties - the required property 'enable_tcp' was present.");
                }
