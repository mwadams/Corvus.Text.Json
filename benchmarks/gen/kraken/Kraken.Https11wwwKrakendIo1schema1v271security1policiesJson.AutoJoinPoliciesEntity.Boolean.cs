...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
        ...
        public readonly partial struct AutoJoinPoliciesEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1policiesJson.AutoJoinPoliciesEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AutoJoinPoliciesEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AutoJoinPoliciesEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(AutoJoinPoliciesEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(AutoJoinPoliciesEntity value)
            {
