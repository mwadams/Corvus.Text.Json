        ...
        public readonly partial struct ExportersEntity
        {
            ...
            public readonly partial struct RequiredPort
            {
                ...
                public readonly partial struct TagStatuscodeEntity
                    : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opencensusJson.ExportersEntity.RequiredPort.TagStatuscodeEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator TagStatuscodeEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator TagStatuscodeEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(TagStatuscodeEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(TagStatuscodeEntity value)
                    {
