...
#if NET8_0_OR_GREATER
                        : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity>,
                          IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity>,
                          ...
                          IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity>,
                          IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity>
#else
                        : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.ExportersEntity.RequiredHostAndNameArray.RequiredHostAndName.PortEntity>
#endif
                    {
                        ...
                        public static implicit operator PortEntity(JsonNumber value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonNumber(PortEntity value)
                        {
                            return
                                value.AsNumber;
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonInteger(PortEntity value)
                        {
                            return
                        ...
                        public static explicit operator byte(PortEntity value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(byte value)
                        {
                        ...
                        public static explicit operator decimal(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(decimal value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator double(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(double value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator short(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(short value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator int(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(int value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static implicit operator long(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static implicit operator PortEntity(long value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator Int128(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(Int128 value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
#endif
                        ...
                        public static explicit operator sbyte(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(sbyte value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator Half(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(Half value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
#endif
                        ...
                        public static explicit operator float(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(float value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator ushort(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(ushort value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator uint(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(uint value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator ulong(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(ulong value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
                        ...
                        public static explicit operator UInt128(PortEntity value)
                        {
                            if ((value.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <param name="value">The value from which to convert.</param>
                        /// <returns>An instance of the <see cref="PortEntity"/>.</returns>
                        public static explicit operator PortEntity(UInt128 value)
                        {
                            return new(new BinaryJsonNumber(value));
                        }
#endif
                        ...
                        /// </returns>
                        public static bool operator <(PortEntity left, PortEntity right)
                        {
                        ...
                        public static PortEntity operator +(PortEntity left, PortEntity right)
                        {
                        ...
                        /// <returns>The result of the operation.</returns>
                        public static PortEntity operator ++(PortEntity value)
                        {
                        ...
                        /// </returns>
                        public static int Compare(in PortEntity lhs, in PortEntity rhs)
                        {
