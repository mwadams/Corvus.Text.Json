...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson
    {
        ...
        public readonly partial struct LogStatusChangeEntity
            : IJsonBoolean<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271qos1circuitBreakerJson.LogStatusChangeEntity>
        {
            /// <summary>
            /// Conversion from <see cref="bool"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LogStatusChangeEntity(bool value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator LogStatusChangeEntity(JsonBoolean value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonBoolean(LogStatusChangeEntity value)
            {
                return
                    value.AsBoolean;
            }
            ...
            public static implicit operator bool(LogStatusChangeEntity value)
            {
