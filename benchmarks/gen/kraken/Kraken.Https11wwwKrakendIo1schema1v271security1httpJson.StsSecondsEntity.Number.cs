...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1httpJson
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct StsSecondsEntity
#if NET8_0_OR_GREATER
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              IAdditionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              ISubtractionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              IMultiplyOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              IDivisionOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity, CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              IIncrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>,
              IDecrementOperators<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>
#else
            : IJsonNumber<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271security1httpJson.StsSecondsEntity>
#endif
        {
            /// <summary>
            /// Initializes a new instance of the <see cref = "StsSecondsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            public StsSecondsEntity(long value)
            ...
            public static implicit operator StsSecondsEntity(JsonNumber value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonNumber(StsSecondsEntity value)
            {
                return
                    value.AsNumber;
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator JsonInteger(StsSecondsEntity value)
            {
                return
            ...
            public static explicit operator byte(StsSecondsEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(byte value)
            {
            ...
            public static explicit operator decimal(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(decimal value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator double(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(double value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator short(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(short value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator int(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(int value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static implicit operator long(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static implicit operator StsSecondsEntity(long value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Int128(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(Int128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator sbyte(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(sbyte value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator Half(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(Half value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            public static explicit operator float(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(float value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ushort(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(ushort value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator uint(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(uint value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator ulong(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(ulong value)
            {
                return new(new BinaryJsonNumber(value));
            }
            ...
            public static explicit operator UInt128(StsSecondsEntity value)
            {
                if ((value.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <param name="value">The value from which to convert.</param>
            /// <returns>An instance of the <see cref="StsSecondsEntity"/>.</returns>
            public static explicit operator StsSecondsEntity(UInt128 value)
            {
                return new(new BinaryJsonNumber(value));
            }
#endif
            ...
            /// </returns>
            public static bool operator <(StsSecondsEntity left, StsSecondsEntity right)
            {
            ...
            public static StsSecondsEntity operator +(StsSecondsEntity left, StsSecondsEntity right)
            {
            ...
            /// <returns>The result of the operation.</returns>
            public static StsSecondsEntity operator ++(StsSecondsEntity value)
            {
            ...
            /// </returns>
            public static int Compare(in StsSecondsEntity lhs, in StsSecondsEntity rhs)
            {
