...
public readonly partial struct Kraken
{
    ...
    public readonly partial struct DisableRestEntity
        : IJsonBoolean<CorvusJsonSchema.Kraken.DisableRestEntity>
    {
        /// <summary>
        /// Conversion from <see cref="bool"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DisableRestEntity(bool value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DisableRestEntity(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(DisableRestEntity value)
        {
            return
                value.AsBoolean;
        }
        ...
        public static implicit operator bool(DisableRestEntity value)
        {
