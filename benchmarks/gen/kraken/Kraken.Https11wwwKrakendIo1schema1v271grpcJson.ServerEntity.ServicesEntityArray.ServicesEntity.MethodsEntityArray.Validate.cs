                    ...
                    public readonly partial struct MethodsEntityArray
                    {
                        ...
                        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            if (level > ValidationLevel.Basic)
                            {
                                ...
                                result = result.PushSchemaLocation("kraken.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1grpc.json/properties/server/properties/services/items/properties/methods");
                            }
                        ...
                        public static partial class CorvusValidation
                        {
                                ...
                                ValidationLevel level)
                            {
                                ...
                                int length = 0;
                                using JsonArrayEnumerator<CorvusJsonSchema.Kraken.Https11wwwKrakendIo1schema1v271grpcJson.ServerEntity.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity> arrayEnumerator = value.EnumerateArray();
