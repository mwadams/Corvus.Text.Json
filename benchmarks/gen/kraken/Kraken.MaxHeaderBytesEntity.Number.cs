...
public readonly partial struct Kraken
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct MaxHeaderBytesEntity
#if NET8_0_OR_GREATER
        : IJsonNumber<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          IAdditionOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          ISubtractionOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          IMultiplyOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          IDivisionOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity, CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          IIncrementOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>,
          IDecrementOperators<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>
#else
        : IJsonNumber<CorvusJsonSchema.Kraken.MaxHeaderBytesEntity>
#endif
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "MaxHeaderBytesEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public MaxHeaderBytesEntity(long value)
        ...
        public static implicit operator MaxHeaderBytesEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(MaxHeaderBytesEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(MaxHeaderBytesEntity value)
        {
            return
        ...
        public static explicit operator byte(MaxHeaderBytesEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(byte value)
        {
        ...
        public static explicit operator decimal(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator int(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator long(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static implicit operator MaxHeaderBytesEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(MaxHeaderBytesEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="MaxHeaderBytesEntity"/>.</returns>
        public static explicit operator MaxHeaderBytesEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(MaxHeaderBytesEntity left, MaxHeaderBytesEntity right)
        {
        ...
        public static MaxHeaderBytesEntity operator +(MaxHeaderBytesEntity left, MaxHeaderBytesEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static MaxHeaderBytesEntity operator ++(MaxHeaderBytesEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in MaxHeaderBytesEntity lhs, in MaxHeaderBytesEntity rhs)
        {
