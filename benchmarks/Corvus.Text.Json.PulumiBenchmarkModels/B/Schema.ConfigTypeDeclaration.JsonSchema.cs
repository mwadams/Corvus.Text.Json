...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigTypeDeclaration
        : IJsonElement<ConfigTypeDeclaration>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchItems(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchSecret(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext4 =
                    Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
            ...
            private static PropertySchemaMatchers<Corvus.PulumiBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.PulumiBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                    ...
                    (static () => JsonPropertyNames.SecretUtf8, MatchSecret),
                    (static () => JsonPropertyNames.TypeUtf8, MatchType),
                    (static () => JsonPropertyNames.ValueUtf8, MatchValue),
                ]);
            }

            private static PropertySchemaMatchers<Corvus.PulumiBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/pulumi.json#/definitions/configTypeDeclaration"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/pulumi.json#/definitions/configTypeDeclaration";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/pulumi.json#/definitions/configTypeDeclaration"u8;
