    ...
    public readonly partial struct DependencyModel
    {
            ...
            : IJsonElement<Scm>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "hg"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly Scm EnumJson1 = ParsedJsonDocument<Scm>.StringConstant([.."\"hg\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "git"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly Scm EnumJson2 = ParsedJsonDocument<Scm>.StringConstant([.."\"git\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// as a <see cref="Scm"/>.
                /// </summary>
                public static Scm Hg { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "hg"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> HgUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "git"
                /// as a <see cref="Scm"/>.
                /// </summary>
                public static Scm Git { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "git"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> GitUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/properties/scm"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/properties/scm";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DependencyModel/properties/scm"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("hg"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("git"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
