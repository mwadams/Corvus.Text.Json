    ...
    : IJsonElement<Schema>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaPathProvider AllowDuplicatesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allow_duplicates"u8, buffer, out written);
        private static readonly JsonSchemaPathProvider CollectionsValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/collections/$ref"u8, buffer, out written);
        ...
        private static void MatchAdditionalProperties(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Text.Json.JsonElementForBooleanFalseSchema.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Text.Json.JsonElementForBooleanFalseSchema.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchAllowDuplicates(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AllowDuplicatesUtf8,
                    evaluationPath: AllowDuplicatesSchemaEvaluationPath);

            Corvus.AnsibleMetaBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchCollectionsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.CollectionsValueUtf8,
                    evaluationPath: CollectionsValueSchemaEvaluationPath);

            Corvus.AnsibleMetaBenchmark.Baseline.Schema.Collections.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchDependencies(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext3 =
                Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.AnsibleMetaBenchmark.Baseline.Schema.DependencyModelArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchGalaxyInfo(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext4 =
                Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.GalaxyInfoUtf8,
                    evaluationPath: GalaxyInfoSchemaEvaluationPath);

            Corvus.AnsibleMetaBenchmark.Baseline.Schema.GalaxyInfoModel.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
        ...
        private static PropertySchemaMatchers<Corvus.AnsibleMetaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.AnsibleMetaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.AllowDuplicatesUtf8, MatchAllowDuplicates),
                (static () => JsonPropertyNames.CollectionsValueUtf8, MatchCollectionsValue),
                (static () => JsonPropertyNames.DependenciesUtf8, MatchDependencies),
                (static () => JsonPropertyNames.GalaxyInfoUtf8, MatchGalaxyInfo),
            ]);
        }
