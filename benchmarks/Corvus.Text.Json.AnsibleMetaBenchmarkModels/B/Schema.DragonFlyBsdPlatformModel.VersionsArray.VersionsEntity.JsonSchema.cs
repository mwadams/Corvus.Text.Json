        ...
        public readonly partial struct VersionsArray
        {
                ...
                : IJsonElement<VersionsEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "5.2"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly VersionsEntity EnumJson1 = ParsedJsonDocument<VersionsEntity>.StringConstant([.."\"5.2\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "5.4"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly VersionsEntity EnumJson2 = ParsedJsonDocument<VersionsEntity>.StringConstant([.."\"5.4\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                ...
                public static class EnumValues
                {
                    ...
                    /// </summary>
                    public static VersionsEntity Value52 { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "5.2"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Value52Utf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "5.4"
                    /// as a <see cref="VersionsEntity"/>.
                    /// </summary>
                    public static VersionsEntity Value54 { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "5.4"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> Value54Utf8 => Constants.Enum2;
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DragonFlyBSDPlatformModel/properties/versions/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DragonFlyBSDPlatformModel/properties/versions/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/ansible/ansible-lint/main/src/ansiblelint/schemas/meta.json#/definitions/DragonFlyBSDPlatformModel/properties/versions/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("5.2"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("5.4"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
