        ...
        public readonly partial struct GeometriesEntityArray
        {
                ...
                : IJsonElement<GeometriesEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://geojson.org/schema/GeoJSON.json#/oneOf/6/properties/geometries/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://geojson.org/schema/GeoJSON.json#/oneOf/6/properties/geometries/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://geojson.org/schema/GeoJSON.json#/oneOf/6/properties/geometries/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                            ...
                            switch (oneOfDiscriminatorBranch)
                            {
                                case 0:
                                {
                                    JsonSchemaContext discriminatorContext0 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                                ...
                                case 1:
                                {
                                    JsonSchemaContext discriminatorContext1 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                                ...
                                case 2:
                                {
                                    JsonSchemaContext discriminatorContext2 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                                ...
                                case 3:
                                {
                                    JsonSchemaContext discriminatorContext3 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext3);
                                ...
                                case 4:
                                {
                                    JsonSchemaContext discriminatorContext4 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext4);
                                ...
                                case 5:
                                {
                                    JsonSchemaContext discriminatorContext5 =
                                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                                    Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext5);
                        ...
                        JsonSchemaContext oneOfContext0 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                        ...
                        JsonSchemaContext oneOfContext1 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                        ...
                        JsonSchemaContext oneOfContext2 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                        ...
                        JsonSchemaContext oneOfContext3 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                        ...
                        JsonSchemaContext oneOfContext4 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                        ...
                        JsonSchemaContext oneOfContext5 =
                            Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Current.GeoJsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
