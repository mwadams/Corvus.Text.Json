...
public readonly partial struct GeojsonSchema
{
    ...
    public readonly partial struct GeoJsonFeatureCollection
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GeoJsonFeatureCollection instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GeoJsonFeatureCollection"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GeoJsonFeatureCollection(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the <c>features</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Mutable Features
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FeaturesUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GeoJsonFeatureCollection(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBbox(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFeatures(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("features");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FeaturesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Features, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFeatures<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GeoJsonFeatureCollection.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(GeoJsonFeatureCollection instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GeoJsonFeatureCollection"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source features,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source bbox = default)
            {
                features.AddAsProperty(JsonPropertyNamesEscaped.Features, ref builder, escapeName: false);
            ...
            public void Create(
                ...
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source bbox = default)
            {
                Create(ref _builder, features, type, bbox);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source<TContext> features,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, features, type, bbox);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source features, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(features, type, bbox);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.Source<TContext> features, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, features, type, bbox);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GeoJsonFeatureCollection, Mutable>(this);
        }
    }
}
