...
public readonly partial struct GeojsonSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray Coordinates
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity value))
                {
                    return value;
                }
