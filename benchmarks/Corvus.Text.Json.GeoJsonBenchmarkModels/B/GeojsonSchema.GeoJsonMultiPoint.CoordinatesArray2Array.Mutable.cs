    ...
    public readonly partial struct GeoJsonMultiPoint
    {
        ...
        public readonly partial struct CoordinatesArray2Array
        {
...
#endif
            {
                ...
                public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Mutable>(_parent, _idx);
                }
                ...
                public bool TryGetNumericValues(Span<double> items, out int written)
                {
                    CheckValidInstance();
                    written = 0;
                    foreach (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Mutable item in EnumerateArray())
                    {
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray oldItem, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.JsonNumberArray current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
