...
public readonly partial struct GeojsonSchema
{
    ...
    public readonly partial struct GeoJsonFeatureCollection
        ...
        : IJsonElement<GeoJsonFeatureCollection>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GeoJsonFeatureCollection"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GeoJsonFeatureCollection(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GeoJsonFeatureCollection DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray Bbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.JsonNumberArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray Features
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FeaturesUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.TypeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GeoJsonFeatureCollection left, in GeoJsonFeatureCollection right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GeoJsonFeatureCollection left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GeoJsonFeatureCollection instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GeoJsonFeatureCollection(JsonElement instance)
        {
            return GeoJsonFeatureCollection.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeoJsonFeatureCollection From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeoJsonFeatureCollection ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeoJsonFeatureCollection>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeoJsonFeatureCollection ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeoJsonFeatureCollection>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GeoJsonFeatureCollection ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GeoJsonFeatureCollection>(json, options);
        }
        ...
        /// </exception>
        public static GeoJsonFeatureCollection ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GeoJsonFeatureCollection>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GeoJsonFeatureCollection? result)
        {
            return JsonElementHelpers.TryParseValue<GeoJsonFeatureCollection>(ref reader, out result);
        }
...
#if NET
        static GeoJsonFeatureCollection IJsonElement<GeoJsonFeatureCollection>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GeoJsonFeatureCollection: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Features"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Features"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FeaturesUtf8 => "features"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Features"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Features => "features"u8;
