            ...
            public readonly partial struct GeoJsonLineString
            {
...
#endif
                {
                    ...
                    public bool TryGetNumericValues(Span<double> items, out int written)
                    {
                        CheckValidInstance();
                        written = 0;
                        foreach (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonLineString.CoordinatesArray2Array.JsonNumberArray item in EnumerateArray())
                        {
                    ...
                    public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonLineString.CoordinatesArray2Array.JsonNumberArray this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonLineString.CoordinatesArray2Array.JsonNumberArray>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonLineString.CoordinatesArray2Array.JsonNumberArray> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonLineString.CoordinatesArray2Array.JsonNumberArray>(_parent, _idx);
                    }
