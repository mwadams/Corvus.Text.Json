        ...
        public readonly partial struct PropertiesEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
