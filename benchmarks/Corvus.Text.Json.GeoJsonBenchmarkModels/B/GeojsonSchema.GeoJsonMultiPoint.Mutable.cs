...
public readonly partial struct GeojsonSchema
{
    ...
    public readonly partial struct GeoJsonMultiPoint
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBbox(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source coordinates,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source<TContext> coordinates,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source coordinates, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.CoordinatesArray2Array.Source<TContext> coordinates, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiPoint.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
