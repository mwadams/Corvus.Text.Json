...
public readonly partial struct GeojsonSchema
{
    ...
    public readonly partial struct GeoJsonPoint
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Mutable Bbox
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BboxUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Mutable Coordinates
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CoordinatesUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBbox(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBbox<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCoordinates<TContext>(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source coordinates,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source bbox = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> coordinates,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Source type,
                in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> bbox = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source coordinates, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source bbox = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.CoordinateArray.Source<TContext> coordinates, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.TypeEntity.Source type, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonPoint.JsonNumberArray.Source<TContext> bbox = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
