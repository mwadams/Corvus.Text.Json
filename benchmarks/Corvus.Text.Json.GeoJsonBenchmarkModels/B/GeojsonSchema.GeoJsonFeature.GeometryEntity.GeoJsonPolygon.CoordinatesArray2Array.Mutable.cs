            ...
            public readonly partial struct GeoJsonPolygon
            {
                ...
                public readonly partial struct CoordinatesArray2Array
                {
...
#endif
                    {
                        ...
                        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Mutable this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Mutable>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Mutable> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Mutable>(_parent, _idx);
                        }
                        ...
                        public bool TryGetNumericValues(Span<double> items, out int written)
                        {
                            CheckValidInstance();
                            written = 0;
                            foreach (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Mutable item in EnumerateArray())
                            {
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void SetItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void InsertItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void AddItem(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Source value)
                        {
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Remove(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray item)
                        {
                            CheckValidInstance();
                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray>(this, in item))
                            {
                                return false;
                            }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void RemoveWhere(JsonPredicate<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray> predicate)
                        {
                            CheckValidInstance();
                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray>(this, predicate);
                            _documentVersion = _parent.Version;
                        }
                        ...
                        public bool Replace(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray oldItem, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.Source newItem)
                        {
                            ...
                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray>(_parent, _idx);

                            while (enumerator.MoveNext())
                            {
                                Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray current = enumerator.Current;
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonPolygon.CoordinatesArray2Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
