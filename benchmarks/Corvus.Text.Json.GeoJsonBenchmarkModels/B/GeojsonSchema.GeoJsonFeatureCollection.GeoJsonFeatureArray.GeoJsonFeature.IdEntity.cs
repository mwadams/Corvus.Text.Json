            ...
            public readonly partial struct GeoJsonFeature
            {
...
#endif
                {
                    ...
                    public bool TryGetAsJsonNumber(out Corvus.GeoJsonBenchmark.Baseline.JsonNumber result)
                    {
                        ...
                        {
                            result = Corvus.GeoJsonBenchmark.Baseline.JsonNumber.From(this);
                            return true;
                        }
                    ...
                    public bool TryGetAsJsonString(out Corvus.GeoJsonBenchmark.Baseline.JsonString result)
                    {
                        ...
                        {
                            result = Corvus.GeoJsonBenchmark.Baseline.JsonString.From(this);
                            return true;
                        }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.IdEntity, TContext, TResult> defaultMatch)
...
#endif
                    {
                        if (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonNumber(Corvus.GeoJsonBenchmark.Baseline.JsonNumber.From(this), context);
                        }

                        if (Corvus.GeoJsonBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonString(Corvus.GeoJsonBenchmark.Baseline.JsonString.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.IdEntity, TResult> defaultMatch)
                    {
                        if (Corvus.GeoJsonBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonNumber(Corvus.GeoJsonBenchmark.Baseline.JsonNumber.From(this));
                        }

                        if (Corvus.GeoJsonBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonString(Corvus.GeoJsonBenchmark.Baseline.JsonString.From(this));
                        }
