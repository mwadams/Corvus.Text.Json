    ...
    public readonly partial struct GeoJsonMultiLineString
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray item in EnumerateArray())
                {
            ...
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray>(_parent, _idx);
            }
