    ...
    public readonly partial struct GeoJsonFeature
    {
        ...
        public readonly partial struct PropertiesEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    if (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                    Matcher<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf1Entity(out Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity result)
                {
                    if (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.PropertiesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
