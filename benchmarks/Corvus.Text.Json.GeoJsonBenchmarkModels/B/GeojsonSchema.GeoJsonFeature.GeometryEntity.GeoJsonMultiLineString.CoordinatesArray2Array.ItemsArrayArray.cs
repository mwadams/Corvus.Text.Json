                ...
                public readonly partial struct CoordinatesArray2Array
                {
...
#endif
                    {
                        ...
                        public bool TryGetNumericValues(Span<double> items, out int written)
                        {
                            CheckValidInstance();
                            written = 0;
                            foreach (Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray item in EnumerateArray())
                            {
                        ...
                        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiLineString.CoordinatesArray2Array.ItemsArrayArray.JsonNumberArray>(_parent, _idx);
                        }
