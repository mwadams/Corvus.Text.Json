            ...
            public readonly partial struct GeoJsonGeometryCollection
            {
                ...
                public readonly partial struct GeometriesEntityArray
                {
...
#endif
                    {
                        ...
                        public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Mutable this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Mutable>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Mutable> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Mutable>(_parent, _idx);
                        }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void SetItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void InsertItem(int itemIndex, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void AddItem(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Source value)
                        {
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Remove(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity item)
                        {
                            CheckValidInstance();
                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity>(this, in item))
                            {
                                return false;
                            }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void RemoveWhere(JsonPredicate<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity> predicate)
                        {
                            CheckValidInstance();
                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity>(this, predicate);
                            _documentVersion = _parent.Version;
                        }
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Replace(in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity oldItem, in Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.Source newItem)
                        {
                            CheckValidInstance();
                            ...
                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity>(_parent, _idx);

                            while (enumerator.MoveNext())
                            {
                                Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity current = enumerator.Current;
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
