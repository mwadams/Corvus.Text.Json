                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                else
                                {
                                    ...
                                    while (arrayValidation_enumerator.MoveNext())
                                    {
                                        ...
                                        JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.JsonSchema.PushChildContext(
                                            parentDocument,
                                        ...
                                        Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
