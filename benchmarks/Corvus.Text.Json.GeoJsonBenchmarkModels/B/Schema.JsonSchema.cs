    ...
    public static partial class JsonSchema
    {
            ...
            ref JsonSchemaContext context)
        {
                ...
                switch (oneOfDiscriminatorBranch)
                {
                    case 0:
                    {
                        JsonSchemaContext discriminatorContext0 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                    ...
                    case 1:
                    {
                        JsonSchemaContext discriminatorContext1 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                    ...
                    case 2:
                    {
                        JsonSchemaContext discriminatorContext2 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                    ...
                    case 3:
                    {
                        JsonSchemaContext discriminatorContext3 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext3);
                    ...
                    case 4:
                    {
                        JsonSchemaContext discriminatorContext4 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext4);
                    ...
                    case 5:
                    {
                        JsonSchemaContext discriminatorContext5 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext5);
                    ...
                    case 6:
                    {
                        JsonSchemaContext discriminatorContext6 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext6);
                    ...
                    case 7:
                    {
                        JsonSchemaContext discriminatorContext7 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf7SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext7);
                    ...
                    case 8:
                    {
                        JsonSchemaContext discriminatorContext8 =
                            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf8SchemaEvaluationPath);
                        Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext8);
            ...
            JsonSchemaContext oneOfContext0 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
            ...
            JsonSchemaContext oneOfContext3 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
            ...
            JsonSchemaContext oneOfContext4 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiLineString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiLineString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
            ...
            JsonSchemaContext oneOfContext5 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonMultiPolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
            ...
            JsonSchemaContext oneOfContext6 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonGeometryCollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
            ...
            JsonSchemaContext oneOfContext7 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf7SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeature.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext7);
            ...
            JsonSchemaContext oneOfContext8 =
                Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf8SchemaEvaluationPath);
            Corvus.GeoJsonBenchmark.Baseline.Schema.GeoJsonFeatureCollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext8);
