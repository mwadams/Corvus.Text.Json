    ...
    public readonly partial struct GeoJsonFeatureCollection
    {
            ...
            : IJsonElement<TypeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum = "FeatureCollection"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"FeatureCollection\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "FeatureCollection"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity FeatureCollection { get; } = Constants.EnumJson;
                /// <summary>
                /// Gets the string "FeatureCollection"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FeatureCollectionUtf8 => Constants.Enum;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://geojson.org/schema/GeoJSON.json#/oneOf/8/properties/type"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://geojson.org/schema/GeoJSON.json#/oneOf/8/properties/type";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://geojson.org/schema/GeoJSON.json#/oneOf/8/properties/type"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("FeatureCollection"u8))
                        {
