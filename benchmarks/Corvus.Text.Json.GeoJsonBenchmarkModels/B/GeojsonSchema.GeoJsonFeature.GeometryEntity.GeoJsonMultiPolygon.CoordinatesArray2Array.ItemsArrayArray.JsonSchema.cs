                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                else
                                {
                                    ...
                                    while (arrayValidation_enumerator.MoveNext())
                                    {
                                        ...
                                        JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonSchema.PushChildContext(
                                            parentDocument,
                                        ...
                                        Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeature.GeometryEntity.GeoJsonMultiPolygon.CoordinatesArray2Array.ItemsArrayArray.ItemsArray2Array.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
