...
public readonly partial struct GeojsonSchema
{
    ...
    public readonly partial struct GeoJsonFeatureCollection
    {
...
#endif
        {
            ...
            public Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature>(_parent, _idx);
            }
