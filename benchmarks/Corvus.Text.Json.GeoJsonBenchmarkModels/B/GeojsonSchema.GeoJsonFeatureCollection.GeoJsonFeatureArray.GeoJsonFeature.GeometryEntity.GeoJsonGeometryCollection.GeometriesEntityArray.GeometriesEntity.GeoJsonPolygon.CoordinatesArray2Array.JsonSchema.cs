                                                ...
                                                ref JsonSchemaContext context)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    while (arrayValidation_enumerator.MoveNext())
                                                    {
                                                        ...
                                                        JsonSchemaContext childContext = Corvus.GeoJsonBenchmark.Baseline.GeojsonSchema.GeoJsonFeatureCollection.GeoJsonFeatureArray.GeoJsonFeature.GeometryEntity.GeoJsonGeometryCollection.GeometriesEntityArray.GeometriesEntity.GeoJsonPolygon.CoordinatesArray2Array.ItemsArrayArray.JsonSchema.PushChildContext(
                                                            parentDocument,
