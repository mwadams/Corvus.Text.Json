...
public readonly partial struct PersonArray
{
    ...
    static PrefixItems0 IJsonElement<PrefixItems0>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
        ...
        public readonly ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(PrefixItems0 instance) => new(JsonElement.From(instance));
        ...
        {
            public static readonly JsonSchemaPathProvider SchemaLocation = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/prefixItems/0"u8, buffer, out written);
