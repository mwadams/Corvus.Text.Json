...
public readonly partial struct PersonName
    : IJsonObject<Benchmark.CorvusJsonSchema2.PersonName>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema2.NameComponent FirstName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema2.NameComponent>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema2.NameComponent LastName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema2.OtherNames OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema2.OtherNames>();
                }
            }
    ...
    public static PersonName Create(
        in Benchmark.CorvusJsonSchema2.NameComponent firstName,
        in Benchmark.CorvusJsonSchema2.NameComponent? lastName = null,
        in Benchmark.CorvusJsonSchema2.OtherNames? otherNames = null)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithFirstName(in Benchmark.CorvusJsonSchema2.NameComponent value)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithLastName(in Benchmark.CorvusJsonSchema2.NameComponent value)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithOtherNames(in Benchmark.CorvusJsonSchema2.OtherNames value)
    {
