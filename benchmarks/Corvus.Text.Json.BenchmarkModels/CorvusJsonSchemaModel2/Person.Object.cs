...
public readonly partial struct Person
    : IJsonObject<Benchmark.CorvusJsonSchema2.Person>
{
    /// <summary>
    ...
    /// </summary>
    public Benchmark.CorvusJsonSchema2.Age Age
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema2.Age>();
                }
            }
    ...
    /// </summary>
    public Benchmark.CorvusJsonSchema2.CompetedInYears CompetedInYears
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.CompetedInYearsUtf8, out JsonElement result))
                {
                    return new(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                if (this.objectBacking.TryGetValue(JsonPropertyNames.CompetedInYears, out JsonAny result))
                {
                    return result.As<Benchmark.CorvusJsonSchema2.CompetedInYears>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema2.PersonName Name
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema2.PersonName>();
                }
            }
    ...
    public static Person Create(
        in Benchmark.CorvusJsonSchema2.PersonName name,
        in Benchmark.CorvusJsonSchema2.Age? age = null,
        in Benchmark.CorvusJsonSchema2.CompetedInYears? competedInYears = null)
    {
        ...
        if (age is not null)
        {
            builder.Add(JsonPropertyNames.Age, age.Value.AsAny);
        }

        if (competedInYears is not null)
        {
            builder.Add(JsonPropertyNames.CompetedInYears, competedInYears.Value.AsAny);
        }
    ...
    public Person WithAge(in Benchmark.CorvusJsonSchema2.Age value)
    {
        return this.SetProperty(JsonPropertyNames.Age, value);
    }
    ...
    /// <param name="value">The new property value</param>
    /// <returns>The instance with the property set.</returns>
    public Person WithCompetedInYears(in Benchmark.CorvusJsonSchema2.CompetedInYears value)
    {
        return this.SetProperty(JsonPropertyNames.CompetedInYears, value);
    }
    ...
    /// </para>
    /// </remarks>
    public Person WithName(in Benchmark.CorvusJsonSchema2.PersonName value)
    {
