...
public readonly partial struct NameComponentArray
    : IJsonArray<Benchmark.CorvusJsonSchema2.NameComponentArray>,
      IReadOnlyCollection<Benchmark.CorvusJsonSchema2.NameComponent>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    public Benchmark.CorvusJsonSchema2.NameComponent this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Benchmark.CorvusJsonSchema2.NameComponent>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static NameComponentArray Create(ReadOnlySpan<Benchmark.CorvusJsonSchema2.NameComponent> items)
    {
        return new([..items]);
    }
    ...
    public static NameComponentArray FromItems(params Benchmark.CorvusJsonSchema2.NameComponent[] items)
    {
        return new([..items]);
    }
    ...
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2, in Benchmark.CorvusJsonSchema2.NameComponent item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2, in Benchmark.CorvusJsonSchema2.NameComponent item3, in Benchmark.CorvusJsonSchema2.NameComponent item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2, in Benchmark.CorvusJsonSchema2.NameComponent item3, in Benchmark.CorvusJsonSchema2.NameComponent item4, in Benchmark.CorvusJsonSchema2.NameComponent item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2, in Benchmark.CorvusJsonSchema2.NameComponent item3, in Benchmark.CorvusJsonSchema2.NameComponent item4, in Benchmark.CorvusJsonSchema2.NameComponent item5, in Benchmark.CorvusJsonSchema2.NameComponent item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema2.NameComponent item1, in Benchmark.CorvusJsonSchema2.NameComponent item2, in Benchmark.CorvusJsonSchema2.NameComponent item3, in Benchmark.CorvusJsonSchema2.NameComponent item4, in Benchmark.CorvusJsonSchema2.NameComponent item5, in Benchmark.CorvusJsonSchema2.NameComponent item6, in Benchmark.CorvusJsonSchema2.NameComponent item7)
    {
    ...
    public static NameComponentArray FromRange(IEnumerable<Benchmark.CorvusJsonSchema2.NameComponent> items)
    {
        return new([..items]);
    }
    ...
    /// <inheritdoc/>
    IEnumerator<Benchmark.CorvusJsonSchema2.NameComponent> IEnumerable<Benchmark.CorvusJsonSchema2.NameComponent>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<Benchmark.CorvusJsonSchema2.NameComponent>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Benchmark.CorvusJsonSchema2.NameComponent> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    public NameComponentArray Add(in Benchmark.CorvusJsonSchema2.NameComponent item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public NameComponentArray Add(params Benchmark.CorvusJsonSchema2.NameComponent[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Benchmark.CorvusJsonSchema2.NameComponent item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public NameComponentArray AddRange(IEnumerable<Benchmark.CorvusJsonSchema2.NameComponent> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Benchmark.CorvusJsonSchema2.NameComponent item in items)
        {
    ...
    /// <inheritdoc/>
    public NameComponentArray Insert(int index, in Benchmark.CorvusJsonSchema2.NameComponent item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public NameComponentArray InsertRange(int index, IEnumerable<Benchmark.CorvusJsonSchema2.NameComponent> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public NameComponentArray Replace(in Benchmark.CorvusJsonSchema2.NameComponent oldValue, in Benchmark.CorvusJsonSchema2.NameComponent newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public NameComponentArray SetItem(int index, in Benchmark.CorvusJsonSchema2.NameComponent value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }
    ...
    /// <inheritdoc/>
    public NameComponentArray Remove(in Benchmark.CorvusJsonSchema2.NameComponent oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
