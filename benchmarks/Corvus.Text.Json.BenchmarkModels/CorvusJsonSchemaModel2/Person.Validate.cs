            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            foreach (JsonObjectProperty property in value.EnumerateObject())
            {
                ...
                if (property.NameEquals(JsonPropertyNames.AgeUtf8, JsonPropertyNames.Age))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Benchmark.CorvusJsonSchema2.Age>().Validate(result.CreateChildContext(), level);
                ...
                else if (property.NameEquals(JsonPropertyNames.CompetedInYearsUtf8, JsonPropertyNames.CompetedInYears))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Benchmark.CorvusJsonSchema2.CompetedInYears>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
                ...
                else if (property.NameEquals(JsonPropertyNames.NameUtf8, JsonPropertyNames.Name))
                {
                    ...
                    ValidationContext propertyResult = property.Value.As<Benchmark.CorvusJsonSchema2.PersonName>().Validate(result.CreateChildContext(), level);
                    if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                    {
                        return propertyResult;
                    }
