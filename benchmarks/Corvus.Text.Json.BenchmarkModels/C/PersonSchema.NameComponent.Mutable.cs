...
public readonly partial struct PersonSchema
{
    ...
    public readonly partial struct NameComponent
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NameComponent instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NameComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NameComponent(Mutable instance)
            {
        ...
        {
            return workspace.CreateBuilder<NameComponent, Mutable>(this);
        }
    }
}
