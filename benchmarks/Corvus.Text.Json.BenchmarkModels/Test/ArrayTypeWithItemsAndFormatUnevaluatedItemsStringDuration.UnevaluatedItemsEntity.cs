...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDuration
{
        ...
        : IJsonElement<UnevaluatedItemsEntity>
    {
        ...
        public ref struct Source
        {
            ...
            private Source(NodaTime.Period value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => JsonElementHelpers.TryFormatPeriod(v, buffer, out written)); _kind = Kind.StringSimpleType; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(NodaTime.Period value) => new (value);
