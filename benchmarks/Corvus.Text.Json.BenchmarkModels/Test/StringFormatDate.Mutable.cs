...
public readonly partial struct StringFormatDate
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatDate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatDate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatDate(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatDate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
