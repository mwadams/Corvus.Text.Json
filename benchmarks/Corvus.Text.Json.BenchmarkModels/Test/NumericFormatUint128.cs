...
public readonly partial struct NumericFormatUint128
    : IJsonElement<NumericFormatUint128>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatUint128"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatUint128(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatUint128 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatUint128 left, in NumericFormatUint128 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatUint128 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatUint128 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatUint128 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatUint128(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatUint128 IJsonElement<NumericFormatUint128>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatUint128: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatUint128, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatUint128 instance) => new(JsonElement.From(instance));
