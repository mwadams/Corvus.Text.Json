...
public readonly partial struct StringFormatDateTime
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatDateTime instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatDateTime"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatDateTime(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatDateTime.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
