...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayUint128
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayUint128>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayUint128"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayUint128(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayUint128 DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayUint128 left, in MultiDimensionHigherRankFixedSizeNumericArrayUint128 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayUint128 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayUint128 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayUint128 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayUint128(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayUint128 IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayUint128>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayUint128: ValueKind = {ValueKind} : \"{ToString()}\"";
...
#if NET
        private readonly ReadOnlySpan<UInt128> _UInt128Array;
#endif
...
#if NET
        private Source(ReadOnlySpan<UInt128> value)
        {
            _UInt128Array = value;
            _kind = Kind.UInt128Array;
        }
#endif

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayUint128 instance) => new(JsonElement.From(instance));

#if NET
        public static Source FromArray(ReadOnlySpan<UInt128> value)
        {
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
#if NET
                case Kind.UInt128Array:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _UInt128Array!, escapeName, nameRequiresUnescaping);
                    break;
#endif
                default:
...
#if NET
                case Kind.UInt128Array:
                    valueBuilder.AddPropertyArrayValue(name, _UInt128Array!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
...
#if NET
                case Kind.UInt128Array:
                    valueBuilder.AddItemArrayValue(_UInt128Array!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<UInt128> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayUint128.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayUint128, Mutable>(this);
    }
}
