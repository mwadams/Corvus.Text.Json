...
public readonly partial struct ComplexComposedObjectWithProperties
{
    ...
    public readonly partial struct AnyOf1Entity
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            /// </summary>
            public Test.ComplexComposedObjectWithProperties.AnyOf1Entity.WholeNumberEntity.Mutable WholeNumber
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WholeNumberUtf8, out Test.ComplexComposedObjectWithProperties.AnyOf1Entity.WholeNumberEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the wholeNumber property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetWholeNumber(in Source value)
            {
                CheckValidInstance();

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WholeNumberUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.WholeNumber, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        public ref struct Source
        {
            ...
            public Source(Test.ComplexComposedObjectWithProperties.AnyOf1Entity.Builder.Build value) { _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Test.ComplexComposedObjectWithProperties.AnyOf1Entity.WholeNumberEntity.Source wholeNumber = default)
            {
                wholeNumber.AddAsProperty(JsonPropertyNamesEscaped.WholeNumber, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="AnyOf1Entity"/>.
            /// </summary>
            public void Create(in Test.ComplexComposedObjectWithProperties.AnyOf1Entity.WholeNumberEntity.Source wholeNumber = default)
            {
                Create(ref _builder, wholeNumber);
            }
        ...
        {
            return workspace.CreateDocumentBuilder<AnyOf1Entity, Mutable>(this);
        }
    }
}
