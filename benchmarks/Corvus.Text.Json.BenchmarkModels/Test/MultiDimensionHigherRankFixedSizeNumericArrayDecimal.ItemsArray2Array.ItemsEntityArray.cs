...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayDecimal
{
    ...
    public readonly partial struct ItemsArray2Array
    {
            ...
            : IJsonElement<ItemsEntityArray>
        {
            ...
            /// </remarks>
            public static int ValueBufferSize => 5;
            ...
            public Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray.ItemsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray.ItemsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_parent, _idx);
            }
