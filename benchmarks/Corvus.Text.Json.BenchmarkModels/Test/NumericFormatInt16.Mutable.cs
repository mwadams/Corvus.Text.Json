...
public readonly partial struct NumericFormatInt16
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatInt16 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatInt16"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatInt16(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatInt16.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
