...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex
    : IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.UnevaluatedItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.UnevaluatedItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.UnevaluatedItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.UnevaluatedItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex left, in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex.UnevaluatedItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringRegex, Mutable>(this);
    }
}
