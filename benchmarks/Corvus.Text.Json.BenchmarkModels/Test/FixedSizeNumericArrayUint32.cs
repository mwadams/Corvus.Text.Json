...
public readonly partial struct FixedSizeNumericArrayUint32
    : IJsonElement<FixedSizeNumericArrayUint32>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArrayUint32"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArrayUint32(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArrayUint32 DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArrayUint32.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArrayUint32.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.FixedSizeNumericArrayUint32.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.FixedSizeNumericArrayUint32.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayUint32 left, in FixedSizeNumericArrayUint32 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayUint32 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArrayUint32 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArrayUint32 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new FixedSizeNumericArrayUint32(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static FixedSizeNumericArrayUint32 IJsonElement<FixedSizeNumericArrayUint32>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArrayUint32: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.FixedSizeNumericArrayUint32.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(FixedSizeNumericArrayUint32 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.FixedSizeNumericArrayUint32.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<FixedSizeNumericArrayUint32, Mutable>(this);
    }
}
