...
public readonly partial struct NumericFormatUint16
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatUint16 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatUint16"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatUint16(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatUint16.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
