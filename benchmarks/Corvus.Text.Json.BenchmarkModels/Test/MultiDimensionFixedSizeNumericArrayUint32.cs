...
public readonly partial struct MultiDimensionFixedSizeNumericArrayUint32
    : IJsonElement<MultiDimensionFixedSizeNumericArrayUint32>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionFixedSizeNumericArrayUint32"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionFixedSizeNumericArrayUint32(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionFixedSizeNumericArrayUint32 DefaultInstance { get; }
    ...
    public Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint32 left, in MultiDimensionFixedSizeNumericArrayUint32 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint32 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionFixedSizeNumericArrayUint32 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionFixedSizeNumericArrayUint32 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionFixedSizeNumericArrayUint32(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionFixedSizeNumericArrayUint32 IJsonElement<MultiDimensionFixedSizeNumericArrayUint32>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayUint32: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionFixedSizeNumericArrayUint32.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionFixedSizeNumericArrayUint32 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<uint> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionFixedSizeNumericArrayUint32.ItemsEntityArray.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionFixedSizeNumericArrayUint32, Mutable>(this);
    }
}
