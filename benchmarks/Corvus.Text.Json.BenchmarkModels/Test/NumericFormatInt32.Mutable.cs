...
public readonly partial struct NumericFormatInt32
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatInt32 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatInt32"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatInt32(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatInt32.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
