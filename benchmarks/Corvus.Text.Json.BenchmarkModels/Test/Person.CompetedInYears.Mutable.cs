                ...
                public readonly partial struct Person
                {
                    ...
                    public readonly partial struct CompetedInYears
                    {
                            ...
                            : IMutableJsonElement<Mutable>
                        {
                            ...
                            public static explicit operator Mutable(CompetedInYears instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="CompetedInYears"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator CompetedInYears(Mutable instance)
                            {
                            ...
                            public Test.Person.Year.Mutable this[int index]
                            {
                                get
                                {
                                    CheckValidInstance();
                                    return _parent.GetArrayIndexElement<Test.Person.Year.Mutable>(_idx, index);
                                }
                            }
                            ...
                            /// </summary>
                            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                            public ArrayEnumerator<Test.Person.Year.Mutable> EnumerateArray()
                            {
                                CheckValidInstance();
                                return EnumeratorCreator.CreateArrayEnumerator<Test.Person.Year.Mutable>(_parent, _idx);
                            }
                            ...
                            /// </remarks>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public void SetItem(int itemIndex, in Test.Person.Year.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </remarks>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public void InsertItem(int itemIndex, in Test.Person.Year.Source value)
                            {
                                CheckValidInstance();
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                                value.AddAsItem(ref cvb);
                            ...
                            /// </remarks>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public void RemoveWhere(JsonPredicate<Test.Person.Year> predicate)
                            {
                                CheckValidInstance();
                                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.Person.Year>(this, predicate);
                                _documentVersion = _parent.Version;
                            }
                        ...
                        public ref struct Source
                        {
                            ...
                            public Source(Test.Person.CompetedInYears.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }
