                    ...
                    public readonly partial struct ItemsArray2Array
                    {
                        ...
                        public readonly partial struct ItemsEntityArray
                        {
                                ...
                                : IMutableJsonElement<Mutable>
                            {
                                ...
                                public Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Mutable this[int index]
                                {
                                    get
                                    {
                                        CheckValidInstance();
                                        return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Mutable>(_idx, index);
                                    }
                                }
                                ...
                                /// </summary>
                                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Mutable> EnumerateArray()
                                {
                                    CheckValidInstance();
                                    return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Mutable>(_parent, _idx);
                                }
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void SetItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void InsertItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Source value)
                                {
                                    CheckValidInstance();
                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                                    value.AddAsItem(ref cvb);
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void RemoveWhere(JsonPredicate<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity> predicate)
                                {
                                    CheckValidInstance();
                                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(this, predicate);
                                    _documentVersion = _parent.Version;
                                }
                            ...
                            public ref struct Source
                            {
                                ...
                                public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// </summary>
                                public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray.ItemsEntity.Source value)
                                {
