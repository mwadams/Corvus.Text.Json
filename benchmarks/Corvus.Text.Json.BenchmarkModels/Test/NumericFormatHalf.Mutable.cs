...
public readonly partial struct NumericFormatHalf
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatHalf instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatHalf"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatHalf(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatHalf.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
