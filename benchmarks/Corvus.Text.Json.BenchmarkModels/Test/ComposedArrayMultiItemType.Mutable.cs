...
public readonly partial struct ComposedArrayMultiItemType
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Test.ComposedArrayMultiItemType.ItemsEntityArray.Mutable(Mutable value)
        {
            return Test.ComposedArrayMultiItemType.ItemsEntityArray.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Test.ComposedArrayMultiItemType.ItemsEntityArray.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Test.ComposedArrayMultiItemType.OneOf1EItemArray.Mutable(Mutable value)
        {
            return Test.ComposedArrayMultiItemType.OneOf1EItemArray.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Test.ComposedArrayMultiItemType.OneOf1EItemArray.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(ComposedArrayMultiItemType instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ComposedArrayMultiItemType"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ComposedArrayMultiItemType(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ComposedArrayMultiItemType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Test.ComposedArrayMultiItemType.Mutable, TContext, TResult> defaultMatch)
        {
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Test.ComposedArrayMultiItemType.Mutable, TResult> defaultMatch)
        {
            if (Test.ComposedArrayMultiItemType.ItemsEntityArray.JsonSchema.Evaluate(_parent, _idx))
            {
