...
public readonly partial struct ComplexComposedObjectWithProperties
{
    ...
    public readonly partial struct AnyOf0Entity
    {
        ...
        public readonly partial struct EitherOrEntity
            : IJsonElement<EitherOrEntity>
        {
            private readonly IJsonDocument _parent;
            private readonly int _idx;

            /// <summary>
            /// Initializes a new instance of the <see cref="EitherOrEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EitherOrEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EitherOrEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in EitherOrEntity left, in EitherOrEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EitherOrEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(EitherOrEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EitherOrEntity From<T>(in T instance)
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EitherOrEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EitherOrEntity IJsonElement<EitherOrEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EitherOrEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
