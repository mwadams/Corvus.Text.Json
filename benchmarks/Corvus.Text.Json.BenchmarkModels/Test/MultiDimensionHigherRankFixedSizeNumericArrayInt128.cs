...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayInt128
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayInt128>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayInt128"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayInt128(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayInt128 DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayInt128 left, in MultiDimensionHigherRankFixedSizeNumericArrayInt128 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayInt128 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayInt128 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayInt128 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayInt128(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayInt128 IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayInt128>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayInt128: ValueKind = {ValueKind} : \"{ToString()}\"";
...
#if NET
        private readonly ReadOnlySpan<Int128> _Int128Array;
#endif
...
#if NET
        private Source(ReadOnlySpan<Int128> value)
        {
            _Int128Array = value;
            _kind = Kind.Int128Array;
        }
#endif

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayInt128 instance) => new(JsonElement.From(instance));

#if NET
        public static Source FromArray(ReadOnlySpan<Int128> value)
        {
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
#if NET
                case Kind.Int128Array:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _Int128Array!, escapeName, nameRequiresUnescaping);
                    break;
#endif
                default:
...
#if NET
                case Kind.Int128Array:
                    valueBuilder.AddPropertyArrayValue(name, _Int128Array!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
...
#if NET
                case Kind.Int128Array:
                    valueBuilder.AddItemArrayValue(_Int128Array!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
    ...
    public ref struct Builder
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int CreateTensor(ReadOnlySpan<Int128> tensor)
        {
        ...
        /// <returns>The number of items consumed.</returns>
        /// <exception cref="ArgumentException">The tensor did not contain the correct number of values for the array rank and dimension.</exception>
        internal int CreateTensor(ReadOnlySpan<Int128> tensor, bool createArray)
        {
            int index = 0;
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayInt128, Mutable>(this);
    }
}
