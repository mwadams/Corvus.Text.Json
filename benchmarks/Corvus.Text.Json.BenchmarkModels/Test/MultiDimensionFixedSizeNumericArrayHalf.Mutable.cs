...
public readonly partial struct MultiDimensionFixedSizeNumericArrayHalf
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(MultiDimensionFixedSizeNumericArrayHalf instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MultiDimensionFixedSizeNumericArrayHalf"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MultiDimensionFixedSizeNumericArrayHalf(Mutable instance)
        {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayHalf.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray>(this, predicate);
            _documentVersion = _parent.Version;
        }
