...
public readonly partial struct FixedSizeNumericArraySingle
    : IJsonElement<FixedSizeNumericArraySingle>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArraySingle"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArraySingle(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArraySingle DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArraySingle.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArraySingle.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.FixedSizeNumericArraySingle.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.FixedSizeNumericArraySingle.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArraySingle left, in FixedSizeNumericArraySingle right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArraySingle left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArraySingle instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArraySingle From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new FixedSizeNumericArraySingle(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static FixedSizeNumericArraySingle IJsonElement<FixedSizeNumericArraySingle>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArraySingle: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.FixedSizeNumericArraySingle.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(FixedSizeNumericArraySingle instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.FixedSizeNumericArraySingle.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<FixedSizeNumericArraySingle, Mutable>(this);
    }
}
