...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate
    : IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.UnevaluatedItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.UnevaluatedItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.UnevaluatedItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.UnevaluatedItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate left, in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate.UnevaluatedItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<ArrayTypeWithItemsAndFormatUnevaluatedItemsStringDate, Mutable>(this);
    }
}
