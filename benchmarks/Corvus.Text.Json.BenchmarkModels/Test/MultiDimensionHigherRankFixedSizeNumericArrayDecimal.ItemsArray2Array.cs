...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayDecimal
{
        ...
        : IJsonElement<ItemsArray2Array>
    {
        ...
        public Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ItemsEntityArray>(_parent, _idx);
        }
