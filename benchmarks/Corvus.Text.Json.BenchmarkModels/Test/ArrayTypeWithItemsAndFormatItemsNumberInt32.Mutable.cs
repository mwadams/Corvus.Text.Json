...
public readonly partial struct ArrayTypeWithItemsAndFormatItemsNumberInt32
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(ArrayTypeWithItemsAndFormatItemsNumberInt32 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ArrayTypeWithItemsAndFormatItemsNumberInt32"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayTypeWithItemsAndFormatItemsNumberInt32(Mutable instance)
        {
        ...
        public Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatItemsNumberInt32.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ArrayTypeWithItemsAndFormatItemsNumberInt32.ItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
