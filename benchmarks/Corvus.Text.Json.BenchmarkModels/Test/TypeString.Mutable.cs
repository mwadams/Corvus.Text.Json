...
public readonly partial struct TypeString
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypeString instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypeString"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypeString(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypeString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
