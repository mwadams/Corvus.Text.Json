...
public readonly partial struct NumericFormatUint64
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatUint64 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatUint64"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatUint64(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatUint64.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
