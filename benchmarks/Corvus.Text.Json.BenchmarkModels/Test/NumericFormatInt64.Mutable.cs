...
public readonly partial struct NumericFormatInt64
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatInt64 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatInt64"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatInt64(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatInt64.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
