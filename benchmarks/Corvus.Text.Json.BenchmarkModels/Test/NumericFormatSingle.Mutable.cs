...
public readonly partial struct NumericFormatSingle
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatSingle instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatSingle"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatSingle(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatSingle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
