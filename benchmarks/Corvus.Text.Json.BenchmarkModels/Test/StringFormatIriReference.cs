...
public readonly partial struct StringFormatIriReference
    : IJsonElement<StringFormatIriReference>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatIriReference"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatIriReference(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatIriReference DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatIriReference left, in StringFormatIriReference right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatIriReference left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatIriReference instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatIriReference From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatIriReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatIriReference IJsonElement<StringFormatIriReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatIriReference: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatIriReference, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatIriReference instance) => new(JsonElement.From(instance));
