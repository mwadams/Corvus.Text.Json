...
public readonly partial struct NumericFormatSbyte
    : IJsonElement<NumericFormatSbyte>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatSbyte"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatSbyte(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatSbyte DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatSbyte left, in NumericFormatSbyte right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatSbyte left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatSbyte instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatSbyte From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatSbyte(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatSbyte IJsonElement<NumericFormatSbyte>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatSbyte: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatSbyte, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatSbyte instance) => new(JsonElement.From(instance));
