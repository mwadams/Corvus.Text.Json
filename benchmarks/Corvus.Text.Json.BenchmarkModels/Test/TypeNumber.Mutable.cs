...
public readonly partial struct TypeNumber
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypeNumber instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypeNumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypeNumber(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypeNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
