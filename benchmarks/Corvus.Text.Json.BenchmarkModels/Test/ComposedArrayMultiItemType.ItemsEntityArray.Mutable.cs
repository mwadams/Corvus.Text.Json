...
public readonly partial struct ComposedArrayMultiItemType
{
    ...
    public readonly partial struct ItemsEntityArray
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                value.AddAsItem(ref cvb);
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ComposedArrayMultiItemType.ItemsEntityArray.ItemsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
