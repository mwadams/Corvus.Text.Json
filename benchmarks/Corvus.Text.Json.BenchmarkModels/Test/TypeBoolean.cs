...
public readonly partial struct TypeBoolean
    : IJsonElement<TypeBoolean>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="TypeBoolean"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TypeBoolean(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TypeBoolean DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in TypeBoolean left, in TypeBoolean right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TypeBoolean left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TypeBoolean instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypeBoolean From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TypeBoolean(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TypeBoolean IJsonElement<TypeBoolean>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TypeBoolean: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<TypeBoolean, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TypeBoolean instance) => new(JsonElement.From(instance));
