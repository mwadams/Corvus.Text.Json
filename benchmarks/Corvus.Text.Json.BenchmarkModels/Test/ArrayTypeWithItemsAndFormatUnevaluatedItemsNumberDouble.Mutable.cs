...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble(Mutable instance)
        {
        ...
        public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberDouble.UnevaluatedItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
