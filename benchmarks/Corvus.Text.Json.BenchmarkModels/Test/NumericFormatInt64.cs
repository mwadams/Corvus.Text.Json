...
public readonly partial struct NumericFormatInt64
    : IJsonElement<NumericFormatInt64>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatInt64"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatInt64(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatInt64 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatInt64 left, in NumericFormatInt64 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatInt64 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatInt64 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatInt64 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatInt64(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatInt64 IJsonElement<NumericFormatInt64>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatInt64: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatInt64, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatInt64 instance) => new(JsonElement.From(instance));
