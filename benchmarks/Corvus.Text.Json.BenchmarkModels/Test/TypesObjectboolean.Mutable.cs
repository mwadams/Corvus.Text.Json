...
public readonly partial struct TypesObjectboolean
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesObjectboolean instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesObjectboolean"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesObjectboolean(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesObjectboolean.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
