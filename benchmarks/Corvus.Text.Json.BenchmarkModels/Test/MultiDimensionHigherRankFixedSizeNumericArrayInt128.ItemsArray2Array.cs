...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayInt128
{
        ...
        : IJsonElement<ItemsArray2Array>
    {
        ...
        public Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.ItemsEntityArray this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.ItemsEntityArray>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.ItemsEntityArray> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt128.ItemsArray2Array.ItemsEntityArray>(_parent, _idx);
        }
