...
public readonly partial struct TypesArraynull
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesArraynull instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesArraynull"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesArraynull(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesArraynull.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
