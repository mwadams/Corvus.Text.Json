...
public readonly partial struct MultiDimensionFixedSizeNumericArrayDouble
    : IJsonElement<MultiDimensionFixedSizeNumericArrayDouble>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionFixedSizeNumericArrayDouble"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionFixedSizeNumericArrayDouble(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionFixedSizeNumericArrayDouble DefaultInstance { get; }
    ...
    public Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayDouble left, in MultiDimensionFixedSizeNumericArrayDouble right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayDouble left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionFixedSizeNumericArrayDouble instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionFixedSizeNumericArrayDouble From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionFixedSizeNumericArrayDouble(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionFixedSizeNumericArrayDouble IJsonElement<MultiDimensionFixedSizeNumericArrayDouble>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayDouble: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionFixedSizeNumericArrayDouble.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionFixedSizeNumericArrayDouble instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<double> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionFixedSizeNumericArrayDouble.ItemsEntityArray.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionFixedSizeNumericArrayDouble, Mutable>(this);
    }
}
