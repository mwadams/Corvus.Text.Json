...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArraySbyte
{
    ...
    public readonly partial struct ItemsArray2Array
    {
            ...
            : IJsonElement<ItemsEntityArray>
        {
            ...
            public Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray.ItemsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray.ItemsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_parent, _idx);
            }
