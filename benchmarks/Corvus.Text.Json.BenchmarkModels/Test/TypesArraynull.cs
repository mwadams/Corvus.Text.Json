...
public readonly partial struct TypesArraynull
    : IJsonElement<TypesArraynull>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="TypesArraynull"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TypesArraynull(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TypesArraynull DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in TypesArraynull left, in TypesArraynull right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TypesArraynull left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TypesArraynull instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypesArraynull From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TypesArraynull(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TypesArraynull IJsonElement<TypesArraynull>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TypesArraynull: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.TypesArraynull.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TypesArraynull instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<TypesArraynull, Mutable>(this);
    }
}
