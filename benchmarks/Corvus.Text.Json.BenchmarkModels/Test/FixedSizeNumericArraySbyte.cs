...
public readonly partial struct FixedSizeNumericArraySbyte
    : IJsonElement<FixedSizeNumericArraySbyte>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArraySbyte"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArraySbyte(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArraySbyte DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArraySbyte.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArraySbyte.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArraySbyte left, in FixedSizeNumericArraySbyte right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArraySbyte left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArraySbyte instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArraySbyte From<T>(in T instance)
...
#if NET
    static FixedSizeNumericArraySbyte IJsonElement<FixedSizeNumericArraySbyte>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArraySbyte: ValueKind = {ValueKind} : \"{ToString()}\"";
