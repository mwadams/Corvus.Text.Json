...
public readonly partial struct Person
{
    ...
    public readonly partial struct Year
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public static explicit operator Mutable(Year instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Year"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Year(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Year(value.ParentDocument, value.ParentDocumentIndex))) ||
