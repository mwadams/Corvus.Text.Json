                                                    ...
                                                    public readonly partial struct AnyOf0Entity
                                                    {
                                                        ...
                                                        public readonly partial struct EitherOrEntity
                                                        {
                                                                ...
                                                                : IMutableJsonElement<Mutable>
                                                            {
                                                                ...
                                                                public static explicit operator Mutable(EitherOrEntity instance)
                                                                {
                                                                ...
                                                                /// <returns>An immutable instance of a <see cref="EitherOrEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                                public static implicit operator EitherOrEntity(Mutable instance)
                                                                {
                                                                ...
                                                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                                                private string DebuggerDisplay => $"EitherOrEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
