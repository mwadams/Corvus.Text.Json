...
public readonly partial struct TypeArray
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypeArray instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypeArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypeArray(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypeArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
