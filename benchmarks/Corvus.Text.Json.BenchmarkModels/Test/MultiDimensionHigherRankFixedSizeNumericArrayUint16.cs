...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayUint16
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayUint16>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayUint16"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayUint16(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayUint16 DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayUint16 left, in MultiDimensionHigherRankFixedSizeNumericArrayUint16 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayUint16 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayUint16 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayUint16 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayUint16(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayUint16 IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayUint16>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayUint16: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        private readonly ReadOnlySpan<ushort> _ushortArray;
        ...
        private Source(ReadOnlySpan<ushort> value)
        {
            _ushortArray = value;
            _kind = Kind.UshortArray;
        }

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayUint16 instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Source FromArray(ReadOnlySpan<ushort> value)
        {
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.UshortArray:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _ushortArray!, escapeName, nameRequiresUnescaping);
                    break;
                default:
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.UshortArray:
                    valueBuilder.AddPropertyArrayValue(name, _ushortArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.UshortArray:
                    valueBuilder.AddItemArrayValue(_ushortArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public ref struct Builder
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int CreateTensor(ReadOnlySpan<ushort> tensor)
        {
        ...
        /// <returns>The number of items consumed.</returns>
        /// <exception cref="ArgumentException">The tensor did not contain the correct number of values for the array rank and dimension.</exception>
        internal int CreateTensor(ReadOnlySpan<ushort> tensor, bool createArray)
        {
            int index = 0;
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayUint16.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayUint16, Mutable>(this);
    }
}
