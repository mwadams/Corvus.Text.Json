...
public readonly partial struct MultiDimensionFixedSizeNumericArrayHalf
{
        ...
        : IJsonElement<ItemsEntityArray>
    {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayHalf.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
