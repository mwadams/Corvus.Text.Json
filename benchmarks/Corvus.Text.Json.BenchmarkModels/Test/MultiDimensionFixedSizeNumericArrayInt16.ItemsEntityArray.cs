...
public readonly partial struct MultiDimensionFixedSizeNumericArrayInt16
{
        ...
        : IJsonElement<ItemsEntityArray>
    {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayInt16.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayInt16.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt16.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt16.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
