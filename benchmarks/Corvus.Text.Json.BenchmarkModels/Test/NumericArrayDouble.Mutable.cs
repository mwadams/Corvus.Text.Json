...
public readonly partial struct NumericArrayDouble
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericArrayDouble instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericArrayDouble"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericArrayDouble(Mutable instance)
        {
        ...
        public Test.NumericArrayDouble.ItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.NumericArrayDouble.ItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.NumericArrayDouble.ItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.NumericArrayDouble.ItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NumericArrayDouble(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericArrayDouble.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.NumericArrayDouble.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.NumericArrayDouble.ItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.NumericArrayDouble.ItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.NumericArrayDouble.ItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
    ...
    public ref struct Source
    {
        ...
        public Source(Test.NumericArrayDouble.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(NumericArrayDouble instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.NumericArrayDouble.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<NumericArrayDouble, Mutable>(this);
    }
}
