...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberSbyte
{
        ...
        : IJsonElement<UnevaluatedItemsEntity>
    {
        ...
        public ref struct Source
        {
            ...
            private Source(sbyte value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.NumericSimpleType; }

            public static implicit operator Source(UnevaluatedItemsEntity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(sbyte value) => new (value);
