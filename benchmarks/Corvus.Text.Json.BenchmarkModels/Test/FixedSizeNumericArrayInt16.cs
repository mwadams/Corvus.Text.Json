...
public readonly partial struct FixedSizeNumericArrayInt16
    : IJsonElement<FixedSizeNumericArrayInt16>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArrayInt16"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArrayInt16(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArrayInt16 DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArrayInt16.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArrayInt16.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.FixedSizeNumericArrayInt16.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.FixedSizeNumericArrayInt16.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayInt16 left, in FixedSizeNumericArrayInt16 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayInt16 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArrayInt16 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArrayInt16 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new FixedSizeNumericArrayInt16(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static FixedSizeNumericArrayInt16 IJsonElement<FixedSizeNumericArrayInt16>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArrayInt16: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.FixedSizeNumericArrayInt16.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(FixedSizeNumericArrayInt16 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.FixedSizeNumericArrayInt16.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<FixedSizeNumericArrayInt16, Mutable>(this);
    }
}
