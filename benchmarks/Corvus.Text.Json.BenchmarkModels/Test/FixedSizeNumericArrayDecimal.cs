...
public readonly partial struct FixedSizeNumericArrayDecimal
    : IJsonElement<FixedSizeNumericArrayDecimal>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArrayDecimal"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArrayDecimal(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArrayDecimal DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArrayDecimal.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArrayDecimal.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.FixedSizeNumericArrayDecimal.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.FixedSizeNumericArrayDecimal.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayDecimal left, in FixedSizeNumericArrayDecimal right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayDecimal left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArrayDecimal instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArrayDecimal From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new FixedSizeNumericArrayDecimal(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static FixedSizeNumericArrayDecimal IJsonElement<FixedSizeNumericArrayDecimal>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArrayDecimal: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.FixedSizeNumericArrayDecimal.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(FixedSizeNumericArrayDecimal instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.FixedSizeNumericArrayDecimal.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<FixedSizeNumericArrayDecimal, Mutable>(this);
    }
}
