...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberUint32
{
        ...
        : IJsonElement<UnevaluatedItemsEntity>
    {
        ...
        public ref struct Source
        {
            ...
            private Source(uint value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.NumericSimpleType; }

            public static implicit operator Source(UnevaluatedItemsEntity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(uint value) => new (value);
