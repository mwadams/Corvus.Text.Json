...
public readonly partial struct StringFormatTime
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatTime instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatTime"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatTime(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatTime.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
