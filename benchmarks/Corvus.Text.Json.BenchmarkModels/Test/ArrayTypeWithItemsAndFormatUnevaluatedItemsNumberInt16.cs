...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16
    : IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.UnevaluatedItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.UnevaluatedItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.UnevaluatedItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.UnevaluatedItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 left, in ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 IJsonElement<ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16 instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Source FromArray(ReadOnlySpan<short> value) => new(value);
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16.UnevaluatedItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16, Mutable>(this);
    }
}
