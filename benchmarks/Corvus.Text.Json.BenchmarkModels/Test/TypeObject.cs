...
public readonly partial struct TypeObject
    : IJsonElement<TypeObject>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="TypeObject"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TypeObject(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TypeObject DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in TypeObject left, in TypeObject right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TypeObject left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TypeObject instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypeObject From<T>(in T instance)
...
#if NET
    static TypeObject IJsonElement<TypeObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TypeObject: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<TypeObject, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public Source(Test.TypeObject.Builder.Build value) { _objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TypeObject instance) => new(JsonElement.From(instance));
