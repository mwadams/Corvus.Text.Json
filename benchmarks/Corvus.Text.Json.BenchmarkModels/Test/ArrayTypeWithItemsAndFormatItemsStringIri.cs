...
public readonly partial struct ArrayTypeWithItemsAndFormatItemsStringIri
    : IJsonElement<ArrayTypeWithItemsAndFormatItemsStringIri>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatItemsStringIri"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatItemsStringIri(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatItemsStringIri DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatItemsStringIri.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatItemsStringIri.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsStringIri.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsStringIri.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsStringIri left, in ArrayTypeWithItemsAndFormatItemsStringIri right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsStringIri left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatItemsStringIri instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatItemsStringIri From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ArrayTypeWithItemsAndFormatItemsStringIri(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ArrayTypeWithItemsAndFormatItemsStringIri IJsonElement<ArrayTypeWithItemsAndFormatItemsStringIri>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatItemsStringIri: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.ArrayTypeWithItemsAndFormatItemsStringIri.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ArrayTypeWithItemsAndFormatItemsStringIri instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.ArrayTypeWithItemsAndFormatItemsStringIri.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<ArrayTypeWithItemsAndFormatItemsStringIri, Mutable>(this);
    }
}
