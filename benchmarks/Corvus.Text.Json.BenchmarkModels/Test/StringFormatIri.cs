...
public readonly partial struct StringFormatIri
    : IJsonElement<StringFormatIri>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatIri"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatIri(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatIri DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatIri left, in StringFormatIri right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatIri left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatIri instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatIri From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatIri(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatIri IJsonElement<StringFormatIri>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatIri: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatIri, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatIri instance) => new(JsonElement.From(instance));
