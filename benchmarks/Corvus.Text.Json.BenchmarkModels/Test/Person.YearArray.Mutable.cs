...
public readonly partial struct Person
{
    ...
    public readonly partial struct YearArray
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public static explicit operator Mutable(YearArray instance)
            {
            ...
            /// <returns>An instance of JsonElement, initialized from the <see cref="IJsonElement{T}"/>.</returns>                
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator YearArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"YearArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
