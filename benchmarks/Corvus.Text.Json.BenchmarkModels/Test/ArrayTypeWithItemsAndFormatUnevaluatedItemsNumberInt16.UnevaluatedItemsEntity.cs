...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt16
{
        ...
        : IJsonElement<UnevaluatedItemsEntity>
    {
        ...
        public ref struct Source
        {
            ...
            private Source(short value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => Utf8Formatter.TryFormat(v, buffer, out written)); _kind = Kind.NumericSimpleType; }

            public static implicit operator Source(UnevaluatedItemsEntity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(short value) => new (value);
