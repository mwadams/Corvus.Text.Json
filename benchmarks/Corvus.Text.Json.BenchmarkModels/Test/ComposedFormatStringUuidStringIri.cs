...
public readonly partial struct ComposedFormatStringUuidStringIri
    : IJsonElement<ComposedFormatStringUuidStringIri>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ComposedFormatStringUuidStringIri"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ComposedFormatStringUuidStringIri(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ComposedFormatStringUuidStringIri DefaultInstance { get; }
    ...
    /// <summary>
    /// Conversion to <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf0Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Test.ComposedFormatStringUuidStringIri.AnyOf0Entity(ComposedFormatStringUuidStringIri value)
    {
        return Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf0Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ComposedFormatStringUuidStringIri(Test.ComposedFormatStringUuidStringIri.AnyOf0Entity value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion to <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf1Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Test.ComposedFormatStringUuidStringIri.AnyOf1Entity(ComposedFormatStringUuidStringIri value)
    {
        return Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf1Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ComposedFormatStringUuidStringIri(Test.ComposedFormatStringUuidStringIri.AnyOf1Entity value)
    {
        return From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in ComposedFormatStringUuidStringIri left, in ComposedFormatStringUuidStringIri right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ComposedFormatStringUuidStringIri left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ComposedFormatStringUuidStringIri instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ComposedFormatStringUuidStringIri From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ComposedFormatStringUuidStringIri(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ComposedFormatStringUuidStringIri IJsonElement<ComposedFormatStringUuidStringIri>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ComposedFormatStringUuidStringIri: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public bool TryGetAsAnyOf0Entity(out Test.ComposedFormatStringUuidStringIri.AnyOf0Entity result)
    {
        if (Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.From(this);
            return true;
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf1Entity" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsAnyOf1Entity(out Test.ComposedFormatStringUuidStringIri.AnyOf1Entity result)
    {
        if (Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.From(this);
            return true;
        }
    ...
    /// <param name="matchAnyOf0Entity">Match a <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf0Entity"/>.</param>
    /// <param name="matchAnyOf1Entity">Match a <see cref="Test.ComposedFormatStringUuidStringIri.AnyOf1Entity"/>.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Matcher<Test.ComposedFormatStringUuidStringIri.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
        Matcher<Test.ComposedFormatStringUuidStringIri.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
        Matcher<Test.ComposedFormatStringUuidStringIri, TContext, TResult> defaultMatch)
    {
        if (Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.From(this), context);
        }

        if (Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        Matcher<Test.ComposedFormatStringUuidStringIri.AnyOf0Entity, TResult> matchAnyOf0Entity,
        Matcher<Test.ComposedFormatStringUuidStringIri.AnyOf1Entity, TResult> matchAnyOf1Entity,
        Matcher<Test.ComposedFormatStringUuidStringIri, TResult> defaultMatch)
    {
        if (Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Test.ComposedFormatStringUuidStringIri.AnyOf0Entity.From(this));
        }

        if (Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Test.ComposedFormatStringUuidStringIri.AnyOf1Entity.From(this));
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(ComposedFormatStringUuidStringIri instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Test.ComposedFormatStringUuidStringIri.AnyOf0Entity instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Uri value) => new (value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Test.ComposedFormatStringUuidStringIri.AnyOf1Entity instance) => new(JsonElement.From(instance));
