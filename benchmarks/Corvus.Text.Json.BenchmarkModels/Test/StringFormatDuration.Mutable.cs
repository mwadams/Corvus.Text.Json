...
public readonly partial struct StringFormatDuration
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatDuration instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatDuration"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatDuration(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatDuration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
