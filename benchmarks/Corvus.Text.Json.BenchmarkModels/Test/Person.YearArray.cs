...
public readonly partial struct Person
{
    ...
    public readonly partial struct YearArray
        : IJsonElement<YearArray>
    {
        private readonly IJsonDocument _parent;
        private readonly int _idx;

        /// <summary>
        /// Initializes a new instance of the <see cref="YearArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal YearArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static YearArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in YearArray left, in YearArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in YearArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(YearArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static YearArray From<T>(in T instance)
        ...
        {
            return
                (obj is IJsonElement value && Equals(new YearArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static YearArray IJsonElement<YearArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"YearArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            return workspace.CreateDocumentBuilder<YearArray, Mutable>(this);
        }
        ...
        public ref struct Source
        {
            ...
            public Source(Test.Person.YearArray.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(YearArray instance) => new(JsonElement.From(instance));
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void Add(in Test.Person.Year.Source value)
            {
