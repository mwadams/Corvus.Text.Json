...
public readonly partial struct StringFormatIpv6
    : IJsonElement<StringFormatIpv6>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatIpv6"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatIpv6(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatIpv6 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatIpv6 left, in StringFormatIpv6 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatIpv6 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatIpv6 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatIpv6 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatIpv6(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatIpv6 IJsonElement<StringFormatIpv6>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatIpv6: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatIpv6 instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatIpv6, Mutable>(this);
    }
}
