...
public readonly partial struct NumericFormatDecimal
    : IJsonElement<NumericFormatDecimal>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatDecimal"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatDecimal(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatDecimal DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatDecimal left, in NumericFormatDecimal right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatDecimal left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatDecimal instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatDecimal From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatDecimal(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatDecimal IJsonElement<NumericFormatDecimal>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatDecimal: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatDecimal instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatDecimal, Mutable>(this);
    }
}
