...
public readonly partial struct StringFormatUriReference
    : IJsonElement<StringFormatUriReference>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatUriReference"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatUriReference(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatUriReference DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatUriReference left, in StringFormatUriReference right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatUriReference left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatUriReference instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatUriReference From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatUriReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatUriReference IJsonElement<StringFormatUriReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatUriReference: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatUriReference, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatUriReference instance) => new(JsonElement.From(instance));
