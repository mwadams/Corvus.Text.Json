...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayDecimal
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayDecimal>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayDecimal"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayDecimal(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayDecimal DefaultInstance { get; }
    ...
    /// </remarks>
    public static int ValueBufferSize => 30;
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayDecimal left, in MultiDimensionHigherRankFixedSizeNumericArrayDecimal right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayDecimal left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayDecimal instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayDecimal From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayDecimal(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayDecimal IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayDecimal>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayDecimal: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        private readonly ReadOnlySpan<decimal> _decimalArray;
        ...
        private Source(ReadOnlySpan<decimal> value)
        {
            _decimalArray = value;
            _kind = Kind.DecimalArray;
        }

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayDecimal instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Source FromArray(ReadOnlySpan<decimal> value)
        {
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.DecimalArray:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _decimalArray!, escapeName, nameRequiresUnescaping);
                    break;
                default:
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.DecimalArray:
                    valueBuilder.AddPropertyArrayValue(name, _decimalArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.DecimalArray:
                    valueBuilder.AddItemArrayValue(_decimalArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public ref struct Builder
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int CreateTensor(ReadOnlySpan<decimal> tensor)
        {
        ...
        /// <returns>The number of items consumed.</returns>
        /// <exception cref="ArgumentException">The tensor did not contain the correct number of values for the array rank and dimension.</exception>
        internal int CreateTensor(ReadOnlySpan<decimal> tensor, bool createArray)
        {
            int index = 0;
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayDecimal, Mutable>(this);
    }
}
