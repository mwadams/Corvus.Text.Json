...
public readonly partial struct NumericFormatDouble
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatDouble instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatDouble"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatDouble(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatDouble.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
