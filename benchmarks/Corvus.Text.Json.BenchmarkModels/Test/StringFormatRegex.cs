...
public readonly partial struct StringFormatRegex
    : IJsonElement<StringFormatRegex>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatRegex"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatRegex(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatRegex DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatRegex left, in StringFormatRegex right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatRegex left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatRegex instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatRegex From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatRegex(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatRegex IJsonElement<StringFormatRegex>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatRegex: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatRegex instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatRegex, Mutable>(this);
    }
}
