...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayHalf
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayHalf>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayHalf"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayHalf(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayHalf DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayHalf left, in MultiDimensionHigherRankFixedSizeNumericArrayHalf right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayHalf left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayHalf instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayHalf From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayHalf(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayHalf IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayHalf>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayHalf: ValueKind = {ValueKind} : \"{ToString()}\"";
...
#if NET
        private readonly ReadOnlySpan<Half> _HalfArray;
#endif
...
#if NET
        private Source(ReadOnlySpan<Half> value)
        {
            _HalfArray = value;
            _kind = Kind.HalfArray;
        }
#endif

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayHalf instance) => new(JsonElement.From(instance));

#if NET
        public static Source FromArray(ReadOnlySpan<Half> value)
        {
...
#if NET
                case Kind.HalfArray:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _HalfArray!, escapeName, nameRequiresUnescaping);
                    break;
#endif
                default:
...
#if NET
                case Kind.HalfArray:
                    valueBuilder.AddPropertyArrayValue(name, _HalfArray!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
...
#if NET
                case Kind.HalfArray:
                    valueBuilder.AddItemArrayValue(_HalfArray!);
                    break;
#endif
                default:
                    Debug.Fail("Unexpected Kind");
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<Half> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayHalf, Mutable>(this);
    }
}
