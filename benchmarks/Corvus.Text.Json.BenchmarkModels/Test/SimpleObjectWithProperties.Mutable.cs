...
public readonly partial struct SimpleObjectWithProperties
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(SimpleObjectWithProperties instance)
        {
        ...
        /// </summary>
        public Test.SimpleObjectWithProperties.NameEntity.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Test.SimpleObjectWithProperties.NameEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Test.SimpleObjectWithProperties.OtherNameEntity.Mutable OtherName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNameUtf8, out Test.SimpleObjectWithProperties.OtherNameEntity.Mutable value))
                {
                    return value;
                }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SimpleObjectWithProperties.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
