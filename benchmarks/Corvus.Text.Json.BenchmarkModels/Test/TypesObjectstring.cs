    ...
    : IJsonElement<TypesObjectstring>
{
    ...
    {
        return workspace.CreateDocumentBuilder<TypesObjectstring, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public Source(Test.TypesObjectstring.Builder.Build value) { _objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TypesObjectstring instance) => new(JsonElement.From(instance));
