...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArraySbyte
{
        ...
        : IJsonElement<ItemsArray2Array>
    {
        ...
        public Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySbyte.ItemsArray2Array.ItemsEntityArray>(_parent, _idx);
        }
