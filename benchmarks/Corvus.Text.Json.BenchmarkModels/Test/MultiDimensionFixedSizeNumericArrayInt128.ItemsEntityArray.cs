...
public readonly partial struct MultiDimensionFixedSizeNumericArrayInt128
{
        ...
        : IJsonElement<ItemsEntityArray>
    {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayInt128.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayInt128.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt128.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt128.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
