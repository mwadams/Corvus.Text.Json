...
public readonly partial struct TypesObjectstring
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesObjectstring instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesObjectstring"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesObjectstring(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesObjectstring.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
