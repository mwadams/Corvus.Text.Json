...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayByte
{
        ...
        : IJsonElement<ItemsArray2Array>
    {
        ...
        public Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayByte.ItemsArray2Array.ItemsEntityArray>(_parent, _idx);
        }
