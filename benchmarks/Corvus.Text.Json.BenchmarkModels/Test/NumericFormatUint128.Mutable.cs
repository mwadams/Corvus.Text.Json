...
public readonly partial struct NumericFormatUint128
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatUint128 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatUint128"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatUint128(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatUint128.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
