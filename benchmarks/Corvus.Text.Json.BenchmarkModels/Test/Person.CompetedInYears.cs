...
public readonly partial struct Person
{
        ...
        : IJsonElement<CompetedInYears>
    {
        ...
        public Test.Person.Year this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.Person.Year>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.Person.Year> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.Person.Year>(_parent, _idx);
        }
