...
public readonly partial struct Person
{
        ...
        : IJsonElement<NameComponentArray>
    {
        ...
        public Test.Person.NameComponent this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.Person.NameComponent>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.Person.NameComponent> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.Person.NameComponent>(_parent, _idx);
        }
