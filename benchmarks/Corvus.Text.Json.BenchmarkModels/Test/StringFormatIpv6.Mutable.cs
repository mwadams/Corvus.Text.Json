...
public readonly partial struct StringFormatIpv6
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatIpv6 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatIpv6"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatIpv6(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatIpv6.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
