...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayDecimal
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(MultiDimensionHigherRankFixedSizeNumericArrayDecimal instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MultiDimensionHigherRankFixedSizeNumericArrayDecimal"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MultiDimensionHigherRankFixedSizeNumericArrayDecimal(Mutable instance)
        {
        ...
        public Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayDecimal.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionHigherRankFixedSizeNumericArrayDecimal.ItemsArray2Array>(this, predicate);
            _documentVersion = _parent.Version;
        }
