...
public readonly partial struct ComposedArrayMultiItemType
{
    ...
    public readonly partial struct OneOf1EItemArray
        : IJsonElement<OneOf1EItemArray>
    {
        private readonly IJsonDocument _parent;
        private readonly int _idx;

        /// <summary>
        /// Initializes a new instance of the <see cref="OneOf1EItemArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OneOf1EItemArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OneOf1EItemArray DefaultInstance { get; }
        ...
        public Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in OneOf1EItemArray left, in OneOf1EItemArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OneOf1EItemArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OneOf1EItemArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OneOf1EItemArray From<T>(in T instance)
...
#if NET
        static OneOf1EItemArray IJsonElement<OneOf1EItemArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OneOf1EItemArray: ValueKind = {ValueKind} : \"{ToString()}\"";
