...
public readonly partial struct ComplexComposedObjectWithProperties
{
    ...
    public readonly partial struct AnyOf0Entity
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            /// <summary>
            /// Gets the (optional) <c>eitherOr</c> property.
            /// </summary>
            public Test.ComplexComposedObjectWithProperties.AnyOf0Entity.EitherOrEntity.Mutable EitherOr
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EitherOrUtf8, out Test.ComplexComposedObjectWithProperties.AnyOf0Entity.EitherOrEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the eitherOr property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEitherOr(in Source value)
            {
                CheckValidInstance();

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EitherOrUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.EitherOr, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        public ref struct Source
        {
            ...
            public Source(Test.ComplexComposedObjectWithProperties.AnyOf0Entity.Builder.Build value) { _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Test.ComplexComposedObjectWithProperties.AnyOf0Entity.EitherOrEntity.Source eitherOr = default)
            {
                eitherOr.AddAsProperty(JsonPropertyNamesEscaped.EitherOr, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="AnyOf0Entity"/>.
            /// </summary>
            public void Create(in Test.ComplexComposedObjectWithProperties.AnyOf0Entity.EitherOrEntity.Source eitherOr = default)
            {
                Create(ref _builder, eitherOr);
            }
        ...
        {
            return workspace.CreateDocumentBuilder<AnyOf0Entity, Mutable>(this);
        }
    }
}
