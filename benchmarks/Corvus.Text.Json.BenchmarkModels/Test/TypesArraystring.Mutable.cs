...
public readonly partial struct TypesArraystring
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesArraystring instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesArraystring"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesArraystring(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesArraystring.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
