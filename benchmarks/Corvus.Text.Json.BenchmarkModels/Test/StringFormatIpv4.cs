...
public readonly partial struct StringFormatIpv4
    : IJsonElement<StringFormatIpv4>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatIpv4"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatIpv4(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatIpv4 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatIpv4 left, in StringFormatIpv4 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatIpv4 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatIpv4 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatIpv4 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatIpv4(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatIpv4 IJsonElement<StringFormatIpv4>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatIpv4: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatIpv4 instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatIpv4, Mutable>(this);
    }
}
