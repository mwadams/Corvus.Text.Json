...
public readonly partial struct StringFormatUriReference
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatUriReference instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatUriReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatUriReference(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatUriReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
