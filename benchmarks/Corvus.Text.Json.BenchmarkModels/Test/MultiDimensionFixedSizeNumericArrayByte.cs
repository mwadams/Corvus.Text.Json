...
public readonly partial struct MultiDimensionFixedSizeNumericArrayByte
    : IJsonElement<MultiDimensionFixedSizeNumericArrayByte>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionFixedSizeNumericArrayByte"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionFixedSizeNumericArrayByte(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionFixedSizeNumericArrayByte DefaultInstance { get; }
    ...
    public Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayByte left, in MultiDimensionFixedSizeNumericArrayByte right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayByte left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionFixedSizeNumericArrayByte instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionFixedSizeNumericArrayByte From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionFixedSizeNumericArrayByte(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionFixedSizeNumericArrayByte IJsonElement<MultiDimensionFixedSizeNumericArrayByte>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayByte: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionFixedSizeNumericArrayByte.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionFixedSizeNumericArrayByte instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<byte> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionFixedSizeNumericArrayByte, Mutable>(this);
    }
}
