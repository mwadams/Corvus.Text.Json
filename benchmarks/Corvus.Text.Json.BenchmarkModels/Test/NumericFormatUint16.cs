...
public readonly partial struct NumericFormatUint16
    : IJsonElement<NumericFormatUint16>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatUint16"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatUint16(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatUint16 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatUint16 left, in NumericFormatUint16 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatUint16 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatUint16 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatUint16 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatUint16(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatUint16 IJsonElement<NumericFormatUint16>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatUint16: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatUint16 instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatUint16, Mutable>(this);
    }
}
