...
public readonly partial struct NumericFormatDouble
    : IJsonElement<NumericFormatDouble>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatDouble"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatDouble(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatDouble DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatDouble left, in NumericFormatDouble right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatDouble left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatDouble instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatDouble From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatDouble(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatDouble IJsonElement<NumericFormatDouble>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatDouble: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatDouble instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatDouble, Mutable>(this);
    }
}
