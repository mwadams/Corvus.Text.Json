...
public readonly partial struct NumericFormatUint64
    : IJsonElement<NumericFormatUint64>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatUint64"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatUint64(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatUint64 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatUint64 left, in NumericFormatUint64 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatUint64 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatUint64 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatUint64 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatUint64(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatUint64 IJsonElement<NumericFormatUint64>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatUint64: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatUint64 instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatUint64, Mutable>(this);
    }
}
