...
public readonly partial struct ComplexComposedObjectWithProperties
{
    ...
    public readonly partial struct AnyOf1Entity
    {
        ...
        public readonly partial struct WholeNumberEntity
            : IJsonElement<WholeNumberEntity>
        {
            private readonly IJsonDocument _parent;
            private readonly int _idx;

            /// <summary>
            /// Initializes a new instance of the <see cref="WholeNumberEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WholeNumberEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WholeNumberEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in WholeNumberEntity left, in WholeNumberEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WholeNumberEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(WholeNumberEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WholeNumberEntity From<T>(in T instance)
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WholeNumberEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WholeNumberEntity IJsonElement<WholeNumberEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WholeNumberEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WholeNumberEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateDocumentBuilder<WholeNumberEntity, Mutable>(this);
            }
        }
    }
}
