...
public readonly partial struct MultiDimensionFixedSizeNumericArrayUint64
    : IJsonElement<MultiDimensionFixedSizeNumericArrayUint64>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionFixedSizeNumericArrayUint64"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionFixedSizeNumericArrayUint64(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionFixedSizeNumericArrayUint64 DefaultInstance { get; }
    ...
    public Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint64 left, in MultiDimensionFixedSizeNumericArrayUint64 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint64 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionFixedSizeNumericArrayUint64 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionFixedSizeNumericArrayUint64 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionFixedSizeNumericArrayUint64(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionFixedSizeNumericArrayUint64 IJsonElement<MultiDimensionFixedSizeNumericArrayUint64>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayUint64: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionFixedSizeNumericArrayUint64.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionFixedSizeNumericArrayUint64 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<ulong> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionFixedSizeNumericArrayUint64.ItemsEntityArray.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionFixedSizeNumericArrayUint64, Mutable>(this);
    }
}
