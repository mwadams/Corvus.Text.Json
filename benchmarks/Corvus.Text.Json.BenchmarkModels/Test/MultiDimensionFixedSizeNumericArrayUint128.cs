...
public readonly partial struct MultiDimensionFixedSizeNumericArrayUint128
    : IJsonElement<MultiDimensionFixedSizeNumericArrayUint128>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionFixedSizeNumericArrayUint128"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionFixedSizeNumericArrayUint128(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionFixedSizeNumericArrayUint128 DefaultInstance { get; }
    ...
    public Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint128 left, in MultiDimensionFixedSizeNumericArrayUint128 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionFixedSizeNumericArrayUint128 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionFixedSizeNumericArrayUint128 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionFixedSizeNumericArrayUint128 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionFixedSizeNumericArrayUint128(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionFixedSizeNumericArrayUint128 IJsonElement<MultiDimensionFixedSizeNumericArrayUint128>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayUint128: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionFixedSizeNumericArrayUint128.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionFixedSizeNumericArrayUint128 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<UInt128> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionFixedSizeNumericArrayUint128.ItemsEntityArray.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionFixedSizeNumericArrayUint128, Mutable>(this);
    }
}
