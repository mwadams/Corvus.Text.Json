...
public readonly partial struct StringFormatRegex
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatRegex instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatRegex"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatRegex(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatRegex.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
