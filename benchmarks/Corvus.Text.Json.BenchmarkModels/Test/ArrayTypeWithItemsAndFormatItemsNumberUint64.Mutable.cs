...
public readonly partial struct ArrayTypeWithItemsAndFormatItemsNumberUint64
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(ArrayTypeWithItemsAndFormatItemsNumberUint64 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ArrayTypeWithItemsAndFormatItemsNumberUint64"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayTypeWithItemsAndFormatItemsNumberUint64(Mutable instance)
        {
        ...
        public Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatItemsNumberUint64.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ArrayTypeWithItemsAndFormatItemsNumberUint64.ItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
