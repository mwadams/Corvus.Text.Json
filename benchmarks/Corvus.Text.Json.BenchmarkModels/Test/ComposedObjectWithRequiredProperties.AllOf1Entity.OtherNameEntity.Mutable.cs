    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public readonly partial struct OtherNameEntity
        {
                ...
                : IMutableJsonElement<Mutable>
            {
                ...
                public static explicit operator Mutable(OtherNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OtherNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OtherNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OtherNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
