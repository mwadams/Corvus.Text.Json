...
public readonly partial struct StringFormatUuid
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatUuid instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatUuid"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatUuid(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatUuid.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
