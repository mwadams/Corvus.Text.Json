...
public readonly partial struct NumericFormatInt128
    : IJsonElement<NumericFormatInt128>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatInt128"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatInt128(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatInt128 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatInt128 left, in NumericFormatInt128 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatInt128 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatInt128 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatInt128 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatInt128(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatInt128 IJsonElement<NumericFormatInt128>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatInt128: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatInt128, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatInt128 instance) => new(JsonElement.From(instance));
