...
public readonly partial struct NumericArrayUint64
    : IJsonElement<NumericArrayUint64>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericArrayUint64"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericArrayUint64(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericArrayUint64 DefaultInstance { get; }
    ...
    public Test.NumericArrayUint64.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.NumericArrayUint64.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in NumericArrayUint64 left, in NumericArrayUint64 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericArrayUint64 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericArrayUint64 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericArrayUint64 From<T>(in T instance)
...
#if NET
    static NumericArrayUint64 IJsonElement<NumericArrayUint64>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericArrayUint64: ValueKind = {ValueKind} : \"{ToString()}\"";
