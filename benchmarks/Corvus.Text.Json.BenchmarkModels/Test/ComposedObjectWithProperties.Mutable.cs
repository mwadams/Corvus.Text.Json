...
public readonly partial struct ComposedObjectWithProperties
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        /// </summary>
        public Test.ComposedObjectWithProperties.AllOf0Entity.NameEntity.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Test.ComposedObjectWithProperties.AllOf0Entity.NameEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Test.ComposedObjectWithProperties.AllOf1Entity.OtherNameEntity.Mutable OtherName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNameUtf8, out Test.ComposedObjectWithProperties.AllOf1Entity.OtherNameEntity.Mutable value))
                {
                    return value;
                }
