...
public readonly partial struct TypeNull
    : IJsonElement<TypeNull>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="TypeNull"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TypeNull(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TypeNull DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in TypeNull left, in TypeNull right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TypeNull left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TypeNull instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypeNull From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TypeNull(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TypeNull IJsonElement<TypeNull>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TypeNull: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<TypeNull, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TypeNull instance) => new(JsonElement.From(instance));
