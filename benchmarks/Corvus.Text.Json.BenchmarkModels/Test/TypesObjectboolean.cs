...
public readonly partial struct TypesObjectboolean
    : IJsonElement<TypesObjectboolean>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="TypesObjectboolean"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TypesObjectboolean(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TypesObjectboolean DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in TypesObjectboolean left, in TypesObjectboolean right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TypesObjectboolean left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TypesObjectboolean instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TypesObjectboolean From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TypesObjectboolean(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TypesObjectboolean IJsonElement<TypesObjectboolean>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TypesObjectboolean: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.TypesObjectboolean.Builder.Build value) { _objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TypesObjectboolean instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<TypesObjectboolean, Mutable>(this);
    }
}
