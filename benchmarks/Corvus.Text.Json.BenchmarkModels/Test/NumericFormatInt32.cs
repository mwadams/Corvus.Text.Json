...
public readonly partial struct NumericFormatInt32
    : IJsonElement<NumericFormatInt32>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="NumericFormatInt32"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal NumericFormatInt32(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static NumericFormatInt32 DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in NumericFormatInt32 left, in NumericFormatInt32 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in NumericFormatInt32 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(NumericFormatInt32 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static NumericFormatInt32 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new NumericFormatInt32(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static NumericFormatInt32 IJsonElement<NumericFormatInt32>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"NumericFormatInt32: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        return workspace.CreateDocumentBuilder<NumericFormatInt32, Mutable>(this);
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(NumericFormatInt32 instance) => new(JsonElement.From(instance));
