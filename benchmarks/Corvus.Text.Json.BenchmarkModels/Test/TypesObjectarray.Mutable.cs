...
public readonly partial struct TypesObjectarray
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesObjectarray instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesObjectarray"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesObjectarray(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesObjectarray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
