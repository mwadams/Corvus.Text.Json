...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayInt16
{
    ...
    public readonly partial struct ItemsArray2Array
    {
            ...
            : IJsonElement<ItemsEntityArray>
        {
            ...
            public Test.MultiDimensionHigherRankFixedSizeNumericArrayInt16.ItemsArray2Array.ItemsEntityArray.ItemsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt16.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt16.ItemsArray2Array.ItemsEntityArray.ItemsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt16.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_parent, _idx);
            }
