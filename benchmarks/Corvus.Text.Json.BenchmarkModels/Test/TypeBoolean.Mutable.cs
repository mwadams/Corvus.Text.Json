...
public readonly partial struct TypeBoolean
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypeBoolean instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypeBoolean"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypeBoolean(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypeBoolean.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
