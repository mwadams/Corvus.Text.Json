...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArraySingle
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArraySingle>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArraySingle"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArraySingle(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArraySingle DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArraySingle left, in MultiDimensionHigherRankFixedSizeNumericArraySingle right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArraySingle left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArraySingle instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArraySingle From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArraySingle(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArraySingle IJsonElement<MultiDimensionHigherRankFixedSizeNumericArraySingle>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArraySingle: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        private readonly ReadOnlySpan<float> _floatArray;
        ...
        private Source(ReadOnlySpan<float> value)
        {
            _floatArray = value;
            _kind = Kind.FloatArray;
        }

        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArraySingle instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Source FromArray(ReadOnlySpan<float> value)
        {
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.FloatArray:
                    valueBuilder.AddPropertyArrayValue(utf8Name, _floatArray!, escapeName, nameRequiresUnescaping);
                    break;
                default:
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.FloatArray:
                    valueBuilder.AddPropertyArrayValue(name, _floatArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Builder:
                    ...
                    break;
                case Kind.FloatArray:
                    valueBuilder.AddItemArrayValue(_floatArray!);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public ref struct Builder
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int CreateTensor(ReadOnlySpan<float> tensor)
        {
        ...
        /// <returns>The number of items consumed.</returns>
        /// <exception cref="ArgumentException">The tensor did not contain the correct number of values for the array rank and dimension.</exception>
        internal int CreateTensor(ReadOnlySpan<float> tensor, bool createArray)
        {
            int index = 0;
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArraySingle.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArraySingle, Mutable>(this);
    }
}
