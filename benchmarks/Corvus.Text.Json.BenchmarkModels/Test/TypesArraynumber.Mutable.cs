...
public readonly partial struct TypesArraynumber
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(TypesArraynumber instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TypesArraynumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TypesArraynumber(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TypesArraynumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
