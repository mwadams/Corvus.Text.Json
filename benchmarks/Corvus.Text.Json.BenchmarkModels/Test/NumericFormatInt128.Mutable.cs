...
public readonly partial struct NumericFormatInt128
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatInt128 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatInt128"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatInt128(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatInt128.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
