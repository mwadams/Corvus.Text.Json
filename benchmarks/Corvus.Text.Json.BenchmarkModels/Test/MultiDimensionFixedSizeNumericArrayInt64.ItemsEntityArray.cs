...
public readonly partial struct MultiDimensionFixedSizeNumericArrayInt64
{
        ...
        : IJsonElement<ItemsEntityArray>
    {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayInt64.ItemsEntityArray.ItemsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayInt64.ItemsEntityArray.ItemsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt64.ItemsEntityArray.ItemsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayInt64.ItemsEntityArray.ItemsEntity>(_parent, _idx);
        }
