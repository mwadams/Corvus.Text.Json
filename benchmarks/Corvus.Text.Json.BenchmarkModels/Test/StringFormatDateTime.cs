...
public readonly partial struct StringFormatDateTime
    : IJsonElement<StringFormatDateTime>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatDateTime"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatDateTime(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatDateTime DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatDateTime left, in StringFormatDateTime right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatDateTime left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatDateTime instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatDateTime From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatDateTime(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatDateTime IJsonElement<StringFormatDateTime>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatDateTime: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatDateTime instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatDateTime, Mutable>(this);
    }
}
