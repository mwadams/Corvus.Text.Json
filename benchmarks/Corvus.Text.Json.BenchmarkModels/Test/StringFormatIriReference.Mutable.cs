...
public readonly partial struct StringFormatIriReference
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatIriReference instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatIriReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatIriReference(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatIriReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
