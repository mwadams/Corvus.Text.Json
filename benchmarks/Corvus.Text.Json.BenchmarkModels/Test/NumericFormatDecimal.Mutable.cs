...
public readonly partial struct NumericFormatDecimal
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatDecimal instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatDecimal"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatDecimal(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatDecimal.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
