...
public readonly partial struct StringFormatUri
    : IJsonElement<StringFormatUri>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatUri"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatUri(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatUri DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatUri left, in StringFormatUri right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatUri left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatUri instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatUri From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatUri(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatUri IJsonElement<StringFormatUri>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatUri: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatUri instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatUri, Mutable>(this);
    }
}
