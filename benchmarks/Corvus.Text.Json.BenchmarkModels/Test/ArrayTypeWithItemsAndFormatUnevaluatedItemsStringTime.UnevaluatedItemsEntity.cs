...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsStringTime
{
    ...
    public readonly partial struct UnevaluatedItemsEntity
        : IJsonElement<UnevaluatedItemsEntity>
    {
        ...
        internal UnevaluatedItemsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static UnevaluatedItemsEntity DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in UnevaluatedItemsEntity left, in UnevaluatedItemsEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in UnevaluatedItemsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(UnevaluatedItemsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnevaluatedItemsEntity From<T>(in T instance)
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UnevaluatedItemsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static UnevaluatedItemsEntity IJsonElement<UnevaluatedItemsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UnevaluatedItemsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            return workspace.CreateDocumentBuilder<UnevaluatedItemsEntity, Mutable>(this);
        }
        ...
        public ref struct Source
        {
            ...
            private Source(NodaTime.OffsetTime value) { SimpleTypesBacking.Initialize(ref _simpleTypeBacking, value, static (v, buffer, out written) => JsonElementHelpers.TryFormatOffsetTime(v, buffer, out written)); _kind = Kind.StringSimpleType; }

            public static implicit operator Source(UnevaluatedItemsEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(NodaTime.OffsetTime value) => new (value);
