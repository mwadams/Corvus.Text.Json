...
public readonly partial struct StringFormatUri
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatUri instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatUri"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatUri(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatUri.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
