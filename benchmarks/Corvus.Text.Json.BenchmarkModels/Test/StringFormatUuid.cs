...
public readonly partial struct StringFormatUuid
    : IJsonElement<StringFormatUuid>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatUuid"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatUuid(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatUuid DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatUuid left, in StringFormatUuid right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatUuid left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatUuid instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatUuid From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatUuid(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatUuid IJsonElement<StringFormatUuid>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatUuid: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatUuid instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatUuid, Mutable>(this);
    }
}
