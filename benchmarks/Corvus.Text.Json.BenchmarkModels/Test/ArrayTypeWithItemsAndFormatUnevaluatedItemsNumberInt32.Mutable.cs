...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32(Mutable instance)
        {
        ...
        public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberInt32.UnevaluatedItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
