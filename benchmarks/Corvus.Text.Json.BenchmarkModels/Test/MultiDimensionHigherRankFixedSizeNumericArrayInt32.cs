...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayInt32
    : IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayInt32>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="MultiDimensionHigherRankFixedSizeNumericArrayInt32"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MultiDimensionHigherRankFixedSizeNumericArrayInt32(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MultiDimensionHigherRankFixedSizeNumericArrayInt32 DefaultInstance { get; }
    ...
    public Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayInt32 left, in MultiDimensionHigherRankFixedSizeNumericArrayInt32 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MultiDimensionHigherRankFixedSizeNumericArrayInt32 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MultiDimensionHigherRankFixedSizeNumericArrayInt32 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MultiDimensionHigherRankFixedSizeNumericArrayInt32 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MultiDimensionHigherRankFixedSizeNumericArrayInt32(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MultiDimensionHigherRankFixedSizeNumericArrayInt32 IJsonElement<MultiDimensionHigherRankFixedSizeNumericArrayInt32>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MultiDimensionHigherRankFixedSizeNumericArrayInt32: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MultiDimensionHigherRankFixedSizeNumericArrayInt32 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        internal int CreateTensor(ReadOnlySpan<int> tensor, bool createArray)
        {
            ...
            while (index < tensor.Length)
            {
                ...
                Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array.Builder inner = new(_builder);
                index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array.ValueBufferSize), createArray: true);
        ...
        /// </summary>
        public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayInt32.ItemsArray2Array.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<MultiDimensionHigherRankFixedSizeNumericArrayInt32, Mutable>(this);
    }
}
