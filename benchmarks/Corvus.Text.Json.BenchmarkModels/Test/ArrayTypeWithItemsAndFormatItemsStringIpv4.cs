...
public readonly partial struct ArrayTypeWithItemsAndFormatItemsStringIpv4
    : IJsonElement<ArrayTypeWithItemsAndFormatItemsStringIpv4>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatItemsStringIpv4"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatItemsStringIpv4(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatItemsStringIpv4 DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsStringIpv4 left, in ArrayTypeWithItemsAndFormatItemsStringIpv4 right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsStringIpv4 left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatItemsStringIpv4 instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatItemsStringIpv4 From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ArrayTypeWithItemsAndFormatItemsStringIpv4(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ArrayTypeWithItemsAndFormatItemsStringIpv4 IJsonElement<ArrayTypeWithItemsAndFormatItemsStringIpv4>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatItemsStringIpv4: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ArrayTypeWithItemsAndFormatItemsStringIpv4 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.ArrayTypeWithItemsAndFormatItemsStringIpv4.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<ArrayTypeWithItemsAndFormatItemsStringIpv4, Mutable>(this);
    }
}
