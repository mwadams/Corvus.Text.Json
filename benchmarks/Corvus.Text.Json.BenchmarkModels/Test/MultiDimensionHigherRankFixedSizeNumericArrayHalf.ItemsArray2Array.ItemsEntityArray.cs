...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayHalf
{
    ...
    public readonly partial struct ItemsArray2Array
    {
            ...
            : IJsonElement<ItemsEntityArray>
        {
            ...
            public Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.ItemsEntityArray.ItemsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.ItemsEntityArray.ItemsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayHalf.ItemsArray2Array.ItemsEntityArray.ItemsEntity>(_parent, _idx);
            }
