        ...
        public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsStringTime
        {
            ...
            public readonly partial struct UnevaluatedItemsEntity
            {
                    ...
                    : IMutableJsonElement<Mutable>
                {
                    ...
                    public static explicit operator Mutable(UnevaluatedItemsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UnevaluatedItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UnevaluatedItemsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UnevaluatedItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
