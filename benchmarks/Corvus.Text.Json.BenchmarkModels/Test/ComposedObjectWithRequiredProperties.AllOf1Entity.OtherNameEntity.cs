...
public readonly partial struct ComposedObjectWithRequiredProperties
{
    ...
    public readonly partial struct AllOf1Entity
    {
        ...
        public readonly partial struct OtherNameEntity
            : IJsonElement<OtherNameEntity>
        {
            private readonly IJsonDocument _parent;
            private readonly int _idx;

            /// <summary>
            /// Initializes a new instance of the <see cref="OtherNameEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OtherNameEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OtherNameEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in OtherNameEntity left, in OtherNameEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OtherNameEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OtherNameEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OtherNameEntity From<T>(in T instance)
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OtherNameEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OtherNameEntity IJsonElement<OtherNameEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OtherNameEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                return workspace.CreateDocumentBuilder<OtherNameEntity, Mutable>(this);
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OtherNameEntity instance) => new(JsonElement.From(instance));
