...
namespace Test;
                        ...
                        public readonly partial struct ComposedArrayMultiItemType
                        {
                            ...
                            public readonly partial struct OneOf1EItemArray
                            {
                                    ...
                                    : IMutableJsonElement<Mutable>
                                {
                                    ...
                                    public static explicit operator Mutable(OneOf1EItemArray instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="OneOf1EItemArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator OneOf1EItemArray(Mutable instance)
                                    {
                                    ...
                                    public Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Mutable this[int index]
                                    {
                                        get
                                        {
                                            CheckValidInstance();
                                            return _parent.GetArrayIndexElement<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Mutable>(_idx, index);
                                        }
                                    }
                                    ...
                                    /// </summary>
                                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                    public ArrayEnumerator<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Mutable> EnumerateArray()
                                    {
                                        CheckValidInstance();
                                        return EnumeratorCreator.CreateArrayEnumerator<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Mutable>(_parent, _idx);
                                    }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new OneOf1EItemArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"OneOf1EItemArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    /// <summary>
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void SetItem(int itemIndex, in Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Source value)
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void InsertItem(int itemIndex, in Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Source value)
                                    {
                                        CheckValidInstance();
                                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                                        value.AddAsItem(ref cvb);
                                    ...
                                    /// </remarks>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public void RemoveWhere(JsonPredicate<Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity> predicate)
                                    {
                                        CheckValidInstance();
                                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity>(this, predicate);
                                        _documentVersion = _parent.Version;
                                    }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public Source(Test.ComposedArrayMultiItemType.OneOf1EItemArray.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

                                    public static implicit operator Source(OneOf1EItemArray instance) => new(JsonElement.From(instance));
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// </summary>
                                    public void Add(in Test.ComposedArrayMultiItemType.OneOf1EItemArray.ItemsEntity.Source value)
                                    {
                                ...
                                {
                                    return workspace.CreateDocumentBuilder<OneOf1EItemArray, Mutable>(this);
                                }
                            }
                        }
