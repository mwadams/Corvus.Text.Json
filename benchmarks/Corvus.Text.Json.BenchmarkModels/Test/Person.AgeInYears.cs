...
public readonly partial struct Person
{
    ...
    public readonly partial struct AgeInYears
        : IJsonElement<AgeInYears>
    {
        private readonly IJsonDocument _parent;
        private readonly int _idx;

        /// <summary>
        /// Initializes a new instance of the <see cref="AgeInYears"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AgeInYears(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AgeInYears DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in AgeInYears left, in AgeInYears right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AgeInYears left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AgeInYears instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AgeInYears From<T>(in T instance)
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AgeInYears(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AgeInYears IJsonElement<AgeInYears>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AgeInYears: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            return workspace.CreateDocumentBuilder<AgeInYears, Mutable>(this);
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AgeInYears instance) => new(JsonElement.From(instance));
