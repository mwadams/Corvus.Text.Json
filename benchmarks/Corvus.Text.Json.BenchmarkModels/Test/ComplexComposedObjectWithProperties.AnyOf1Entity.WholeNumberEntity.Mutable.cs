    ...
    public readonly partial struct AnyOf1Entity
    {
        ...
        public readonly partial struct WholeNumberEntity
        {
                ...
                : IMutableJsonElement<Mutable>
            {
                ...
                public static explicit operator Mutable(WholeNumberEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WholeNumberEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WholeNumberEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WholeNumberEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
