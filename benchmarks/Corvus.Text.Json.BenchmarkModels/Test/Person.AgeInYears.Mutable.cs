...
public readonly partial struct Person
{
    ...
    public readonly partial struct AgeInYears
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public static explicit operator Mutable(AgeInYears instance)
            {
            ...
            /// <returns>An instance of JsonElement, initialized from the <see cref="IJsonElement{T}"/>.</returns>                
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AgeInYears(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AgeInYears.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
