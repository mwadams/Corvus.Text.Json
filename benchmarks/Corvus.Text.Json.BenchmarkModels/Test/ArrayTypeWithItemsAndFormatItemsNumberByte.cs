...
public readonly partial struct ArrayTypeWithItemsAndFormatItemsNumberByte
    : IJsonElement<ArrayTypeWithItemsAndFormatItemsNumberByte>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="ArrayTypeWithItemsAndFormatItemsNumberByte"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ArrayTypeWithItemsAndFormatItemsNumberByte(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ArrayTypeWithItemsAndFormatItemsNumberByte DefaultInstance { get; }
    ...
    public Test.ArrayTypeWithItemsAndFormatItemsNumberByte.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatItemsNumberByte.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsNumberByte left, in ArrayTypeWithItemsAndFormatItemsNumberByte right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ArrayTypeWithItemsAndFormatItemsNumberByte left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ArrayTypeWithItemsAndFormatItemsNumberByte instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ArrayTypeWithItemsAndFormatItemsNumberByte From<T>(in T instance)
...
#if NET
    static ArrayTypeWithItemsAndFormatItemsNumberByte IJsonElement<ArrayTypeWithItemsAndFormatItemsNumberByte>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatItemsNumberByte: ValueKind = {ValueKind} : \"{ToString()}\"";
