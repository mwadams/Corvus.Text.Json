...
public readonly partial struct NumericFormatUint32
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatUint32 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatUint32"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatUint32(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatUint32.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
