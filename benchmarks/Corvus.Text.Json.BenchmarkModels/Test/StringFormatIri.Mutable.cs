...
public readonly partial struct StringFormatIri
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(StringFormatIri instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StringFormatIri"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StringFormatIri(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StringFormatIri.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
