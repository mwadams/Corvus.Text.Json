...
public readonly partial struct MultiDimensionFixedSizeNumericArrayByte
{
    ...
    public readonly partial struct ItemsEntityArray
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Source value)
            {
                CheckValidInstance();
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                value.AddAsItem(ref cvb);
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
        ...
        public ref struct Source
        {
            ...
            public Source(Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void Add(in Test.MultiDimensionFixedSizeNumericArrayByte.ItemsEntityArray.ItemsEntity.Source value)
            {
