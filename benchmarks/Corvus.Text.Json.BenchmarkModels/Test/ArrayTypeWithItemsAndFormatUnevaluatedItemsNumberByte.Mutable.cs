...
public readonly partial struct ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte(Mutable instance)
        {
        ...
        public Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.ArrayTypeWithItemsAndFormatUnevaluatedItemsNumberByte.UnevaluatedItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
