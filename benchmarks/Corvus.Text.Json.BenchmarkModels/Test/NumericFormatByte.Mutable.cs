...
public readonly partial struct NumericFormatByte
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericFormatByte instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericFormatByte"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericFormatByte(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericFormatByte.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
