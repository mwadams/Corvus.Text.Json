...
public readonly partial struct StringFormatDuration
    : IJsonElement<StringFormatDuration>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringFormatDuration"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StringFormatDuration(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StringFormatDuration DefaultInstance { get; }
    ...
    /// </returns>
    public static bool operator ==(in StringFormatDuration left, in StringFormatDuration right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StringFormatDuration left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StringFormatDuration instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringFormatDuration From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StringFormatDuration(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StringFormatDuration IJsonElement<StringFormatDuration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StringFormatDuration: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(StringFormatDuration instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateDocumentBuilder<StringFormatDuration, Mutable>(this);
    }
}
