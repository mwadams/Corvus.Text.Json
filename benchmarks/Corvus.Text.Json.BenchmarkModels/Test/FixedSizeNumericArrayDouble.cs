...
public readonly partial struct FixedSizeNumericArrayDouble
    : IJsonElement<FixedSizeNumericArrayDouble>
{
    private readonly IJsonDocument _parent;
    private readonly int _idx;

    /// <summary>
    /// Initializes a new instance of the <see cref="FixedSizeNumericArrayDouble"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal FixedSizeNumericArrayDouble(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static FixedSizeNumericArrayDouble DefaultInstance { get; }
    ...
    public Test.FixedSizeNumericArrayDouble.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Test.FixedSizeNumericArrayDouble.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Test.FixedSizeNumericArrayDouble.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Test.FixedSizeNumericArrayDouble.ItemsEntity>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayDouble left, in FixedSizeNumericArrayDouble right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in FixedSizeNumericArrayDouble left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(FixedSizeNumericArrayDouble instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FixedSizeNumericArrayDouble From<T>(in T instance)
    ...
    {
        return
            (obj is IJsonElement value && Equals(new FixedSizeNumericArrayDouble(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static FixedSizeNumericArrayDouble IJsonElement<FixedSizeNumericArrayDouble>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"FixedSizeNumericArrayDouble: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public Source(Test.FixedSizeNumericArrayDouble.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(FixedSizeNumericArrayDouble instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.FixedSizeNumericArrayDouble.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<FixedSizeNumericArrayDouble, Mutable>(this);
    }
}
