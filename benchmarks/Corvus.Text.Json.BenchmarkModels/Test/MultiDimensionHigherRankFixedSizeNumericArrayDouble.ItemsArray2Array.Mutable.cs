...
public readonly partial struct MultiDimensionHigherRankFixedSizeNumericArrayDouble
{
    ...
    public readonly partial struct ItemsArray2Array
    {
            ...
            : IMutableJsonElement<Mutable>
        {
            ...
            public Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Source value)
            {
                CheckValidInstance();
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
                value.AddAsItem(ref cvb);
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray>(this, predicate);
                _documentVersion = _parent.Version;
            }
        ...
        public ref struct Source
        {
            ...
            public Source(Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal int CreateTensor(ReadOnlySpan<double> tensor, bool createArray)
            {
                ...
                while (index < tensor.Length)
                {
                    ...
                    Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Builder inner = new(_builder);
                    index += inner.CreateTensor(tensor.Slice(index, Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.ValueBufferSize), createArray: true);
            ...
            /// </summary>
            public void Add(in Test.MultiDimensionHigherRankFixedSizeNumericArrayDouble.ItemsArray2Array.ItemsEntityArray.Source value)
            {
