...
public readonly partial struct NumericArrayInt128
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(NumericArrayInt128 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NumericArrayInt128"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NumericArrayInt128(Mutable instance)
        {
        ...
        public Test.NumericArrayInt128.ItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.NumericArrayInt128.ItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Test.NumericArrayInt128.ItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Test.NumericArrayInt128.ItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NumericArrayInt128(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NumericArrayInt128.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.NumericArrayInt128.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.NumericArrayInt128.ItemsEntity.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.NumericArrayInt128.ItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.NumericArrayInt128.ItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
    ...
    public ref struct Source
    {
        ...
        public Source(Test.NumericArrayInt128.Builder.Build value) { _arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(NumericArrayInt128 instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        public void Add(in Test.NumericArrayInt128.ItemsEntity.Source value)
        {
    ...
    {
        return workspace.CreateDocumentBuilder<NumericArrayInt128, Mutable>(this);
    }
}
