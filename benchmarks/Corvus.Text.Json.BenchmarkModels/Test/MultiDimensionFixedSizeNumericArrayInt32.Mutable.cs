...
public readonly partial struct MultiDimensionFixedSizeNumericArrayInt32
{
        ...
        : IMutableJsonElement<Mutable>
    {
        ...
        public static explicit operator Mutable(MultiDimensionFixedSizeNumericArrayInt32 instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MultiDimensionFixedSizeNumericArrayInt32"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MultiDimensionFixedSizeNumericArrayInt32(Mutable instance)
        {
        ...
        public Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray.Mutable>(_idx, index);
            }
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MultiDimensionFixedSizeNumericArrayInt32.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray.Source value)
        {
            CheckValidInstance();
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 30);
            value.AddAsItem(ref cvb);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Test.MultiDimensionFixedSizeNumericArrayInt32.ItemsEntityArray>(this, predicate);
            _documentVersion = _parent.Version;
        }
