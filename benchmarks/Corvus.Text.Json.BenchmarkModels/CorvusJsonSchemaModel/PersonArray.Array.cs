...
public readonly partial struct PersonArray
    : IJsonArray<Benchmark.CorvusJsonSchema.PersonArray>,
      IReadOnlyCollection<Benchmark.CorvusJsonSchema.Person>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    ...
    public Benchmark.CorvusJsonSchema.Person this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<Benchmark.CorvusJsonSchema.Person>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static PersonArray Create(ReadOnlySpan<Benchmark.CorvusJsonSchema.Person> items)
    {
        return new([..items]);
    }
    ...
    public static PersonArray FromItems(params Benchmark.CorvusJsonSchema.Person[] items)
    {
        return new([..items]);
    }
    ...
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2, in Benchmark.CorvusJsonSchema.Person item3)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2, in Benchmark.CorvusJsonSchema.Person item3, in Benchmark.CorvusJsonSchema.Person item4)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2, in Benchmark.CorvusJsonSchema.Person item3, in Benchmark.CorvusJsonSchema.Person item4, in Benchmark.CorvusJsonSchema.Person item5)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2, in Benchmark.CorvusJsonSchema.Person item3, in Benchmark.CorvusJsonSchema.Person item4, in Benchmark.CorvusJsonSchema.Person item5, in Benchmark.CorvusJsonSchema.Person item6)
    {
    ...
    /// <returns>An instance of the array constructed from the values.</returns>
    public static PersonArray FromItems(in Benchmark.CorvusJsonSchema.Person item1, in Benchmark.CorvusJsonSchema.Person item2, in Benchmark.CorvusJsonSchema.Person item3, in Benchmark.CorvusJsonSchema.Person item4, in Benchmark.CorvusJsonSchema.Person item5, in Benchmark.CorvusJsonSchema.Person item6, in Benchmark.CorvusJsonSchema.Person item7)
    {
    ...
    public static PersonArray FromRange(IEnumerable<Benchmark.CorvusJsonSchema.Person> items)
    {
        return new([..items]);
    }
    ...
    /// <inheritdoc/>
    IEnumerator<Benchmark.CorvusJsonSchema.Person> IEnumerable<Benchmark.CorvusJsonSchema.Person>.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

    /// <inheritdoc/>
    int IReadOnlyCollection<Benchmark.CorvusJsonSchema.Person>.Count => this.GetArrayLength();
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<Benchmark.CorvusJsonSchema.Person> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    public PersonArray Add(in Benchmark.CorvusJsonSchema.Person item1)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    public PersonArray Add(params Benchmark.CorvusJsonSchema.Person[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Benchmark.CorvusJsonSchema.Person item in items)
        {
            builder.Add(item.AsAny);
        }
    ...
    /// <inheritdoc/>
    public PersonArray AddRange(IEnumerable<Benchmark.CorvusJsonSchema.Person> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        foreach (Benchmark.CorvusJsonSchema.Person item in items)
        {
    ...
    /// <inheritdoc/>
    public PersonArray Insert(int index, in Benchmark.CorvusJsonSchema.Person item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    public PersonArray InsertRange(int index, IEnumerable<Benchmark.CorvusJsonSchema.Person> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    public PersonArray Replace(in Benchmark.CorvusJsonSchema.Person oldValue, in Benchmark.CorvusJsonSchema.Person newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    public PersonArray SetItem(int index, in Benchmark.CorvusJsonSchema.Person value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }
    ...
    /// <inheritdoc/>
    public PersonArray Remove(in Benchmark.CorvusJsonSchema.Person oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }
