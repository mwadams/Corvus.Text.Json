...
public readonly partial struct CompetedInYears
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("person-schema.json#/$defs/CompetedInYears");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<Corvus.Json.JsonInt32> arrayEnumerator = value.EnumerateArray();
