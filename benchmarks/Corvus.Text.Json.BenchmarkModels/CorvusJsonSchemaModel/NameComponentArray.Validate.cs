...
public readonly partial struct NameComponentArray
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("person-schema.json#/$defs/NameComponentArray");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<Benchmark.CorvusJsonSchema.NameComponent> arrayEnumerator = value.EnumerateArray();
