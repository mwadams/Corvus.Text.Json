...
public readonly partial struct PersonSchema
{
    ...
    public readonly partial struct NameComponentArray
        : IJsonArray<Benchmark.CorvusJsonSchema.PersonSchema.NameComponentArray>,
          IReadOnlyCollection<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        ...
        public Benchmark.CorvusJsonSchema.PersonSchema.NameComponent this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static NameComponentArray Create(ReadOnlySpan<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> items)
        {
            return new([..items]);
        }
        ...
        public static NameComponentArray FromItems(params Benchmark.CorvusJsonSchema.PersonSchema.NameComponent[] items)
        {
            return new([..items]);
        }
        ...
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item3, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item3, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item4, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item3, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item4, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item5, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static NameComponentArray FromItems(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item2, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item3, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item4, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item5, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item6, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item7)
        {
        ...
        public static NameComponentArray FromRange(IEnumerable<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> items)
        {
            return new([..items]);
        }
        ...
        /// <inheritdoc/>
        IEnumerator<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> IEnumerable<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        public NameComponentArray Add(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public NameComponentArray Add(params Benchmark.CorvusJsonSchema.PersonSchema.NameComponent[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public NameComponentArray AddRange(IEnumerable<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item in items)
            {
        ...
        /// <inheritdoc/>
        public NameComponentArray Insert(int index, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public NameComponentArray InsertRange(int index, IEnumerable<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public NameComponentArray Replace(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent oldValue, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public NameComponentArray SetItem(int index, in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }
        ...
        /// <inheritdoc/>
        public NameComponentArray Remove(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
