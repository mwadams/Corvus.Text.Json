...
public readonly partial struct PersonName
    : IJsonObject<Benchmark.CorvusJsonSchema.PersonName>
{
    /// <summary>
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema.NameComponent FirstName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema.NameComponent>();
                }
            }
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema.NameComponent LastName
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// </para>
    /// </remarks>
    public Benchmark.CorvusJsonSchema.OtherNames OtherNames
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Benchmark.CorvusJsonSchema.OtherNames>();
                }
            }
    ...
    public static PersonName Create(
        in Benchmark.CorvusJsonSchema.NameComponent firstName,
        in Benchmark.CorvusJsonSchema.NameComponent? lastName = null,
        in Benchmark.CorvusJsonSchema.OtherNames? otherNames = null)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithFirstName(in Benchmark.CorvusJsonSchema.NameComponent value)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithLastName(in Benchmark.CorvusJsonSchema.NameComponent value)
    {
    ...
    /// </para>
    /// </remarks>
    public PersonName WithOtherNames(in Benchmark.CorvusJsonSchema.OtherNames value)
    {
