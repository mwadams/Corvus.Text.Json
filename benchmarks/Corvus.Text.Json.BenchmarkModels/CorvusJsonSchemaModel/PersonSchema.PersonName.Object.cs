...
public readonly partial struct PersonSchema
{
    ...
    public readonly partial struct PersonName
        : IJsonObject<Benchmark.CorvusJsonSchema.PersonSchema.PersonName>
    {
        /// <summary>
        ...
        /// </para>
        /// </remarks>
        public Benchmark.CorvusJsonSchema.PersonSchema.NameComponent FirstName
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Benchmark.CorvusJsonSchema.PersonSchema.NameComponent>();
                    }
                }
        ...
        /// </para>
        /// </remarks>
        public Benchmark.CorvusJsonSchema.PersonSchema.NameComponent LastName
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
        ...
        /// </para>
        /// </remarks>
        public Benchmark.CorvusJsonSchema.PersonSchema.OtherNames OtherNamesValue
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Benchmark.CorvusJsonSchema.PersonSchema.OtherNames>();
                    }
                }
        ...
        public static PersonName Create(
            in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent firstName,
            in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent? lastName = null,
            in Benchmark.CorvusJsonSchema.PersonSchema.OtherNames? otherNames = null)
        {
            ...
            {
                builder.Add(JsonPropertyNames.LastName, lastName.Value.AsAny);
            }

            if (otherNames is not null)
            {
                builder.Add(JsonPropertyNames.OtherNamesValue, otherNames.Value.AsAny);
            }
        ...
        /// <summary>
        /// Sets the <c>firstName</c> property.
        /// </summary>
        ...
        /// </para>
        /// </remarks>
        public PersonName WithFirstName(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent value)
        {
            return this.SetProperty(JsonPropertyNames.FirstName, value);
        }

        /// <summary>
        /// Sets the (optional) <c>lastName</c> property.
        /// </summary>
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        /// <remarks>
        ...
        /// </para>
        /// </remarks>
        public PersonName WithLastName(in Benchmark.CorvusJsonSchema.PersonSchema.NameComponent value)
        {
        ...
        /// </para>
        /// </remarks>
        public PersonName WithOtherNamesValue(in Benchmark.CorvusJsonSchema.PersonSchema.OtherNames value)
        {
            return this.SetProperty(JsonPropertyNames.OtherNamesValue, value);
        }
