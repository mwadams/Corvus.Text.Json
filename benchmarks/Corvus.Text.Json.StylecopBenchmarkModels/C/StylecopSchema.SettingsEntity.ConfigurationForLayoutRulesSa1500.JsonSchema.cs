...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
            ...
            : IJsonElement<ConfigurationForLayoutRulesSa1500>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AllowConsecutiveUsingsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowConsecutiveUsings"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider AllowDoWhileOnClosingBraceSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowDoWhileOnClosingBrace"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider NewlineAtEndOfFileSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/newlineAtEndOfFile"u8, buffer, out written);

                private static void MatchAllowConsecutiveUsings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowConsecutiveUsingsUtf8,
                            evaluationPath: AllowConsecutiveUsingsSchemaEvaluationPath);

                    Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchAllowDoWhileOnClosingBrace(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8,
                            evaluationPath: AllowDoWhileOnClosingBraceSchemaEvaluationPath);

                    Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchNewlineAtEndOfFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.NewlineAtEndOfFileUtf8,
                            evaluationPath: NewlineAtEndOfFileSchemaEvaluationPath);

                    Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.StylecopBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.StylecopBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.AllowConsecutiveUsingsUtf8, MatchAllowConsecutiveUsings),
                        (static () => JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8, MatchAllowDoWhileOnClosingBrace),
                        (static () => JsonPropertyNames.NewlineAtEndOfFileUtf8, MatchNewlineAtEndOfFile),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/layoutRules"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/layoutRules";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/layoutRules"u8;
