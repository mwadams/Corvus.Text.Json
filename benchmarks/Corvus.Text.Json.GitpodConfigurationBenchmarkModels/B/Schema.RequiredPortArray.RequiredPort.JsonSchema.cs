            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchOnOpen(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.OnOpenEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.OnOpenEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static void MatchPort(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext3 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.PortEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.PortEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static void MatchProtocol(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext4 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.TheProtocolOfWorkspacePort.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                ...
                private static void MatchVisibility(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext5 =
                        Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.VisibilityEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.GitpodConfigurationBenchmark.Baseline.Schema.RequiredPortArray.RequiredPort.VisibilityEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
                    context.CommitChildContext(childContext5.IsMatch, ref childContext5);
                }

                private static PropertySchemaMatchers<Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                ...
                private static PropertySchemaMatchers<Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

                private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
                [NotNullWhen(true)]
#endif
                out Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
                {
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.GitpodConfigurationBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                            {
