...
public readonly partial struct Schema
{
        ...
        : IJsonElement<LanguageId>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/LanguageId"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/LanguageId";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/LanguageId"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext0 =
                    Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.LanguageIdSingle.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultiple.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
                ...
                JsonSchemaContext anyOfContext2 =
                    Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf2SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.LanguageIdMultipleNeg.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext2);
