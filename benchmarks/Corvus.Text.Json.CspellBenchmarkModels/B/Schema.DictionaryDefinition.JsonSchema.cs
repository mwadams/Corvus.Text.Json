...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DictionaryDefinition
        : IJsonElement<DictionaryDefinition>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/DictionaryDefinition"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/DictionaryDefinition";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/DictionaryDefinition"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext0 =
                    Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionPreferred.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionPreferred.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionCustom.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
                ...
                JsonSchemaContext anyOfContext2 =
                    Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionAugmented.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf2SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionAugmented.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext2);
                ...
                JsonSchemaContext anyOfContext3 =
                    Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionInline.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf3SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionInline.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext3);
                ...
                JsonSchemaContext anyOfContext4 =
                    Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionAlternate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf4SchemaEvaluationPath);
                Corvus.CspellBenchmark.Baseline.Schema.DictionaryDefinitionAlternate.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext4);
