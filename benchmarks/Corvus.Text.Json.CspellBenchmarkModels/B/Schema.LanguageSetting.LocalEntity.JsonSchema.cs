    ...
    public readonly partial struct LanguageSetting
    {
            ...
            : IJsonElement<LocalEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/LanguageSetting/properties/local"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/LanguageSetting/properties/local";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/LanguageSetting/properties/local"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext anyOfContext1 =
                        Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                    Corvus.CspellBenchmark.Baseline.Schema.LanguageSetting.LocalEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
