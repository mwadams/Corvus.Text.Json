...
public readonly partial struct Schema
{
        ...
        : IJsonElement<VersionLegacy>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Const = "0.1"u8.ToArray();
            /// <summary>
            /// A constant for the <c>const</c> keyword.
            /// </summary>
            public static readonly VersionLegacy ConstJson = ParsedJsonDocument<VersionLegacy>.StringConstant([.."\"0.1\""u8]);
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/VersionLegacy"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/VersionLegacy";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/VersionLegacy"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "0.1"u8, "0.1", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "0.1", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
