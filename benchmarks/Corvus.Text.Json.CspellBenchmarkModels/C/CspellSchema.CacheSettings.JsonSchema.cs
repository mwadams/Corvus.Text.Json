...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct CacheSettings
        : IJsonElement<CacheSettings>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider CacheFormatValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/cacheFormat/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider CacheLocationSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/cacheLocation/$ref/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider CacheStrategyValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/cacheStrategy/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider UseCacheSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/useCache"u8, buffer, out written);

            private static void MatchCacheFormatValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CacheFormatValueUtf8,
                        evaluationPath: CacheFormatValueSchemaEvaluationPath);

                Corvus.CspellBenchmark.Current.CspellSchema.CacheFormat.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchCacheLocation(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.CspellBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CacheLocationUtf8,
                        evaluationPath: CacheLocationSchemaEvaluationPath);

                Corvus.CspellBenchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchCacheStrategyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CacheStrategyValueUtf8,
                        evaluationPath: CacheStrategyValueSchemaEvaluationPath);

                Corvus.CspellBenchmark.Current.CspellSchema.CacheStrategy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static void MatchUseCache(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.UseCacheUtf8,
                        evaluationPath: UseCacheSchemaEvaluationPath);

                Corvus.CspellBenchmark.Current.CspellSchema.CacheSettings.UseCacheEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.CspellBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.CspellBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.CacheFormatValueUtf8, MatchCacheFormatValue),
                    (static () => JsonPropertyNames.CacheLocationUtf8, MatchCacheLocation),
                    (static () => JsonPropertyNames.CacheStrategyValueUtf8, MatchCacheStrategyValue),
                    (static () => JsonPropertyNames.UseCacheUtf8, MatchUseCache),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/definitions/CacheSettings"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cspell-schema.json#/definitions/CacheSettings";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/definitions/CacheSettings"u8;
