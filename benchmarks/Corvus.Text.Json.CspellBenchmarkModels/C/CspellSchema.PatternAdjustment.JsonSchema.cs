...
public readonly partial struct CspellSchema
{
    ...
    public readonly partial struct PatternAdjustment
        : IJsonElement<PatternAdjustment>
    {
        public static partial class JsonSchema
        {
            ...
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPenaltyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("penalty"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPenaltyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("penalty"u8, buffer, out written);

            private const int RequiredOffsetForPenalty = 0;
            private const uint RequiredBitForPenalty = 0b00000000000000000000000000000010;
            ...
            private const uint RequiredBitForRegexp = 0b00000000000000000000000000000100;

            private const uint RequiredBitMask0 =
                RequiredBitForId | RequiredBitForPenalty | RequiredBitForRegexp;
            ...
            private static void MatchPenalty(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                requiredBitBuffer[RequiredOffsetForPenalty] |= RequiredBitForPenalty;
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cspell-schema.json#/definitions/PatternAdjustment"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cspell-schema.json#/definitions/PatternAdjustment";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cspell-schema.json#/definitions/PatternAdjustment"u8;
                ...
                else
                {
                    ...
                    if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                    {
                        if (context.HasCollector)
                        {
                            ...
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPenaltyPresent, "penalty"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRegexpPresent, "regexp"u8, "required"u8);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPenalty] & RequiredBitForPenalty) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPenaltyNotPresent, "penalty"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPenaltyPresent, "penalty"u8, "required"u8);
                        ...
                        {
                            context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyRegexpNotPresent, "regexp"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyRegexpPresent, "regexp"u8, "required"u8);
