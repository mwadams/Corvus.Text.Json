                ...
                public readonly partial struct RequiredKeyAndTitleAndType
                {
                    ...
                    public readonly partial struct AllOf2Entity
                    {
                            ...
                            : IJsonElement<RequiredOptions>
                        {
                            ...
                            {
                                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOptionsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("options"u8, buffer, out written);
                                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOptionsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("options"u8, buffer, out written);

                                private const int RequiredOffsetForOptions = 0;
                                private const uint RequiredBitForOptions = 0b00000000000000000000000000000001;

                                private const uint RequiredBitMask0 =
                                    RequiredBitForOptions;
                                ...
                                private static void MatchOptions(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    JsonSchemaContext childContext1 =
                                        Corvus.LazygitBenchmark.Baseline.Schema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.JsonSchema.PushChildContextUnescaped(
                                            parentDocument,
                                            parentDocumentIndex,
                                            ref context,
                                    ...
                                    Corvus.LazygitBenchmark.Baseline.Schema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                    ...
                                    requiredBitBuffer[RequiredOffsetForOptions] |= RequiredBitForOptions;
                                }
                                ...
                                private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    Corvus.LazygitBenchmark.Baseline.Schema.CustomCommandsPromptsTypeProperty.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/customCommands/items/properties/prompts/items/allOf/2/then"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/customCommands/items/properties/prompts/items/allOf/2/then";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/customCommands/items/properties/prompts/items/allOf/2/then"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.StartObject)
                                    {
                                        ...
                                        {
                                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOptionsPresent, "options"u8, "required"u8);
                                        }
                                        ...
                                        {
                                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOptions] & RequiredBitForOptions) == 0)
                                            {
                                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOptionsNotPresent, "options"u8, "required"u8);
                                            }
                                            else
                                            {
                                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOptionsPresent, "options"u8, "required"u8);
