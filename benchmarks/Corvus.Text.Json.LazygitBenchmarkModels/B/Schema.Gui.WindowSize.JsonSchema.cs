    ...
    public readonly partial struct Gui
    {
            ...
            : IJsonElement<WindowSize>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "normal"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly WindowSize EnumJson1 = ParsedJsonDocument<WindowSize>.StringConstant([.."\"normal\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "half"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly WindowSize EnumJson2 = ParsedJsonDocument<WindowSize>.StringConstant([.."\"half\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "full"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly WindowSize EnumJson3 = ParsedJsonDocument<WindowSize>.StringConstant([.."\"full\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "normal"
                /// as a <see cref="WindowSize"/>.
                /// </summary>
                public static WindowSize Normal { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "normal"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> NormalUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "half"
                /// as a <see cref="WindowSize"/>.
                /// </summary>
                public static WindowSize Half { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "half"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> HalfUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "full"
                /// as a <see cref="WindowSize"/>.
                /// </summary>
                public static WindowSize Full { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "full"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FullUtf8 => Constants.Enum3;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/gui/properties/windowSize"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/gui/properties/windowSize";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/gui/properties/windowSize"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("normal"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("half"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
