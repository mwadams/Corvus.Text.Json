...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
            ...
            : IJsonElement<Paging>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider ColorArgSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/colorArg"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider PagerValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/pager"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider UseConfigValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/useConfig"u8, buffer, out written);

                private static void MatchColorArg(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ColorArgUtf8,
                            evaluationPath: ColorArgSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchPagerValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.PagerValueUtf8,
                            evaluationPath: PagerValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchUseConfigValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.UseConfigValueUtf8,
                            evaluationPath: UseConfigValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.ColorArgUtf8, MatchColorArg),
                        (static () => JsonPropertyNames.PagerValueUtf8, MatchPagerValue),
                        (static () => JsonPropertyNames.UseConfigValueUtf8, MatchUseConfigValue),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/git/properties/paging"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/git/properties/paging";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/git/properties/paging"u8;
