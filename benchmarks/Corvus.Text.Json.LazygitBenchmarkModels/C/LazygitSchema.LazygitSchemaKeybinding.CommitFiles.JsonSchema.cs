...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
            ...
            : IJsonElement<CommitFiles>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider CheckoutCommitFileSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/checkoutCommitFile/$ref"u8, buffer, out written);

                private static void MatchCheckoutCommitFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.CheckoutCommitFileUtf8,
                            evaluationPath: CheckoutCommitFileSchemaEvaluationPath);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.CheckoutCommitFileUtf8))
                    {
                        matcher = MatchCheckoutCommitFile;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/commitFiles"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/commitFiles";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/commitFiles"u8;
