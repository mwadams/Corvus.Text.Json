...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct CommitLength
            : IJsonElement<CommitLength>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider ShowValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/show"u8, buffer, out written);

                private static void MatchShowValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ShowValueUtf8,
                            evaluationPath: ShowValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.ShowValueUtf8))
                    {
                        matcher = MatchShowValue;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/gui/properties/commitLength"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/gui/properties/commitLength";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/gui/properties/commitLength"u8;
