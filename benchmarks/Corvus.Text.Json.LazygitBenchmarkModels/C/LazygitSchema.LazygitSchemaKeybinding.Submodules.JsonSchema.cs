...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
            ...
            : IJsonElement<Submodules>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider BulkMenuSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/bulkMenu/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider InitSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/init/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider UpdateSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/update/$ref"u8, buffer, out written);

                private static void MatchBulkMenu(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.BulkMenuUtf8,
                            evaluationPath: BulkMenuSchemaEvaluationPath);
                ...
                private static void MatchUpdate(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.UpdateUtf8,
                            evaluationPath: UpdateSchemaEvaluationPath);
                ...
                private static PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.BulkMenuUtf8, MatchBulkMenu),
                        (static () => JsonPropertyNames.InitUtf8, MatchInit),
                        (static () => JsonPropertyNames.UpdateUtf8, MatchUpdate),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/submodules"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/submodules";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/submodules"u8;
