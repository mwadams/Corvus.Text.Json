                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
