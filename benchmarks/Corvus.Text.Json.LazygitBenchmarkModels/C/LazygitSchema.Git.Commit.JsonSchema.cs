...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
            ...
            : IJsonElement<Commit>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider SignOffValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/signOff"u8, buffer, out written);

                private static void MatchSignOffValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.SignOffValueUtf8,
                            evaluationPath: SignOffValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.SignOffValueUtf8))
                    {
                        matcher = MatchSignOffValue;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/git/properties/commit"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/git/properties/commit";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/git/properties/commit"u8;
