    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271qos1ratelimit1routerJson
    {
            ...
            : IJsonElement<RequiredMaxRate>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForMaxRate = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForMaxRate;
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.MaxRateUtf8))
                    {
                        matcher = MatchMaxRate;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1qos~1ratelimit~1router.json/anyOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMaxRatePresent, "max_rate"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyMaxRateNotPresent, "max_rate"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyMaxRatePresent, "max_rate"u8, "required"u8);
