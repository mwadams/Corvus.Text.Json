...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271validation1celJson
        : IJsonElement<Https11wwwKrakendIo1schema1v271validation1celJson>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271validation1celJson.ObjectInArray.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271validation1celJson.ObjectInArray.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
