...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
            ...
            : IJsonElement<RequiredReq>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReqPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("req"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReqNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("req"u8, buffer, out written);

                private const int RequiredOffsetForReq = 0;
                private const uint RequiredBitForReq = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForReq;

                private static void MatchReq(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForReq] |= RequiredBitForReq;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.ReqUtf8))
                    {
                        matcher = MatchReq;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReqPresent, "req"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReq] & RequiredBitForReq) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReqNotPresent, "req"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReqPresent, "req"u8, "required"u8);
