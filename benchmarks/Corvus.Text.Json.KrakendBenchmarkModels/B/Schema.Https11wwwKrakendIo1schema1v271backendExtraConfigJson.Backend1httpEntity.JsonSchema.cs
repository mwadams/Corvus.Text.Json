    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
            ...
            : IJsonElement<Backend1httpEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.Backend1httpEntity.RequiredReturnErrorDetails.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.Backend1httpEntity.RequiredReturnErrorDetails.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                    ...
                    JsonSchemaContext oneOfContext1 =
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.Backend1httpEntity.RequiredReturnErrorCode.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271backendExtraConfigJson.Backend1httpEntity.RequiredReturnErrorCode.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
