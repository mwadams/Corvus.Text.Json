            ...
            public readonly partial struct RequiredModifierAndPriorityArray
            {
                    ...
                    : IJsonElement<RequiredModifierAndPriority>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        private const uint RequiredBitForPriority = 0b00000000000000000000000000000010;

                        private const uint RequiredBitMask0 =
                            RequiredBitForModifier | RequiredBitForPriority;
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/priority.Group/properties/modifiers/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/priority.Group/properties/modifiers/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1modifier~1martian.json/properties/priority.Group/properties/modifiers/items"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.StartObject)
                            {
                                ...
                                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                {
                                    ...
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPriorityPresent, "priority"u8, "required"u8);
                                }
                                ...
                                else
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyPriorityNotPresent, "priority"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyPriorityPresent, "priority"u8, "required"u8);
