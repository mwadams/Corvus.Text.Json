    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271documentation1openapiJson
    {
            ...
            : IJsonElement<DefinitionOfErrorsOas3Only>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/response_definition"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/response_definition";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1documentation~1openapi.json/properties/response_definition"u8;
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271documentation1openapiJson.DefinitionOfErrorsOas3Only.RequiredContentType.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
