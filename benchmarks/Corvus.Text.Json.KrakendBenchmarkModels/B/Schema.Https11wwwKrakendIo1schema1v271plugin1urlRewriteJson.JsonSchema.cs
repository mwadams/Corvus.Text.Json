        ...
        public static partial class JsonSchema
        {
            ...
            private static void MatchLiteral(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.LiteralMatch.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.LiteralMatch.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchRegexp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RegexpArrayArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RegexpArrayArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1url-rewrite.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext anyOfContext0 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RequiredLiteral.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RequiredLiteral.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
                ...
                JsonSchemaContext anyOfContext1 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RequiredRegexp.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf1SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1urlRewriteJson.RequiredRegexp.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext1);
