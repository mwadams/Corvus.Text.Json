    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
        ...
        public readonly partial struct Backend1httpEntity
        {
            ...
            public readonly partial struct RequiredReturnErrorDetails
                : IJsonElement<RequiredReturnErrorDetails>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReturnErrorDetailsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("return_error_details"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyReturnErrorDetailsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("return_error_details"u8, buffer, out written);

                    private const int RequiredOffsetForReturnErrorDetails = 0;
                    private const uint RequiredBitForReturnErrorDetails = 0b00000000000000000000000000000001;

                    private const uint RequiredBitMask0 =
                        RequiredBitForReturnErrorDetails;

                    private static void MatchReturnErrorDetails(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        requiredBitBuffer[RequiredOffsetForReturnErrorDetails] |= RequiredBitForReturnErrorDetails;
                    }
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.ReturnErrorDetailsUtf8))
                        {
                            matcher = MatchReturnErrorDetails;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/backend~1http/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.StartObject)
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReturnErrorDetailsPresent, "return_error_details"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForReturnErrorDetails] & RequiredBitForReturnErrorDetails) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyReturnErrorDetailsNotPresent, "return_error_details"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyReturnErrorDetailsPresent, "return_error_details"u8, "required"u8);
