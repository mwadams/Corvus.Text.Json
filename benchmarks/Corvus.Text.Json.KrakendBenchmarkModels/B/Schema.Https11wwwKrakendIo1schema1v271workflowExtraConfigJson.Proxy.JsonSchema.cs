...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271workflowExtraConfigJson
    {
            ...
            : IJsonElement<Proxy>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider CombinerSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/combiner"u8, buffer, out written);
                ...
                private static readonly JsonSchemaPathProvider SequentialSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/sequential"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider StaticSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/static"u8, buffer, out written);

                private static void MatchCombiner(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.KrakendBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.CombinerUtf8,
                            evaluationPath: CombinerSchemaEvaluationPath);
                ...
                private static void MatchFlatmapFilter(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271proxy1flatmapJson.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchSequential(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.SequentialProxy.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.SequentialUtf8,
                            evaluationPath: SequentialSchemaEvaluationPath);

                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.SequentialProxy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    context.CommitChildContext(childContext2.IsMatch, ref childContext2);
                }

                private static void MatchStatic(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext3 =
                        Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.StaticUtf8,
                            evaluationPath: StaticSchemaEvaluationPath);

                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271workflowExtraConfigJson.Proxy.StaticResponse.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.CombinerUtf8, MatchCombiner),
                        (static () => JsonPropertyNames.FlatmapFilterUtf8, MatchFlatmapFilter),
                        (static () => JsonPropertyNames.SequentialUtf8, MatchSequential),
                        (static () => JsonPropertyNames.StaticUtf8, MatchStatic),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1workflow_extra_config.json/properties/proxy"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1workflow_extra_config.json/properties/proxy";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1workflow_extra_config.json/properties/proxy"u8;
