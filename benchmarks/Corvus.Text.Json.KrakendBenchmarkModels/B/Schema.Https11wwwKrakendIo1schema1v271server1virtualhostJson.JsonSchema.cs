        ...
        public static partial class JsonSchema
        {
            ...
            private static void MatchAliasedHosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.VirtualhostsWithAlias.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.VirtualhostsWithAlias.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchHosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.RequiredHosts.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.RequiredHosts.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.RequiredAliasedHosts.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271server1virtualhostJson.RequiredAliasedHosts.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
