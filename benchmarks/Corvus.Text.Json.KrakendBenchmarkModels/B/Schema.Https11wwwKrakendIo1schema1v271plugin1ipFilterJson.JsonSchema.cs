...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Https11wwwKrakendIo1schema1v271plugin1ipFilterJson>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAllowPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("allow"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAllowNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("allow"u8, buffer, out written);

            private const int RequiredOffsetForAllow = 0;
            private const uint RequiredBitForAllow = 0b00000000000000000000000000000001;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCidrPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("CIDR"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCidrNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("CIDR"u8, buffer, out written);

            private const int RequiredOffsetForCidr = 0;
            private const uint RequiredBitForCidr = 0b00000000000000000000000000000010;
            ...
            private static void MatchAllow(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.AllowOrDenyMode.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.AllowOrDenyMode.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchCidrValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.Cidr.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.Cidr.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static void MatchClientIpHeadersValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.ClientIpHeaders.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.ClientIpHeaders.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchTrustedProxiesValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.TrustedProxies.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Baseline.Schema.Https11wwwKrakendIo1schema1v271plugin1ipFilterJson.TrustedProxies.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1ip-filter.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1ip-filter.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1ip-filter.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAllowPresent, "allow"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCidrPresent, "CIDR"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAllow] & RequiredBitForAllow) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAllowNotPresent, "allow"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAllowPresent, "allow"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCidr] & RequiredBitForCidr) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyCidrNotPresent, "CIDR"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyCidrPresent, "CIDR"u8, "required"u8);
