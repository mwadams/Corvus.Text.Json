...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271server1virtualhostJson
    {
        ...
        public readonly partial struct RequiredAliasedHosts
            : IJsonElement<RequiredAliasedHosts>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAliasedHostsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("aliased_hosts"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAliasedHostsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("aliased_hosts"u8, buffer, out written);

                private const int RequiredOffsetForAliasedHosts = 0;
                private const uint RequiredBitForAliasedHosts = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForAliasedHosts;

                private static void MatchAliasedHosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForAliasedHosts] |= RequiredBitForAliasedHosts;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.AliasedHostsUtf8))
                    {
                        matcher = MatchAliasedHosts;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/oneOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/oneOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/oneOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAliasedHostsPresent, "aliased_hosts"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAliasedHosts] & RequiredBitForAliasedHosts) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAliasedHostsNotPresent, "aliased_hosts"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAliasedHostsPresent, "aliased_hosts"u8, "required"u8);
