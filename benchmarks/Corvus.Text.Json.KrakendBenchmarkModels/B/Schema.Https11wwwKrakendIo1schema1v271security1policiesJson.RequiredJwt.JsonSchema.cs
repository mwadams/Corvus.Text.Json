...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271security1policiesJson
    {
            ...
            : IJsonElement<RequiredJwt>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyJwtPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("jwt"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyJwtNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("jwt"u8, buffer, out written);

                private const int RequiredOffsetForJwt = 0;
                private const uint RequiredBitForJwt = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForJwt;

                private static void MatchJwt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForJwt] |= RequiredBitForJwt;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.JwtUtf8))
                    {
                        matcher = MatchJwt;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/2"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/2";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/2"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyJwtPresent, "jwt"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForJwt] & RequiredBitForJwt) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyJwtNotPresent, "jwt"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyJwtPresent, "jwt"u8, "required"u8);
