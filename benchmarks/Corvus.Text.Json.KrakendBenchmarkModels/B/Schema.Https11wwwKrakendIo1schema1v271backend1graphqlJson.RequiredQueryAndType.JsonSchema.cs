...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backend1graphqlJson
    {
            ...
            : IJsonElement<RequiredQueryAndType>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQueryPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("query"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyQueryNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("query"u8, buffer, out written);

                private const int RequiredOffsetForQuery = 0;
                private const uint RequiredBitForQuery = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForQuery | RequiredBitForType;
                ...
                {
                    requiredBitBuffer[RequiredOffsetForQuery] |= RequiredBitForQuery;
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1graphql.json/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1graphql.json/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1graphql.json/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQueryPresent, "query"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForQuery] & RequiredBitForQuery) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyQueryNotPresent, "query"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyQueryPresent, "query"u8, "required"u8);
