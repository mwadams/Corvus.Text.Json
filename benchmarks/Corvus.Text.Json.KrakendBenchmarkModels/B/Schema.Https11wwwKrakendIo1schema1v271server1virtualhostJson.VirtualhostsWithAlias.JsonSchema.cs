...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271server1virtualhostJson
    {
            ...
            : IJsonElement<VirtualhostsWithAlias>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider Az09SchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/[a-z0-9_]"u8, buffer, out written);

                private static void MatchAz09(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.KrakendBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AZ09Utf8,
                            evaluationPath: Az09SchemaEvaluationPath);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.AZ09Utf8))
                    {
                        matcher = MatchAz09;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/properties/aliased_hosts"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/properties/aliased_hosts";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/properties/aliased_hosts"u8;
