...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271backendExtraConfigJson
    {
            ...
            : IJsonElement<BackendCache>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider SharedSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/shared"u8, buffer, out written);

                private static void MatchShared(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.KrakendBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.SharedUtf8,
                            evaluationPath: SharedSchemaEvaluationPath);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.SharedUtf8))
                    {
                        matcher = MatchShared;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/qos~1http-cache"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/qos~1http-cache";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend_extra_config.json/properties/qos~1http-cache"u8;
