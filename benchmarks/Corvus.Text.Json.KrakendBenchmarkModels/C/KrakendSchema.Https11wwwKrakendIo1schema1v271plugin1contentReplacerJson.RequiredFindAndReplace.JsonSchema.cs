...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson
    {
            ...
            : IJsonElement<RequiredFindAndReplace>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFindPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("find"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFindNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("find"u8, buffer, out written);

                private const int RequiredOffsetForFind = 0;
                private const uint RequiredBitForFind = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForFind | RequiredBitForReplace;
                private static readonly JsonSchemaPathProvider FindSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/find"u8, buffer, out written);
                ...
                private static void MatchFind(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.KrakendBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.FindUtf8,
                            evaluationPath: FindSchemaEvaluationPath);
                    ...
                    requiredBitBuffer[RequiredOffsetForFind] |= RequiredBitForFind;
                }
                ...
                private static void MatchRegexp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson.RequiredFindAndReplace.IsARegexp.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271plugin1contentReplacerJson.RequiredFindAndReplace.IsARegexp.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.FindUtf8, MatchFind),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1content-replacer.json/additionalProperties"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1content-replacer.json/additionalProperties";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1plugin~1content-replacer.json/additionalProperties"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFindPresent, "find"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForFind] & RequiredBitForFind) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyFindNotPresent, "find"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFindPresent, "find"u8, "required"u8);
