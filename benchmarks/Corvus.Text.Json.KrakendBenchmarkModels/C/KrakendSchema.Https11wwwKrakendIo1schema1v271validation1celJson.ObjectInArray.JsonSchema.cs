...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Https11wwwKrakendIo1schema1v271validation1celJson
    {
            ...
            : IJsonElement<ObjectInArray>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCheckExprPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("check_expr"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCheckExprNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("check_expr"u8, buffer, out written);

                private const int RequiredOffsetForCheckExpr = 0;
                private const uint RequiredBitForCheckExpr = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForCheckExpr;
                private static readonly JsonSchemaPathProvider CheckExprSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/check_expr"u8, buffer, out written);

                private static void MatchCheckExpr(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.KrakendBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.CheckExprUtf8,
                            evaluationPath: CheckExprSchemaEvaluationPath);
                    ...
                    requiredBitBuffer[RequiredOffsetForCheckExpr] |= RequiredBitForCheckExpr;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.CheckExprUtf8))
                    {
                        matcher = MatchCheckExpr;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1validation~1cel.json/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCheckExprPresent, "check_expr"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCheckExpr] & RequiredBitForCheckExpr) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCheckExprNotPresent, "check_expr"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCheckExprPresent, "check_expr"u8, "required"u8);
