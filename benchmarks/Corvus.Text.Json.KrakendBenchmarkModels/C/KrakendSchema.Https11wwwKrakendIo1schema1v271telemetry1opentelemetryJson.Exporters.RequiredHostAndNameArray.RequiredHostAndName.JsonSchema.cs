        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct RequiredHostAndNameArray
            {
                ...
                public readonly partial struct RequiredHostAndName
                    : IJsonElement<RequiredHostAndName>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        private const uint RequiredBitForHost = 0b00000000000000000000000000000001;
                        ...
                        private const uint RequiredBitMask0 =
                            RequiredBitForHost | RequiredBitForName;
                        ...
                        private static readonly JsonSchemaPathProvider DisableTracesValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/disable_traces"u8, buffer, out written);
                        ...
                        private static readonly JsonSchemaPathProvider UseHttpSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/use_http"u8, buffer, out written);
                        ...
                        private static void MatchDisableMetricsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            ...
                            JsonSchemaContext childContext =
                                Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableMetrics.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                            ...
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableMetrics.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            context.CommitChildContext(childContext.IsMatch, ref childContext);
                        }

                        private static void MatchDisableTracesValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext1 =
                                Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableTraces.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.DisableTracesValueUtf8,
                                    evaluationPath: DisableTracesValueSchemaEvaluationPath);

                            Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableTraces.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                        ...
                        private static void MatchPortValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            ...
                            JsonSchemaContext childContext4 =
                                Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.Port.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                    parentDocumentIndex,
                                    ref context,
                            ...
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Https11wwwKrakendIo1schema1v271telemetry1opentelemetryJson.Exporters.RequiredHostAndNameArray.RequiredHostAndName.Port.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                            context.CommitChildContext(childContext4.IsMatch, ref childContext4);
                        }

                        private static void MatchUseHttp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext5 =
                                Corvus.KrakendBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.UseHttpUtf8,
                                    evaluationPath: UseHttpSchemaEvaluationPath);
                        ...
                        private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                                ...
                                (static () => JsonPropertyNames.DisableTracesValueUtf8, MatchDisableTracesValue),
                                ...
                                (static () => JsonPropertyNames.UseHttpUtf8, MatchUseHttp),
                            ]);
                        }
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/exporters/properties/otlp/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/exporters/properties/otlp/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "krakend-schema.json#/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry.json/properties/exporters/properties/otlp/items"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.StartObject)
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHostPresent, "host"u8, "required"u8);
                                ...
                                else
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyHostNotPresent, "host"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHostPresent, "host"u8, "required"u8);
