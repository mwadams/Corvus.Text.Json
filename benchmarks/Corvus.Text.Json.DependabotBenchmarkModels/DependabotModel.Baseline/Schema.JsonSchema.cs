    ...
    : IJsonElement<Schema>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUpdateConfigsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("update_configs"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUpdateConfigsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("update_configs"u8, buffer, out written);

        private const int RequiredOffsetForUpdateConfigs = 0;
        private const uint RequiredBitForUpdateConfigs = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForUpdateConfigs | RequiredBitForVersion;
        private static readonly JsonSchemaPathProvider UpdateConfigsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/update_configs"u8, buffer, out written);
        ...
        private static void MatchUpdateConfigs(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.UpdateConfigsUtf8,
                    evaluationPath: UpdateConfigsSchemaEvaluationPath);

            Corvus.DependabotBenchmark.Baseline.Schema.RequiredDirectoryAndPackageManagerAndUpdateScheduleArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForUpdateConfigs] |= RequiredBitForUpdateConfigs;
        }
        ...
        private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.DependabotBenchmark.Baseline.Schema.VersionEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.DependabotBenchmark.Baseline.Schema.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static PropertySchemaMatchers<Corvus.DependabotBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.DependabotBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.UpdateConfigsUtf8, MatchUpdateConfigs),
                (static () => JsonPropertyNames.VersionUtf8, MatchVersion),
            ]);
        }

        private static PropertySchemaMatchers<Corvus.DependabotBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Corvus.DependabotBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.DependabotBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUpdateConfigsPresent, "update_configs"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUpdateConfigs] & RequiredBitForUpdateConfigs) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyUpdateConfigsNotPresent, "update_configs"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUpdateConfigsPresent, "update_configs"u8, "required"u8);
