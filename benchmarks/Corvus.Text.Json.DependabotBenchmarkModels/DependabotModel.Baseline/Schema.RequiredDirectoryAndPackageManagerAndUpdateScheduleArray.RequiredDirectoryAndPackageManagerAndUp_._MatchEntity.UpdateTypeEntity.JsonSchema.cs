                            ...
                            public static partial class JsonSchema
                            {
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    if (tokenType == JsonTokenType.String)
                                    {
                                        ...
                                        if (unescapedUtf8JsonString.Span.SequenceEqual("security:patch"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("semver:patch"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("semver:minor"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }

                                        if (unescapedUtf8JsonString.Span.SequenceEqual("in_range"u8))
                                        {
                                            goto enumShortCircuitSuccess;
                                        }
