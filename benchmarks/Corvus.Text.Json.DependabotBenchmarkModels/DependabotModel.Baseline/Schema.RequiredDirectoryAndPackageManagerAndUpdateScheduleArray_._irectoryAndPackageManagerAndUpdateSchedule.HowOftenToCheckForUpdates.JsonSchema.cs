        ...
        public readonly partial struct RequiredDirectoryAndPackageManagerAndUpdateSchedule
        {
                ...
                : IJsonElement<HowOftenToCheckForUpdates>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "live"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly HowOftenToCheckForUpdates EnumJson1 = ParsedJsonDocument<HowOftenToCheckForUpdates>.StringConstant([.."\"live\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "daily"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly HowOftenToCheckForUpdates EnumJson2 = ParsedJsonDocument<HowOftenToCheckForUpdates>.StringConstant([.."\"daily\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum3 = "weekly"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly HowOftenToCheckForUpdates EnumJson3 = ParsedJsonDocument<HowOftenToCheckForUpdates>.StringConstant([.."\"weekly\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum4 = "monthly"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly HowOftenToCheckForUpdates EnumJson4 = ParsedJsonDocument<HowOftenToCheckForUpdates>.StringConstant([.."\"monthly\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "live"
                    /// as a <see cref="HowOftenToCheckForUpdates"/>.
                    /// </summary>
                    public static HowOftenToCheckForUpdates Live { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "live"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> LiveUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "daily"
                    /// as a <see cref="HowOftenToCheckForUpdates"/>.
                    /// </summary>
                    public static HowOftenToCheckForUpdates Daily { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "daily"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> DailyUtf8 => Constants.Enum2;

                    /// <summary>
                    /// Gets the string "weekly"
                    /// as a <see cref="HowOftenToCheckForUpdates"/>.
                    /// </summary>
                    public static HowOftenToCheckForUpdates Weekly { get; } = Constants.EnumJson3;
                    /// <summary>
                    /// Gets the string "weekly"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> WeeklyUtf8 => Constants.Enum3;

                    /// <summary>
                    /// Gets the string "monthly"
                    /// as a <see cref="HowOftenToCheckForUpdates"/>.
                    /// </summary>
                    public static HowOftenToCheckForUpdates Monthly { get; } = Constants.EnumJson4;
                    /// <summary>
                    /// Gets the string "monthly"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> MonthlyUtf8 => Constants.Enum4;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/dependabot.json#/properties/update_configs/items/properties/update_schedule"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://json.schemastore.org/dependabot.json#/properties/update_configs/items/properties/update_schedule";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/dependabot.json#/properties/update_configs/items/properties/update_schedule"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("live"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("daily"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("weekly"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("monthly"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
