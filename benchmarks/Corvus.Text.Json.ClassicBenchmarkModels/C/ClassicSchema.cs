...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ClassicSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ClassicSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ClassicSchema DefaultInstance { get; }
    ...
    public Corvus.ClassicBenchmark.Current.ClassicSchema.Person this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.ClassicSchema.Person>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.Person> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.Person>(_parent, _idx);
    }
    ...
    public static implicit operator Corvus.ClassicBenchmark.Current.ClassicSchema.PersonArray(ClassicSchema value)
    {
        return Corvus.ClassicBenchmark.Current.ClassicSchema.PersonArray.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ClassicSchema(Corvus.ClassicBenchmark.Current.ClassicSchema.PersonArray value)
    {
        return From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in ClassicSchema left, in ClassicSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ClassicSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ClassicSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ClassicSchema(JsonElement instance)
    {
        return ClassicSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ClassicSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ClassicSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ClassicSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ClassicSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ClassicSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ClassicSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ClassicSchema>(json, options);
    }
    ...
    /// </exception>
    public static ClassicSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ClassicSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ClassicSchema? result)
    {
        return JsonElementHelpers.TryParseValue<ClassicSchema>(ref reader, out result);
    }
...
#if NET
    static ClassicSchema IJsonElement<ClassicSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ClassicSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public bool TryGetAsPersonArray(out Corvus.ClassicBenchmark.Current.ClassicSchema.PersonArray result)
    {
        ...
        {
            result = Corvus.ClassicBenchmark.Current.ClassicSchema.PersonArray.From(this);
            return true;
        }
