...
public readonly partial struct ClassicSchema
{
...
#endif
    {
        ...
        internal PersonNameElementArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement>(_parent, _idx);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PersonNameElementArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PersonNameElementArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PersonNameElementArray(JsonElement instance)
        {
            return PersonNameElementArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElementArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElementArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElementArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElementArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElementArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElementArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElementArray>(json, options);
        }
        ...
        /// </exception>
        public static PersonNameElementArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PersonNameElementArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PersonNameElementArray? result)
        {
            return JsonElementHelpers.TryParseValue<PersonNameElementArray>(ref reader, out result);
        }
...
#if NET
        static PersonNameElementArray IJsonElement<PersonNameElementArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PersonNameElementArray: ValueKind = {ValueKind} : \"{ToString()}\"";
