...
public readonly partial struct ClassicSchema
{
    ...
    public readonly partial struct PersonNameElementArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PersonNameElementArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PersonNameElementArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PersonNameElementArray(Mutable instance)
            {
            ...
            public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PersonNameElementArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PersonNameElementArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement oldItem, in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElementArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PersonNameElementArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElementArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PersonNameElementArray, Mutable>(this);
        }
    }
}
