...
public readonly partial struct ClassicSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble Height
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName value))
                {
                    return value;
                }
