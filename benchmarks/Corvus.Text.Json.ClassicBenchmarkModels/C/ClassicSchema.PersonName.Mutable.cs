...
public readonly partial struct ClassicSchema
{
    ...
    public readonly partial struct PersonName
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable FamilyName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FamilyNameUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable GivenName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GivenNameUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Mutable OtherNamesValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtherNamesValueUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFamilyName(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source value)
            {
                CheckValidInstance();
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.FamilyName, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGivenName(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.GivenName, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOtherNamesValue(in Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOtherNamesValue<TContext>(in Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source familyName,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source givenName = default,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Source otherNames = default)
            {
                familyName.AddAsProperty(JsonPropertyNamesEscaped.FamilyName, ref builder, escapeName: false);
                givenName.AddAsProperty(JsonPropertyNamesEscaped.GivenName, ref builder, escapeName: false);
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source familyName,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source givenName = default,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Source<TContext> otherNames = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source familyName, in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonNameElement.Source givenName = default, in Corvus.ClassicBenchmark.Current.ClassicSchema.OtherNames.Source otherNames = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
