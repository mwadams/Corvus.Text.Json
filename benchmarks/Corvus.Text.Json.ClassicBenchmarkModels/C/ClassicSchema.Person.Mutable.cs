...
public readonly partial struct ClassicSchema
{
    ...
    public readonly partial struct Person
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble.Mutable Height
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeightUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetHeight(in Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetName(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetName<TContext>(in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Source<TContext> value)
            ...
            public void SetNetWorth(in Corvus.ClassicBenchmark.Current.JsonDecimal.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.NetWorth, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.ClassicBenchmark.Current.ClassicSchema.Person.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.ClassicBenchmark.Current.ClassicSchema.Person.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Source name,
                ...
                in Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble.Source height = default,
                in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default)
            {
                ...
                netWorth.AddAsProperty(JsonPropertyNamesEscaped.NetWorth, ref builder, escapeName: false);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.PersonName.Source<TContext> name,
                in Corvus.ClassicBenchmark.Current.JsonDate.Source dateOfBirth = default,
                in Corvus.ClassicBenchmark.Current.JsonEmail.Source email = default,
                in Corvus.ClassicBenchmark.Current.ClassicSchema.HeightRangeDouble.Source height = default,
                in Corvus.ClassicBenchmark.Current.JsonDecimal.Source netWorth = default)
