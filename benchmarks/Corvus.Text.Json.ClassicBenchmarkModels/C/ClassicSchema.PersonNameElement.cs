...
public readonly partial struct ClassicSchema
{
...
#endif
    {
        ...
        internal PersonNameElement(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(PersonNameElement value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PersonNameElement left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PersonNameElement instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PersonNameElement(JsonElement instance)
        {
            return PersonNameElement.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElement From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElement>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElement>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PersonNameElement ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PersonNameElement>(json, options);
        }
        ...
        /// </exception>
        public static PersonNameElement ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PersonNameElement>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PersonNameElement? result)
        {
            return JsonElementHelpers.TryParseValue<PersonNameElement>(ref reader, out result);
        }
...
#if NET
        static PersonNameElement IJsonElement<PersonNameElement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PersonNameElement: ValueKind = {ValueKind} : \"{ToString()}\"";
