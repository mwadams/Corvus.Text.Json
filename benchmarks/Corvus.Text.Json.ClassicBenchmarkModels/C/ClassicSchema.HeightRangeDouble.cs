...
public readonly partial struct ClassicSchema
{
...
#endif
    {
        ...
        internal HeightRangeDouble(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator long(HeightRangeDouble value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double(HeightRangeDouble value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(HeightRangeDouble value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(HeightRangeDouble value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(HeightRangeDouble value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in HeightRangeDouble left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(HeightRangeDouble instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HeightRangeDouble(JsonElement instance)
        {
            return HeightRangeDouble.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HeightRangeDouble From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HeightRangeDouble ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HeightRangeDouble>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HeightRangeDouble ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HeightRangeDouble>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HeightRangeDouble ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<HeightRangeDouble>(json, options);
        }
        ...
        /// </exception>
        public static HeightRangeDouble ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<HeightRangeDouble>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out HeightRangeDouble? result)
        {
            return JsonElementHelpers.TryParseValue<HeightRangeDouble>(ref reader, out result);
        }
...
#if NET
        static HeightRangeDouble IJsonElement<HeightRangeDouble>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HeightRangeDouble: ValueKind = {ValueKind} : \"{ToString()}\"";
