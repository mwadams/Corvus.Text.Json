        ...
        public readonly partial struct ArgsEntityArray
        {
                ...
                : IJsonElement<ArgsEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/functionRef/properties/args/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/$defs/functionRef/properties/args/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/functionRef/properties/args/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        JsonSchemaContext oneOfContext1 =
                            Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.NumericExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                        ...
                        JsonSchemaContext oneOfContext2 =
                            Corvus.Cql2Benchmark.Baseline.Schema.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                        ...
                        JsonSchemaContext oneOfContext3 =
                            Corvus.Cql2Benchmark.Baseline.Schema.SpatialInstance.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.SpatialInstance.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                        ...
                        JsonSchemaContext oneOfContext4 =
                            Corvus.Cql2Benchmark.Baseline.Schema.TemporalInstance.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.TemporalInstance.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                        ...
                        JsonSchemaContext oneOfContext5 =
                            Corvus.Cql2Benchmark.Baseline.Schema.ArrayExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.ArrayExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
                        ...
                        JsonSchemaContext oneOfContext6 =
                            Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                        Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
