...
public readonly partial struct Schema
{
        ...
        : IJsonElement<ComparisonPredicate>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/comparisonPredicate"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/comparisonPredicate";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/comparisonPredicate"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Cql2Benchmark.Baseline.Schema.BinaryComparisonPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.BinaryComparisonPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Cql2Benchmark.Baseline.Schema.IsLikePredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.IsLikePredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                ...
                JsonSchemaContext oneOfContext2 =
                    Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.IsBetweenPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                ...
                JsonSchemaContext oneOfContext3 =
                    Corvus.Cql2Benchmark.Baseline.Schema.IsInListPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.IsInListPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                ...
                JsonSchemaContext oneOfContext4 =
                    Corvus.Cql2Benchmark.Baseline.Schema.IsNullPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.IsNullPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
