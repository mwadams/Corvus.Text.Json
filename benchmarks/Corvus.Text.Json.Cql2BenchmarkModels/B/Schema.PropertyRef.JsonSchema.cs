...
public readonly partial struct Schema
{
        ...
        : IJsonElement<PropertyRef>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPropertyPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("property"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPropertyNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("property"u8, buffer, out written);

            private const int RequiredOffsetForProperty = 0;
            private const uint RequiredBitForProperty = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForProperty;
            private static readonly JsonSchemaPathProvider PropertySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/property"u8, buffer, out written);

            private static void MatchProperty(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Cql2Benchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.PropertyUtf8,
                        evaluationPath: PropertySchemaEvaluationPath);

                Corvus.Cql2Benchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForProperty] |= RequiredBitForProperty;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.PropertyUtf8))
                {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/propertyRef"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/propertyRef";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/propertyRef"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPropertyPresent, "property"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForProperty] & RequiredBitForProperty) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPropertyNotPresent, "property"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPropertyPresent, "property"u8, "required"u8);
