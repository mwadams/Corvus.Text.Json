...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BboxLiteral
        : IJsonElement<BboxLiteral>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBboxPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("bbox"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBboxNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("bbox"u8, buffer, out written);

            private const int RequiredOffsetForBbox = 0;
            private const uint RequiredBitForBbox = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForBbox;
            private static readonly JsonSchemaPathProvider BboxValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/bbox/$ref"u8, buffer, out written);

            private static void MatchBboxValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Cql2Benchmark.Baseline.Schema.Bbox.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.BboxValueUtf8,
                        evaluationPath: BboxValueSchemaEvaluationPath);

                Corvus.Cql2Benchmark.Baseline.Schema.Bbox.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForBbox] |= RequiredBitForBbox;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.BboxValueUtf8))
                {
                    matcher = MatchBboxValue;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/bboxLiteral"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/bboxLiteral";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/bboxLiteral"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBboxPresent, "bbox"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBbox] & RequiredBitForBbox) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBboxNotPresent, "bbox"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBboxPresent, "bbox"u8, "required"u8);
