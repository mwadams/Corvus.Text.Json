...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SpatialInstance
        : IJsonElement<SpatialInstance>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/spatialInstance"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/spatialInstance";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/spatialInstance"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Cql2Benchmark.Baseline.Schema.GeometryLiteral.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.GeometryLiteral.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Cql2Benchmark.Baseline.Schema.BboxLiteral.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.BboxLiteral.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
