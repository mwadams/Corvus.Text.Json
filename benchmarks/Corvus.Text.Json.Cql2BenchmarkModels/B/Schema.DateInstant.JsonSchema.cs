...
public readonly partial struct Schema
{
        ...
        : IJsonElement<DateInstant>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDatePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("date"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDateNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("date"u8, buffer, out written);

            private const int RequiredOffsetForDate = 0;
            private const uint RequiredBitForDate = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForDate;
            private static readonly JsonSchemaPathProvider DateSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/date/$ref"u8, buffer, out written);

            private static void MatchDate(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Cql2Benchmark.Baseline.Schema.DateString.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Cql2Benchmark.Baseline.Schema.DateString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForDate] |= RequiredBitForDate;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.DateUtf8))
                {
                    matcher = MatchDate;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/dateInstant"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/dateInstant";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/dateInstant"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDatePresent, "date"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDate] & RequiredBitForDate) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDateNotPresent, "date"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDatePresent, "date"u8, "required"u8);
