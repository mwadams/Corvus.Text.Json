    ...
    public static partial class JsonSchema
    {
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext oneOfContext0 =
                Corvus.Cql2Benchmark.Baseline.Schema.AndOrExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.AndOrExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.NotExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                Corvus.Cql2Benchmark.Baseline.Schema.ComparisonPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.ComparisonPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
            ...
            JsonSchemaContext oneOfContext3 =
                Corvus.Cql2Benchmark.Baseline.Schema.SpatialPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.SpatialPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
            ...
            JsonSchemaContext oneOfContext4 =
                Corvus.Cql2Benchmark.Baseline.Schema.TemporalPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.TemporalPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
            ...
            JsonSchemaContext oneOfContext5 =
                Corvus.Cql2Benchmark.Baseline.Schema.ArrayPredicate.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.ArrayPredicate.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
            ...
            JsonSchemaContext oneOfContext6 =
                Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
            ...
            JsonSchemaContext oneOfContext7 =
                Corvus.Cql2Benchmark.Baseline.JsonBoolean.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf7SchemaEvaluationPath);
            Corvus.Cql2Benchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext7);
