...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GeometryLiteral
        : IJsonElement<GeometryLiteral>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/geometryLiteral"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/geometryLiteral";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/geometryLiteral"u8;
                ...
                ref JsonSchemaContext context)
            {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        case 0:
                        {
                            JsonSchemaContext discriminatorContext0 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext0);
                        ...
                        case 1:
                        {
                            JsonSchemaContext discriminatorContext1 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext1);
                        ...
                        case 2:
                        {
                            JsonSchemaContext discriminatorContext2 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Polygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Polygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext2);
                        ...
                        case 3:
                        {
                            JsonSchemaContext discriminatorContext3 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Multipoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Multipoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext3);
                        ...
                        case 4:
                        {
                            JsonSchemaContext discriminatorContext4 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext4);
                        ...
                        case 5:
                        {
                            JsonSchemaContext discriminatorContext5 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext5);
                        ...
                        case 6:
                        {
                            JsonSchemaContext discriminatorContext6 =
                                Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext6);
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Point.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Linestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                ...
                JsonSchemaContext oneOfContext2 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Polygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Polygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                ...
                JsonSchemaContext oneOfContext3 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Multipoint.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Multipoint.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                ...
                JsonSchemaContext oneOfContext4 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Multilinestring.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
                ...
                JsonSchemaContext oneOfContext5 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Multipolygon.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
                ...
                JsonSchemaContext oneOfContext6 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Geometrycollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
