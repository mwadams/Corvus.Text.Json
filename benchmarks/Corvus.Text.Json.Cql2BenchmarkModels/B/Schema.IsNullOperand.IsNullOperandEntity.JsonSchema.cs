    ...
    public readonly partial struct IsNullOperand
    {
            ...
            : IJsonElement<IsNullOperandEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/isNullOperand/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/$defs/isNullOperand/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/isNullOperand/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext5 =
                        Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf5SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Baseline.Schema.PropertyRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext5);
