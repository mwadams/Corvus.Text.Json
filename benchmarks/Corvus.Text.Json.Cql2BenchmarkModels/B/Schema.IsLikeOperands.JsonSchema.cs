...
public readonly partial struct Schema
{
        ...
        : IJsonElement<IsLikeOperands>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/isLikeOperands"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/isLikeOperands";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/isLikeOperands"u8;
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        switch (arrayValidation_itemCount)
                        {
                            case 0:
                            {
                                JsonSchemaContext childContext = Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity.JsonSchema.PushChildContext(
                                    parentDocument,
                                ...
                                Corvus.Cql2Benchmark.Baseline.Schema.IsLikeOperands.PrefixItems0Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                            ...
                            case 1:
                            {
                                JsonSchemaContext childContext1 = Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.JsonSchema.PushChildContext(
                                    parentDocument,
                                    arrayValidation_currentIndex,
                                    ref context,
                                    itemIndex: arrayValidation_itemCount,
                                ...
                                Corvus.Cql2Benchmark.Baseline.Schema.PatternExpression.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
