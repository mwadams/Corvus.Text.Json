    ...
    public readonly partial struct FunctionRef
    {
            ...
            : IJsonElement<OpEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/functionRef/properties/op"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/$defs/functionRef/properties/op";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/functionRef/properties/op"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext notContext =
                        Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.OpEntity.NotEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: NotSchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Baseline.Schema.FunctionRef.OpEntity.NotEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref notContext);
