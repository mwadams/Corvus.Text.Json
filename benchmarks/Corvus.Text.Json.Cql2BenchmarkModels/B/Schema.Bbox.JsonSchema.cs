...
public readonly partial struct Schema
{
        ...
        : IJsonElement<Bbox>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/bbox"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/bbox";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/bbox"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Baseline.Schema.Bbox.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
