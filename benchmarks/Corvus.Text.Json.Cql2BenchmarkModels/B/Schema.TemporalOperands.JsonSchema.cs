...
public readonly partial struct Schema
{
        ...
        : IJsonElement<TemporalOperands>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/temporalOperands"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/$defs/temporalOperands";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/temporalOperands"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.Cql2Benchmark.Baseline.Schema.TemporalOperands.TemporalOperandsEntity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.Cql2Benchmark.Baseline.Schema.TemporalOperands.TemporalOperandsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
