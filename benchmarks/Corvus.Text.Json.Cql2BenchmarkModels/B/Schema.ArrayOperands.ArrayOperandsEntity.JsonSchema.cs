...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ArrayOperands
    {
        ...
        public readonly partial struct ArrayOperandsEntity
            : IJsonElement<ArrayOperandsEntity>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/$defs/arrayOperands/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/$defs/arrayOperands/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/$defs/arrayOperands/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Corvus.Cql2Benchmark.Baseline.Schema.ArrayExpression.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Corvus.Cql2Benchmark.Baseline.Schema.ArrayExpression.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
