...
public readonly partial struct Cql2Schema
{
        ...
        : IJsonElement<GeometryLiteral>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("cql2-schema.json#/$defs/geometryLiteral"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "cql2-schema.json#/$defs/geometryLiteral";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "cql2-schema.json#/$defs/geometryLiteral"u8;
                ...
                ref JsonSchemaContext context)
            {
                    ...
                    switch (oneOfDiscriminatorBranch)
                    {
                        ...
                        case 6:
                        {
                            JsonSchemaContext discriminatorContext6 =
                                Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                            Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref discriminatorContext6);
                ...
                JsonSchemaContext oneOfContext6 =
                    Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf6SchemaEvaluationPath);
                Corvus.Cql2Benchmark.Current.Cql2Schema.Geometrycollection.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext6);
