        ...
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("AfterExternBlock"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("NoIndent"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("Indent"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
                }
