...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
        ...
        public readonly partial struct PropertyGenerationBehaviorEntity
            : IJsonElement<PropertyGenerationBehaviorEntity>
        {
            /// <summary>
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "PreferThrowingProperties"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly PropertyGenerationBehaviorEntity EnumJson1 = ParsedJsonDocument<PropertyGenerationBehaviorEntity>.StringConstant([.."\"PreferThrowingProperties\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "PreferAutoProperties"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly PropertyGenerationBehaviorEntity EnumJson2 = ParsedJsonDocument<PropertyGenerationBehaviorEntity>.StringConstant([.."\"PreferAutoProperties\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "PreferThrowingProperties"
                /// as a <see cref="PropertyGenerationBehaviorEntity"/>.
                /// </summary>
                public static PropertyGenerationBehaviorEntity PreferThrowingProperties { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "PreferThrowingProperties"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> PreferThrowingPropertiesUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "PreferAutoProperties"
                /// as a <see cref="PropertyGenerationBehaviorEntity"/>.
                /// </summary>
                public static PropertyGenerationBehaviorEntity PreferAutoProperties { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "PreferAutoProperties"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> PreferAutoPropertiesUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/omnisharp.json#/properties/ImplementTypeOptions/properties/PropertyGenerationBehavior"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/omnisharp.json#/properties/ImplementTypeOptions/properties/PropertyGenerationBehavior";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/omnisharp.json#/properties/ImplementTypeOptions/properties/PropertyGenerationBehavior"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("PreferThrowingProperties"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("PreferAutoProperties"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
