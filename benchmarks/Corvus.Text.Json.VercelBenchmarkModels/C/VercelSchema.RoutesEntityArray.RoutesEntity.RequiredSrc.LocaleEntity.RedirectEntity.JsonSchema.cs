                                ...
                                else
                                {
                                    ...
                                    while (objectValidation_enumerator.MoveNext())
                                    {
                                        ...
                                        if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                        {
                                            ...
                                            Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.LocaleEntity.RedirectEntity.Type1256Entity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
