    ...
    public readonly partial struct RoutesEntityArray
    {
        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredHandle
                : IJsonElement<RequiredHandle>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHandlePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("handle"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyHandleNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("handle"u8, buffer, out written);

                    private const int RequiredOffsetForHandle = 0;
                    private const uint RequiredBitForHandle = 0b00000000000000000000000000000001;

                    private const uint RequiredBitMask0 =
                        RequiredBitForHandle;
                    private static readonly JsonSchemaPathProvider HandleSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/handle"u8, buffer, out written);

                    private static void MatchHandle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
                        JsonSchemaContext childContext =
                            Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.HandleUtf8,
                                evaluationPath: HandleSchemaEvaluationPath);

                        Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForHandle] |= RequiredBitForHandle;
                    }
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.HandleUtf8))
                        {
                            matcher = MatchHandle;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("vercel-schema.json#/properties/routes/items/anyOf/1"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "vercel-schema.json#/properties/routes/items/anyOf/1";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "vercel-schema.json#/properties/routes/items/anyOf/1"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHandlePresent, "handle"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForHandle] & RequiredBitForHandle) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyHandleNotPresent, "handle"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyHandlePresent, "handle"u8, "required"u8);
