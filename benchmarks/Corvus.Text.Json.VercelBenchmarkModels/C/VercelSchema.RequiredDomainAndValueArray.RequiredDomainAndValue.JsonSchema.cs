...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDomainAndValueArray
    {
        ...
        public readonly partial struct RequiredDomainAndValue
            : IJsonElement<RequiredDomainAndValue>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDomainPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("domain"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyDomainNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("domain"u8, buffer, out written);

                private const int RequiredOffsetForDomain = 0;
                private const uint RequiredBitForDomain = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitMask0 =
                    RequiredBitForDomain | RequiredBitForValue;
                ...
                private static void MatchDomain(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForDomain] |= RequiredBitForDomain;
                }
                ...
                private static void MatchValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("vercel-schema.json#/properties/wildcard/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "vercel-schema.json#/properties/wildcard/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "vercel-schema.json#/properties/wildcard/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDomainPresent, "domain"u8, "required"u8);
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForDomain] & RequiredBitForDomain) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyDomainNotPresent, "domain"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyDomainPresent, "domain"u8, "required"u8);
