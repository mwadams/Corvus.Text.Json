...
public readonly partial struct VercelSchema
{
        ...
        : IJsonElement<EnvEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public const string SchemaLocation = "vercel-schema.json#/properties/env";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "vercel-schema.json#/properties/env"u8;
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                        {
                            ...
                            Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
