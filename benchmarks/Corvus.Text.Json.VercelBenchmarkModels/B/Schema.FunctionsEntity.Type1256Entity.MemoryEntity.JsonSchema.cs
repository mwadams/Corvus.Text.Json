...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FunctionsEntity
    {
        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct MemoryEntity
                : IJsonElement<MemoryEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            JsonSchemaEvaluation.MatchLessThanOrEquals(isNegative, integral, fractional, exponent, false, "3008"u8, ""u8, 0, "3008", "maximum"u8, ref context);
                            ...
                            JsonSchemaEvaluation.MatchGreaterThanOrEquals(isNegative, integral, fractional, exponent, false, "128"u8, ""u8, 0, "128", "minimum"u8, ref context);
                        }
                    }
