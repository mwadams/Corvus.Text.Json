...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GitEntity
        : IJsonElement<GitEntity>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider DeploymentEnabledSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/deploymentEnabled"u8, buffer, out written);

            private static void MatchDeploymentEnabled(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.DeploymentEnabledUtf8,
                        evaluationPath: DeploymentEnabledSchemaEvaluationPath);

                Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.DeploymentEnabledUtf8))
                {
                    matcher = MatchDeploymentEnabled;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/git"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "schema.json#/properties/git";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/git"u8;
