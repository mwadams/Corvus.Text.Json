...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredUseArray
    {
        ...
        public readonly partial struct RequiredUse
            : IJsonElement<RequiredUse>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUsePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("use"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUseNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("use"u8, buffer, out written);

                private const int RequiredOffsetForUse = 0;
                private const uint RequiredBitForUse = 0b00000000000000000000000000000001;
                ...
                private static readonly JsonSchemaPathProvider UseSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/use"u8, buffer, out written);
                ...
                private static void MatchConfig(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchSrc(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchUse(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.UseUtf8,
                            evaluationPath: UseSchemaEvaluationPath);

                    Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    ...
                    requiredBitBuffer[RequiredOffsetForUse] |= RequiredBitForUse;
                }
                ...
                private static PropertySchemaMatchers<Corvus.VercelBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.VercelBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                        ...
                        (static () => JsonPropertyNames.UseUtf8, MatchUse),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/builds/items"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "schema.json#/properties/builds/items";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/builds/items"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUsePresent, "use"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUse] & RequiredBitForUse) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyUseNotPresent, "use"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUsePresent, "use"u8, "required"u8);
