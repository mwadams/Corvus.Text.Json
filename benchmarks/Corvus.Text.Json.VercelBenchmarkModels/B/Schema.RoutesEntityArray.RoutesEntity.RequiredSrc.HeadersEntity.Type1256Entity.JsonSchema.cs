                ...
                public readonly partial struct HeadersEntity
                {
                        ...
                        : IJsonElement<Type1256Entity>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("schema.json#/properties/routes/items/anyOf/0/properties/headers/patternProperties/^.{1,256}$"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "schema.json#/properties/routes/items/anyOf/0/properties/headers/patternProperties/^.{1,256}$";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "schema.json#/properties/routes/items/anyOf/0/properties/headers/patternProperties/^.{1,256}$"u8;
