    ...
    public static partial class JsonSchema
    {
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext hoistedAllOf0_context =
                Corvus.YamllintBenchmark.Baseline.Schema.Ignore.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf0SchemaEvaluationPath);
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (objectValidation_unescapedPropertyName.Span.SequenceEqual("ignore"u8))
                    {
                        ...
                        JsonSchemaContext hoistedChildContext =
                            Corvus.YamllintBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                        ...
                        Corvus.YamllintBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref hoistedChildContext);
