    ...
    public static partial class JsonSchema
    {
        ...
        private static void MatchImports(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheImportsField.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchScopes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
        {
            ...
            JsonSchemaContext childContext1 =
                Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.ImportmapBenchmark.Current.ImportmapSchema.TheScopesField.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static PropertySchemaMatchers<Corvus.ImportmapBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.ImportmapBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.ImportsUtf8, MatchImports),
                (static () => JsonPropertyNames.ScopesUtf8, MatchScopes),
            ]);
        }

        private static PropertySchemaMatchers<Corvus.ImportmapBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out Corvus.ImportmapBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.ImportmapBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
