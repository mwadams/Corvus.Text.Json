...
| [BigIntegerPolyfills](/api/corvus-text-json-internal-bigintegerpolyfills.html) | class | Polyfills for `BigInteger` methods that are not available in all target frameworks. |
