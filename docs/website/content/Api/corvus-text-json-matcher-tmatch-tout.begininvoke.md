...
Title: "Matcher<TMatch, TOut>.BeginInvoke Method — Corvus.Text.Json"
---
## Definition
...
```csharp
public virtual IAsyncResult BeginInvoke(ref TMatch match, AsyncCallback callback, object object)
```
