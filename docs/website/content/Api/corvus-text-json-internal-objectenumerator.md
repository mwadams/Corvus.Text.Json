...
|----------|------|-------------|
| [CurrentIndex](/api/corvus-text-json-internal-objectenumerator.currentindex.html) | [`int`](https://learn.microsoft.com/dotnet/api/system.int32) | Gets the current index in the document. |
