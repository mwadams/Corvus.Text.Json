...
Title: "JsonElement.Mutable.Inequality Operator — Corvus.Text.Json"
---
## Definition
...
|------|------|-------------|
| `left` | [`JsonElement.Mutable`](/api/corvus-text-json-jsonelement-mutable.html) |  |
| `right` | [`JsonElement.Mutable`](/api/corvus-text-json-jsonelement-mutable.html) |  |
