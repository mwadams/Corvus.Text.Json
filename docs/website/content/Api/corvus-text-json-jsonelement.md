...
| [CreateBuilder(JsonWorkspace, ref JsonElement.Source, int)](/api/corvus-text-json-jsonelement.createbuilder.html#createbuilder-jsonworkspace-ref-jsonelement-source-int) `static` |  |
| [CreateBuilder(JsonWorkspace, ref TContext, JsonElement.ArrayBuilder.Build&lt;TContext&gt;, int)](/api/corvus-text-json-jsonelement.createbuilder.html#createbuilder-jsonworkspace-ref-tcontext-jsonelement-arraybuilder-build-tcontext-int) `static` |  |
| [CreateBuilder(JsonWorkspace, ref TContext, JsonElement.ObjectBuilder.Build&lt;TContext&gt;, int)](/api/corvus-text-json-jsonelement.createbuilder.html#createbuilder-jsonworkspace-ref-tcontext-jsonelement-objectbuilder-build-tcontext-int) `static` |  |
| [CreateBuilder(JsonWorkspace)](/api/corvus-text-json-jsonelement.createbuilder.html#createbuilder-jsonworkspace) | Creates a mutable document builder from this JsonElement using the specified workspace. |
...
| [Equals(object)](/api/corvus-text-json-jsonelement.equals.html#equals-object) | Determines whether the specified object is equal to the current JsonElement. |
| [Equals(T)](/api/corvus-text-json-jsonelement.equals.html#equals-t) | Determines whether the current JsonElement is equal to another JsonElement-like value through deep comparison. |
...
| [GetProperty(string)](/api/corvus-text-json-jsonelement.getproperty.html#getproperty-string) | Gets a [`JsonElement`](/api/corvus-text-json-jsonelement.html) representing the value of a required property identified by `propertyName`. |
| [GetProperty(ReadOnlySpan&lt;char&gt;)](/api/corvus-text-json-jsonelement.getproperty.html#getproperty-readonlyspan-char) | Gets a [`JsonElement`](/api/corvus-text-json-jsonelement.html) representing the value of a required property identified by `propertyName`. |
| [GetProperty(ReadOnlySpan&lt;byte&gt;)](/api/corvus-text-json-jsonelement.getproperty.html#getproperty-readonlyspan-byte) | Gets a [`JsonElement`](/api/corvus-text-json-jsonelement.html) representing the value of a required property identified by `utf8PropertyName`. |
...
| [ParseValue(ReadOnlySpan&lt;byte&gt;, JsonDocumentOptions)](/api/corvus-text-json-jsonelement.parsevalue.html#parsevalue-readonlyspan-byte-jsondocumentoptions) `static` | Parses UTF8-encoded text representing a single JSON value into a [`JsonElement`](/api/corvus-text-json-jsonelement.html). |
| [ParseValue(ReadOnlySpan&lt;char&gt;, JsonDocumentOptions)](/api/corvus-text-json-jsonelement.parsevalue.html#parsevalue-readonlyspan-char-jsondocumentoptions) `static` | Parses text representing a single JSON value into a [`JsonElement`](/api/corvus-text-json-jsonelement.html). |
| [ParseValue(string, JsonDocumentOptions)](/api/corvus-text-json-jsonelement.parsevalue.html#parsevalue-string-jsondocumentoptions) `static` | Parses text representing a single JSON value into a [`JsonElement`](/api/corvus-text-json-jsonelement.html). |
| [ParseValue(ref Utf8JsonReader)](/api/corvus-text-json-jsonelement.parsevalue.html#parsevalue-ref-utf8jsonreader) `static` | Parses one JSON value (including objects or arrays) from the provided reader. |
| [ToString()](/api/corvus-text-json-jsonelement.tostring.html#tostring) | Gets a string representation for the current value appropriate to the value type. |
| [ToString(string, IFormatProvider)](/api/corvus-text-json-jsonelement.tostring.html#tostring-string-iformatprovider) |  |
| [TryFormat(Span&lt;char&gt;, ref int, ReadOnlySpan&lt;char&gt;, IFormatProvider)](/api/corvus-text-json-jsonelement.tryformat.html#tryformat-span-char-ref-int-readonlyspan-char-iformatprovider) |  |
| [TryFormat(Span&lt;byte&gt;, ref int, ReadOnlySpan&lt;char&gt;, IFormatProvider)](/api/corvus-text-json-jsonelement.tryformat.html#tryformat-span-byte-ref-int-readonlyspan-char-iformatprovider) |  |
...
| [TryGetLine(int, ref ReadOnlyMemory&lt;byte&gt;)](/api/corvus-text-json-jsonelement.trygetline.html#trygetline-int-ref-readonlymemory-byte) | Tries to get the specified line from the original source document as UTF-8 bytes. |
| [TryGetLine(int, ref string)](/api/corvus-text-json-jsonelement.trygetline.html#trygetline-int-ref-string) | Tries to get the specified line from the original source document as a string. |
| [TryGetLineAndOffset(ref int, ref int)](/api/corvus-text-json-jsonelement.trygetlineandoffset.html#trygetlineandoffset-ref-int-ref-int) | Tries to get the 1-based line number and character offset of this element in the original source document. |
| [TryGetLineAndOffset(ref int, ref int, ref long)](/api/corvus-text-json-jsonelement.trygetlineandoffset.html#trygetlineandoffset-ref-int-ref-int-ref-long) | Tries to get the 1-based line number, character offset, and byte offset of this element in the original source document. |
...
| [TryGetProperty(string, ref JsonElement)](/api/corvus-text-json-jsonelement.trygetproperty.html#trygetproperty-string-ref-jsonelement) | Looks for a property named `propertyName` in the current object, returning whether or not such a property existed. When the property exists `value` is assigned to the value of that property. |
| [TryGetProperty(ReadOnlySpan&lt;char&gt;, ref JsonElement)](/api/corvus-text-json-jsonelement.trygetproperty.html#trygetproperty-readonlyspan-char-ref-jsonelement) | Looks for a property named `propertyName` in the current object, returning whether or not such a property existed. When the property exists `value` is assigned to the value of that property. |
| [TryGetProperty(ReadOnlySpan&lt;byte&gt;, ref JsonElement)](/api/corvus-text-json-jsonelement.trygetproperty.html#trygetproperty-readonlyspan-byte-ref-jsonelement) | Looks for a property named `utf8PropertyName` in the current object, returning whether or not such a property existed. When the property exists `value` is assigned to the value of that property. |
...
| [ValueEquals(string)](/api/corvus-text-json-jsonelement.valueequals.html#valueequals-string) | Compares `text` to the string value of this element. |
| [ValueEquals(ReadOnlySpan&lt;byte&gt;)](/api/corvus-text-json-jsonelement.valueequals.html#valueequals-readonlyspan-byte) | Compares the text represented by `utf8Text` to the string value of this element. |
| [ValueEquals(ReadOnlySpan&lt;char&gt;)](/api/corvus-text-json-jsonelement.valueequals.html#valueequals-readonlyspan-char) | Compares `text` to the string value of this element. |
