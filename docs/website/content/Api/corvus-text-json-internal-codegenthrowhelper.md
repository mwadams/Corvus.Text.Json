...
| [ThrowFormatException](/api/corvus-text-json-internal-codegenthrowhelper.throwformatexception.html) `static` | Throws a generic [`FormatException`](https://learn.microsoft.com/dotnet/api/system.formatexception) for format-related errors. |
