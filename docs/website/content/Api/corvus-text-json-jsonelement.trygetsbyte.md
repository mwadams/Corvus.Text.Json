...
Title: "JsonElement.TryGetSByte Method — Corvus.Text.Json"
---
## Definition
...
`true` if the number can be represented as an [`SByte`](https://learn.microsoft.com/dotnet/api/system.sbyte), `false` otherwise.
