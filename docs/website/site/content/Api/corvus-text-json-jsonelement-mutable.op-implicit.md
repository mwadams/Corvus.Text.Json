...
**Source:** [JsonElement.Mutable.cs](https://github.com/mwadams/Corvus.Text.Json/blob/main/src/Corvus.Text.Json/Corvus/Text/Json/DocumentBuilder/JsonElement.Mutable.cs#L2064)

## implicit operator JsonElement {#implicit-operator-jsonelement}

```csharp
public static implicit operator JsonElement(JsonElement.Mutable value)
```
