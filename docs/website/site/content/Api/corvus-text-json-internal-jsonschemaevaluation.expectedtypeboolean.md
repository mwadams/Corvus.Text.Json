...
Title: "JsonSchemaEvaluation.ExpectedTypeBoolean Field — Corvus.Text.Json.Internal"
---
## Definition
...
## ExpectedTypeBoolean {#expectedtypeboolean}

```csharp
JsonSchemaMessageProvider ExpectedTypeBoolean
```
