...
Title: "JsonElement.TryGetByte Method — Corvus.Text.Json"
---
## Definition
...
`true` if the number can be represented as a [`Byte`](https://learn.microsoft.com/dotnet/api/system.byte), `false` otherwise.
