...
Title: "JsonElement.ArrayBuilder.Build.BeginInvoke Method — Corvus.Text.Json"
---
## Definition
...
```csharp
public virtual IAsyncResult BeginInvoke(ref JsonElement.ArrayBuilder builder, AsyncCallback callback, object object)
```
