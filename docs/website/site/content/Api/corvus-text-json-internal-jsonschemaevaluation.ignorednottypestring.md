...
Title: "JsonSchemaEvaluation.IgnoredNotTypeString Field — Corvus.Text.Json.Internal"
---
## Definition
...
## IgnoredNotTypeString {#ignorednottypestring}

A message provider for ignored non-string type validation.

```csharp
JsonSchemaMessageProvider IgnoredNotTypeString
```
