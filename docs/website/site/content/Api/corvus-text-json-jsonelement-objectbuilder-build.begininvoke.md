...
Title: "JsonElement.ObjectBuilder.Build.BeginInvoke Method — Corvus.Text.Json"
---
## Definition
...
```csharp
public virtual IAsyncResult BeginInvoke(ref JsonElement.ObjectBuilder builder, AsyncCallback callback, object object)
```
