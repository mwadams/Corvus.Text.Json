...
Title: "JsonElement.GetLocalDate Method — Corvus.Text.Json"
---
## Definition
...
The value of the element as a [`LocalDate`](https://www.nodatime.org/3.3.x/api/NodaTime.LocalDate.html).
