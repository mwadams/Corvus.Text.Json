...
using var builtDoc = ThreeTuple.CreateBuilder(workspace, ThreeTuple.Build((ref ThreeTuple.Builder b) =>
{
...
// Create via builder
using JsonWorkspace workspace = JsonWorkspace.Create();
using var doc = ThreeTuple.CreateBuilder(workspace, ThreeTuple.Build((ref ThreeTuple.Builder b) =>
{
    b.CreateTuple(42, "World", true);
}));
