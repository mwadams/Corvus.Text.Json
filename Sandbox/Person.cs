...
public readonly struct Person : IJsonElement<Person>
{
    ...
    public static JsonDocumentBuilder<Mutable> CreateDocument(JsonWorkspace workspace, int age, PersonName.Builder.Source name, CompetedInYears.Builder.Source competedInYears, int initialCapacity = 30)
    {
    ...
    public ref struct Builder
    {
        ...
        public void Create(int age, PersonName.Builder.Source name, CompetedInYears.Builder.Source competedInYears)
        {
            Create(ref _builder, age, name, competedInYears);
        }

        internal static void Create(ref ComplexValueBuilder builder, int age, PersonName.Builder.Source name, CompetedInYears.Builder.Source competedInYears)
        {
            builder.AddProperty(JsonPropertyNames.Age, age);
