...
namespace Corvus.Text.Json.Serialization.Tests
{
    public abstract partial class ConstructorTests
    {
        ...
        public async Task MultipleProperties_Cannot_BindTo_TheSame_ConstructorParameter()
        {
            ...
            Assert.Contains("'x'", exStr);
            Assert.Contains("Corvus.Text.Json.Serialization.Tests.Point_MultipleMembers_BindTo_OneConstructorParameter", exStr);
        ...
        public async Task All_ConstructorParameters_MustBindTo_ObjectMembers()
        {
            ...
            string exStr = ex.ToString();
            Assert.Contains("Corvus.Text.Json.Serialization.Tests.Point_Without_Members", exStr);

            ex = await Assert.ThrowsAsync<InvalidOperationException>(
                () => Serializer.DeserializeWrapper<Point_With_MismatchedMembers>("{}"));
            exStr = ex.ToString();
            Assert.Contains("Corvus.Text.Json.Serialization.Tests.Point_With_MismatchedMembers", exStr);
        ...
        public async Task LeadingReferenceMetadataNotSupported()
        {
            ...
            string exStr = ex.ToString();
            Assert.Contains("Corvus.Text.Json.Serialization.Tests.ConstructorTests+Employee", exStr);
        ...
        public async Task ExtensionDataProperty_CannotBindTo_CtorParam()
        {
            ...
            string exStr = ex.ToString(); // System.InvalidOperationException: 'The extension data property 'ExtensionData' on type 'Corvus.Text.Json.Serialization.Tests.ConstructorTests+Class_ExtData_CtorParam' cannot bind with a parameter in the deserialization constructor.'
            Assert.Contains("ExtensionData", exStr);
            Assert.Contains("Corvus.Text.Json.Serialization.Tests.ConstructorTests+Class_ExtData_CtorParam", exStr);
        }
        ...
        public async Task PathForChildListFails(int bufferSize)
        {
            ...
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeWrapper<RootClass>(PathForChildListFails_Json, options));
        ...
        {
            JsonSerializerOptions options = new() { DefaultBufferSize = bufferSize };
            JsonException e = await Assert.ThrowsAsync<JsonException>(() => Serializer.DeserializeWrapper<RootClass>(PathForChildDictionaryFails_Json, options));
