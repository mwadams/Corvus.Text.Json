...
namespace Corvus.Text.Json.Serialization.Tests
{
    public abstract partial class ConstructorTests : SerializerTests
    {
        ...
        public async Task NoConstructorHandlingWhenObjectHasConverter()
        {
            ...
            string serialized = await Serializer.SerializeWrapper(new Point_3D(10, 6));
            ...
            serialized = await Serializer.SerializeWrapper(new[] { new Point_3D(10, 6) });
            ...
            serialized = await Serializer.SerializeWrapper(new WrapperForPoint_3D { Point_3D = new Point_3D(10, 6) });
            ...
            serialized = await Serializer.SerializeWrapper(new Point_3D(10, 6));
        ...
        {
            string serialized = await Serializer.SerializeWrapper(new BitVector32(1));
        ...
        public async Task ArgumentDeserialization_UseNamingPolicy_ToMatch()
        {
            ...
            string json = await Serializer.SerializeWrapper(new Point_ExtendedPropNames(1, 2), options);
        ...
        public async Task ArgumentStateNotOverwritten()
        {
            ...
            string json = await Serializer.SerializeWrapper(obj2);
        ...
        {
            string json = await Serializer.SerializeWrapper(new StructWithFourArgs(1, 2, 3, 4));
        ...
        public async Task Record_NamingPolicy()
        {
            ...
            // Verify no match if no naming policy
            MyRecord obj = await Serializer.DeserializeWrapper<MyRecord>(Json);
            Assert.Equal(0, obj.Prop);
            ...
            // Verify match with naming policy
            obj = await Serializer.DeserializeWrapper<MyRecord>(Json, options);
            Assert.Equal(5, obj.Prop);
        }
        ...
        public async Task DefaultForValueTypeCtorParam(Type type)
        {
            ...
            Assert.Equal(json, await Serializer.SerializeWrapper(obj, options));
        }
