...
namespace Corvus.Text.Json.Serialization.Tests
{
    ...
    public class ObjWCtorMixedParams : ITestClassWithParameterizedCtor
    {
        ...
        public static ObjWCtorMixedParams GetInstance() =>
            ...
            JsonSerializer.Deserialize(s_json, Corvus.Text.Json.SourceGeneration.Tests.ConstructorTests_Default.ConstructorTestsContext_Default.Default.ObjWCtorMixedParams);
#else
