...
using Corvus.Text.Json.Serialization.Tests;
using System.Xml.Linq;
using Json.Schema;
using Xunit;
using Xunit.Sdk;

namespace Corvus.Text.Json.Schema.Tests
{
...
////            // rely on a polyfilled version of JsonSchemaExporter for Corvus.Text.Json v8
...
////            Assert.StartsWith("Corvus.Text.Json.Serialization.Converters.NullableConverter`1", nullableConverterType.FullName);
...
////            Assert.StartsWith("Corvus.Text.Json.Serialization.Converters.EnumConverter`1", enumConverterType.FullName);
