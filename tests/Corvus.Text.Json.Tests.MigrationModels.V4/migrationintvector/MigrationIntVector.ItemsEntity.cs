...
public readonly partial struct MigrationIntVector
{
...

    {
        ...
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        public ItemsEntity(BinaryJsonNumber value)
        {
        ...
        /// </summary>
        public static string SchemaLocation { get; } = "migration-int-vector.json#/items";
        ...
        /// <returns>An instance of this type, initialized from the provided value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static ItemsEntity IJsonValue<ItemsEntity>.FromObject<TValue>(in TValue value)
        {
            if (value.HasJsonElementBacking)
            {
                return new(value.AsJsonElement);
