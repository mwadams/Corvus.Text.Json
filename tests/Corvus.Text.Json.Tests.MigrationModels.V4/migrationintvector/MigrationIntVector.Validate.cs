...
public readonly partial struct MigrationIntVector
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("migration-int-vector.json");
        }
    ...
    public static partial class CorvusValidation
    {
        ...
        /// </summary>
        public static readonly long MaxItems = 3;

        /// <summary>
        /// A constant for the <c>minItems</c> keyword.
        /// </summary>
        public static readonly long MinItems = 3;
            ...
            ValidationLevel level)
        {
            ...
            int length = 0;
            using JsonArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity> arrayEnumerator = value.EnumerateArray();
