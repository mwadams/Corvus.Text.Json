...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          IAdditionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          ISubtractionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          IMultiplyOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          IDivisionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          IIncrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>,
          IDecrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>
#else
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationIntVector.ItemsEntity>
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(ItemsEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(ItemsEntity value)
        {
            return
        ...
        public static explicit operator byte(ItemsEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(byte value)
        {
        ...
        public static explicit operator decimal(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator int(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        public static explicit operator long(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(ItemsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="ItemsEntity"/>.</returns>
        public static explicit operator ItemsEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(ItemsEntity left, ItemsEntity right)
        {
        ...
        public static ItemsEntity operator +(ItemsEntity left, ItemsEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static ItemsEntity operator ++(ItemsEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in ItemsEntity lhs, in ItemsEntity rhs)
        {
