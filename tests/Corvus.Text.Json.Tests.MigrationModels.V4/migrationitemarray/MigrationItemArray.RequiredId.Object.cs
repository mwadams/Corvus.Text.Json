...
public readonly partial struct MigrationItemArray
{
    ...
    public readonly partial struct RequiredId
        : IJsonObject<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId>
    {
        /// <summary>
        /// Conversion from <see cref="ImmutableList{JsonObjectProperty}"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RequiredId(ImmutableList<JsonObjectProperty> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonObjectProperty>(RequiredId value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RequiredId(JsonObject value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonObject(RequiredId value)
        {
            return
                value.AsObject;
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId.IdEntity Id
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId.IdEntity>();
                    }
                }
        ...
        /// </summary>
        public Corvus.Json.JsonString Label
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    if (this.jsonElementBacking.TryGetProperty(JsonPropertyNames.LabelUtf8, out JsonElement result))
                    {
                        return new(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    if (this.objectBacking.TryGetValue(JsonPropertyNames.Label, out JsonAny result))
                    {
        ...
        /// <inheritdoc/>
        public static RequiredId FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
            return new(source.Select(kvp => new JsonObjectProperty(kvp.Key, kvp.Value)).ToImmutableList());
        }

        /// <inheritdoc/>
        public static RequiredId FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        public static RequiredId FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// </summary>
        public static RequiredId Create(in Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId.IdEntity id, in Corvus.Json.JsonString? label = null)
        {
            var builder = ImmutableList.CreateBuilder<JsonObjectProperty>();

            if (id.IsNotUndefined())
            {
                builder.Add(JsonPropertyNames.Id, id.AsAny);
            }

            if (label is Corvus.Json.JsonString labelNotNull && labelNotNull.IsNotUndefined())
            {
                builder.Add(JsonPropertyNames.Label, label.Value.AsAny);
            }
        ...
        public RequiredId WithId(in Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId.IdEntity value)
        {
            return value.IsNotUndefined() ? this.SetProperty(JsonPropertyNames.Id, value) : this.RemoveProperty(JsonPropertyNames.Id);
        }

        /// <summary>
        /// Sets the (optional) <c>label</c> property.
        /// </summary>
        /// <param name="value">The new property value</param>
        /// <returns>The instance with the property set.</returns>
        public RequiredId WithLabel(in Corvus.Json.JsonString value)
        {
            return value.IsNotUndefined() ? this.SetProperty(JsonPropertyNames.Label, value) : this.RemoveProperty(JsonPropertyNames.Label);
        }
        ...
        /// <inheritdoc />
        public RequiredId SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc />
        public RequiredId RemoveProperty(in JsonPropertyName name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public RequiredId RemoveProperty(string name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public RequiredId RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }

        /// <inheritdoc />
        public RequiredId RemoveProperty(ReadOnlySpan<byte> name)
        {
            return new(__CorvusObjectHelpers.GetPropertyBackingWithout(this, name));
        }
        ...
        private static class __CorvusObjectHelpers
        {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBacking(in RequiredId that)
            {
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredId that, in JsonPropertyName name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredId that, ReadOnlySpan<char> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredId that, ReadOnlySpan<byte> name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <returns>An immutable list of <see cref="JsonObjectProperty"/>, built from the existing object, without the given property.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWithout(in RequiredId that, string name)
            {
                if ((that.backing & Backing.Object) != 0)
                {
                    return that.objectBacking.Remove(name);
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public static ImmutableList<JsonObjectProperty> GetPropertyBackingWith(in RequiredId that, in JsonPropertyName name, in JsonAny value)
            {
                if ((that.backing & Backing.Object) != 0)
                {
