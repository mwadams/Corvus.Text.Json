    ...
    public readonly partial struct RequiredId
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("migration-item-array.json#/items");
            }
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                foreach (JsonObjectProperty property in value.EnumerateObject())
                {
                    if (property.NameEquals(JsonPropertyNames.IdUtf8, JsonPropertyNames.Id))
                    {
                        ...
                        ValidationContext propertyResult = property.Value.As<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationItemArray.RequiredId.IdEntity>().Validate(result.CreateChildContext(), level);
                    ...
                    else if (property.NameEquals(JsonPropertyNames.LabelUtf8, JsonPropertyNames.Label))
                    {
                        result = result.WithLocalProperty(propertyCount);
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifierAndProperty(new("#/properties/label"), JsonPropertyNames.Label);
                        }
