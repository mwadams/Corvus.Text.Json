...
/// </summary>
#if NET8_0_OR_GREATER
[CollectionBuilder(typeof(MigrationTuple), "Create")]
#endif
public readonly partial struct MigrationTuple
    : IJsonArray<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static MigrationTuple EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);

    /// <inheritdoc/>
    Corvus.Json.JsonAny IJsonArray<MigrationTuple>.this[int index]
    {
        get
        {
    ...
    /// </summary>
    public Corvus.Json.JsonString Item1
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[0].As<Corvus.Json.JsonString>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    /// <summary>
    /// Gets the tuple item as a <see cref="Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity"/>.
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity Item2
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[1].As<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static implicit operator (Corvus.Json.JsonString, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity, Corvus.Json.JsonBoolean)(MigrationTuple value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator MigrationTuple((Corvus.Json.JsonString, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity, Corvus.Json.JsonBoolean) value)
    {
        return MigrationTuple.Create(value.Item1, value.Item2, value.Item3);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator MigrationTuple(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImmutableList<JsonAny>(MigrationTuple value)
    {
        return
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator MigrationTuple(JsonArray value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator JsonArray(MigrationTuple value)
    {
        return
            value.AsArray;
    }
    ...
    public static MigrationTuple From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    static MigrationTuple IJsonArray<MigrationTuple>.FromRange(IEnumerable<JsonAny> items)
    {
        return new([..items]);
    }
    ...
    /// <param name="items">The items from which to construct the instance.</param>
    /// <returns>An instance of the array constructed from the items.</returns>
    static MigrationTuple IJsonArray<MigrationTuple>.FromRange<T>(IEnumerable<T> items)
    {
    ...
    public static MigrationTuple Create(in Corvus.Json.JsonString item1, in Corvus.Text.Json.Tests.MigrationModels.V4.MigrationTuple.PrefixItems1Entity item2, in Corvus.Json.JsonBoolean item3)
    {
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.Add(in JsonAny item1)
    {
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.Add(params JsonAny[] items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.AddRange<TArray>(in TArray items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.AddRange<TItem>(IEnumerable<TItem> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.AddRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
    ...
    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.Insert(int index, in JsonAny item1)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.InsertRange<TArray>(int index, in TArray items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.InsertRange(int index, IEnumerable<JsonAny> items)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.Replace(in JsonAny oldValue, in JsonAny newValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.SetItem(int index, in JsonAny value)
    {
        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.Remove(in JsonAny oldValue)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.RemoveAt(int index)
    {
        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
    }

    /// <inheritdoc/>
    MigrationTuple IJsonArray<MigrationTuple>.RemoveRange(int index, int count)
    {
    ...
    private static class __CorvusArrayHelpers
    {
        ...
        public static ImmutableList<JsonAny> GetImmutableList(in MigrationTuple arrayInstance)
        {
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in MigrationTuple arrayInstance)
        {
        ...
        public static ImmutableList<JsonAny> GetImmutableListSetting(in MigrationTuple arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListReplacing(in MigrationTuple arrayInstance, in JsonAny oldItem, in JsonAny newItem)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithout(in MigrationTuple arrayInstance, in JsonAny item)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in MigrationTuple arrayInstance, int index, int count)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith(in MigrationTuple arrayInstance, int index, in JsonAny value)
        {
            if ((arrayInstance.backing & Backing.JsonElement) != 0)
            {
                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
        ...
        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in MigrationTuple arrayInstance, int index, TEnumerable values)
