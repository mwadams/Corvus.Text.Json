...
public readonly partial struct MigrationUnion
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("migration-union.json");
        }
    ...
    public static partial class CorvusValidation
    {
            ...
            ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            ValidationContext oneOfResult0 = value.As<Corvus.Json.JsonString>().Validate(oneOfChildContext0, level);
            ...
            ValidationContext oneOfResult1 = value.As<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationUnion.OneOf1Entity>().Validate(oneOfChildContext1, level);
