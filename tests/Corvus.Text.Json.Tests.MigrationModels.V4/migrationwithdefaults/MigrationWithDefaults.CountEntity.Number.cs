...
#if NET8_0_OR_GREATER
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          IAdditionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          ISubtractionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          IMultiplyOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          IDivisionOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity, Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          IIncrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>,
          IDecrementOperators<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>
#else
        : IJsonNumber<Corvus.Text.Json.Tests.MigrationModels.V4.MigrationWithDefaults.CountEntity>
#endif
    {
        ...
        public static implicit operator CountEntity(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(CountEntity value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonInteger(CountEntity value)
        {
            return
        ...
        public static explicit operator byte(CountEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(byte value)
        {
        ...
        public static explicit operator decimal(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator double(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(double value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator short(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static implicit operator int(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static implicit operator CountEntity(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator long(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator sbyte(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Half(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        public static explicit operator float(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ushort(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator uint(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator ulong(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(CountEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="CountEntity"/>.</returns>
        public static explicit operator CountEntity(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// </returns>
        public static bool operator <(CountEntity left, CountEntity right)
        {
        ...
        public static CountEntity operator +(CountEntity left, CountEntity right)
        {
        ...
        /// <returns>The result of the operation.</returns>
        public static CountEntity operator ++(CountEntity value)
        {
        ...
        /// </returns>
        public static int Compare(in CountEntity lhs, in CountEntity rhs)
        {
