...
public class BigNumberEqualityTests
{
    ...
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
    ...
    public void Equals_WithDifferentSignificandSameExponent_ShouldReturnFalse()
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(456), 5);
    ...
    public void Equals_WithSameSignificandDifferentExponent_ShouldReturnFalse()
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 10);
    ...
    public void Equals_WithDifferentSignificandAndExponent_ShouldReturnFalse()
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(456), 10);
    ...
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(BigInteger.Zero, 0);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(BigInteger.Zero, 0);
    ...
    [Fact]
    public void Equals_WithZeroSignificandDifferentExponents_ShouldReturnFalse()
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(BigInteger.Zero, 0);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(BigInteger.Zero, 5);
    ...
    public void Equals_WithNegativeSignificands_ShouldWorkCorrectly()
    {
        ...
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(-123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(-123), 5);
        var bigNumber3 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
    ...
    public void Equals_WithVeryLargeSignificands_ShouldWorkCorrectly()
    {
        ...
        var bigNumber1 = new Corvus.Text.Json.BigNumber(largeSignificand, 999);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(largeSignificand, 999);
        var bigNumber3 = new Corvus.Text.Json.BigNumber(largeSignificand + 1, 999);
    ...
    {
        // Arrange
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 999999);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 999999);
        var bigNumber3 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 999998);
    ...
    public void Equals_WithObjectOverload_ShouldWorkCorrectly()
    {
        ...
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber3 = new Corvus.Text.Json.BigNumber(new BigInteger(456), 5);
    ...
    public void GetHashCode_WithDifferentBigNumbers_ShouldReturnDifferentHashCodes()
    {
        ...
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 5);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(456), 5);
        var bigNumber3 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 10);
    ...
    public void GetHashCode_WithVeryLargeValues_ShouldBeConsistent()
    {
        // Arrange
        var largeSignificand = BigInteger.Parse("12345678901234567890123456789012345678901234567890");
        var bigNumber1 = new Corvus.Text.Json.BigNumber(largeSignificand, 999999);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(largeSignificand, 999999);
    ...
    public void Equality_RoundTripThroughParsing_ShouldBeConsistent()
    {
        ...
        bool parseSuccess = Corvus.Text.Json.BigNumber.TryParse(Encoding.UTF8.GetBytes(buffer.Slice(0, charsWritten).ToString()), out var parsedBigNumber);
    ...
    [Fact]
    public void Equality_WithEquivalentButDifferentRepresentations_ShouldNotBeEqual()
    {
        // Arrange
        ...
        var bigNumber1 = new Corvus.Text.Json.BigNumber(new BigInteger(123), 3);
        var bigNumber2 = new Corvus.Text.Json.BigNumber(new BigInteger(123000), 0);

        // Act & Assert
        BigNumberTestData.AssertBigNumbersNotEqual(bigNumber1, bigNumber2);
        Assert.False(bigNumber1 == bigNumber2);
        Assert.True(bigNumber1 != bigNumber2);
        Assert.NotEqual(bigNumber1.GetHashCode(), bigNumber2.GetHashCode());
    }
    ...
    public void IEquatable_Implementation_ShouldWorkCorrectly()
    {
        ...
        // Act & Assert
        IEquatable<Corvus.Text.Json.BigNumber> equatable1 = bigNumber1;
