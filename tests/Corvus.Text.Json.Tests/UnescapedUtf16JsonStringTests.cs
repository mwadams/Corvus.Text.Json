...
namespace Corvus.Text.Json.Tests
{
    public static class UnescapedUtf16JsonStringTests
    {
        ...
        {
            JsonElement element = JsonElement.ParseValue("\"caf\\u00E9\"");
            using UnescapedUtf16JsonString result = element.GetUtf16String();
        ...
        {
            JsonElement element = JsonElement.ParseValue("42");
        ...
        {
            JsonElement element = JsonElement.ParseValue("\"test value\"");
            using UnescapedUtf16JsonString result = element.GetUtf16String();
        ...
        {
            using JsonWorkspace workspace = JsonWorkspace.Create();
            using var doc = JsonElement.CreateBuilder(workspace, JsonElement.ParseValue("42"));
            JsonElement.Mutable element = doc.RootElement;
        ...
        {
            JsonElement element = JsonElement.ParseValue("\"owned\"");
        ...
        {
            JsonElement element = JsonElement.ParseValue("\"dispose test\"");
            UnescapedUtf16JsonString result = element.GetUtf16String();
            result.Dispose();
        ...
        {
            JsonElement element = JsonElement.ParseValue("{\"name\":\"hello\\nworld\"}");
        ...
        {
            JsonElement element = JsonElement.ParseValue("[\"alpha\",\"beta\\tgamma\"]");
