...
namespace Corvus.Text.Json.Tests
{
    public static class JsonSchemaContextTests
    {
        ...
        public static void BeginContext_WithResultsCollector_SetsHasCollectorTrue()
        {
            ...
            // Act
            using JsonSchemaContext context = JsonSchemaContext.BeginContext(
                parentDocument,
                parentIndex,
        ...
        {
            // Arrange
            using ParsedJsonDocument<JsonElement> document = ParsedJsonDocument<JsonElement>.Parse("42");
            (IJsonDocument parentDocument, int parentIndex) = JsonElementHelpers.GetParentDocumentAndIndex(document.RootElement);
        ...
        public static void ZeroSizeDocument_HandlesCorrectly()
        {
            ...
            using ParsedJsonDocument<JsonElement> arrayDoc = ParsedJsonDocument<JsonElement>.Parse("[]");
            using ParsedJsonDocument<JsonElement> objectDoc = ParsedJsonDocument<JsonElement>.Parse("{}");

            // Test empty array
            (IJsonDocument parentDocument, int parentIndex) = JsonElementHelpers.GetParentDocumentAndIndex(arrayDoc.RootElement);
            using JsonSchemaContext arrayContext = JsonSchemaContext.BeginContext(
                parentDocument,
                parentIndex,
                usingEvaluatedItems: true,
                usingEvaluatedProperties: false);
            ...
            using JsonSchemaContext objectContext = JsonSchemaContext.BeginContext(
                parentDocument,
                parentIndex,
                usingEvaluatedItems: false,
                usingEvaluatedProperties: true);
        ...
        public static void IgnoredKeyword_DoesNotAffectMatchStatus()
        {
            ...
            using JsonSchemaContext context2 = JsonSchemaContext.BeginContext(
                parentDocument,
                parentIndex,
                usingEvaluatedItems: true,
                usingEvaluatedProperties: false);
        ...
        public static void AllMethodOverloads_ComprehensiveCoverageTest()
        {
            ...
            var unescapedChild = context.PushChildContextUnescaped(parentDocument, parentIndex, true, true, "prop"u8);
            context.CommitChildContext(true, ref unescapedChild);

            var genericChild = context.PushChildContext(parentDocument, parentIndex, true, true, "provider-context");
