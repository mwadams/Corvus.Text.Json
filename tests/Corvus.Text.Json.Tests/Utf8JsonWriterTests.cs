...
""";
    ...
    private static void WriteNullStringsHelper(JsonWriterOptions writerOptions)
    {
        ...
        var jsonText = JsonEncodedText.Encode(utf8Str.AsSpan());
        output.Clear();
        using (var writer = new Utf8JsonWriter(output, writerOptions))
        {
    ...
    public void WriteLargeJsonToStreamWithoutFlushing()
    {
        try
        {
            ...
            var text1 = JsonEncodedText.Encode(largeArray.AsSpan(0, 7_500));
            var text2 = JsonEncodedText.Encode(largeArray.AsSpan(0, 5_000));
            var text3 = JsonEncodedText.Encode(largeArray.AsSpan(0, 150_000_000));
    ...
    public void WriteHelloWorld(JsonWriterOptions options)
    {
        ...
        var encodedPropertyName = JsonEncodedText.Encode(propertyName);
        var encodedValue = JsonEncodedText.Encode(value);
    ...
    public void WriteHelloWorldEscaped_AdditionalCases(JsonWriterOptions options, string key, string value)
    {
        ...
        var encodedKey = JsonEncodedText.Encode(key);
        var encodedValue = JsonEncodedText.Encode(value);
    ...
    public void WriteDateTime_TrimsFractionCorrectly_SerializerRoundtrip()
    {
        ...
        using var doc = ParsedJsonDocument<JsonElement>.Parse(output.WrittenMemory);
    ...
    {
        var jet = JsonEncodedText.Encode("propJet");
