...
namespace StandaloneEvaluatorTestSuite.Draft201909.Ref;
    ...
    public class Fixture : IAsyncLifetime
    {
        ...
        public Task InitializeAsync()
        {
            this.Evaluator = TestEvaluatorHelper.GenerateEvaluatorForVirtualFile(
                ...
                "StandaloneEvaluatorTestSuite.Draft201909.Ref",
...
public class SuiteRefWithRecursiveAnchor : IClassFixture<SuiteRefWithRecursiveAnchor.Fixture>
{
    ...
    {
        using var doc = ParsedJsonDocument<JsonElement>.Parse("[\"foo\",[\"bar\" , [] , 8]]");
        Assert.True(_fixture.Evaluator.Evaluate(doc.RootElement));
    }
    ...
    {
        using var doc = ParsedJsonDocument<JsonElement>.Parse("[\"foo\",[\"bar\" , [] , 8], 8]");
        Assert.False(_fixture.Evaluator.Evaluate(doc.RootElement));
    }
