...
namespace StandaloneEvaluatorTestSuite.Draft202012.Optional.Format.RelativeJsonPointer;
    ...
    public class Fixture : IAsyncLifetime
    {
        ...
        public Task InitializeAsync()
        {
            this.Evaluator = TestEvaluatorHelper.GenerateEvaluatorForVirtualFile(
                ...
                "StandaloneEvaluatorTestSuite.Draft202012.Optional.Format.RelativeJsonPointer",
