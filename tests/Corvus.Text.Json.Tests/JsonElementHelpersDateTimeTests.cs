...
namespace Corvus.Text.Json.Tests
{
    public class JsonElementHelpersDateTimeTests
    {
        ...
        public void TryFormatPeriod_RoundTrip()
        {
            ...
            var timeOnly = (Period.FromHours(23) + Period.FromMinutes(59) + Period.FromSeconds(59)).Normalize();
            ...
            var fractionalMillis = Period.FromMilliseconds(123).Normalize();
            ...
            var fractionalMicros = Period.FromTicks(1).Normalize(); // 100ns = 0.0001ms = 0.0000001s
            ...
            var negative = (Period.FromDays(-1) + Period.FromHours(-2)).Normalize();
            ...
            var max = (Period.FromYears(9999) + Period.FromMonths(12) + Period.FromDays(31) +
        ...
        public void TryParsePeriod_ValidAndInvalid()
        {
            ...
            Assert.True(JsonElementHelpers.TryParsePeriod(validFull, out var periodFull));
            Assert.Equal(
            ...
            Assert.True(JsonElementHelpers.TryParsePeriod(validFractional, out var periodFractional));
