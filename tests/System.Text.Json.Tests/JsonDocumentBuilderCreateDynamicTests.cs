  ...
  ""second"":
  {
    ...
    public static class ParsedDocumentExtensions
    {
        public static JsonDocumentBuilder<JsonElement.Mutable> BuildDynamicDocument(this JsonElement source, JsonWorkspace workspace)
        {
            ...
            {
                return JsonElement.CreateDocument(workspace, (ref JsonObjectBuilder objectBuilder) =>
                {
            ...
            {
                return JsonElement.CreateDocument(workspace, (ref JsonArrayBuilder arrayBuilder) =>
                {
            ...
            {
                return JsonElement.CreateDocument(workspace, true);
            }
            else if (source.ValueKind == JsonValueKind.False)
            {
                return JsonElement.CreateDocument(workspace, false);
            }
            ...
            static void BuildProperty(ReadOnlySpan<byte> propertyName, JsonElement propertyValue, ref JsonObjectBuilder builder)
            {
                ...
                {
                    case JsonValueKind.Object:
                        builder.Add(propertyName, (ref JsonObjectBuilder objectBuilder) =>
                        {
            ...
            static void BuildItem(JsonElement value, ref JsonArrayBuilder builder)
            {
                ...
                {
                    case JsonValueKind.Object:
                        builder.Add((ref JsonObjectBuilder objectBuilder) =>
                        {
                        ...
                        break;
                    case JsonValueKind.Array:
                        builder.Add((ref JsonArrayBuilder arrayBuilder) =>
                        {
