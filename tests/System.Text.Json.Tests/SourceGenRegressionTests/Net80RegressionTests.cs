...
using Corvus.Text.Json.Tests.SourceGenRegressionTests.Net80;
using Xunit;
using HighLowTemps = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net80.HighLowTemps;
using WeatherForecastWithPOCOs = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net80.WeatherForecastWithPOCOs;
