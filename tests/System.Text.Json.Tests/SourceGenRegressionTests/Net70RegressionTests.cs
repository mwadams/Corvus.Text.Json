...
using Corvus.Text.Json.Tests.SourceGenRegressionTests.Net70;
using Xunit;
using HighLowTemps = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net70.HighLowTemps;
using WeatherForecastWithPOCOs = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net70.WeatherForecastWithPOCOs;
