...
using Corvus.Text.Json.Tests.SourceGenRegressionTests.Net60;
using Xunit;
using HighLowTemps = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net60.HighLowTemps;
using WeatherForecastWithPOCOs = Corvus.Text.Json.Tests.SourceGenRegressionTests.Net60.WeatherForecastWithPOCOs;
