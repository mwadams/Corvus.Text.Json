...
namespace Corvus.Text.Json.Serialization.Tests
{
    public static partial class CustomConverterTests
    {
        ...
        public static void AttributeCreateConverterFail()
        {
            ...
            // Message should be in the form "The converter specified on 'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithInvalidConverter.MyInt' does not derive from JsonConverter or have a public parameterless constructor."
            Assert.Contains("'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithInvalidConverter.MyInt'", ex.Message);
            ...
            // Message should be in the form "The converter specified on 'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithNullConverter.MyInt'  is not compatible with the type 'System.Int32'."
            Assert.Contains("'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithNullConverter.MyInt'", ex.Message);
        ...
        [InlineData(typeof(InvalidTypeConverterClass),
            "Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterClass.MyEnumValues",
            "System.Collections.Generic.ICollection`1[Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterEnum]")]
        [InlineData(typeof(InvalidEnumTypeConverterClass),
            "Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidEnumTypeConverterClass.MyEnumValues",
            "Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterEnum")]
        public static void AttributeOnPropertyFail(Type type, string propertyName, string propertyTypeName)
        {
            ...
            // Message should be in the form "The converter specified on 'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterClass.MyEnumValues' is not compatible with the type 'System.Collections.Generic.ICollection`1[Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterEnum]'."
        ...
        [Theory]
        [InlineData(typeof(InvalidTypeConverterClassWithAttribute), "Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterClassWithAttribute")]
        [InlineData(typeof(InvalidTypeConverterEnumWithAttribute), "Corvus.Text.Json.Serialization.Tests.CustomConverterTests+InvalidTypeConverterEnumWithAttribute")]
        ...
        public static void PropertyHasMoreThanOneConverter()
        {
            ...
            // Message should be in the form "The attribute 'Corvus.Text.Json.Serialization.JsonConverterAttribute' cannot exist more than once on 'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithTwoConvertersOnProperty.MyInt'."
            Assert.Contains("'Corvus.Text.Json.Serialization.JsonConverterAttribute'", ex.Message);
            Assert.Contains("'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithTwoConvertersOnProperty.MyInt'", ex.Message);
        ...
        public static void TypeHasMoreThanOneConverter()
        {
            ...
            // Message should be in the form "The attribute 'Corvus.Text.Json.Serialization.JsonConverterAttribute' cannot exist more than once on 'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithTwoConverters'."
            Assert.Contains("'Corvus.Text.Json.Serialization.JsonConverterAttribute'", ex.Message);
            Assert.Contains("'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+PocoWithTwoConverters'", ex.Message);
        ...
        public static void ConverterWithoutDefaultCtor()
        {
            ...
            Assert.Contains("'Corvus.Text.Json.Serialization.Tests.CustomConverterTests+ClassWithConverterWithoutPublicEmptyCtor'", ex.Message);
        }
