...
namespace Corvus.Text.Json.Serialization.Samples
{
    /// <summary>
    ...
    public static class JsonSerializerExtensions
    {
        ...
        /// <see cref="Corvus.Text.Json.JsonElement"/> to instead deserializing as the one of the
        ...
        /// </summary>
        /// <remarks>
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.StartObject"/>, <see cref="JsonDynamicObject"/>
        /// is returned which implements <see cref="System.Collections.IDictionary{string, object}"/>.
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.StartArray"/>, <see cref="System.Collections.IList{object}"/>
        /// is returned which implements <see cref="System.Collections.IList{object}"/>.
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.String"/>, <see cref="JsonDynamicString"/>
        /// is returned and supports an implicit cast to <see cref="string"/>.
        /// An explicit cast or assignment to other types, such as <see cref="Corvus.Text.Json.JsonTokenType.DateTime"/>,
        /// is supported provided there is a custom converter for that Type.
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.Number"/>, <see cref="JsonDynamicNumber"/> is returned.
        /// An explicit cast or assignment is required to the appropriate number type, such as <see cref="decimal"/> or <see cref="long"/>.
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.True"/> and <see cref="Corvus.Text.Json.JsonTokenType.False"/>,
        ...
        /// When deserializing <see cref="Corvus.Text.Json.JsonTokenType.Null"/>, <see langword="null"/> is returned.
        /// </remarks>
