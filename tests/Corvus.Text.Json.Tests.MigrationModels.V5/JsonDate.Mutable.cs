...
public readonly partial struct JsonDate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonDate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonDate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonDate(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonDate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonDate instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonDate, Mutable>(this);
    }
}
