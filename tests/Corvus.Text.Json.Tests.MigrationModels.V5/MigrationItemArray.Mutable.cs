...
public readonly partial struct MigrationItemArray
{
...
#endif
    {
        ...
        public static explicit operator Mutable(MigrationItemArray instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MigrationItemArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MigrationItemArray(Mutable instance)
        {
        ...
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Mutable>(_parent, _idx);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MigrationItemArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.Source value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId> predicate)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MigrationItemArray instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<MigrationItemArray, Mutable>(this);
    }
}
