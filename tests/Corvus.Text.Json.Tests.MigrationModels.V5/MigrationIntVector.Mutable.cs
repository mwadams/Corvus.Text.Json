...
public readonly partial struct MigrationIntVector
{
...
#endif
    {
        ...
        public static explicit operator Mutable(MigrationIntVector instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MigrationIntVector"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MigrationIntVector(Mutable instance)
        {
        ...
        public Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<int> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Mutable item in EnumerateArray())
            {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MigrationIntVector(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MigrationIntVector.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 oldItem, in Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 current = enumerator.Current;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
...
int item in tensor)                {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, scoped in Source value, int initialCapacity = 5)
    {
    ...
    {
        return workspace.CreateBuilder<MigrationIntVector, Mutable>(this);
    }
}