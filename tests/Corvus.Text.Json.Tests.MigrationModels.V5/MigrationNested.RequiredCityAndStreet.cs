...
public readonly partial struct MigrationNested
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.JsonString City
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.JsonString Street
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonString value))
                {
                    return value;
                }
