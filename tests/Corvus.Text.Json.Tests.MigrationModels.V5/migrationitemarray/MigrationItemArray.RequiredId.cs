...
public readonly partial struct MigrationItemArray
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.IdEntity Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.IdEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.LabelEntity Label
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId.LabelEntity value))
                {
                    return value;
                }
