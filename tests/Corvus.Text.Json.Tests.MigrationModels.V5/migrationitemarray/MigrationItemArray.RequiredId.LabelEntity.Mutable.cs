    ...
    public readonly partial struct RequiredId
    {
        ...
        public readonly partial struct LabelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LabelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LabelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LabelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LabelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LabelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LabelEntity, Mutable>(this);
            }
        }
    }
}
