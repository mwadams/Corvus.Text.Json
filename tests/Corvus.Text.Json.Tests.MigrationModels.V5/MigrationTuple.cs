...
#endif
{
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonString Item1
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.JsonString>(_idx, 0);
        }
    }
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 Item2
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(_idx, 1);
        }
    }
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonBoolean Item3
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.JsonBoolean>(_idx, 2);
        }
    }
