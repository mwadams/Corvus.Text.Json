...
public readonly partial struct MigrationComposite
{
...
#endif
    {
        ...
        public static implicit operator Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable(Mutable value)
        {
            return Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable(Mutable value)
        {
            return Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Mutable(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(MigrationComposite instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MigrationComposite"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MigrationComposite(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.Mutable Budget
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BudgetUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Mutable Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.DescriptionEntity.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.DescriptionEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.NameEntity.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.NameEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetBudget(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("budget");
            }
            ...
            else
            {
                ...
                value.AddAsProperty(JsonPropertyNamesEscaped.Budget, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCount(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDescription(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.DescriptionEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.NameEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        public void Apply(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName value)
        {
            CheckValidInstance();
        ...
        /// This will add or update any property values provided by the <paramref name="value"/>.
        /// </remarks>
        public void Apply(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MigrationComposite.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchRequiredName(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable.From(this), context);
            }

            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredCount(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable.From(this));
            }

            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredCount(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable.From(this));
            }
        ...
        public bool TryGetAsRequiredName(out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName result)
        {
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.Mutable.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredCount(out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount result)
        {
            if (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MigrationComposite instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="MigrationComposite"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.Source budget,
            in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Source count,
            in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.NameEntity.Source name,
            in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.DescriptionEntity.Source description = default)
        {
            budget.AddAsProperty(JsonPropertyNamesEscaped.Budget, ref builder, escapeName: false);
        ...
        public void Create(
            ...
            in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.DescriptionEntity.Source description = default)
        {
            Create(ref _builder, budget, count, name, description);
        }
    ...
    {
        return workspace.CreateBuilder<MigrationComposite, Mutable>(this);
    }
}
