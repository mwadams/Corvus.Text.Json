...
public readonly partial struct MigrationComposite
{
    ...
    public readonly partial struct BudgetEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BudgetEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BudgetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BudgetEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BudgetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BudgetEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BudgetEntity, Mutable>(this);
        }
    }
}
