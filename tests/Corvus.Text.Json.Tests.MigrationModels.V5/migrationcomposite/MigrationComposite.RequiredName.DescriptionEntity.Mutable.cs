    ...
    public readonly partial struct RequiredName
    {
        ...
        public readonly partial struct DescriptionEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DescriptionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DescriptionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DescriptionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DescriptionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DescriptionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DescriptionEntity, Mutable>(this);
            }
        }
    }
}
