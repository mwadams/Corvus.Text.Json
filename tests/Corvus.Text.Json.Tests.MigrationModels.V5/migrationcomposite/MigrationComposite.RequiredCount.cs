...
public readonly partial struct MigrationComposite
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredCount"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredCount(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredCount DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity Count
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RequiredCount left, in RequiredCount right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredCount left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredCount instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredCount(JsonElement instance)
        {
            return RequiredCount.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCount From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCount ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCount>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCount ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCount>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCount ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCount>(json, options);
        }
        ...
        /// </exception>
        public static RequiredCount ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredCount>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredCount? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredCount>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredCount(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredCount IJsonElement<RequiredCount>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredCount: ValueKind = {ValueKind} : \"{ToString()}\"";
