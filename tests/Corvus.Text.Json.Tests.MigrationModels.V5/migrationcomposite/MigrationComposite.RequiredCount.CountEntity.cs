...
public readonly partial struct MigrationComposite
{
    ...
    /// </summary>
    public readonly partial struct RequiredCount
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
...
#endif
        {
            ...
            /// </summary>
            public static CountEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator long(CountEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator double(CountEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();
