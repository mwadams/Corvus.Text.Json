    ...
    : IJsonElement<MigrationComposite>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBudgetPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("budget"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBudgetNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("budget"u8, buffer, out written);

        private const int RequiredOffsetForBudget = 0;
        private const uint RequiredBitForBudget = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForBudget;
        private static readonly JsonSchemaPathProvider BudgetSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/budget"u8, buffer, out written);

        private static void MatchBudget(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.BudgetUtf8,
                    evaluationPath: BudgetSchemaEvaluationPath);

            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.BudgetEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForBudget] |= RequiredBitForBudget;
        }
        ...
        {
            if (span.SequenceEqual(JsonPropertyNames.BudgetUtf8))
            {
                matcher = MatchBudget;
                return true;
            }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("migration-composite.json"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "migration-composite.json";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "migration-composite.json"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext allOfContext0 =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf0SchemaEvaluationPath);
            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredName.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext0);
            ...
            JsonSchemaContext allOfContext1 =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext1);
            ...
            if (tokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBudgetPresent, "budget"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBudget] & RequiredBitForBudget) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBudgetNotPresent, "budget"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBudgetPresent, "budget"u8, "required"u8);
