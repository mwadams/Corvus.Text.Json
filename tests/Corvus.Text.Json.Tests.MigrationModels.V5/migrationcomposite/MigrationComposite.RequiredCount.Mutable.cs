...
public readonly partial struct MigrationComposite
{
    ...
    public readonly partial struct RequiredCount
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredCount instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredCount"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredCount(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredCount.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredCount instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RequiredCount"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Source count)
            {
            ...
            /// Creates an instance of a <see cref="RequiredCount"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationComposite.RequiredCount.CountEntity.Source count)
            {
        ...
        {
            return workspace.CreateBuilder<RequiredCount, Mutable>(this);
        }
    }
}
