...
#endif
{
    ...
    internal MigrationStatusEnum(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(MigrationStatusEnum value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationStatusEnum left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationStatusEnum From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationStatusEnum ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationStatusEnum>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationStatusEnum ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationStatusEnum>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationStatusEnum ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationStatusEnum>(json, options);
    }
    ...
    /// </exception>
    public static MigrationStatusEnum ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationStatusEnum>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationStatusEnum? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationStatusEnum>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MigrationStatusEnum(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MigrationStatusEnum IJsonElement<MigrationStatusEnum>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationStatusEnum: ValueKind = {ValueKind} : \"{ToString()}\"";
