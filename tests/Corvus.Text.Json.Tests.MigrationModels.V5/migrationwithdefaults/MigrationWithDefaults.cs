...
public readonly partial struct MigrationWithDefaults
    ...
    : IJsonElement<MigrationWithDefaults>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MigrationWithDefaults"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MigrationWithDefaults(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MigrationWithDefaults DefaultInstance { get; }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.CountEntity Count
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CountUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.CountEntity value))
            {
                return value;
            }

            return Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.CountEntity.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.NameEntity Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.NameEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.StatusEntity value))
            {
                return value;
            }

            return Corvus.Text.Json.Tests.MigrationModels.V5.MigrationWithDefaults.StatusEntity.DefaultInstance;
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in MigrationWithDefaults left, in MigrationWithDefaults right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationWithDefaults left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MigrationWithDefaults instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator MigrationWithDefaults(JsonElement instance)
    {
        return MigrationWithDefaults.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationWithDefaults From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationWithDefaults ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationWithDefaults>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationWithDefaults ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationWithDefaults>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationWithDefaults ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationWithDefaults>(json, options);
    }
    ...
    /// </exception>
    public static MigrationWithDefaults ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationWithDefaults>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationWithDefaults? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationWithDefaults>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MigrationWithDefaults(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MigrationWithDefaults IJsonElement<MigrationWithDefaults>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationWithDefaults: ValueKind = {ValueKind} : \"{ToString()}\"";
