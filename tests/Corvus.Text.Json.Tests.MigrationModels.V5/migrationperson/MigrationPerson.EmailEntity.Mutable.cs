...
public readonly partial struct MigrationPerson
{
    ...
    public readonly partial struct EmailEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EmailEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EmailEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EmailEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EmailEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EmailEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EmailEntity, Mutable>(this);
        }
    }
}
