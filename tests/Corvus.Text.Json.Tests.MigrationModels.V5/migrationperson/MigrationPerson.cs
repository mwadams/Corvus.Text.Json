...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MigrationPerson"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MigrationPerson(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MigrationPerson DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.AgeEntity Age
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AgeUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.AgeEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.DateOfBirthEntity DateOfBirth
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.DateOfBirthEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.EmailEntity Email
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.EmailEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.IsActiveEntity IsActive
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsActiveUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.IsActiveEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.NameEntity Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationPerson.NameEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in MigrationPerson left, in MigrationPerson right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationPerson left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MigrationPerson instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator MigrationPerson(JsonElement instance)
    {
        return MigrationPerson.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationPerson From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationPerson ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationPerson>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationPerson ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationPerson>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationPerson ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationPerson>(json, options);
    }
    ...
    /// </exception>
    public static MigrationPerson ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationPerson>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationPerson? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationPerson>(ref reader, out result);
    }
...
#if NET
    static MigrationPerson IJsonElement<MigrationPerson>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationPerson: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="IsActive"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IsActive => "isActive"u8;
