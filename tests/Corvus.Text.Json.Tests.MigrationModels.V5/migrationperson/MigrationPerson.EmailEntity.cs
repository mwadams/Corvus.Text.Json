...
public readonly partial struct MigrationPerson
{
    ...
    public readonly partial struct EmailEntity
#if NET8_0_OR_GREATER
        : IJsonElement<EmailEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EmailEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EmailEntity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(EmailEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in EmailEntity left, in EmailEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EmailEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmailEntity From<T>(in T instance)
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EmailEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EmailEntity IJsonElement<EmailEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EmailEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
