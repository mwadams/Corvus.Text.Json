...
public readonly partial struct MigrationPerson
{
    ...
    public readonly partial struct IsActiveEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IsActiveEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IsActiveEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsActiveEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsActiveEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IsActiveEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IsActiveEntity, Mutable>(this);
        }
    }
}
