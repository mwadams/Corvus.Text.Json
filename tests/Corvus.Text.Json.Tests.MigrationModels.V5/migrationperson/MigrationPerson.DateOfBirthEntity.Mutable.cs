...
public readonly partial struct MigrationPerson
{
    ...
    public readonly partial struct DateOfBirthEntity
    {
...
#endif
        {
            ...
            public static implicit operator NodaTime.LocalDate(Mutable value) => value._parent.TryGetValue(value._idx, out NodaTime.LocalDate result) ? result : throw new FormatException();
            ...
            public static explicit operator Mutable(DateOfBirthEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DateOfBirthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DateOfBirthEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DateOfBirthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DateOfBirthEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DateOfBirthEntity, Mutable>(this);
        }
    }
}
