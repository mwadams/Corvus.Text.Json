...
public readonly partial struct MigrationStatusEnum
{
...
#endif
    {
        ...
        public static explicit operator Mutable(MigrationStatusEnum instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MigrationStatusEnum"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MigrationStatusEnum(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MigrationStatusEnum.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(MigrationStatusEnum instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<MigrationStatusEnum, Mutable>(this);
    }
}