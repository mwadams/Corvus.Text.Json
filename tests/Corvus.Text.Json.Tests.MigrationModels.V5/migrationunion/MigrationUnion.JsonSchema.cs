    ...
    : IJsonElement<MigrationUnion>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("migration-union.json"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "migration-union.json";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "migration-union.json"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext oneOfContext0 =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf1Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf1Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationUnion.OneOf2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
