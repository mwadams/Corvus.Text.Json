...
public readonly partial struct MigrationTuple
{
    ...
    public readonly partial struct PrefixItems1Entity
        ...
        : IJsonElement<PrefixItems1Entity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal PrefixItems1Entity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator int(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator long(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(PrefixItems1Entity value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PrefixItems1Entity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PrefixItems1Entity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PrefixItems1Entity(JsonElement instance)
        {
            return PrefixItems1Entity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems1Entity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems1Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems1Entity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems1Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems1Entity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems1Entity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems1Entity>(json, options);
        }
        ...
        /// </exception>
        public static PrefixItems1Entity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PrefixItems1Entity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PrefixItems1Entity? result)
        {
            return JsonElementHelpers.TryParseValue<PrefixItems1Entity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PrefixItems1Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PrefixItems1Entity IJsonElement<PrefixItems1Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PrefixItems1Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
