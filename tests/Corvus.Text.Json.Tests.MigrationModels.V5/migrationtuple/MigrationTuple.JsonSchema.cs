            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    switch (arrayValidation_itemCount)
                    {
                        case 0:
                        {
                            JsonSchemaContext childContext = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity.JsonSchema.PushChildContext(
                                parentDocument,
                            ...
                            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                        ...
                        case 1:
                        {
                            JsonSchemaContext childContext1 = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity.JsonSchema.PushChildContext(
                                parentDocument,
                                arrayValidation_currentIndex,
                                ref context,
                                itemIndex: arrayValidation_itemCount,
                            ...
                            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext1);
                        ...
                        case 2:
                        {
                            JsonSchemaContext childContext2 = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity.JsonSchema.PushChildContext(
                                parentDocument,
                                arrayValidation_currentIndex,
                                ref context,
                                itemIndex: arrayValidation_itemCount,
                            ...
                            Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext2);
