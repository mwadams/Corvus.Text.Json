...
public readonly partial struct MigrationTuple
{
...
#endif
    {
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity.Mutable Item1
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity.Mutable>(_idx, 0);
            }
        }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity.Mutable Item2
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity.Mutable>(_idx, 1);
            }
        }
        ...
        /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity.Mutable Item3
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity.Mutable>(_idx, 2);
            }
        }
