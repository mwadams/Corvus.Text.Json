...
public readonly partial struct MigrationTuple
{
    ...
    public readonly partial struct PrefixItems2Entity
#if NET8_0_OR_GREATER
        : IJsonElement<PrefixItems2Entity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal PrefixItems2Entity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PrefixItems2Entity DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(PrefixItems2Entity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in PrefixItems2Entity left, in PrefixItems2Entity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PrefixItems2Entity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PrefixItems2Entity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PrefixItems2Entity(JsonElement instance)
        {
            return PrefixItems2Entity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems2Entity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems2Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems2Entity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems2Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems2Entity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems2Entity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems2Entity>(json, options);
        }
        ...
        /// </exception>
        public static PrefixItems2Entity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PrefixItems2Entity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PrefixItems2Entity? result)
        {
            return JsonElementHelpers.TryParseValue<PrefixItems2Entity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PrefixItems2Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PrefixItems2Entity IJsonElement<PrefixItems2Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PrefixItems2Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
