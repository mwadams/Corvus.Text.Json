...
#endif
{
    ...
    internal MigrationTuple(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity Item1
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems0Entity>(_idx, 0);
        }
    }
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity Item2
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems1Entity>(_idx, 1);
        }
    }
    ...
    /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity Item3
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationTuple.PrefixItems2Entity>(_idx, 2);
        }
    }
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationTuple left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MigrationTuple instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator MigrationTuple(JsonElement instance)
    {
        return MigrationTuple.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationTuple From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationTuple ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationTuple>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationTuple ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationTuple>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationTuple ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationTuple>(json, options);
    }
    ...
    /// </exception>
    public static MigrationTuple ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationTuple>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationTuple? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationTuple>(ref reader, out result);
    }
...
#if NET
    static MigrationTuple IJsonElement<MigrationTuple>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationTuple: ValueKind = {ValueKind} : \"{ToString()}\"";
