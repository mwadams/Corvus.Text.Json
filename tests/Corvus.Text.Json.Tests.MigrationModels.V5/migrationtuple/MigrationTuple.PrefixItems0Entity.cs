...
public readonly partial struct MigrationTuple
{
...
#endif
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PrefixItems0Entity(JsonElement instance)
        {
            return PrefixItems0Entity.From(instance);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems0Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems0Entity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems0Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems0Entity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PrefixItems0Entity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PrefixItems0Entity>(json, options);
        }
        ...
        /// </exception>
        public static PrefixItems0Entity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PrefixItems0Entity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PrefixItems0Entity? result)
        {
            return JsonElementHelpers.TryParseValue<PrefixItems0Entity>(ref reader, out result);
        }
