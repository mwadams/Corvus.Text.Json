...
public readonly partial struct MigrationTuple
{
    ...
    public readonly partial struct PrefixItems1Entity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PrefixItems1Entity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PrefixItems1Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrefixItems1Entity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrefixItems1Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PrefixItems1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PrefixItems1Entity, Mutable>(this);
        }
    }
}
