...
public readonly partial struct MigrationTuple
{
    ...
    public readonly partial struct PrefixItems0Entity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PrefixItems0Entity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PrefixItems0Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrefixItems0Entity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrefixItems0Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PrefixItems0Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PrefixItems0Entity, Mutable>(this);
        }
    }
}
