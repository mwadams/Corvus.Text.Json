...
public readonly partial struct MigrationTuple
{
    ...
    public readonly partial struct PrefixItems2Entity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PrefixItems2Entity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PrefixItems2Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrefixItems2Entity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrefixItems2Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PrefixItems2Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PrefixItems2Entity, Mutable>(this);
        }
    }
}
