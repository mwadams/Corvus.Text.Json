...
#endif
{
    ...
    public bool TryGetNumericValues(Span<int> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 item in EnumerateArray())
        {
    ...
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32 this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.JsonInt32>(_parent, _idx);
    }
