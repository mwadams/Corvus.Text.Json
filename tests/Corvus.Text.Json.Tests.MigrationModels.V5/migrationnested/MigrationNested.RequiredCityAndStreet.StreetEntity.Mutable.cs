    ...
    public readonly partial struct RequiredCityAndStreet
    {
        ...
        public readonly partial struct StreetEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(StreetEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StreetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StreetEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StreetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StreetEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StreetEntity, Mutable>(this);
            }
        }
    }
}
