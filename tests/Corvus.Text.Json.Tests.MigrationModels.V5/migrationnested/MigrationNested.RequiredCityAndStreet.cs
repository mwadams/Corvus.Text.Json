...
public readonly partial struct MigrationNested
{
...
#endif
    {
        ...
        internal RequiredCityAndStreet(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity City
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity Street
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity ZipCode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ZipCodeUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity value))
                {
                    return value;
                }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredCityAndStreet left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredCityAndStreet instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredCityAndStreet(JsonElement instance)
        {
            return RequiredCityAndStreet.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCityAndStreet From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCityAndStreet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCityAndStreet>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCityAndStreet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCityAndStreet>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredCityAndStreet ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredCityAndStreet>(json, options);
        }
        ...
        /// </exception>
        public static RequiredCityAndStreet ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredCityAndStreet>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredCityAndStreet? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredCityAndStreet>(ref reader, out result);
        }
...
#if NET
        static RequiredCityAndStreet IJsonElement<RequiredCityAndStreet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredCityAndStreet: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="City"/>.
            /// </summary>
            public static ReadOnlySpan<byte> City => "city"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Street"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Street => "street"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ZipCode"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ZipCode => "zipCode"u8;
        }
    }
}
