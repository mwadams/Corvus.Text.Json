    ...
    public readonly partial struct RequiredCityAndStreet
    {
        ...
        public readonly partial struct CityEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CityEntity, Mutable>(this);
            }
        }
    }
}
