...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.NameEntity Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.NameEntity value))
            {
                return value;
            }
