...
public readonly partial struct MigrationNested
{
    ...
    public readonly partial struct RequiredCityAndStreet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredCityAndStreet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredCityAndStreet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredCityAndStreet(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity.Mutable City
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity.Mutable Street
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>zipCode</c> property.
            /// </summary>
            public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity.Mutable ZipCode
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ZipCodeUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredCityAndStreet(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>city</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCity(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("city");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CityUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.City, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Set the <c>street</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetStreet(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("street");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StreetUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Street, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Set the <c>zipCode</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetZipCode(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ZipCodeUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ZipCodeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ZipCode, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>zipCode</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveZipCode()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ZipCodeUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredCityAndStreet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredCityAndStreet instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RequiredCityAndStreet"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.CityEntity.Source city,
                in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.StreetEntity.Source street,
                in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity.Source zipCode = default)
            {
                city.AddAsProperty(JsonPropertyNamesEscaped.City, ref builder, escapeName: false);
                street.AddAsProperty(JsonPropertyNamesEscaped.Street, ref builder, escapeName: false);
                zipCode.AddAsProperty(JsonPropertyNamesEscaped.ZipCode, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationNested.RequiredCityAndStreet.ZipCodeEntity.Source zipCode = default)
            {
                Create(ref _builder, city, street, zipCode);
            }
        ...
        {
            return workspace.CreateBuilder<RequiredCityAndStreet, Mutable>(this);
        }
    }
}
