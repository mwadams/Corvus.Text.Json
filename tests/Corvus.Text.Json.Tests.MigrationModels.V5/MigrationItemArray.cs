...
public readonly partial struct MigrationItemArray
    ...
    : IJsonElement<MigrationItemArray>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal MigrationItemArray(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationItemArray.RequiredId>(_parent, _idx);
    }
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationItemArray left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MigrationItemArray instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator MigrationItemArray(JsonElement instance)
    {
        return MigrationItemArray.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationItemArray From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationItemArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationItemArray>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationItemArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationItemArray>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationItemArray ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationItemArray>(json, options);
    }
    ...
    /// </exception>
    public static MigrationItemArray ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationItemArray>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationItemArray? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationItemArray>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MigrationItemArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MigrationItemArray IJsonElement<MigrationItemArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationItemArray: ValueKind = {ValueKind} : \"{ToString()}\"";
