...
#endif
{
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonDate DateOfBirth
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateOfBirthUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonDate value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonEmail Email
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonEmail value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.Text.Json.Tests.MigrationModels.V5.JsonBoolean IsActive
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsActiveUtf8, out Corvus.Text.Json.Tests.MigrationModels.V5.JsonBoolean value))
            {
                return value;
            }
