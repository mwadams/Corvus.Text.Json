...
public readonly partial struct MigrationIntVector
{
...
#endif
    {
        ...
        public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Mutable>(_parent, _idx);
        }
        ...
        public bool TryGetNumericValues(Span<int> items, out int written)
        {
            CheckValidInstance();
            written = 0;
            foreach (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Mutable item in EnumerateArray())
            {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.Source value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity>(this, predicate);
            _documentVersion = _parent.Version;
        }
