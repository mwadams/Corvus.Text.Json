...
public readonly partial struct MigrationIntVector
    ...
    : IJsonElement<MigrationIntVector>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    internal MigrationIntVector(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    public bool TryGetNumericValues(Span<int> items, out int written)
    {
        CheckValidInstance();
        written = 0;
        foreach (Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity item in EnumerateArray())
        {
    ...
    public Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity>(_parent, _idx);
    }
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MigrationIntVector left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationIntVector From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationIntVector ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationIntVector>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationIntVector ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationIntVector>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MigrationIntVector ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MigrationIntVector>(json, options);
    }
    ...
    /// </exception>
    public static MigrationIntVector ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MigrationIntVector>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MigrationIntVector? result)
    {
        return JsonElementHelpers.TryParseValue<MigrationIntVector>(ref reader, out result);
    }
...
#if NET
    static MigrationIntVector IJsonElement<MigrationIntVector>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MigrationIntVector: ValueKind = {ValueKind} : \"{ToString()}\"";
