    ...
    : IJsonElement<MigrationIntVector>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("migration-int-vector.json"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "migration-int-vector.json";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "migration-int-vector.json"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Corvus.Text.Json.Tests.MigrationModels.V5.MigrationIntVector.ItemsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
                ...
                JsonSchemaEvaluation.MatchItemCountLessThanOrEquals(3, arrayValidation_itemCount, "maxItems"u8, ref context);
                ...
                JsonSchemaEvaluation.MatchItemCountGreaterThanOrEquals(3, arrayValidation_itemCount, "minItems"u8, ref context);
            }
        }
