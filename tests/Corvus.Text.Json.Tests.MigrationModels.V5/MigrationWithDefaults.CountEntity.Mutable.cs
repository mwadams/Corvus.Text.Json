...
public readonly partial struct MigrationWithDefaults
{
    ...
    public readonly partial struct CountEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CountEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CountEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CountEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CountEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CountEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CountEntity, Mutable>(this);
        }
    }
}